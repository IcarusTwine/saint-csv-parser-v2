(function()
  print("ClsAlc250 loaded")
  function ClsAlc250.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
    if A0_0:QuestOffer(A2_2, A1_1) then
      A2_2:TurnTo(A1_1)
      A2_2:WaitForTurn()
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EMOTE_HUH)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_CLSALC250_00583_SEVERIAN_000, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_CLSALC250_00583_SEVERIAN_001, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EMOTE_POINT)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_CLSALC250_00583_SEVERIAN_002, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_CLSALC250_00583_SEVERIAN_003, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_CLSALC250_00583_SEVERIAN_004, false)
      A0_0:SystemTalk(A0_0.TEXT_CLSALC250_00583_SYS_000, false)
      A0_0:SystemTalk(A0_0.TEXT_CLSALC250_00583_SYS_001, true)
      A0_0:QuestAccepted()
      return 1
    else
      return 0
  ...
  function ClsAlc250.OnScene00001(A0_3, A1_4, A2_5)
    ...
    L5_8 = A1_4
    L6_9 = A0_3
    L3_6(L4_7, L5_8, L6_9, A0_3.TEXT_CLSALC250_00583_SEVERIAN_010, true)
    L4_7 = A0_3
    L3_6 = A0_3.NpcTrade
    L5_8 = A0_3.NPC_TRADE_INVENTORY_MODE_NORMAL
    L6_9 = nil
    L6_9 = L3_6(L4_7, L5_8, L6_9, nil, A0_3.RITEM0, 1, true)
    if L3_6 == 1 then
      return L3_6, L4_7, L5_8, L6_9
    else
    end
  end
  function ClsAlc250.OnScene00002(A0_10, A1_11, A2_12)
    ...
    L6_16 = A2_12
    L5_15 = A2_12.Talk
    L5_15(L6_16, A1_11, A0_10, A0_10.TEXT_CLSALC250_00583_SEVERIAN_020, false, nil, nil, nil, A0_10.SPEAK_NORMAL_MIDDLE)
    L6_16 = A2_12
    L5_15 = A2_12.Talk
    L5_15(L6_16, A1_11, A0_10, A0_10.TEXT_CLSALC250_00583_SEVERIAN_021, true, nil, nil, nil, A0_10.SPEAK_NORMAL_LONG)
    L6_16 = A2_12
    ...
    L6_16 = A2_12
    L5_15 = A2_12.PlayActionTimeline
    L5_15(L6_16, A0_10.ACTION_TIMELINE_EVENT_ADD_TALK)
    L6_16 = A2_12
    L5_15 = A2_12.Talk
    L5_15(L6_16, A1_11, A0_10, A0_10.TEXT_CLSALC250_00583_SEVERIAN_022, false, nil, nil, nil, A0_10.SPEAK_NORMAL_LONG)
    L6_16 = A2_12
    L5_15 = A2_12.PlayActionTimeline
    L5_15(L6_16, A0_10.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    L6_16 = A2_12
    L5_15 = A2_12.Talk
    L5_15(L6_16, A1_11, A0_10, A0_10.TEXT_CLSALC250_00583_SEVERIAN_023, true, nil, nil, nil, A0_10.SPEAK_NORMAL_MIDDLE)
    L6_16 = A0_10
    L5_15 = A0_10.Wait
    L5_15(L6_16, 10)
    L6_16 = A2_12
    ...
    L6_16 = A2_12
    L5_15 = A2_12.Talk
    L5_15(L6_16, A1_11, A0_10, A0_10.TEXT_CLSALC250_00583_SEVERIAN_024, false, nil, nil, nil, A0_10.SPEAK_NORMAL_LONG)
    L6_16 = A2_12
    L5_15 = A2_12.Talk
    L5_15(L6_16, A1_11, A0_10, A0_10.TEXT_CLSALC250_00583_SEVERIAN_025, false, nil, nil, nil, A0_10.SPEAK_NORMAL_MIDDLE)
    L6_16 = A2_12
    L5_15 = A2_12.Talk
    L5_15(L6_16, A1_11, A0_10, A0_10.TEXT_CLSALC250_00583_SEVERIAN_026, true, nil, nil, nil, A0_10.SPEAK_NORMAL_LONG)
    L6_16 = A0_10
    L5_15 = A0_10.Wait
    L5_15(L6_16, 10)
    L6_16 = A2_12
    ...
    L6_16 = A2_12
    L5_15 = A2_12.Talk
    L5_15(L6_16, A1_11, A0_10, A0_10.TEXT_CLSALC250_00583_SEVERIAN_027, true, nil, nil, nil, A0_10.SPEAK_NORMAL_MIDDLE)
    L6_16 = A0_10
    L5_15 = A0_10.Wait
    L5_15(L6_16, 10)
    L6_16 = A0_10
  ...
  function ClsAlc250.OnScene00003(A0_17, A1_18, A2_19)
  end
  function ClsAlc250.GetEventItems(A0_20, A1_21)
    local L2_22
  ...
  function ClsAlc250.IsTodoChecked(A0_23, A1_24, A2_25)
    local L3_26
