(function()
  print("SubWil117 loaded")
  function SubWil117.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
    ...
    if A0_0:QuestOffer(A2_2, A1_1) then
      ...
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL117_00626_ESMOUR_000_1, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL117_00626_ESMOUR_000_2, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL117_00626_ESMOUR_000_3, true)
      A0_0:QuestAccepted()
      return 1
    else
      return 0
  ...
  function SubWil117.OnScene00001(A0_3, A1_4, A2_5)
    local L3_6, L4_7
    L4_7 = A2_5
    L3_6 = A2_5.TurnTo
    L3_6(L4_7, A1_4)
    ...
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_SUBWIL117_00626_ESMOUR_000_10, false)
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_SUBWIL117_00626_ESMOUR_000_11, true)
    L4_7 = A0_3
  ...
  function SubWil117.GetEventItems(A0_8, A1_9)
    local L2_10
  ...
  function SubWil117.IsTodoChecked(A0_11, A1_12, A2_13)
    local L3_14
