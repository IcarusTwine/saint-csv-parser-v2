(function()
  print("ClsCnj100 loaded")
  function ClsCnj100.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:TurnTo(A1_1)
    A2_2:WaitForTurn()
    if A0_0:QuestOffer(A2_2, A1_1) then
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_ADD_YES, A1_1)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_CLSCNJ100_00211_ESUMIYAN_000_1, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK1, A1_1)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_CLSCNJ100_00211_ESUMIYAN_000_2, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_CLSCNJ100_00211_ESUMIYAN_000_3, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_CLSCNJ100_00211_ESUMIYAN_000_4, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_CLSCNJ100_00211_ESUMIYAN_000_5, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_ADD_YES, A1_1)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_CLSCNJ100_00211_ESUMIYAN_000_6, true)
      A0_0:QuestAccepted()
      return 1
    else
      return 0
  ...
  function ClsCnj100.OnScene00001(A0_3, A1_4, A2_5)
    local L3_6, L4_7
    L4_7 = A2_5
    L3_6 = A2_5.TurnTo
    L3_6(L4_7, A1_4)
    ...
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_CLSCNJ100_00211_ESUMIYAN_000_10, false)
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_CLSCNJ100_00211_ESUMIYAN_000_11, false)
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_CLSCNJ100_00211_ESUMIYAN_000_12, false)
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_CLSCNJ100_00211_ESUMIYAN_000_13, false)
    L4_7 = A2_5
    L3_6 = A2_5.PlayActionTimeline
    L3_6(L4_7, A0_3.ACTION_TIMELINE_EVENT_THINK, A1_4)
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_CLSCNJ100_00211_ESUMIYAN_000_14, false)
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_CLSCNJ100_00211_ESUMIYAN_000_15, false)
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_CLSCNJ100_00211_ESUMIYAN_000_16, false)
    L4_7 = A2_5
    L3_6 = A2_5.PlayActionTimeline
    L3_6(L4_7, A0_3.ACTION_TIMELINE_EVENT_ADD_YES, A1_4)
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_CLSCNJ100_00211_ESUMIYAN_000_17, false)
    L4_7 = A0_3
    L3_6 = A0_3.SystemTalk
    L3_6(L4_7, A0_3.TEXT_CLSCNJ100_00211_SYSTEM_000_20, true)
    L4_7 = A0_3
  ...
  function ClsCnj100.GetEventItems(A0_8, A1_9)
    local L2_10
  ...
  function ClsCnj100.IsTodoChecked(A0_11, A1_12, A2_13)
    local L3_14
