(function()
  print("GaiUsb701 loaded")
  function GaiUsb701.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsb701.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB701_00896_HAURCHEFANT_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB701_00896_HAURCHEFANT_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB701_00896_HAURCHEFANT_000_002, true)
    A0_3:QuestAccepted()
  end
  function GaiUsb701.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7, false)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_GAIUSB701_00896_NPC_000_010, true)
    if A0_6:IsBattleNpcTriggerOwner(A1_7, A2_8, false) == false then
      A0_6:ScenarioMessage(A0_6.TEXT_GAIUSB701_00896_POP_MESSAGE_000)
    else
      A0_6:LogMessage(A0_6.EVENT_NOT_TALK)
    end
  end
  function GaiUsb701.OnScene00003(A0_9, A1_10, A2_11)
    local L3_12, L4_13
    L4_13 = A2_11
    L3_12 = A2_11.LookAt
    L3_12(L4_13, A1_10)
    L4_13 = A2_11
    L3_12 = A2_11.Talk
    L3_12(L4_13, A1_10, A0_9, A0_9.TEXT_GAIUSB701_00896_HAURCHEFANT_000_020, false)
    L4_13 = A2_11
    L3_12 = A2_11.PlayActionTimeline
    L3_12(L4_13, A0_9.ACTION_TIMELINE_EVENT_ADD_YES)
    L4_13 = A2_11
    L3_12 = A2_11.Talk
    L3_12(L4_13, A1_10, A0_9, A0_9.TEXT_GAIUSB701_00896_HAURCHEFANT_000_021, false)
    L4_13 = A2_11
    L3_12 = A2_11.Talk
    L3_12(L4_13, A1_10, A0_9, A0_9.TEXT_GAIUSB701_00896_HAURCHEFANT_000_022, false)
    L4_13 = A2_11
    L3_12 = A2_11.PlayActionTimeline
    L3_12(L4_13, A0_9.ACTION_TIMELINE_EVENT_ADD_YES)
    L4_13 = A2_11
    L3_12 = A2_11.Talk
    L3_12(L4_13, A1_10, A0_9, A0_9.TEXT_GAIUSB701_00896_HAURCHEFANT_000_023, true)
    L4_13 = A0_9
  ...
  function GaiUsb701.OnScene00004(A0_14, A1_15, A2_16)
    A2_16:LookAt(A1_15)
    A2_16:PlayActionTimeline(A0_14.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_16:Talk(A1_15, A0_14, A0_14.TEXT_GAIUSB701_00896_NPC_000_015, true)
  end
  function GaiUsb701.IsTodoChecked(A0_17, A1_18, A2_19)
    local L3_20
