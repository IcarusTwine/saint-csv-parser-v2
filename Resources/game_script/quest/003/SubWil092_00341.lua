(function()
  print("SubWil092 loaded")
  function SubWil092.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
    if A0_0:QuestOffer(A2_2, A1_1) then
      A2_2:TurnTo(A1_1)
      A2_2:WaitForTurn()
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK1)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL092_00341_CHECHEZAN_000, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL092_00341_CHECHEZAN_001, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_ITEM)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL092_00341_CHECHEZAN_002, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL092_00341_CHECHEZAN_003, true)
      return 1
    else
      return 0
    end
  end
  function SubWil092.OnScene00001(A0_3, A1_4, A2_5)
    A0_3:QuestAccepted()
  end
  function SubWil092.OnScene00002(A0_6, A1_7, A2_8)
  ...
  function SubWil092.OnScene00003(A0_16, A1_17, A2_18)
    local L3_19, L4_20
    L4_20 = A2_18
    ...
    L4_20 = A2_18
    L3_19 = A2_18.Talk
    L3_19(L4_20, A1_17, A0_16, A0_16.TEXT_SUBWIL092_00341_CHECHEZAN_011, false)
    L4_20 = A2_18
    L3_19 = A2_18.Talk
    L3_19(L4_20, A1_17, A0_16, A0_16.TEXT_SUBWIL092_00341_CHECHEZAN_012, false)
    L4_20 = A2_18
    L3_19 = A2_18.Talk
    L3_19(L4_20, A1_17, A0_16, A0_16.TEXT_SUBWIL092_00341_CHECHEZAN_013, false)
    L4_20 = A2_18
    L3_19 = A2_18.PlayActionTimeline
    L3_19(L4_20, A0_16.ACTION_TIMELINE_EMOTE_SALUTE)
    L4_20 = A2_18
    L3_19 = A2_18.Talk
    L3_19(L4_20, A1_17, A0_16, A0_16.TEXT_SUBWIL092_00341_CHECHEZAN_014, true)
    L4_20 = A0_16
  ...
  function SubWil092.OnScene00004(A0_21, A1_22, A2_23)
  end
  function SubWil092.GetEventItems(A0_24, A1_25)
    local L2_26
  ...
  function SubWil092.IsTodoChecked(A0_27, A1_28, A2_29)
    local L3_30
...
;(function()
  ...
  function L1_32(A0_35, A1_36, A2_37)
    ...
    if A2_37 == 0 then
      return A1_36:GetQuestUI8BH(L3_38), 4
    elseif A2_37 == 1 then
