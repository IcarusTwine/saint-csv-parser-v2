(function()
  print("StmBdz120 loaded")
  function StmBdz120.OnScene00000(A0_0, A1_1, A2_2)
  ...
  function StmBdz120.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_QUESTION)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDZ120_02670_GEIKO02670_000_000, true)
    A2_5:LookAt(A1_4)
    A2_5:Idle(A0_3.ACTION_TIMELINE_EVENT_BASE_IDLE4)
    A0_3:Wait(30)
    A2_5:TurnTo(A1_4, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDZ120_02670_GEIKO02670_000_001, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDZ120_02670_GEIKO02670_000_002, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDZ120_02670_GEIKO02670_000_003, true)
    A0_3:QuestAccepted()
  end
  function StmBdz120.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7, false)
    A2_8:WaitForTurn()
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_STMBDZ120_02670_AILURUSFULGENS_000_005, true)
    A2_8:WalkOut(0, 1, A0_6.MOVE_WALK)
    A2_8:Transparency(A0_6.TRANS_TYPE_FADE_OUT, 15)
    A2_8:WaitForTransparency()
  end
  function StmBdz120.OnScene00003(A0_9, A1_10, A2_11)
    A2_11:TurnTo(-90, false, true)
    A2_11:WaitForTurn()
    A2_11:Talk(A1_10, A0_9, A0_9.TEXT_STMBDZ120_02670_AILURUSFULGENS_000_005, true)
    A2_11:WalkOut(0, 1, A0_9.MOVE_WALK)
    A2_11:Transparency(A0_9.TRANS_TYPE_FADE_OUT, 15)
    A2_11:WaitForTransparency()
  end
  function StmBdz120.OnScene00004(A0_12, A1_13, A2_14)
    A2_14:TurnTo(A1_13, false)
    A2_14:WaitForTurn()
    A2_14:PlayActionTimeline(A0_12.ACTION_TIMELINE_EVENT_TALK1)
    A2_14:Talk(A1_13, A0_12, A0_12.TEXT_STMBDZ120_02670_GEIKO02670_000_004, true)
  end
  function StmBdz120.OnScene00005(A0_15, A1_16, A2_17)
  ...
  function StmBdz120.OnScene00006(A0_25, A1_26, A2_27)
    local L3_28, L4_29
    L4_29 = A1_26
    ...
    L4_29 = A2_27
    L3_28 = A2_27.Talk
    L3_28(L4_29, A1_26, A0_25, A0_25.TEXT_STMBDZ120_02670_GEIKO02670_000_010, false)
    L4_29 = A2_27
    L3_28 = A2_27.Talk
    L3_28(L4_29, A1_26, A0_25, A0_25.TEXT_STMBDZ120_02670_GEIKO02670_000_011, false)
    L4_29 = A2_27
    L3_28 = A2_27.PlayActionTimeline
    L3_28(L4_29, A0_25.ACTION_TIMELINE_EVENT_TALK1)
    L4_29 = A2_27
    L3_28 = A2_27.Talk
    L3_28(L4_29, A1_26, A0_25, A0_25.TEXT_STMBDZ120_02670_GEIKO02670_000_012, false)
    L4_29 = A2_27
    L3_28 = A2_27.Talk
    L3_28(L4_29, A1_26, A0_25, A0_25.TEXT_STMBDZ120_02670_GEIKO02670_000_013, true)
    L4_29 = A1_26
  ...
  function StmBdz120.GetEventItems(A0_30, A1_31)
    local L2_32
  ...
  function StmBdz120.IsTodoChecked(A0_33, A1_34, A2_35)
    local L3_36
    ...
    if A2_35 == 0 then
      return A1_34:GetQuestUI8AL(L3_36) >= 2
    elseif A2_35 == 1 then
      return false
    end
  end
  ...
  function L1_38(A0_41, A1_42, A2_43, A3_44, A4_45)
    ...
    if A1_42:GetQuestSequence(L5_46) == A0_41.SEQ_1 then
      if A3_44 == A0_41.ACTOR1 then
        if 2 <= A1_42:GetQuestUI8AL(L5_46) then
          return false
        end
  ...
  function L1_38(A0_47, A1_48, A2_49, A3_50, A4_51)
    ...
    if A1_48:GetQuestSequence(L5_52) == A0_47.SEQ_1 then
      if A3_50 == A0_47.ACTOR1 then
        if 2 <= A1_48:GetQuestUI8AL(L5_52) then
          return false
        end
