(function()
  print("SubWil080 loaded")
  function SubWil080.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
    if A0_0:QuestOffer(A2_2, A1_1) then
      A2_2:TurnTo(A1_1)
      A2_2:WaitForTurn()
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_BASE_IDLE2)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL080_00328_DADANEN_000, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK_ANGRY)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL080_00328_DADANEN_001, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL080_00328_DADANEN_002, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL080_00328_DADANEN_003, true)
      A0_0:QuestAccepted()
      return 1
    else
      return 0
  ...
  function SubWil080.OnScene00001(A0_3, A1_4, A2_5)
    ...
    L5_8 = A1_4
    L6_9 = A0_3
    L3_6(L4_7, L5_8, L6_9, A0_3.TEXT_SUBWIL080_00328_DRUNKENSTAG_010, true)
    L4_7 = A0_3
    L3_6 = A0_3.NpcTrade
  ...
  function SubWil080.OnScene00002(A0_10, A1_11, A2_12)
    local L3_13, L4_14
    L4_14 = A2_12
    L3_13 = A2_12.PlayActionTimeline
    L3_13(L4_14, A0_10.ACTION_TIMELINE_EMOTE_HUH)
    L4_14 = A2_12
    L3_13 = A2_12.Talk
    L3_13(L4_14, A1_11, A0_10, A0_10.TEXT_SUBWIL080_00328_DRUNKENSTAG_011, false)
    L4_14 = A2_12
    L3_13 = A2_12.Talk
    L3_13(L4_14, A1_11, A0_10, A0_10.TEXT_SUBWIL080_00328_DRUNKENSTAG_012, false)
    L4_14 = A2_12
    L3_13 = A2_12.PlayActionTimeline
    L3_13(L4_14, A0_10.ACTION_TIMELINE_EVENT_ADD_NO)
    L4_14 = A2_12
    L3_13 = A2_12.Talk
    L3_13(L4_14, A1_11, A0_10, A0_10.TEXT_SUBWIL080_00328_DRUNKENSTAG_013, true)
    L4_14 = A0_10
  ...
  function SubWil080.OnScene00003(A0_15, A1_16, A2_17)
  end
  function SubWil080.GetEventItems(A0_18, A1_19)
    local L2_20
  ...
  function SubWil080.IsTodoChecked(A0_21, A1_22, A2_23)
    local L3_24
