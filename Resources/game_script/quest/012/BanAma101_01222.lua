(function()
  print("BanAma101 loaded")
  function BanAma101.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanAma101.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANAMA101_01222_FIBUBBGAH_000_001, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANAMA101_01222_FIBUBBGAH_000_002, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANAMA101_01222_FIBUBBGAH_000_003, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANAMA101_01222_FIBUBBGAH_000_004, true)
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanAma101.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANAMA101_01222_FIBUBBGAH_000_011, true)
  end
  function BanAma101.OnScene00003(A0_9, A1_10, A2_11)
    ...
    L5_14 = A2_11.WaitForTurn
    L5_14(L6_15)
    L5_14 = A2_11.Talk
    L9_18 = A0_9.TEXT_BANAMA101_01222_FIBUBBGAH_000_021
  ...
  function BanAma101.OnScene00004(A0_19, A1_20, A2_21)
    local L3_22, L4_23
    L4_23 = A2_21
    ...
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_BANAMA101_01222_FIBUBBGAH_000_022, false)
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_BANAMA101_01222_FIBUBBGAH_000_023, true)
    L4_23 = A0_19
    L3_22 = A0_19.QuestReward
    L4_23 = L3_22(L4_23, A2_21, A1_20)
    if L3_22 then
      A0_19:QuestCompleted(A0_19.SCREEN_IMAGE_BEAST_QUEST_COMPLETE)
      if A1_20:IsHowTo(A0_19.HOW_TO_PROOF_OF_FRIENDSHIP) == false then
        A0_19:HowTo(A0_19.HOW_TO_PROOF_OF_FRIENDSHIP)
      end
    else
  ...
  function BanAma101.GetEventItems(A0_24, A1_25)
    local L2_26
    ...
    elseif A1_25:GetQuestSequence(L2_26) == A0_24.SEQ_1 then
      return A0_24.ITEM1, A1_25:GetQuestUI8BL(L2_26), false, A0_24.ITEM0, A1_25:GetQuestUI8CH(L2_26), false
    elseif A1_25:GetQuestSequence(L2_26) == A0_24.SEQ_FINISH then
      return A0_24.ITEM1, A1_25:GetQuestUI8BH(L2_26), false, A0_24.ITEM0, A1_25:GetQuestUI8BL(L2_26), false
    end
  end
  function BanAma101.IsTodoChecked(A0_27, A1_28, A2_29)
    local L3_30
    ...
    elseif A2_29 == 1 then
      return A1_28:GetQuestUI8BL(L3_30) >= 2
    elseif A2_29 == 2 then
      return false
    end
  end
...
;(function()
  ...
  function L1_32(A0_47, A1_48, A2_49)
    ...
    elseif A2_49 == 1 then
      return A1_48:GetQuestUI8BL(L3_50), 2
    elseif A2_49 == 2 then
