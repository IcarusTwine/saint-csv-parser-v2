(function()
  print("SubWil124 loaded")
  function SubWil124.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
    if A0_0:QuestOffer(A2_2, A1_1) then
      A2_2:TurnTo(A1_1)
      A2_2:WaitForTurn()
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EMOTE_WELCOME)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL124_00634_BENEGER_000_1, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL124_00634_BENEGER_000_2, true)
      A0_0:QuestAccepted()
      return 1
    else
      return 0
  ...
  function SubWil124.OnScene00001(A0_3, A1_4, A2_5)
  end
  function SubWil124.OnScene00002(A0_6, A1_7, A2_8)
  end
  function SubWil124.OnScene00003(A0_9, A1_10, A2_11)
  end
  function SubWil124.OnScene00004(A0_12, A1_13, A2_14)
  end
  function SubWil124.OnScene00005(A0_15, A1_16, A2_17)
  end
  function SubWil124.OnScene00006(A0_18, A1_19, A2_20)
  end
  function SubWil124.OnScene00007(A0_21, A1_22, A2_23)
  end
  function SubWil124.OnScene00008(A0_24, A1_25, A2_26)
  end
  function SubWil124.OnScene00009(A0_27, A1_28, A2_29)
  end
  function SubWil124.OnScene00010(A0_30, A1_31, A2_32)
  end
  function SubWil124.OnScene00011(A0_33, A1_34, A2_35)
    ...
    L5_38(L6_39, L7_40)
    L5_38 = A2_35.Talk
    L9_42 = A0_33.TEXT_SUBWIL124_00634_BENEGER_000_10
    L5_38(L6_39, L7_40, L8_41, L9_42, true)
    L5_38 = 1
  ...
  function SubWil124.OnScene00012(A0_43, A1_44, A2_45)
    local L3_46, L4_47
    L4_47 = A2_45
    ...
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_SUBWIL124_00634_BENEGER_000_11, false)
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_SUBWIL124_00634_BENEGER_000_12, false)
    L4_47 = A2_45
    L3_46 = A2_45.PlayActionTimeline
    L3_46(L4_47, A0_43.ACTION_TIMELINE_EMOTE_HUH)
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_SUBWIL124_00634_BENEGER_000_13, false)
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_SUBWIL124_00634_BENEGER_000_14, false)
    L4_47 = A2_45
    L3_46 = A2_45.PlayActionTimeline
    L3_46(L4_47, A0_43.ACTION_TIMELINE_EVENT_ADD_YES)
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_SUBWIL124_00634_BENEGER_000_15, true)
    L4_47 = A0_43
  ...
  function SubWil124.GetEventItems(A0_48, A1_49)
    local L2_50
  ...
  function SubWil124.IsTodoChecked(A0_51, A1_52, A2_53)
    local L3_54
...
;(function()
  ...
  function L1_56(A0_59, A1_60, A2_61, A3_62, A4_63)
    ...
    if A1_60:GetQuestSequence(L5_64) == A0_59.SEQ_1 then
      if A3_62 == A0_59.EOBJECT0 then
        if 5 <= A1_60:GetQuestUI8AL(L5_64) then
          return false
        end
      ...
      elseif A3_62 == A0_59.EOBJECT4 then
        if 5 <= A1_60:GetQuestUI8AL(L5_64) then
          return false
        end
  ...
  function L1_56(A0_71, A1_72, A2_73)
    ...
    if A2_73 == 0 then
      return A1_72:GetQuestUI8AL(L3_74), 5
    elseif A2_73 == 1 then
