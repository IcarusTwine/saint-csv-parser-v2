(function()
  print("FesEvn001 loaded")
  function FesEvn001.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function FesEvn001.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESEVN001_01287_KHLOEBAJHIRI_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESEVN001_01287_KHLOEBAJHIRI_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESEVN001_01287_KHLOEBAJHIRI_000_002, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESEVN001_01287_KHLOEBAJHIRI_000_003, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESEVN001_01287_KHLOEBAJHIRI_000_004, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESEVN001_01287_KHLOEBAJHIRI_000_005, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESEVN001_01287_KHLOEBAJHIRI_000_006, true)
    A0_3:QuestAccepted(A0_3.SCREENIMAGE_ACCEPTED)
  end
  function FesEvn001.OnScene00002(A0_6, A1_7, A2_8)
  ...
  function FesEvn001.OnScene00003(A0_16, A1_17, A2_18)
    A2_18:WaitForTurn()
    A2_18:PlayActionTimeline(A0_16.ACTION_TIMELINE_EVENT_THINK)
    A2_18:Talk(A1_17, A0_16, A0_16.TEXT_FESEVN001_01287_VORSAILE_000_011, false)
    A2_18:Talk(A1_17, A0_16, A0_16.TEXT_FESEVN001_01287_VORSAILE_000_012, true)
    A0_16:Wait(30)
  end
  function FesEvn001.OnScene00004(A0_19, A1_20, A2_21)
    A0_19:BeginCutScene()
    A0_19:PlayCutScene(A0_19.CUT_EVENT1)
    A0_19:EndCutScene()
    A0_19:Skip(A0_19.SKIP_FINALIZE_AUTO_FADEIN)
  end
  function FesEvn001.OnScene00005(A0_22, A1_23, A2_24)
    local L3_25, L4_26
    L4_26 = A0_22
    L3_25 = A0_22.Wait
    L3_25(L4_26, 30)
    ...
    if L3_25 then
      A0_22:QuestCompleted(A0_22.SCREENIMAGE_COMPLETE)
    else
      A0_22:CancelNpcTrade()
    end
    return L3_25, L4_26
  end
  function FesEvn001.GetEventItems(A0_27, A1_28)
    local L2_29
...
;(function()
  ...
  function L1_35(A0_58, A1_59, A2_60, A3_61)
    ...
    elseif A2_60 == A0_58.SEQ_FINISH and A3_61 == A0_58.ACTOR2 then
      ({})[1] = {
        A0_58.ITEM0,
        1,
        false,
