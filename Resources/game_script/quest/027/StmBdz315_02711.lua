(function()
  print("StmBdz315 loaded")
  function StmBdz315.OnScene00000(A0_0, A1_1, A2_2)
  ...
  function StmBdz315.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDZ315_02711_SAIKORO_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDZ315_02711_SAIKORO_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDZ315_02711_SAIKORO_000_002, true)
    A0_3:QuestAccepted()
  end
  function StmBdz315.OnScene00002(A0_6, A1_7, A2_8)
  end
  function StmBdz315.OnScene00003(A0_9, A1_10, A2_11)
    A1_10:LookAt()
    A0_9:SystemTalk(A0_9.TEXT_STMBDZ315_02711_SYSTEM_000_010, true)
  end
  function StmBdz315.OnScene00004(A0_12, A1_13, A2_14)
  end
  function StmBdz315.OnScene00005(A0_15, A1_16, A2_17)
    A1_16:LookAt()
    A0_15:SystemTalk(A0_15.TEXT_STMBDZ315_02711_SYSTEM_000_010, true)
  end
  function StmBdz315.OnScene00006(A0_18, A1_19, A2_20)
  end
  function StmBdz315.OnScene00007(A0_21, A1_22, A2_23)
    A1_22:LookAt()
    A0_21:SystemTalk(A0_21.TEXT_STMBDZ315_02711_SYSTEM_000_010, true)
  end
  function StmBdz315.OnScene00008(A0_24, A1_25, A2_26)
    A2_26:TurnTo(A1_25, false)
    A2_26:WaitForTurn()
    A2_26:PlayActionTimeline(A0_24.ACTION_TIMELINE_EVENT_TALK1)
    A2_26:Talk(A1_25, A0_24, A0_24.TEXT_STMBDZ315_02711_SAIKORO_000_003, true)
  end
  function StmBdz315.OnScene00009(A0_27, A1_28, A2_29)
    A2_29:TurnTo(A1_28, false)
    A2_29:WaitForTurn()
    A2_29:PlayActionTimeline(A0_27.ACTION_TIMELINE_EVENT_TALK_ANGRY)
    A2_29:Talk(A1_28, A0_27, A0_27.TEXT_STMBDZ315_02711_SAIKORO_000_020, false)
    A2_29:Talk(A1_28, A0_27, A0_27.TEXT_STMBDZ315_02711_SAIKORO_000_021, true)
  end
  function StmBdz315.OnScene00010(A0_30, A1_31, A2_32)
    A2_32:TurnTo(A1_31, false)
    A2_32:WaitForTurn()
    A2_32:PlayActionTimeline(A0_30.ACTION_TIMELINE_EVENT_TALK_ANGRY)
    A2_32:Talk(A1_31, A0_30, A0_30.TEXT_STMBDZ315_02711_SAIKORO_000_022, true)
  end
  function StmBdz315.OnScene00011(A0_33, A1_34, A2_35)
  ...
  function StmBdz315.OnScene00012(A0_43, A1_44, A2_45)
    local L3_46, L4_47
    L4_47 = A1_44
    ...
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_STMBDZ315_02711_SAIKORO_000_030, false)
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_STMBDZ315_02711_SAIKORO_000_031, false)
    L4_47 = A2_45
    L3_46 = A2_45.PlayActionTimeline
    L3_46(L4_47, A0_43.ACTION_TIMELINE_EVENT_ADD_YES)
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_STMBDZ315_02711_SAIKORO_000_032, true)
    L4_47 = A2_45
  ...
  function StmBdz315.GetEventItems(A0_48, A1_49)
    local L2_50
  ...
  function StmBdz315.IsTodoChecked(A0_51, A1_52, A2_53)
    local L3_54
    ...
    elseif A2_53 == 2 then
      return 1 <= A1_52:GetQuestUI8BH(L3_54)
    elseif A2_53 == 3 then
      return false
    end
  end
