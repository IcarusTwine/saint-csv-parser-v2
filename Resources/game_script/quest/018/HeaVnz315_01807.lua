(function()
  print("HeaVnz315 loaded")
  function HeaVnz315.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function HeaVnz315.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_NO)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ315_01807_IDATEN_000_000, false)
    A2_5:PlayActionTimeline(A0_3.EVENT_ACTION_SIJI)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ315_01807_IDATEN_000_001, true)
    A0_3:Wait(10)
    A0_3:QuestAccepted()
  end
  function HeaVnz315.OnScene00002(A0_6, A1_7, A2_8)
    if A0_6:IsBattleNpcOwner(A1_7, true) == true or A0_6:IsBattleNpcTriggerOwner(A1_7, A2_8, false) == true then
    else
      A0_6:LogMessage(A0_6.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function HeaVnz315.OnScene00003(A0_9, A1_10, A2_11)
  end
  function HeaVnz315.OnScene00004(A0_12, A1_13, A2_14)
    if A0_12:IsBattleNpcOwner(A1_13, true) == true or A0_12:IsBattleNpcTriggerOwner(A1_13, A2_14, false) == true then
    else
      A0_12:LogMessage(A0_12.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function HeaVnz315.OnScene00005(A0_15, A1_16, A2_17)
  end
  function HeaVnz315.OnScene00006(A0_18, A1_19, A2_20)
    if A0_18:IsBattleNpcOwner(A1_19, true) == true or A0_18:IsBattleNpcTriggerOwner(A1_19, A2_20, false) == true then
    else
      A0_18:LogMessage(A0_18.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function HeaVnz315.OnScene00007(A0_21, A1_22, A2_23)
  end
  function HeaVnz315.OnScene00008(A0_24, A1_25, A2_26)
  end
  function HeaVnz315.OnScene00009(A0_27, A1_28, A2_29)
  end
  function HeaVnz315.OnScene00010(A0_30, A1_31, A2_32)
  end
  function HeaVnz315.OnScene00011(A0_33, A1_34, A2_35)
  end
  function HeaVnz315.OnScene00012(A0_36, A1_37, A2_38)
  end
  function HeaVnz315.OnScene00013(A0_39, A1_40, A2_41)
  end
  function HeaVnz315.OnScene00014(A0_42, A1_43, A2_44)
    A2_44:TurnTo(A1_43, false)
    A2_44:WaitForTurn()
    A2_44:PlayActionTimeline(A0_42.EVENT_ACTION_SIJI)
    A2_44:Talk(A1_43, A0_42, A0_42.TEXT_HEAVNZ315_01807_IDATEN_000_010, true)
  end
  function HeaVnz315.OnScene00015(A0_45, A1_46, A2_47)
    local L3_48, L4_49
    L4_49 = A2_47
    L3_48 = A2_47.TurnTo
    ...
    L4_49 = A2_47
    L3_48 = A2_47.Talk
    L3_48(L4_49, A1_46, A0_45, A0_45.TEXT_HEAVNZ315_01807_IDATEN_000_020, false)
    L4_49 = A2_47
    L3_48 = A2_47.PlayActionTimeline
    L3_48(L4_49, A0_45.ACTION_TIMELINE_EVENT_ADD_YES)
    L4_49 = A2_47
    L3_48 = A2_47.Talk
    L3_48(L4_49, A1_46, A0_45, A0_45.TEXT_HEAVNZ315_01807_IDATEN_000_021, true)
    L4_49 = A0_45
    L3_48 = A0_45.Wait
    L3_48(L4_49, 10)
    L4_49 = A0_45
  ...
  function HeaVnz315.IsTodoChecked(A0_50, A1_51, A2_52)
    local L3_53
  ...
  function HeaVnz315.GetBalloonTalkArgs(A0_54, A1_55, A2_56, A3_57, ...)
    local L5_59
