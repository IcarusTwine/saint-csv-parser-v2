(function()
  print("HeaVna105 loaded")
  function HeaVna105.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function HeaVna105.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNA105_01584_REDWALD_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNA105_01584_REDWALD_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNA105_01584_REDWALD_000_002, true)
    A0_3:QuestAccepted()
  end
  function HeaVna105.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7, false)
    A2_8:WaitForTurn()
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EMOTE_ME)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_HEAVNA105_01584_ROTHE_000_010, true)
    ...
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_HEAVNA105_01584_ROTHE_000_011, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_HEAVNA105_01584_ROTHE_000_012, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_HEAVNA105_01584_ROTHE_000_013, true)
  end
  function HeaVna105.OnScene00003(A0_9, A1_10, A2_11)
    A2_11:TurnTo(A1_10, false)
    A2_11:WaitForTurn()
    A2_11:PlayActionTimeline(A0_9.ACTION_TIMELINE_EVENT_TALK1)
    A2_11:Talk(A1_10, A0_9, A0_9.TEXT_HEAVNA105_01584_REDWALD_000_004, true)
  end
  function HeaVna105.OnScene00004(A0_12, A1_13, A2_14)
  end
  function HeaVna105.OnScene00005(A0_15, A1_16, A2_17)
    if A0_15:IsBattleNpcOwner(A1_16, true) == true or A0_15:IsBattleNpcTriggerOwner(A1_16, A2_17, false) == true then
    else
      A0_15:LogMessage(A0_15.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function HeaVna105.OnScene00006(A0_18, A1_19, A2_20)
  end
  function HeaVna105.OnScene00007(A0_21, A1_22, A2_23)
    if A0_21:IsBattleNpcOwner(A1_22, true) == true or A0_21:IsBattleNpcTriggerOwner(A1_22, A2_23, false) == true then
    else
      A0_21:LogMessage(A0_21.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function HeaVna105.OnScene00008(A0_24, A1_25, A2_26)
  end
  function HeaVna105.OnScene00009(A0_27, A1_28, A2_29)
    if A0_27:IsBattleNpcOwner(A1_28, true) == true or A0_27:IsBattleNpcTriggerOwner(A1_28, A2_29, false) == true then
    else
      A0_27:LogMessage(A0_27.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function HeaVna105.OnScene00010(A0_30, A1_31, A2_32)
  end
  function HeaVna105.OnScene00011(A0_33, A1_34, A2_35)
  ...
  function HeaVna105.OnScene00012(A0_36, A1_37, A2_38)
  end
  function HeaVna105.OnScene00013(A0_39, A1_40, A2_41)
    if A0_39:IsBattleNpcOwner(A1_40, true) == true or A0_39:IsBattleNpcTriggerOwner(A1_40, A2_41, false) == true then
    else
      A0_39:LogMessage(A0_39.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function HeaVna105.OnScene00014(A0_42, A1_43, A2_44)
  end
  function HeaVna105.OnScene00015(A0_45, A1_46, A2_47)
  ...
  function HeaVna105.OnScene00016(A0_48, A1_49, A2_50)
  end
  function HeaVna105.OnScene00017(A0_51, A1_52, A2_53)
  ...
  function HeaVna105.OnScene00018(A0_54, A1_55, A2_56)
  end
  function HeaVna105.OnScene00019(A0_57, A1_58, A2_59)
  ...
  function HeaVna105.OnScene00020(A0_60, A1_61, A2_62)
  end
  function HeaVna105.OnScene00021(A0_63, A1_64, A2_65)
  ...
  function HeaVna105.OnScene00022(A0_66, A1_67, A2_68)
  end
  function HeaVna105.OnScene00023(A0_69, A1_70, A2_71)
  ...
  function HeaVna105.OnScene00024(A0_72, A1_73, A2_74)
    A2_74:TurnTo(A1_73, false)
    A2_74:WaitForTurn()
    A2_74:PlayActionTimeline(A0_72.ACTION_TIMELINE_EVENT_TALK1)
    A2_74:Talk(A1_73, A0_72, A0_72.TEXT_HEAVNA105_01584_ROTHE_000_020, true)
  end
  function HeaVna105.OnScene00025(A0_75, A1_76, A2_77)
    local L3_78, L4_79
    L4_79 = A2_77
    L3_78 = A2_77.TurnTo
    ...
    L4_79 = A2_77
    L3_78 = A2_77.Talk
    L3_78(L4_79, A1_76, A0_75, A0_75.TEXT_HEAVNA105_01584_ROTHE_000_030, false)
    L4_79 = A2_77
    L3_78 = A2_77.PlayActionTimeline
    L3_78(L4_79, A0_75.ACTION_TIMELINE_EMOTE_JOY)
    L4_79 = A2_77
    L3_78 = A2_77.Talk
    L3_78(L4_79, A1_76, A0_75, A0_75.TEXT_HEAVNA105_01584_ROTHE_000_031, true)
    L4_79 = A0_75
  ...
  function HeaVna105.IsTodoChecked(A0_80, A1_81, A2_82)
    local L3_83
  ...
  function L1_85(A0_88, A1_89, A2_90, A3_91, A4_92)
    ...
    elseif A1_89:GetQuestSequence(L5_93) == A0_88.SEQ_2 then
      ...
      elseif A4_92 == A0_88.ENEMY0 then
        return 2 > A1_89:GetQuestUI8BL(L5_93)
  ...
  function L1_85(A0_94, A1_95, A2_96, A3_97, A4_98)
    ...
    elseif A1_95:GetQuestSequence(L5_99) == A0_94.SEQ_2 then
      ...
      elseif A4_98 == A0_94.ENEMY0 then
        return 2 > A1_95:GetQuestUI8BL(L5_99)
