(function()
  print("HeaVnz211 loaded")
  function HeaVnz211.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function HeaVnz211.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ211_01780_HUNTER01780_000_010, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_NO)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ211_01780_HUNTER01780_000_011, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ211_01780_HUNTER01780_000_012, true)
    A0_3:Wait(10)
    A0_3:QuestAccepted()
  end
  function HeaVnz211.OnScene00002(A0_6, A1_7, A2_8)
  end
  function HeaVnz211.OnScene00003(A0_9, A1_10, A2_11)
    A2_11:LookAt(A1_10)
    A2_11:Talk(A1_10, A0_9, A0_9.TEXT_HEAVNZ211_01780_HUNTER01780_000_020, true)
  end
  function HeaVnz211.OnScene00004(A0_12, A1_13, A2_14)
  end
  function HeaVnz211.OnScene00005(A0_15, A1_16, A2_17)
  end
  function HeaVnz211.OnScene00006(A0_18, A1_19, A2_20)
    local L3_21, L4_22
    L4_22 = A2_20
    L3_21 = A2_20.LookAt
    L3_21(L4_22, A1_19)
    L4_22 = A2_20
    L3_21 = A2_20.Talk
    L3_21(L4_22, A1_19, A0_18, A0_18.TEXT_HEAVNZ211_01780_HUNTER01780_000_030, true)
    L4_22 = A0_18
    L3_21 = A0_18.Wait
    L3_21(L4_22, 10)
    L4_22 = A0_18
  ...
  function HeaVnz211.OnScene00007(A0_23, A1_24, A2_25)
  end
  function HeaVnz211.OnScene00008(A0_26, A1_27, A2_28)
  end
  function HeaVnz211.IsTodoChecked(A0_29, A1_30, A2_31)
    local L3_32
...
;(function()
  ...
  function L1_34(A0_37, A1_38, A2_39, A3_40, A4_41)
    ...
    elseif A1_38:GetQuestSequence(L5_42) == A0_37.SEQ_1 then
      if A3_40 == A0_37.ENEMY0 then
        if A1_38:GetQuestUI8AL(L5_42) >= 4 then
          return false
        end
        return A1_38:GetQuestUI8AL(L5_42) < 4
  ...
  function L1_34(A0_43, A1_44, A2_45, A3_46, A4_47)
    ...
    elseif A1_44:GetQuestSequence(L5_48) == A0_43.SEQ_1 then
      if A3_46 == A0_43.ENEMY0 then
        if A1_44:GetQuestUI8AL(L5_48) >= 4 then
          return false
        end
        return A1_44:GetQuestUI8AL(L5_48) < 4
