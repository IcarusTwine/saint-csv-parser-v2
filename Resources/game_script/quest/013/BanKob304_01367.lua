(function()
  print("BanKob304 loaded")
  function BanKob304.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanKob304.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANKOB304_01367_BOBU_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANKOB304_01367_BOBU_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANKOB304_01367_BOBU_000_002, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANKOB304_01367_BOBU_000_003, true)
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanKob304.OnScene00002(A0_6, A1_7, A2_8)
  end
  function BanKob304.OnScene00003(A0_9, A1_10, A2_11)
  end
  function BanKob304.OnScene00004(A0_12, A1_13, A2_14)
  end
  function BanKob304.OnScene00005(A0_15, A1_16, A2_17)
  end
  function BanKob304.OnScene00006(A0_18, A1_19, A2_20)
  end
  function BanKob304.OnScene00007(A0_21, A1_22, A2_23)
  end
  function BanKob304.OnScene00008(A0_24, A1_25, A2_26)
  end
  function BanKob304.OnScene00009(A0_27, A1_28, A2_29)
  end
  function BanKob304.OnScene00010(A0_30, A1_31, A2_32)
  end
  function BanKob304.OnScene00011(A0_33, A1_34, A2_35)
  end
  function BanKob304.OnScene00012(A0_36, A1_37, A2_38)
    A2_38:TurnTo(A1_37)
    A2_38:WaitForTurn()
    A2_38:PlayActionTimeline(A0_36.ACTION_TIMELINE_EVENT_TALK1)
    A2_38:Talk(A1_37, A0_36, A0_36.TEXT_BANKOB304_01367_BOBU_000_004, true)
  end
  function BanKob304.OnScene00013(A0_39, A1_40, A2_41)
  ...
  function BanKob304.OnScene00014(A0_49, A1_50, A2_51)
    A2_51:PlayActionTimeline(A0_49.ACTION_TIMELINE_EVENT_GIVE)
    A2_51:Talk(A1_50, A0_49, A0_49.TEXT_BANKOB304_01367_BAGO_000_011, false)
    A2_51:Talk(A1_50, A0_49, A0_49.TEXT_BANKOB304_01367_BAGO_000_012, true)
  end
  function BanKob304.OnScene00015(A0_52, A1_53, A2_54)
    A2_54:TurnTo(A1_53)
    A2_54:WaitForTurn()
    A2_54:PlayActionTimeline(A0_52.ACTION_TIMELINE_EVENT_TALK1)
    A2_54:Talk(A1_53, A0_52, A0_52.TEXT_BANKOB304_01367_BOBU_000_004, true)
  end
  function BanKob304.OnScene00016(A0_55, A1_56, A2_57)
    local L3_58, L4_59
    L4_59 = A2_57
    L3_58 = A2_57.TurnTo
    L3_58(L4_59, A1_56)
    ...
    L4_59 = A2_57
    L3_58 = A2_57.Talk
    L3_58(L4_59, A1_56, A0_55, A0_55.TEXT_BANKOB304_01367_BOBU_000_020, false)
    L4_59 = A2_57
    L3_58 = A2_57.Talk
    L3_58(L4_59, A1_56, A0_55, A0_55.TEXT_BANKOB304_01367_BOBU_000_021, true)
    L4_59 = A0_55
  ...
  function BanKob304.GetEventItems(A0_60, A1_61)
    local L2_62
  ...
  function BanKob304.IsTodoChecked(A0_63, A1_64, A2_65)
    local L3_66
    ...
    if A2_65 == 0 then
      return A1_64:GetQuestUI8AL(L3_66) >= 5
    elseif A2_65 == 1 then
  ...
  function L1_68(A0_71, A1_72, A2_73, A3_74, A4_75)
    ...
    if A1_72:GetQuestSequence(L5_76) == A0_71.SEQ_1 then
      if A3_74 == A0_71.EOBJECT0 then
        if 5 <= A1_72:GetQuestUI8AL(L5_76) then
          return false
        end
