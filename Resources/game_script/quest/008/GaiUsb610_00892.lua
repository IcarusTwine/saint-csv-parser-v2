(function()
  print("GaiUsb610 loaded")
  function GaiUsb610.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsb610.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_THINK)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB610_00892_PRAIRILLOT_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB610_00892_PRAIRILLOT_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB610_00892_PRAIRILLOT_000_002, true)
    A0_3:QuestAccepted()
  end
  function GaiUsb610.OnScene00002(A0_6, A1_7, A2_8)
  end
  function GaiUsb610.OnScene00003(A0_9, A1_10, A2_11)
  end
  function GaiUsb610.OnScene00004(A0_12, A1_13, A2_14)
  end
  function GaiUsb610.OnScene00005(A0_15, A1_16, A2_17)
  end
  function GaiUsb610.OnScene00006(A0_18, A1_19, A2_20)
  end
  function GaiUsb610.OnScene00007(A0_21, A1_22, A2_23)
  end
  function GaiUsb610.OnScene00008(A0_24, A1_25, A2_26)
  end
  function GaiUsb610.OnScene00009(A0_27, A1_28, A2_29)
  end
  function GaiUsb610.OnScene00010(A0_30, A1_31, A2_32)
  end
  function GaiUsb610.OnScene00011(A0_33, A1_34, A2_35)
  end
  function GaiUsb610.OnScene00012(A0_36, A1_37, A2_38)
  end
  function GaiUsb610.OnScene00013(A0_39, A1_40, A2_41)
  end
  function GaiUsb610.OnScene00014(A0_42, A1_43, A2_44)
  end
  function GaiUsb610.OnScene00015(A0_45, A1_46, A2_47)
  end
  function GaiUsb610.OnScene00016(A0_48, A1_49, A2_50)
  end
  function GaiUsb610.OnScene00017(A0_51, A1_52, A2_53)
  end
  function GaiUsb610.OnScene00018(A0_54, A1_55, A2_56)
    ...
    L5_59 = A0_54.ACTION_TIMELINE_EMOTE_ANGRY_STRONG
    L3_57(L4_58, L5_59)
    L4_58 = A2_56
    L3_57 = A2_56.Talk
    L5_59 = A1_55
  ...
  function GaiUsb610.OnScene00019(A0_64, A1_65, A2_66)
    local L3_67, L4_68
    L4_68 = A2_66
    ...
    L4_68 = A2_66
    L3_67 = A2_66.Talk
    L3_67(L4_68, A1_65, A0_64, A0_64.TEXT_GAIUSB610_00892_STEPHANNOT_000_021, false)
    L4_68 = A2_66
    L3_67 = A2_66.Talk
    L3_67(L4_68, A1_65, A0_64, A0_64.TEXT_GAIUSB610_00892_STEPHANNOT_000_022, true)
    L4_68 = A0_64
  ...
  function GaiUsb610.GetEventItems(A0_69, A1_70)
    local L2_71
  ...
  function GaiUsb610.IsTodoChecked(A0_72, A1_73, A2_74)
    local L3_75
    ...
    if A2_74 == 0 then
      return A1_73:GetQuestUI8AL(L3_75) >= 8
    elseif A2_74 == 1 then
      return false
    end
  end
  ...
  function L1_77(A0_80, A1_81, A2_82, A3_83, A4_84)
    ...
    if A1_81:GetQuestSequence(L5_85) == A0_80.SEQ_1 then
      if A3_83 == A0_80.EOBJECT0 then
        if 8 <= A1_81:GetQuestUI8AL(L5_85) then
          return false
        end
  ...
  function L1_77(A0_86, A1_87, A2_88, A3_89, A4_90)
    ...
    if A1_87:GetQuestSequence(L5_91) == A0_86.SEQ_1 then
      if A3_89 == A0_86.EOBJECT0 then
        if 8 <= A1_87:GetQuestUI8AL(L5_91) then
          return false
        end
