(function()
  print("JobDrg400 loaded")
  function JobDrg400.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function JobDrg400.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRG400_01069_ALBERIC_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_THINK)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRG400_01069_ALBERIC_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRG400_01069_ALBERIC_000_002, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRG400_01069_ALBERIC_000_003, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRG400_01069_ALBERIC_000_004, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRG400_01069_ALBERIC_000_005, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRG400_01069_ALBERIC_000_006, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRG400_01069_ALBERIC_000_007, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_NO)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRG400_01069_ALBERIC_000_008, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRG400_01069_ALBERIC_000_009, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRG400_01069_ALBERIC_000_010, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRG400_01069_ALBERIC_000_011, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_NO)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRG400_01069_ALBERIC_000_012, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRG400_01069_ALBERIC_000_013, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRG400_01069_ALBERIC_000_014, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_NO)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRG400_01069_ALBERIC_000_015, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRG400_01069_ALBERIC_000_016, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRG400_01069_ALBERIC_000_017, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRG400_01069_ALBERIC_000_018, true)
    A0_3:QuestAccepted()
  end
  function JobDrg400.OnScene00002(A0_6, A1_7, A2_8)
    if A0_6:IsBattleNpcTriggerOwner(A1_7, A2_8) == true then
    else
      A2_8:LookAt(A1_7)
      A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
      A2_8:Talk(A1_7, A0_6, A0_6.TEXT_JOBDRG400_01069_HEUSTIENNE_000_020, true)
      A0_6:ScenarioMessage(A0_6.TEXT_JOBDRG400_01069_POP_MESSAGE)
    end
  end
  function JobDrg400.OnScene00003(A0_9, A1_10, A2_11)
    A2_11:LookAt(A1_10)
    A2_11:PlayActionTimeline(A0_9.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_11:Talk(A1_10, A0_9, A0_9.TEXT_JOBDRG400_01069_HEUSTIENNE_000_030, true)
    A2_11:LookAt(0, 0)
    A2_11:WalkOut(-80, 5, A0_9.MOVE_WALK)
    A0_9:Wait(15)
    A2_11:Transparency(A0_9.TRANS_TYPE_FADE_OUT, 30)
    A2_11:WaitForTransparency()
  end
  function JobDrg400.OnScene00004(A0_12, A1_13, A2_14)
    local L3_15, L4_16
    L4_16 = A2_14
    L3_15 = A2_14.TurnTo
    ...
    L4_16 = A2_14
    L3_15 = A2_14.Talk
    L3_15(L4_16, A1_13, A0_12, A0_12.TEXT_JOBDRG400_01069_ALBERIC_000_040, false)
    L4_16 = A2_14
    L3_15 = A2_14.PlayActionTimeline
    L3_15(L4_16, A0_12.ACTION_TIMELINE_EVENT_TALK2)
    L4_16 = A2_14
    L3_15 = A2_14.Talk
    L3_15(L4_16, A1_13, A0_12, A0_12.TEXT_JOBDRG400_01069_ALBERIC_000_041, true)
    L4_16 = A0_12
  ...
  function JobDrg400.OnScene00005(A0_17, A1_18, A2_19, ...)
    local L4_21
    L4_21 = (...)
    A1_18:LookAt()
  ...
  function JobDrg400.IsTodoChecked(A0_22, A1_23, A2_24)
    local L3_25
    ...
    elseif A2_24 == 1 then
      return 1 <= A1_23:GetQuestUI8AL(L3_25)
    elseif A2_24 == 2 then
      return false
    end
  end
  ...
  function L1_27(A0_30, A1_31, A2_32, A3_33, A4_34)
    ...
    if A1_31:GetQuestSequence(L5_35) == A0_30.SEQ_1 then
      ...
      elseif A4_34 == A0_30.ENEMY0 then
        return 5 > A1_31:GetQuestUI8AL(L5_35)
      elseif A4_34 == A0_30.ENEMY1 then
        return 5 > A1_31:GetQuestUI8AL(L5_35)
      elseif A4_34 == A0_30.ENEMY2 then
        return 5 > A1_31:GetQuestUI8AL(L5_35)
      elseif A4_34 == A0_30.ENEMY3 then
        return 5 > A1_31:GetQuestUI8AL(L5_35)
      elseif A4_34 == A0_30.ENEMY4 then
        return 5 > A1_31:GetQuestUI8AL(L5_35)
      end
    end
    return false
