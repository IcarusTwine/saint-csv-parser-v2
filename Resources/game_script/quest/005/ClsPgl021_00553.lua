(function()
  print("ClsPgl021 loaded")
  function ClsPgl021.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function ClsPgl021.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EMOTE_CLAP)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_CLSPGL021_00553_HAMON_000_1, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_CLSPGL021_00553_HAMON_000_2, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_CLSPGL021_00553_HAMON_000_3, true)
    A0_3:QuestAccepted()
  end
  function ClsPgl021.OnScene00002(A0_6, A1_7, A2_8)
    local L3_9, L4_10
    L4_10 = A2_8
    L3_9 = A2_8.TurnTo
    L3_9(L4_10, A1_7)
    ...
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_CLSPGL021_00553_HAMON_000_10, false)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_CLSPGL021_00553_HAMON_000_11, false)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_CLSPGL021_00553_HAMON_000_12, false)
    L4_10 = A2_8
    L3_9 = A2_8.PlayActionTimeline
    L3_9(L4_10, A0_6.TEXT_CLSPGL021_00553_HAMON_000_13)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_CLSPGL021_00553_HAMON_000_13, true)
    L4_10 = A0_6
    L3_9 = A0_6.QuestReward
    L4_10 = L3_9(L4_10, A2_8, A1_7)
    if L3_9 then
      A0_6:QuestCompleted()
      A0_6:SystemTalk(A0_6.TEXT_CLSPGL021_00553_SYSTEM_000_50, true)
    end
    return L3_9, L4_10
  end
  function ClsPgl021.IsTodoChecked(A0_11, A1_12, A2_13)
    local L3_14
