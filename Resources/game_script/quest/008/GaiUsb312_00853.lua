(function()
  print("GaiUsb312 loaded")
  function GaiUsb312.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsb312.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB312_00853_PEBALOH_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB312_00853_PEBALOH_000_001, true)
    A0_3:QuestAccepted()
  end
  function GaiUsb312.OnScene00002(A0_6, A1_7, A2_8)
    A0_6:ScenarioMessage(A0_6.TEXT_GAIUSB312_00853_POP_MESSAGE_000)
  end
  function GaiUsb312.OnScene00003(A0_9, A1_10, A2_11)
  end
  function GaiUsb312.OnScene00004(A0_12, A1_13, A2_14)
  end
  function GaiUsb312.OnScene00005(A0_15, A1_16, A2_17)
  end
  function GaiUsb312.OnScene00006(A0_18, A1_19, A2_20)
  end
  function GaiUsb312.OnScene00007(A0_21, A1_22, A2_23)
  end
  function GaiUsb312.OnScene00008(A0_24, A1_25, A2_26)
  end
  function GaiUsb312.OnScene00009(A0_27, A1_28, A2_29)
    local L3_30, L4_31
    L4_31 = A2_29
    L3_30 = A2_29.TurnTo
    ...
    L4_31 = A2_29
    L3_30 = A2_29.Talk
    L3_30(L4_31, A1_28, A0_27, A0_27.TEXT_GAIUSB312_00853_PEBALOH_000_030, false)
    L4_31 = A2_29
    L3_30 = A2_29.PlayActionTimeline
    L3_30(L4_31, A0_27.ACTION_TIMELINE_EMOTE_BOW)
    L4_31 = A2_29
    L3_30 = A2_29.Talk
    L3_30(L4_31, A1_28, A0_27, A0_27.TEXT_GAIUSB312_00853_PEBALOH_000_031, true)
    L4_31 = A0_27
  ...
  function GaiUsb312.IsTodoChecked(A0_32, A1_33, A2_34)
    local L3_35
