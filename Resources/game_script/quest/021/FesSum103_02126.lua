(function()
  print("FesSum103 loaded")
  function FesSum103.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function FesSum103.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    if A1_4:IsQuestCompleted(A0_3.QUEST0) ~= true then
      A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESSUM103_02126_ESPAN_000_000, false)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESSUM103_02126_ESPAN_000_001, false)
    end
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESSUM103_02126_ESPAN_000_002, true)
    A0_3:SystemTalk(A0_3.TEXT_FESSUM103_02126_SYSTEM_000_003, false)
    A0_3:SystemTalk(A0_3.TEXT_FESSUM103_02126_SYSTEM_000_004, true)
    A0_3:QuestAccepted()
  end
  function FesSum103.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7, false)
    A2_8:WaitForTurn()
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK2)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_FESSUM103_02126_ESPAN_000_005, true)
  end
  function FesSum103.OnScene00003(A0_9, A1_10, A2_11)
    A2_11:TurnTo(A1_10, false)
    A2_11:WaitForTurn()
    A2_11:PlayActionTimeline(A0_9.ACTION_TIMELINE_EVENT_TALK2)
    A2_11:Talk(A1_10, A0_9, A0_9.TEXT_FESSUM103_02126_SENDO02126_000_08, true)
    return (A0_9:YesNo(A0_9.TEXT_FESSUM103_02126_Q1_000_050, A0_9.TEXT_FESSUM103_02126_A1_000_051, A0_9.TEXT_FESSUM103_02126_A1_000_052, A0_9.DEFAULT_NO))
  end
  function FesSum103.OnScene00004(A0_12, A1_13, A2_14)
  ...
  function FesSum103.OnScene00005(A0_22, A1_23, A2_24)
    local L3_25, L4_26
    L4_26 = A1_23
    L3_25 = A1_23.IsQuestCompleted
    L3_25 = L3_25(L4_26, A0_22.QUEST0)
    if L3_25 ~= true then
      L4_26 = A2_24
      ...
      L4_26 = A2_24
      L3_25 = A2_24.Talk
      L3_25(L4_26, A1_23, A0_22, A0_22.TEXT_FESSUM103_02126_ESPAN_000_020, false)
      L4_26 = A2_24
      L3_25 = A2_24.Talk
      L3_25(L4_26, A1_23, A0_22, A0_22.TEXT_FESSUM103_02126_ESPAN_000_021, true)
    else
      L4_26 = A2_24
      L3_25 = A2_24.PlayActionTimeline
  ...
  function FesSum103.GetEventItems(A0_27, A1_28)
    local L2_29
  ...
  function FesSum103.IsTodoChecked(A0_30, A1_31, A2_32)
    local L3_33
  ...
  function L1_35(A0_38, A1_39, A2_40, A3_41, A4_42)
    ...
    if A1_39:GetQuestSequence(L5_43) == A0_38.SEQ_1 then
      ...
      elseif A3_41 == A0_38.ACTOR2 then
        return A1_39:GetQuestUI8AL(L5_43) < 1
      end
    end
    return false
  end
