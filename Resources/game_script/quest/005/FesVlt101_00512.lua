(function()
  print("FesVlt101 loaded")
  function FesVlt101.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function FesVlt101.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EMOTE_POSING)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESVLT101_00512_LISSETE_000_001, false)
    ...
    if A1_4:IsQuestCompleted(A0_3.QUEST0) == true then
      ...
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESVLT101_00512_LISSETE_000_002, false)
    else
      A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EMOTE_BLOWKISS)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESVLT101_00512_LISSETE_000_003, false)
    end
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EMOTE_JOY_STRONG)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESVLT101_00512_LISSETE_000_004, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESVLT101_00512_LISSETE_000_005, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESVLT101_00512_LISSETE_000_006, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EMOTE_BLOWKISS)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESVLT101_00512_LISSETE_100_006, true)
    A0_3:QuestAccepted()
  end
  function FesVlt101.OnScene00002(A0_6, A1_7, A2_8)
    local L3_9, L4_10
    L4_10 = A2_8
    L3_9 = A2_8.TurnTo
    ...
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_FESVLT101_00512_HORTEFENSE_000_010, true)
    L4_10 = A2_8
    ...
    L4_10 = A2_8
    L3_9 = A2_8.PlayActionTimeline
    L3_9(L4_10, A0_6.ACTION_TIMELINE_EMOTE_LAUGH)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_FESVLT101_00512_HORTEFENSE_000_011, true)
    L4_10 = A2_8
    L3_9 = A2_8.CancelActionTimeline
    L3_9(L4_10, A0_6.ACTION_TIMELINE_EMOTE_LAUGH)
    L4_10 = A2_8
    ...
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_FESVLT101_00512_HORTEFENSE_000_012, false)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_FESVLT101_00512_HORTEFENSE_000_013, false)
    L4_10 = A2_8
    L3_9 = A2_8.PlayActionTimeline
    L3_9(L4_10, A0_6.ACTION_TIMELINE_EVENT_TALK1)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_FESVLT101_00512_HORTEFENSE_000_014, false)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_FESVLT101_00512_HORTEFENSE_000_015, false)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_FESVLT101_00512_HORTEFENSE_000_016, true)
    L4_10 = A0_6
  ...
  function FesVlt101.OnScene00003(A0_11, A1_12, A2_13)
    A2_13:TurnTo(A1_12, false)
    A2_13:WaitForTurn()
    A2_13:PlayActionTimeline(A0_11.ACTION_TIMELINE_EMOTE_BLOWKISS)
    A2_13:Talk(A1_12, A0_11, A0_11.TEXT_FESVLT101_00512_LISSETE_000_008, true)
  end
  function FesVlt101.IsTodoChecked(A0_14, A1_15, A2_16)
    local L3_17
