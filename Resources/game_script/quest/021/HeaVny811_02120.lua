(function()
  print("HeaVny811 loaded")
  function HeaVny811.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function HeaVny811.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2, A1_4)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNY811_02120_EUSTACIA_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNY811_02120_EUSTACIA_000_001, true)
    A0_3:QuestAccepted()
  end
  function HeaVny811.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:LookAt(A1_7)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_HEAVNY811_02120_ARDOLAIN_000_010, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_HEAVNY811_02120_ARDOLAIN_000_011, true)
  end
  function HeaVny811.OnScene00003(A0_9, A1_10, A2_11)
    A2_11:TurnTo(A1_10, false)
    A2_11:Talk(A1_10, A0_9, A0_9.TEXT_HEAVNY811_02120_EUSTACIA_000_012, true)
  end
  function HeaVny811.OnScene00004(A0_12, A1_13, A2_14)
  end
  function HeaVny811.OnScene00005(A0_15, A1_16, A2_17)
    local L3_18, L4_19
    L4_19 = A0_15
    L3_18 = A0_15.SystemTalk
    L3_18(L4_19, A0_15.TEXT_HEAVNY811_02120_SYSTEM_100_020, true)
    L4_19 = A0_15
    ...
    if L3_18 then
      ...
      A0_15:Wait(125)
      A0_15:ScenarioMessage(A0_15.TEXT_HEAVNY811_02120_SYSTEM_000_020)
      A0_15:Wait(15)
      A0_15:SystemTalk(A0_15.TEXT_HEAVNY811_02120_SYSTEM_000_021, true)
    end
    return L3_18, L4_19
  end
  function HeaVny811.OnScene00006(A0_20, A1_21, A2_22)
    A2_22:TurnTo(A1_21, false)
    A2_22:Talk(A1_21, A0_20, A0_20.TEXT_HEAVNY811_02120_EUSTACIA_000_012, true)
  end
  function HeaVny811.OnScene00007(A0_23, A1_24, A2_25)
    A2_25:LookAt(A1_24)
    A2_25:Talk(A1_24, A0_23, A0_23.TEXT_HEAVNY811_02120_ARDOLAIN_000_024, true)
  end
  function HeaVny811.IsTodoChecked(A0_26, A1_27, A2_28)
    local L3_29
