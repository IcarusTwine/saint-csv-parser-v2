(function()
  print("BanKob102 loaded")
  function BanKob102.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanKob102.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANKOB102_01326_BOZU_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANKOB102_01326_BOZU_000_001, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANKOB102_01326_BOZU_000_002, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANKOB102_01326_BOZU_000_003, true)
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanKob102.OnScene00002(A0_6, A1_7, A2_8)
  end
  function BanKob102.OnScene00003(A0_9, A1_10, A2_11)
  end
  function BanKob102.OnScene00004(A0_12, A1_13, A2_14)
  end
  function BanKob102.OnScene00005(A0_15, A1_16, A2_17)
  end
  function BanKob102.OnScene00006(A0_18, A1_19, A2_20)
  end
  function BanKob102.OnScene00007(A0_21, A1_22, A2_23)
  end
  function BanKob102.OnScene00008(A0_24, A1_25, A2_26)
  end
  function BanKob102.OnScene00009(A0_27, A1_28, A2_29)
  end
  function BanKob102.OnScene00010(A0_30, A1_31, A2_32)
  end
  function BanKob102.OnScene00011(A0_33, A1_34, A2_35)
  end
  function BanKob102.OnScene00012(A0_36, A1_37, A2_38)
  end
  function BanKob102.OnScene00013(A0_39, A1_40, A2_41)
  end
  function BanKob102.OnScene00014(A0_42, A1_43, A2_44)
    A2_44:TurnTo(A1_43, false)
    A2_44:Talk(A1_43, A0_42, A0_42.TEXT_BANKOB102_01326_BOZU_000_004, true)
  end
  function BanKob102.OnScene00015(A0_45, A1_46, A2_47)
    ...
    if L6_51 == 1 then
      L9_54 = A1_46
      L7_52(L8_53, L9_54, A0_45, A0_45.TEXT_BANKOB102_01326_BOZU_000_011, false)
      L9_54 = A1_46
      L7_52(L8_53, L9_54, A0_45, A0_45.TEXT_BANKOB102_01326_BOZU_000_012, true)
      return L6_51
    else
    end
  end
  function BanKob102.OnScene00016(A0_55, A1_56, A2_57)
    local L3_58, L4_59
    L4_59 = A0_55
    ...
    if L3_58 then
      ...
      if A1_56:IsHowTo(A0_55.HOW_TO_PROOF_OF_FRIENDSHIP) == false then
        A0_55:HowTo(A0_55.HOW_TO_PROOF_OF_FRIENDSHIP)
      end
    else
  ...
  function BanKob102.GetEventItems(A0_60, A1_61)
    local L2_62
  ...
  function BanKob102.IsTodoChecked(A0_63, A1_64, A2_65)
    local L3_66
  ...
  function L1_68(A0_87, A1_88, A2_89)
    ...
    if A1_88:GetQuestSequence(L3_90) == A0_87.SEQ_1 then
      if A2_89:GetBaseId() == A0_87.EOBJECT0 then
        if 3 <= A1_88:GetQuestUI8AL(L3_90) then
          return true, false
        end
        if A1_88:GetQuestBitFlag8(L3_90, 1) then
          return true, false
        end
      end
