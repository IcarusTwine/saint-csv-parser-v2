(function()
  print("StmBdz320 loaded")
  function StmBdz320.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function StmBdz320.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDZ320_02716_MISAGO_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDZ320_02716_MISAGO_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDZ320_02716_MISAGO_000_002, true)
    A0_3:QuestAccepted()
  end
  function StmBdz320.OnScene00002(A0_6, A1_7, A2_8)
  end
  function StmBdz320.OnScene00003(A0_9, A1_10, A2_11)
  end
  function StmBdz320.OnScene00004(A0_12, A1_13, A2_14)
  end
  function StmBdz320.OnScene00005(A0_15, A1_16, A2_17)
  end
  function StmBdz320.OnScene00006(A0_18, A1_19, A2_20)
  end
  function StmBdz320.OnScene00007(A0_21, A1_22, A2_23)
  end
  function StmBdz320.OnScene00008(A0_24, A1_25, A2_26)
  end
  function StmBdz320.OnScene00009(A0_27, A1_28, A2_29)
  end
  function StmBdz320.OnScene00010(A0_30, A1_31, A2_32)
  end
  function StmBdz320.OnScene00011(A0_33, A1_34, A2_35)
  end
  function StmBdz320.OnScene00012(A0_36, A1_37, A2_38)
  end
  function StmBdz320.OnScene00013(A0_39, A1_40, A2_41)
  end
  function StmBdz320.OnScene00014(A0_42, A1_43, A2_44)
    A2_44:TurnTo(A1_43, false)
    A2_44:WaitForTurn()
    A2_44:PlayActionTimeline(A0_42.ACTION_TIMELINE_EVENT_TALK1)
    A2_44:Talk(A1_43, A0_42, A0_42.TEXT_STMBDZ320_02716_MISAGO_000_003, true)
  end
  function StmBdz320.OnScene00015(A0_45, A1_46, A2_47)
  ...
  function StmBdz320.OnScene00016(A0_55, A1_56, A2_57)
    local L3_58, L4_59
    L4_59 = A1_56
    ...
    L4_59 = A2_57
    L3_58 = A2_57.Talk
    L3_58(L4_59, A1_56, A0_55, A0_55.TEXT_STMBDZ320_02716_MISAGO_000_010, false)
    L4_59 = A2_57
    L3_58 = A2_57.Talk
    L3_58(L4_59, A1_56, A0_55, A0_55.TEXT_STMBDZ320_02716_MISAGO_000_011, false)
    L4_59 = A2_57
    L3_58 = A2_57.Talk
    L3_58(L4_59, A1_56, A0_55, A0_55.TEXT_STMBDZ320_02716_MISAGO_000_012, true)
    L4_59 = A1_56
    L3_58 = A1_56.CancelActionTimeline
    L3_58(L4_59, A0_55.ACTION_TIMELINE_EVENT_ITEM)
    L4_59 = A0_55
  ...
  function StmBdz320.GetEventItems(A0_60, A1_61)
    local L2_62
  ...
  function StmBdz320.IsTodoChecked(A0_63, A1_64, A2_65)
    local L3_66
    ...
    if A2_65 == 0 then
      return A1_64:GetQuestUI8BH(L3_66) >= 3
    elseif A2_65 == 1 then
      return 3 <= A1_64:GetQuestUI8AL(L3_66)
    elseif A2_65 == 2 then
      return 3 <= A1_64:GetQuestUI8DH(L3_66)
    elseif A2_65 == 3 then
      return false
    end
  end
...
;(function()
  ...
  function L1_68(A0_71, A1_72, A2_73, A3_74, A4_75)
    ...
    if A1_72:GetQuestSequence(L5_76) == A0_71.SEQ_1 then
      if A3_74 == A0_71.EOBJECT0 then
        if 3 <= A1_72:GetQuestUI8BH(L5_76) then
          return false
        end
      ...
      elseif A3_74 == A0_71.EOBJECT3 then
        if 3 <= A1_72:GetQuestUI8AL(L5_76) then
          return false
        end
      ...
      elseif A3_74 == A0_71.ENEMY0 then
        return 3 > A1_72:GetQuestUI8DH(L5_76)
  ...
  function L1_68(A0_77, A1_78, A2_79, A3_80, A4_81)
    ...
    if A1_78:GetQuestSequence(L5_82) == A0_77.SEQ_1 then
      if A3_80 == A0_77.EOBJECT0 then
        if 3 <= A1_78:GetQuestUI8BH(L5_82) then
          return false
        end
      ...
      elseif A3_80 == A0_77.EOBJECT3 then
        if 3 <= A1_78:GetQuestUI8AL(L5_82) then
          return false
        end
      ...
      elseif A3_80 == A0_77.ENEMY0 then
        return 3 > A1_78:GetQuestUI8DH(L5_82)
  ...
  function L1_68(A0_83, A1_84, A2_85)
    ...
    if A2_85 == 0 then
      return A1_84:GetQuestUI8BH(L3_86), 3
    elseif A2_85 == 1 then
      return A1_84:GetQuestUI8AL(L3_86), 3
    elseif A2_85 == 2 then
      return A1_84:GetQuestUI8DH(L3_86), 3
    elseif A2_85 == 3 then
