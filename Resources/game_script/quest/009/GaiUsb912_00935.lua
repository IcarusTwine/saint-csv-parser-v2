(function()
  print("GaiUsb912 loaded")
  function GaiUsb912.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsb912.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_THINK)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB912_00935_CHARMINE_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_NO)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB912_00935_CHARMINE_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB912_00935_CHARMINE_000_002, true)
    A0_3:QuestAccepted()
  end
  function GaiUsb912.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:LookAt(A1_7)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_CHAIR_TALK)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_GAIUSB912_00935_LAURENCE_000_010, false)
    A2_8:TurnTo(A1_7, false)
    A2_8:WaitForTurn()
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK_ANGRY)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_GAIUSB912_00935_LAURENCE_000_011, true)
  end
  function GaiUsb912.OnScene00003(A0_9, A1_10, A2_11)
  end
  function GaiUsb912.OnScene00004(A0_12, A1_13, A2_14)
  end
  function GaiUsb912.OnScene00005(A0_15, A1_16, A2_17)
    A2_17:LookAt(A1_16)
    A2_17:PlayActionTimeline(A0_15.ACTION_TIMELINE_EVENT_CHAIR_TALK)
    A2_17:Talk(A1_16, A0_15, A0_15.TEXT_GAIUSB912_00935_LAURENCE_000_015, true)
  end
  function GaiUsb912.OnScene00006(A0_18, A1_19, A2_20)
  ...
  function GaiUsb912.OnScene00007(A0_28, A1_29, A2_30)
    local L3_31, L4_32
    L4_32 = A2_30
    L3_31 = A2_30.TurnTo
    ...
    L4_32 = A2_30
    L3_31 = A2_30.Talk
    L3_31(L4_32, A1_29, A0_28, A0_28.TEXT_GAIUSB912_00935_CHARMINE_000_040, false)
    L4_32 = A2_30
    L3_31 = A2_30.Talk
    L3_31(L4_32, A1_29, A0_28, A0_28.TEXT_GAIUSB912_00935_CHARMINE_000_041, false)
    L4_32 = A2_30
    L3_31 = A2_30.PlayActionTimeline
    L3_31(L4_32, A0_28.ACTION_TIMELINE_EVENT_ADD_YES)
    L4_32 = A2_30
    L3_31 = A2_30.Talk
    L3_31(L4_32, A1_29, A0_28, A0_28.TEXT_GAIUSB912_00935_CHARMINE_000_042, true)
    L4_32 = A0_28
  ...
  function GaiUsb912.OnScene00008(A0_33, A1_34, A2_35)
    A2_35:LookAt(A1_34)
    A2_35:PlayActionTimeline(A0_33.ACTION_TIMELINE_EVENT_CHAIR_TALK)
    A2_35:Talk(A1_34, A0_33, A0_33.TEXT_GAIUSB912_00935_LAURENCE_000_015, true)
  end
  function GaiUsb912.GetEventItems(A0_36, A1_37)
    local L2_38
  ...
  function GaiUsb912.IsTodoChecked(A0_39, A1_40, A2_41)
    local L3_42
