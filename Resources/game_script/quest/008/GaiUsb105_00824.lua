(function()
  print("GaiUsb105 loaded")
  function GaiUsb105.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsb105.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB105_00824_UKHUBATIA_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB105_00824_UKHUBATIA_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB105_00824_UKHUBATIA_000_002, true)
    A0_3:QuestAccepted()
  end
  function GaiUsb105.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_GAIUSB105_00824_RIRIDESU_000_010, true)
  end
  function GaiUsb105.OnScene00003(A0_9, A1_10, A2_11)
    A2_11:TurnTo(A1_10, false)
    A2_11:Talk(A1_10, A0_9, A0_9.TEXT_GAIUSB105_00824_DRIFTINGCLOUD_000_020, true)
  end
  function GaiUsb105.OnScene00004(A0_12, A1_13, A2_14)
    A2_14:LookAt(A1_13)
    A2_14:Talk(A1_13, A0_12, A0_12.TEXT_GAIUSB105_00824_SIDIMUND_000_030, true)
  end
  function GaiUsb105.OnScene00005(A0_15, A1_16, A2_17)
    local L3_18, L4_19
    L4_19 = A2_17
    L3_18 = A2_17.TurnTo
    ...
    L4_19 = A2_17
    L3_18 = A2_17.Talk
    L3_18(L4_19, A1_16, A0_15, A0_15.TEXT_GAIUSB105_00824_UKHUBATIA_000_050, false)
    L4_19 = A2_17
    L3_18 = A2_17.PlayActionTimeline
    L3_18(L4_19, A0_15.ACTION_TIMELINE_EVENT_ADD_YES)
    L4_19 = A2_17
    L3_18 = A2_17.Talk
    L3_18(L4_19, A1_16, A0_15, A0_15.TEXT_GAIUSB105_00824_UKHUBATIA_000_051, true)
    L4_19 = A0_15
  ...
  function GaiUsb105.IsTodoChecked(A0_20, A1_21, A2_22)
    local L3_23
    ...
    if A2_22 == 0 then
      return A1_21:GetQuestUI8AH(L3_23) >= 3
    elseif A2_22 == 1 then
      return false
    end
  end
...
;(function()
  ...
  function L1_25(A0_40, A1_41, A2_42)
    ...
    if A2_42 == 0 then
      return A1_41:GetQuestUI8AH(L3_43), 3
    elseif A2_42 == 1 then
