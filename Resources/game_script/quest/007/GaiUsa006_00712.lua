(function()
  print("GaiUsa006 loaded")
  function GaiUsa006.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsa006.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_QUESTION)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA006_00712_YSABEL_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA006_00712_YSABEL_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA006_00712_YSABEL_000_002, true)
    A0_3:QuestAccepted()
  end
  function GaiUsa006.OnScene00002(A0_6, A1_7, A2_8)
    A0_6:Inventory(true)
  end
  function GaiUsa006.OnScene00003(A0_9, A1_10, A2_11)
  end
  function GaiUsa006.OnScene00004(A0_12, A1_13, A2_14)
    A0_12:Inventory(true)
  end
  function GaiUsa006.OnScene00005(A0_15, A1_16, A2_17)
  end
  function GaiUsa006.OnScene00006(A0_18, A1_19, A2_20)
    A0_18:Inventory(true)
  end
  function GaiUsa006.OnScene00007(A0_21, A1_22, A2_23)
  end
  function GaiUsa006.OnScene00008(A0_24, A1_25, A2_26)
    local L3_27, L4_28
    L4_28 = A2_26
    L3_27 = A2_26.TurnTo
    L3_27(L4_28, A1_25)
    ...
    L4_28 = A2_26
    L3_27 = A2_26.Talk
    L3_27(L4_28, A1_25, A0_24, A0_24.TEXT_GAIUSA006_00712_YSABEL_000_010, false)
    L4_28 = A2_26
    L3_27 = A2_26.Talk
    L3_27(L4_28, A1_25, A0_24, A0_24.TEXT_GAIUSA006_00712_YSABEL_000_011, false)
    L4_28 = A2_26
    L3_27 = A2_26.PlayActionTimeline
    L3_27(L4_28, A0_24.ACTION_TIMELINE_EMOTE_ME)
    L4_28 = A2_26
    L3_27 = A2_26.Talk
    L3_27(L4_28, A1_25, A0_24, A0_24.TEXT_GAIUSA006_00712_YSABEL_000_012, true)
    L4_28 = A0_24
  ...
  function GaiUsa006.OnScene00009(A0_29, A1_30, A2_31)
  end
  function GaiUsa006.OnScene00010(A0_32, A1_33, A2_34)
  end
  function GaiUsa006.OnScene00011(A0_35, A1_36, A2_37)
  end
  function GaiUsa006.OnScene00012(A0_38, A1_39, A2_40)
  end
  function GaiUsa006.OnScene00013(A0_41, A1_42, A2_43)
  end
  function GaiUsa006.OnScene00014(A0_44, A1_45, A2_46)
  end
  function GaiUsa006.GetEventItems(A0_47, A1_48)
    local L2_49
  ...
  function GaiUsa006.IsTodoChecked(A0_50, A1_51, A2_52)
    local L3_53
...
;(function()
  ...
  function L1_55(A0_70, A1_71, A2_72, A3_73)
    ...
    L4_74 = L4_74(A0_70)
    if A1_71:GetQuestSequence(L4_74) == A0_70.SEQ_1 and (A2_72:GetBaseId() == A0_70.EOBJECT0 or A2_72:GetBaseId() == A0_70.EOBJECT1 or A2_72:GetBaseId() == A0_70.EOBJECT2) and A3_73 == A0_70.ITEM0 then
      return true
    end
    return false
  end
  ...
  function L1_55(A0_79, A1_80, A2_81, A3_82)
    ...
    if A1_80:GetQuestSequence(L4_83) == A0_79.SEQ_1 then
      if A2_81:GetBaseId() == A0_79.EOBJECT0 then
        if 3 <= A1_80:GetQuestUI8AL(L4_83) then
          return false
        end
  ...
  function L1_55(A0_84, A1_85, A2_86)
    ...
    if A1_85:GetQuestSequence(L3_87) == A0_84.SEQ_1 then
      if A2_86:GetBaseId() == A0_84.EOBJECT0 then
        if 3 <= A1_85:GetQuestUI8AL(L3_87) then
          return true, false
        end
