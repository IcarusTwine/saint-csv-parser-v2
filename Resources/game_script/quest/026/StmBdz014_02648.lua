(function()
  print("StmBdz014 loaded")
  function StmBdz014.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function StmBdz014.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_BIG)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDZ014_02648_PANICMAN02648_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDZ014_02648_PANICMAN02648_000_001, true)
    A0_3:QuestAccepted()
  end
  function StmBdz014.OnScene00002(A0_6, A1_7, A2_8)
    if A0_6:IsBattleNpcOwner(A1_7, true) == true or A0_6:IsBattleNpcTriggerOwner(A1_7, A2_8, false) == true then
    else
      A0_6:LogMessage(A0_6.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function StmBdz014.OnScene00003(A0_9, A1_10, A2_11)
  end
  function StmBdz014.OnScene00004(A0_12, A1_13, A2_14)
    A0_12:LogMessage(A0_12.EVENT_NOT_TALK)
  end
  function StmBdz014.OnScene00005(A0_15, A1_16, A2_17)
  end
  function StmBdz014.OnScene00006(A0_18, A1_19, A2_20)
    A2_20:TurnTo(A1_19, false)
    A2_20:WaitForTurn()
    A2_20:PlayActionTimeline(A0_18.ACTION_TIMELINE_EVENT_TALK_BIG)
    A2_20:Talk(A1_19, A0_18, A0_18.TEXT_STMBDZ014_02648_PANICMAN02648_000_003, true)
  end
  function StmBdz014.OnScene00007(A0_21, A1_22, A2_23)
  end
  function StmBdz014.OnScene00008(A0_24, A1_25, A2_26)
    A2_26:TurnTo(A1_25, false)
    A2_26:WaitForTurn()
    A2_26:PlayActionTimeline(A0_24.ACTION_TIMELINE_EVENT_SUFFERING)
    A2_26:Talk(A1_25, A0_24, A0_24.TEXT_STMBDZ014_02648_PINCHMAN02648_000_010, false)
    A2_26:Talk(A1_25, A0_24, A0_24.TEXT_STMBDZ014_02648_PINCHMAN02648_000_011, true)
  end
  function StmBdz014.OnScene00009(A0_27, A1_28, A2_29)
    A2_29:TurnTo(A1_28, false)
    A2_29:WaitForTurn()
    A2_29:PlayActionTimeline(A0_27.ACTION_TIMELINE_EVENT_TALK_BIG)
    A2_29:Talk(A1_28, A0_27, A0_27.TEXT_STMBDZ014_02648_PANICMAN02648_000_010, true)
  end
  function StmBdz014.OnScene00010(A0_30, A1_31, A2_32)
    local L3_33, L4_34
    L4_34 = A2_32
    L3_33 = A2_32.TurnTo
    ...
    L4_34 = A2_32
    L3_33 = A2_32.Talk
    L3_33(L4_34, A1_31, A0_30, A0_30.TEXT_STMBDZ014_02648_PANICMAN02648_000_030, false)
    L4_34 = A2_32
    L3_33 = A2_32.Talk
    L3_33(L4_34, A1_31, A0_30, A0_30.TEXT_STMBDZ014_02648_PANICMAN02648_000_031, false)
    L4_34 = A2_32
    L3_33 = A2_32.PlayActionTimeline
    L3_33(L4_34, A0_30.ACTION_TIMELINE_EVENT_ADD_YES)
    L4_34 = A2_32
    L3_33 = A2_32.Talk
    L3_33(L4_34, A1_31, A0_30, A0_30.TEXT_STMBDZ014_02648_PANICMAN02648_000_032, true)
    L4_34 = A0_30
  ...
  function StmBdz014.OnScene00011(A0_35, A1_36, A2_37)
    A2_37:TurnTo(A1_36, false)
    A2_37:WaitForTurn()
    A2_37:PlayActionTimeline(A0_35.ACTION_TIMELINE_EVENT_TALK_BOTHHAND)
    A2_37:Talk(A1_36, A0_35, A0_35.TEXT_STMBDZ014_02648_PINCHMAN02648_000_020, true)
  end
  function StmBdz014.IsTodoChecked(A0_38, A1_39, A2_40)
    local L3_41
