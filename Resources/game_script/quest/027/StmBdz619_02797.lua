(function()
  print("StmBdz619 loaded")
  function StmBdz619.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function StmBdz619.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDZ619_02797_CAALUN_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDZ619_02797_CAALUN_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDZ619_02797_CAALUN_000_002, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_BOTHHAND)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDZ619_02797_CAALUN_000_003, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_NO)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDZ619_02797_CAALUN_000_004, true)
    A0_3:QuestAccepted()
  end
  function StmBdz619.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7, false)
    A2_8:WaitForTurn()
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK_BOTHHAND)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_STMBDZ619_02797_CAALUN_000_005, true)
  end
  function StmBdz619.OnScene00003(A0_9, A1_10, A2_11)
  ...
  function StmBdz619.OnScene00004(A0_19, A1_20, A2_21)
    local L3_22, L4_23
    L4_23 = A1_20
    ...
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_STMBDZ619_02797_CAALUN_100_020, true)
    L4_23 = A2_21
    ...
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_STMBDZ619_02797_CAALUN_000_020, false)
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_STMBDZ619_02797_CAALUN_000_021, false)
    L4_23 = A2_21
    L3_22 = A2_21.PlayActionTimeline
    L3_22(L4_23, A0_19.ACTION_TIMELINE_EVENT_ADD_YES)
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_STMBDZ619_02797_CAALUN_000_022, true)
    L4_23 = A0_19
  ...
  function StmBdz619.GetEventItems(A0_24, A1_25)
    local L2_26
  ...
  function StmBdz619.IsTodoChecked(A0_27, A1_28, A2_29)
    local L3_30
    ...
    if A2_29 == 0 then
      return A1_28:GetQuestUI8BH(L3_30) >= 2
    elseif A2_29 == 1 then
      return false
    end
  end
  ...
  function L1_32(A0_41, A1_42, A2_43, A3_44, A4_45)
    ...
    if A1_42:GetQuestSequence(L5_46) == A0_41.SEQ_1 then
      if A3_44 == A0_41.ENEMY0 then
        return 2 > A1_42:GetQuestUI8BH(L5_46)
