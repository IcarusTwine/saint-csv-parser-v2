(function()
  print("BanAma309 loaded")
  function BanAma309.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanAma309.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANAMA309_01250_YADOVVGAH_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANAMA309_01250_YADOVVGAH_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANAMA309_01250_YADOVVGAH_000_002, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANAMA309_01250_YADOVVGAH_000_003, false)
    A2_5:PlayActionTimeline(A0_3.LOC_ITEM_MOT_1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANAMA309_01250_YADOVVGAH_000_004, true)
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanAma309.OnScene00002(A0_6, A1_7, A2_8)
  end
  function BanAma309.OnScene00003(A0_9, A1_10, A2_11)
    A2_11:PlayVfx(A0_9.LOC_VFX_01)
  end
  function BanAma309.OnScene00004(A0_12, A1_13, A2_14)
  end
  function BanAma309.OnScene00005(A0_15, A1_16, A2_17)
    A2_17:PlayVfx(A0_15.LOC_VFX_01)
  end
  function BanAma309.OnScene00006(A0_18, A1_19, A2_20)
  end
  function BanAma309.OnScene00007(A0_21, A1_22, A2_23)
    A2_23:PlayVfx(A0_21.LOC_VFX_01)
  end
  function BanAma309.OnScene00008(A0_24, A1_25, A2_26)
  end
  function BanAma309.OnScene00009(A0_27, A1_28, A2_29)
    A2_29:PlayVfx(A0_27.LOC_VFX_01)
  end
  function BanAma309.OnScene00010(A0_30, A1_31, A2_32)
  end
  function BanAma309.OnScene00011(A0_33, A1_34, A2_35)
    A2_35:PlayVfx(A0_33.LOC_VFX_01)
  end
  function BanAma309.OnScene00012(A0_36, A1_37, A2_38)
  end
  function BanAma309.OnScene00013(A0_39, A1_40, A2_41)
    A2_41:PlayVfx(A0_39.LOC_VFX_01)
  end
  function BanAma309.OnScene00014(A0_42, A1_43, A2_44)
  end
  function BanAma309.OnScene00015(A0_45, A1_46, A2_47)
    A2_47:PlayVfx(A0_45.LOC_VFX_01)
  end
  function BanAma309.OnScene00016(A0_48, A1_49, A2_50)
    if A0_48:IsBattleNpcOwner(A1_49, true) == true or A0_48:IsBattleNpcTriggerOwner(A1_49, A2_50, false) == true then
      A0_48:ScenarioMessage(A0_48.TEXT_BANAMA309_01250_POP_MESSAGE_000_000)
      A0_48:CancelEventScene()
    end
  end
  function BanAma309.OnScene00017(A0_51, A1_52, A2_53)
    if A0_51:IsBattleNpcOwner(A1_52, true) == true or A0_51:IsBattleNpcTriggerOwner(A1_52, A2_53, false) == true then
    else
      A0_51:ScenarioMessage(A0_51.TEXT_BANAMA309_01250_POP_MESSAGE)
    end
  end
  function BanAma309.OnScene00018(A0_54, A1_55, A2_56)
    if A0_54:IsBattleNpcOwner(A1_55, true) == true or A0_54:IsBattleNpcTriggerOwner(A1_55, A2_56, false) == true then
      A0_54:ScenarioMessage(A0_54.TEXT_BANAMA309_01250_POP_MESSAGE_000_000)
      A0_54:CancelEventScene()
    end
  end
  function BanAma309.OnScene00019(A0_57, A1_58, A2_59)
    if A0_57:IsBattleNpcOwner(A1_58, true) == true or A0_57:IsBattleNpcTriggerOwner(A1_58, A2_59, false) == true then
    else
      A0_57:ScenarioMessage(A0_57.TEXT_BANAMA309_01250_POP_MESSAGE)
    end
  end
  function BanAma309.OnScene00020(A0_60, A1_61, A2_62)
    if A0_60:IsBattleNpcOwner(A1_61, true) == true or A0_60:IsBattleNpcTriggerOwner(A1_61, A2_62, false) == true then
      A0_60:ScenarioMessage(A0_60.TEXT_BANAMA309_01250_POP_MESSAGE_000_000)
      A0_60:CancelEventScene()
    end
  end
  function BanAma309.OnScene00021(A0_63, A1_64, A2_65)
    if A0_63:IsBattleNpcOwner(A1_64, true) == true or A0_63:IsBattleNpcTriggerOwner(A1_64, A2_65, false) == true then
    else
      A0_63:ScenarioMessage(A0_63.TEXT_BANAMA309_01250_POP_MESSAGE)
    end
  end
  function BanAma309.OnScene00022(A0_66, A1_67, A2_68)
    if A0_66:IsBattleNpcOwner(A1_67, true) == true or A0_66:IsBattleNpcTriggerOwner(A1_67, A2_68, false) == true then
      A0_66:ScenarioMessage(A0_66.TEXT_BANAMA309_01250_POP_MESSAGE_000_000)
      A0_66:CancelEventScene()
    end
  end
  function BanAma309.OnScene00023(A0_69, A1_70, A2_71)
    if A0_69:IsBattleNpcOwner(A1_70, true) == true or A0_69:IsBattleNpcTriggerOwner(A1_70, A2_71, false) == true then
    else
      A0_69:ScenarioMessage(A0_69.TEXT_BANAMA309_01250_POP_MESSAGE)
    end
  end
  function BanAma309.OnScene00024(A0_72, A1_73, A2_74)
    if A0_72:IsBattleNpcOwner(A1_73, true) == true or A0_72:IsBattleNpcTriggerOwner(A1_73, A2_74, false) == true then
      A0_72:ScenarioMessage(A0_72.TEXT_BANAMA309_01250_POP_MESSAGE_000_000)
      A0_72:CancelEventScene()
    end
  end
  function BanAma309.OnScene00025(A0_75, A1_76, A2_77)
    if A0_75:IsBattleNpcOwner(A1_76, true) == true or A0_75:IsBattleNpcTriggerOwner(A1_76, A2_77, false) == true then
    else
      A0_75:ScenarioMessage(A0_75.TEXT_BANAMA309_01250_POP_MESSAGE)
    end
  end
  function BanAma309.OnScene00026(A0_78, A1_79, A2_80)
    if A0_78:IsBattleNpcOwner(A1_79, true) == true or A0_78:IsBattleNpcTriggerOwner(A1_79, A2_80, false) == true then
      A0_78:ScenarioMessage(A0_78.TEXT_BANAMA309_01250_POP_MESSAGE_000_000)
      A0_78:CancelEventScene()
    end
  end
  function BanAma309.OnScene00027(A0_81, A1_82, A2_83)
    if A0_81:IsBattleNpcOwner(A1_82, true) == true or A0_81:IsBattleNpcTriggerOwner(A1_82, A2_83, false) == true then
    else
      A0_81:ScenarioMessage(A0_81.TEXT_BANAMA309_01250_POP_MESSAGE)
    end
  end
  function BanAma309.OnScene00028(A0_84, A1_85, A2_86)
    if A0_84:IsBattleNpcOwner(A1_85, true) == true or A0_84:IsBattleNpcTriggerOwner(A1_85, A2_86, false) == true then
      A0_84:ScenarioMessage(A0_84.TEXT_BANAMA309_01250_POP_MESSAGE_000_000)
      A0_84:CancelEventScene()
    end
  end
  function BanAma309.OnScene00029(A0_87, A1_88, A2_89)
    if A0_87:IsBattleNpcOwner(A1_88, true) == true or A0_87:IsBattleNpcTriggerOwner(A1_88, A2_89, false) == true then
    else
      A0_87:ScenarioMessage(A0_87.TEXT_BANAMA309_01250_POP_MESSAGE)
    end
  end
  function BanAma309.OnScene00030(A0_90, A1_91, A2_92)
    A2_92:TurnTo(A1_91)
    A2_92:WaitForTurn()
    A2_92:PlayActionTimeline(A0_90.ACTION_TIMELINE_EVENT_TALK1)
    A2_92:Talk(A1_91, A0_90, A0_90.TEXT_BANAMA309_01250_YADOVVGAH_000_010, true)
  end
  function BanAma309.OnScene00031(A0_93, A1_94, A2_95)
    local L3_96, L4_97
    L4_97 = A2_95
    L3_96 = A2_95.TurnTo
    L3_96(L4_97, A1_94)
    ...
    L4_97 = A2_95
    L3_96 = A2_95.Talk
    L3_96(L4_97, A1_94, A0_93, A0_93.TEXT_BANAMA309_01250_YADOVVGAH_000_020, true)
    L4_97 = A0_93
  ...
  function BanAma309.GetEventItems(A0_98, A1_99)
    local L2_100
  ...
  function BanAma309.IsTodoChecked(A0_101, A1_102, A2_103)
    local L3_104
  ...
  function BanAma309.GetBalloonTalkArgs(A0_105, A1_106, A2_107, A3_108)
    local L4_109
    ...
    if A1_106:GetQuestSequence(L4_109) == A0_105.SEQ_1 then
      if A3_108 == A0_105.BALLOON_TALK_TIMING_EVENT_ITEM and A2_107:GetLayoutId() == A0_105.ENEMY0 then
        return A0_105.TEXT_BANAMA309_01250_AMALJAAENEMYA_000_015, 6000, false
      end
      if A3_108 == A0_105.BALLOON_TALK_TIMING_EVENT_ITEM and A2_107:GetLayoutId() == A0_105.ENEMY1 then
        return A0_105.TEXT_BANAMA309_01250_AMALJAAENEMYAB000_016, 6000, false
      end
      if A3_108 == A0_105.BALLOON_TALK_TIMING_EVENT_ITEM and A2_107:GetLayoutId() == A0_105.ENEMY2 then
        return A0_105.TEXT_BANAMA309_01250_AMALJAAENEMYC_000_017, 6000, false
      end
      if A3_108 == A0_105.BALLOON_TALK_TIMING_EVENT_ITEM and A2_107:GetLayoutId() == A0_105.ENEMY3 then
        return A0_105.TEXT_BANAMA309_01250_AMALJAAENEMYD_000_018, 6000, false
      end
