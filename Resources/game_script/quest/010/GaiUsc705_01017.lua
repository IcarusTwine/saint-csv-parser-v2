(function()
  print("GaiUsc705 loaded")
  function GaiUsc705.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsc705.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSC705_01017_BLOEIDIN_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSC705_01017_BLOEIDIN_000_001, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSC705_01017_BLOEIDIN_000_002, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSC705_01017_BLOEIDIN_000_003, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSC705_01017_BLOEIDIN_000_004, true)
    A0_3:QuestAccepted()
  end
  function GaiUsc705.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:LookAt(A1_7)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_GAIUSC705_01017_ENPC1_000_010, true)
    A2_8:WalkOut(180, 3, A0_6.MOVE_WALK)
    A0_6:Wait(15)
    A2_8:Transparency(A0_6.TRANS_TYPE_FADE_OUT, 15)
    A2_8:WaitForTransparency()
  end
  function GaiUsc705.OnScene00003(A0_9, A1_10, A2_11)
    A2_11:LookAt(A1_10)
    A2_11:Talk(A1_10, A0_9, A0_9.TEXT_GAIUSC705_01017_ENPC2_000_020, true)
    A2_11:WalkOut(180, 3, A0_9.MOVE_WALK)
    A0_9:Wait(15)
    A2_11:Transparency(A0_9.TRANS_TYPE_FADE_OUT, 15)
    A2_11:WaitForTransparency()
  end
  function GaiUsc705.OnScene00004(A0_12, A1_13, A2_14)
    A2_14:LookAt(A1_13)
    A2_14:Talk(A1_13, A0_12, A0_12.TEXT_GAIUSC705_01017_ENPC3_000_030, true)
    A2_14:WalkOut(180, 3, A0_12.MOVE_WALK)
    A0_12:Wait(15)
    A2_14:Transparency(A0_12.TRANS_TYPE_FADE_OUT, 15)
    A2_14:WaitForTransparency()
  end
  function GaiUsc705.OnScene00005(A0_15, A1_16, A2_17)
    A2_17:LookAt(A1_16)
    A2_17:Talk(A1_16, A0_15, A0_15.TEXT_GAIUSC705_01017_ENPC4_000_040, true)
    A2_17:WalkOut(180, 3, A0_15.MOVE_WALK)
    A0_15:Wait(15)
    A2_17:Transparency(A0_15.TRANS_TYPE_FADE_OUT, 15)
    A2_17:WaitForTransparency()
  end
  function GaiUsc705.OnScene00006(A0_18, A1_19, A2_20)
    local L3_21, L4_22
    L4_22 = A2_20
    L3_21 = A2_20.TurnTo
    ...
    L4_22 = A2_20
    L3_21 = A2_20.Talk
    L3_21(L4_22, A1_19, A0_18, A0_18.TEXT_GAIUSC705_01017_BLOEIDIN_000_050, false)
    L4_22 = A2_20
    L3_21 = A2_20.PlayActionTimeline
    L3_21(L4_22, A0_18.ACTION_TIMELINE_EVENT_TALK1)
    L4_22 = A2_20
    L3_21 = A2_20.Talk
    L3_21(L4_22, A1_19, A0_18, A0_18.TEXT_GAIUSC705_01017_BLOEIDIN_000_051, true)
    L4_22 = A0_18
  ...
  function GaiUsc705.IsTodoChecked(A0_23, A1_24, A2_25)
    local L3_26
...
;(function()
  ...
  function L1_28(A0_37, A1_38, A2_39, A3_40, A4_41)
    ...
    if A1_38:GetQuestSequence(L5_42) == A0_37.SEQ_1 then
      if A3_40 == A0_37.ACTOR1 then
        if 4 <= A1_38:GetQuestUI8AL(L5_42) then
          return false
        end
  ...
  function L1_28(A0_43, A1_44, A2_45)
    ...
    if A2_45 == 0 then
      return A1_44:GetQuestUI8AL(L3_46), 4
    elseif A2_45 == 1 then
