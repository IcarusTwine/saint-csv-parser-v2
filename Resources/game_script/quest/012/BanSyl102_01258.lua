(function()
  print("BanSyl102 loaded")
  function BanSyl102.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanSyl102.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANSYL102_01258_TONAXIA_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANSYL102_01258_TONAXIA_000_001, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANSYL102_01258_TONAXIA_000_002, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANSYL102_01258_TONAXIA_000_003, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANSYL102_01258_TONAXIA_000_004, true)
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanSyl102.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANSYL102_01258_TONAXIA_000_010, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANSYL102_01258_TONAXIA_000_011, true)
  end
  function BanSyl102.OnScene00003(A0_9, A1_10, A2_11)
    ...
    L5_14 = A2_11.Talk
    L9_18 = A0_9.TEXT_BANSYL102_01258_TONAXIA_000_020
    L5_14(L6_15, L7_16, L8_17, L9_18, true)
    L5_14 = 3
  ...
  function BanSyl102.OnScene00004(A0_19, A1_20, A2_21)
    local L3_22, L4_23
    L4_23 = A2_21
    ...
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_BANSYL102_01258_TONAXIA_000_030, true)
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_BANSYL102_01258_TONAXIA_000_031, true)
    L4_23 = A0_19
    L3_22 = A0_19.QuestReward
    L4_23 = L3_22(L4_23, A2_21, A1_20)
    if L3_22 then
      A0_19:QuestCompleted(A0_19.SCREEN_IMAGE_BEAST_QUEST_COMPLETE)
      if A1_20:IsHowTo(A0_19.HOWTO_YUUKOU) == false then
        A0_19:HowTo(A0_19.HOWTO_YUUKOU)
      end
    else
  ...
  function BanSyl102.GetEventItems(A0_24, A1_25)
    local L2_26
  ...
  function BanSyl102.IsTodoChecked(A0_27, A1_28, A2_29)
    local L3_30
    ...
    if A2_29 == 0 then
      return A1_28:GetQuestUI8CH(L3_30) >= 1
    elseif A2_29 == 1 then
      return 1 <= A1_28:GetQuestUI8CL(L3_30)
    elseif A2_29 == 2 then
      return 2 <= A1_28:GetQuestUI8DH(L3_30)
    elseif A2_29 == 3 then
      return false
    end
  end
...
;(function()
  ...
  function L1_32(A0_35, A1_36, A2_37, A3_38, A4_39)
    ...
    if A1_36:GetQuestSequence(L5_40) == A0_35.SEQ_1 then
      ...
      elseif A3_38 == A0_35.ENEMY2 then
        return 2 > A1_36:GetQuestUI8DH(L5_40)
  ...
  function L1_32(A0_41, A1_42, A2_43, A3_44, A4_45)
    ...
    if A1_42:GetQuestSequence(L5_46) == A0_41.SEQ_1 then
      ...
      elseif A3_44 == A0_41.ENEMY2 then
        return 2 > A1_42:GetQuestUI8DH(L5_46)
  ...
  function L1_32(A0_47, A1_48, A2_49)
    ...
    elseif A2_49 == 1 then
      return A1_48:GetQuestUI8CL(L3_50), 1
    elseif A2_49 == 2 then
      return A1_48:GetQuestUI8DH(L3_50), 2
    elseif A2_49 == 3 then
