(function()
  print("GaiUsc911 loaded")
  function GaiUsc911.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsc911.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_NO)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSC911_01046_EDELSTEIN_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_ANGRY)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSC911_01046_EDELSTEIN_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSC911_01046_EDELSTEIN_000_002, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSC911_01046_EDELSTEIN_000_003, true)
    A0_3:QuestAccepted()
  end
  function GaiUsc911.OnScene00002(A0_6, A1_7, A2_8)
    local L3_9, L4_10
    L4_10 = A2_8
    L3_9 = A2_8.TurnTo
    ...
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_GAIUSC911_01046_RAUBAHN_000_010, false)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_GAIUSC911_01046_RAUBAHN_000_011, true)
    L4_10 = A0_6
  ...
  function GaiUsc911.IsTodoChecked(A0_11, A1_12, A2_13)
    local L3_14
    ...
    if A2_13 == 0 then
      return A1_12:GetQuestUI8BH(L3_14) >= 3
    elseif A2_13 == 1 then
      return 3 <= A1_12:GetQuestUI8AL(L3_14)
    elseif A2_13 == 2 then
      return false
    end
  end
...
;(function()
  ...
  function L1_16(A0_19, A1_20, A2_21, A3_22, A4_23)
    ...
    if A1_20:GetQuestSequence(L5_24) == A0_19.SEQ_1 then
      if A3_22 == A0_19.ENEMY0 or A3_22 == A0_19.ENEMY1 or A3_22 == A0_19.ENEMY2 or A3_22 == A0_19.ENEMY3 or A3_22 == A0_19.ENEMY4 then
        if 3 <= A1_20:GetQuestUI8BH(L5_24) then
          return false
        end
        return 3 > A1_20:GetQuestUI8BH(L5_24)
      elseif A3_22 == A0_19.ENEMY5 or A3_22 == A0_19.ENEMY5 or A3_22 == A0_19.ENEMY5 then
  ...
  function L1_16(A0_25, A1_26, A2_27, A3_28, A4_29)
    ...
    if A1_26:GetQuestSequence(L5_30) == A0_25.SEQ_1 then
      if A3_28 == A0_25.ENEMY0 or A3_28 == A0_25.ENEMY1 or A3_28 == A0_25.ENEMY2 or A3_28 == A0_25.ENEMY3 or A3_28 == A0_25.ENEMY4 then
        if 3 <= A1_26:GetQuestUI8BH(L5_30) then
          return false
        end
        return 3 > A1_26:GetQuestUI8BH(L5_30)
      elseif A3_28 == A0_25.ENEMY5 or A3_28 == A0_25.ENEMY5 or A3_28 == A0_25.ENEMY5 then
