(function()
  print("BanIxa604 loaded")
  function BanIxa604.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanIxa604.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA604_01523_JEZULAHUATAN_000_000, false)
    if A1_4:GetClassJob() == A0_3.CLASS_JOB_BLACKSMITH or A1_4:GetClassJob() == A0_3.CLASS_JOB_ARMOURER or A1_4:GetClassJob() == A0_3.CLASS_JOB_GOLDSMITH then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA604_01523_JEZULAHUATAN_000_010, true)
    elseif A1_4:GetClassJob() == A0_3.CLASS_JOB_ALCHEMIST or A1_4:GetClassJob() == A0_3.CLASS_JOB_CULINARIAN then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA604_01523_JEZULAHUATAN_000_020, true)
    elseif A1_4:GetClassJob() == A0_3.CLASS_JOB_WOODWORKER or A1_4:GetClassJob() == A0_3.CLASS_JOB_TANNER or A1_4:GetClassJob() == A0_3.CLASS_JOB_WEAVER then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA604_01523_JEZULAHUATAN_000_030, true)
    end
    A0_3:Wait(10)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA604_01523_JEZULAHUATAN_000_040, false, A0_3.TALK_SHAPE_EMPHASIS)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA604_01523_JEZULAHUATAN_000_041, true, A0_3.TALK_SHAPE_EMPHASIS)
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanIxa604.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7, false)
    A2_8:WaitForTurn()
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK2)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANIXA604_01523_TATARAMU_000_060, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANIXA604_01523_TATARAMU_000_061, false)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_ITEM)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANIXA604_01523_TATARAMU_000_062, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANIXA604_01523_TATARAMU_000_063, true)
  end
  function BanIxa604.OnScene00003(A0_9, A1_10, A2_11)
    A2_11:TurnTo(A1_10, false)
    A2_11:WaitForTurn()
    A2_11:PlayActionTimeline(A0_9.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_11:Talk(A1_10, A0_9, A0_9.TEXT_BANIXA604_01523_JEZULAHUATAN_000_050, true, A0_9.TALK_SHAPE_EMPHASIS)
  end
  function BanIxa604.OnScene00004(A0_12, A1_13, A2_14)
  ...
  function BanIxa604.OnScene00005(A0_22, A1_23, A2_24)
    A2_24:PlayActionTimeline(A0_22.ACTION_TIMELINE_EVENT_ITEM)
    A2_24:Talk(A1_23, A0_22, A0_22.TEXT_BANIXA604_01523_ISHMERCHANT01523_000_071, true)
    A2_24:WaitForActionTimeline(A0_22.ACTION_TIMELINE_EVENT_ITEM)
    A0_22:Wait(10)
    A2_24:PlayActionTimeline(A0_22.ACTION_TIMELINE_EVENT_THINK)
    A2_24:Talk(A1_23, A0_22, A0_22.TEXT_BANIXA604_01523_ISHMERCHANT01523_100_071, false)
    A2_24:Talk(A1_23, A0_22, A0_22.TEXT_BANIXA604_01523_ISHMERCHANT01523_000_072, true)
  end
  function BanIxa604.OnScene00006(A0_25, A1_26, A2_27)
    A2_27:TurnTo(A1_26, false)
    A2_27:WaitForTurn()
    A2_27:PlayActionTimeline(A0_25.ACTION_TIMELINE_EVENT_TALK2)
    A2_27:Talk(A1_26, A0_25, A0_25.TEXT_BANIXA604_01523_TATARAMU_000_065, true)
  end
  function BanIxa604.OnScene00007(A0_28, A1_29, A2_30)
    A2_30:TurnTo(A1_29, false)
    A2_30:WaitForTurn()
    A2_30:PlayActionTimeline(A0_28.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_30:Talk(A1_29, A0_28, A0_28.TEXT_BANIXA604_01523_JEZULAHUATAN_000_050, true, A0_28.TALK_SHAPE_EMPHASIS)
  end
  function BanIxa604.OnScene00008(A0_31, A1_32, A2_33)
    ...
    L5_36 = A0_31.ACTION_TIMELINE_EVENT_GREETING
    L3_34(L4_35, L5_36)
    L4_35 = A2_33
    L3_34 = A2_33.Talk
    L5_36 = A1_32
  ...
  function BanIxa604.OnScene00009(A0_41, A1_42, A2_43)
    A2_43:PlayActionTimeline(A0_41.ACTION_TIMELINE_EVENT_ITEM)
    A2_43:Talk(A1_42, A0_41, A0_41.TEXT_BANIXA604_01523_NORBETTAUX_000_091, false)
    A2_43:Talk(A1_42, A0_41, A0_41.TEXT_BANIXA604_01523_NORBETTAUX_000_092, true)
    A0_41:Wait(10)
    A0_41:ScenarioMessage(A0_41.TEXT_BANIXA604_01523_POPMESSAGE_000_200)
    A0_41:Wait(10)
  end
  function BanIxa604.OnScene00010(A0_44, A1_45, A2_46)
    A2_46:TurnTo(A1_45, false)
    A2_46:WaitForTurn()
    A2_46:PlayActionTimeline(A0_44.ACTION_TIMELINE_EVENT_TALK2)
    A2_46:Talk(A1_45, A0_44, A0_44.TEXT_BANIXA604_01523_ISHMERCHANT01523_000_080, true)
  end
  function BanIxa604.OnScene00011(A0_47, A1_48, A2_49)
    A2_49:TurnTo(A1_48, false)
    A2_49:WaitForTurn()
    A2_49:PlayActionTimeline(A0_47.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_49:Talk(A1_48, A0_47, A0_47.TEXT_BANIXA604_01523_JEZULAHUATAN_000_050, true, A0_47.TALK_SHAPE_EMPHASIS)
  end
  function BanIxa604.OnScene00012(A0_50, A1_51, A2_52)
  ...
  function BanIxa604.OnScene00013(A0_60, A1_61, A2_62)
    local L3_63, L4_64
    L4_64 = A2_62
    ...
    L4_64 = A2_62
    L3_63 = A2_62.Talk
    L3_63(L4_64, A1_61, A0_60, A0_60.TEXT_BANIXA604_01523_JEZULAHUATAN_000_131, true, A0_60.TALK_SHAPE_EMPHASIS)
    L4_64 = A0_60
    L3_63 = A0_60.Wait
    L3_63(L4_64, 20)
    L4_64 = A1_61
    ...
    if L3_63 >= 1 then
      ...
      L3_63(L4_64, A0_60.TEXT_BANIXA604_01523_SYSTEM_200_200, true)
    end
    L4_64 = A0_60
  ...
  function BanIxa604.OnScene00014(A0_65, A1_66, A2_67)
    A2_67:TurnTo(A1_66, false)
    A2_67:WaitForTurn()
    A2_67:PlayActionTimeline(A0_65.ACTION_TIMELINE_EVENT_GREETING)
    if A1_66:GetNumOfHqItems(A0_65.RITEM1) >= 3 then
      A2_67:Talk(A1_66, A0_65, A0_65.TEXT_BANIXA604_01523_NORBETTAUX_100_100, true)
      A0_65:CancelEventScene()
    else
      A2_67:Talk(A1_66, A0_65, A0_65.TEXT_BANIXA604_01523_NORBETTAUX_000_100, true)
      A0_65:Wait(10)
      A0_65:ScenarioMessage(A0_65.TEXT_BANIXA604_01523_POPMESSAGE_000_200)
      A0_65:Wait(10)
    end
  end
  function BanIxa604.GetEventItems(A0_68, A1_69)
    local L2_70
  ...
  function BanIxa604.IsTodoChecked(A0_71, A1_72, A2_73)
    local L3_74
...
;(function()
  ...
  function L1_76(A0_91, A1_92, A2_93)
    ...
    elseif A2_93 == 2 then
      return A1_92:GetQuestUI8AL(L3_94), 0
    elseif A2_93 == 3 then
      return A1_92:GetNumOfItems(A0_91.RITEM1, A0_91.NUM_OF_ITEMS_FILTER_HQ, false, true), 3
    end
  end
  ...
  function L1_76(A0_95, A1_96, A2_97)
    ...
    if A1_96:GetQuestSequence(L3_98) == A0_95.SEQ_FINISH then
      ...
      elseif A2_97 == A0_95.ACTOR3 then
  ...
  function L1_76(A0_99, A1_100, A2_101, A3_102, A4_103, A5_104, A6_105)
    ...
    elseif A1_100:GetQuestSequence(L7_106) == A0_99.SEQ_FINISH and A3_102 == A0_99.ACTOR0 and A1_100:GetNumOfItems(A0_99.RITEM1, A0_99.NUM_OF_ITEMS_FILTER_HQ, false, true) < 3 then
