(function()
  print("HeaVna113 loaded")
  function HeaVna113.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function HeaVna113.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNA113_01592_LANIAITTE_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNA113_01592_LANIAITTE_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNA113_01592_LANIAITTE_000_002, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNA113_01592_LANIAITTE_000_003, true)
    A0_3:QuestAccepted()
  end
  function HeaVna113.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_HEAVNA113_01592_MARIELLE_000_010, false)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_HEAVNA113_01592_MARIELLE_000_011, false)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_HEAVNA113_01592_MARIELLE_000_012, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_HEAVNA113_01592_MARIELLE_000_013, true)
  end
  function HeaVna113.OnScene00003(A0_9, A1_10, A2_11)
    A2_11:TurnTo(A1_10, false)
    A2_11:WaitForTurn()
    A2_11:PlayActionTimeline(A0_9.ACTION_TIMELINE_EVENT_TALK1)
    A2_11:Talk(A1_10, A0_9, A0_9.TEXT_HEAVNA113_01592_LANIAITTE_000_004, true)
  end
  function HeaVna113.OnScene00004(A0_12, A1_13, A2_14)
  end
  function HeaVna113.OnScene00005(A0_15, A1_16, A2_17)
    if A0_15:IsBattleNpcOwner(A1_16, true) == true or A0_15:IsBattleNpcTriggerOwner(A1_16, A2_17, false) == true then
    else
      A0_15:LogMessage(A0_15.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function HeaVna113.OnScene00006(A0_18, A1_19, A2_20)
  end
  function HeaVna113.OnScene00007(A0_21, A1_22, A2_23)
    if A0_21:IsBattleNpcOwner(A1_22, true) == true or A0_21:IsBattleNpcTriggerOwner(A1_22, A2_23, false) == true then
    else
      A0_21:LogMessage(A0_21.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function HeaVna113.OnScene00008(A0_24, A1_25, A2_26)
  end
  function HeaVna113.OnScene00009(A0_27, A1_28, A2_29)
    if A0_27:IsBattleNpcOwner(A1_28, true) == true or A0_27:IsBattleNpcTriggerOwner(A1_28, A2_29, false) == true then
    else
      A0_27:LogMessage(A0_27.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function HeaVna113.OnScene00010(A0_30, A1_31, A2_32)
  end
  function HeaVna113.OnScene00011(A0_33, A1_34, A2_35)
  ...
  function HeaVna113.OnScene00012(A0_36, A1_37, A2_38)
  end
  function HeaVna113.OnScene00013(A0_39, A1_40, A2_41)
    if A0_39:IsBattleNpcOwner(A1_40, true) == true or A0_39:IsBattleNpcTriggerOwner(A1_40, A2_41, false) == true then
    else
      A0_39:LogMessage(A0_39.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function HeaVna113.OnScene00014(A0_42, A1_43, A2_44)
  end
  function HeaVna113.OnScene00015(A0_45, A1_46, A2_47)
  ...
  function HeaVna113.OnScene00016(A0_48, A1_49, A2_50)
  end
  function HeaVna113.OnScene00017(A0_51, A1_52, A2_53)
    A0_51:SystemTalk(A0_51.TEXT_HEAVNA113_01592_SYSTEM_000_020, true)
  end
  function HeaVna113.OnScene00018(A0_54, A1_55, A2_56)
    A2_56:TurnTo(A1_55, false)
    A2_56:WaitForTurn()
    A2_56:PlayActionTimeline(A0_54.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_56:Talk(A1_55, A0_54, A0_54.TEXT_HEAVNA113_01592_MARIELLE_000_014, true)
  end
  function HeaVna113.OnScene00019(A0_57, A1_58, A2_59)
    local L3_60, L4_61
    L4_61 = A2_59
    L3_60 = A2_59.TurnTo
    ...
    L4_61 = A2_59
    L3_60 = A2_59.Talk
    L3_60(L4_61, A1_58, A0_57, A0_57.TEXT_HEAVNA113_01592_MARIELLE_000_030, true)
    L4_61 = A1_58
    ...
    L4_61 = A2_59
    L3_60 = A2_59.Talk
    L3_60(L4_61, A1_58, A0_57, A0_57.TEXT_HEAVNA113_01592_MARIELLE_000_031, true)
    L4_61 = A0_57
  ...
  function HeaVna113.IsTodoChecked(A0_62, A1_63, A2_64)
    local L3_65
