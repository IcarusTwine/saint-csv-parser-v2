(function()
  print("BanSah301 loaded")
  function BanSah301.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanSah301.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANSAH301_01400_SEWW_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANSAH301_01400_SEWW_000_001, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANSAH301_01400_SEWW_000_002, true)
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanSah301.OnScene00002(A0_6, A1_7, A2_8)
    if A0_6:IsBattleNpcOwner(A1_7, true) == true or A0_6:IsBattleNpcTriggerOwner(A1_7, A2_8, false) == true then
    else
      A0_6:ScenarioMessage(A0_6.TEXT_BANSAH301_01400_POP_MESSAGE_000_000)
    end
  end
  function BanSah301.OnScene00003(A0_9, A1_10, A2_11)
    if A0_9:IsBattleNpcOwner(A1_10, true) == true or A0_9:IsBattleNpcTriggerOwner(A1_10, A2_11, false) == true then
    else
      A0_9:ScenarioMessage(A0_9.TEXT_BANSAH301_01400_POP_MESSAGE_000_000)
    end
  end
  function BanSah301.OnScene00004(A0_12, A1_13, A2_14)
    if A0_12:IsBattleNpcOwner(A1_13, true) == true or A0_12:IsBattleNpcTriggerOwner(A1_13, A2_14, false) == true then
    else
      A0_12:ScenarioMessage(A0_12.TEXT_BANSAH301_01400_POP_MESSAGE_000_001)
    end
  end
  function BanSah301.OnScene00005(A0_15, A1_16, A2_17)
    if A0_15:IsBattleNpcOwner(A1_16, true) == true or A0_15:IsBattleNpcTriggerOwner(A1_16, A2_17, false) == true then
    else
      A0_15:ScenarioMessage(A0_15.TEXT_BANSAH301_01400_POP_MESSAGE_000_001)
    end
  end
  function BanSah301.OnScene00006(A0_18, A1_19, A2_20)
    if A0_18:IsBattleNpcOwner(A1_19, true) == true or A0_18:IsBattleNpcTriggerOwner(A1_19, A2_20, false) == true then
    else
      A0_18:ScenarioMessage(A0_18.TEXT_BANSAH301_01400_POP_MESSAGE_000_002)
    end
  end
  function BanSah301.OnScene00007(A0_21, A1_22, A2_23)
    if A0_21:IsBattleNpcOwner(A1_22, true) == true or A0_21:IsBattleNpcTriggerOwner(A1_22, A2_23, false) == true then
    else
      A0_21:ScenarioMessage(A0_21.TEXT_BANSAH301_01400_POP_MESSAGE_000_002)
    end
  end
  function BanSah301.OnScene00008(A0_24, A1_25, A2_26)
    A2_26:TurnTo(A1_25, false)
    A2_26:Talk(A1_25, A0_24, A0_24.TEXT_BANSAH301_01400_SEWW_000_001, false)
    A2_26:Talk(A1_25, A0_24, A0_24.TEXT_BANSAH301_01400_SEWW_000_002, true)
  end
  function BanSah301.OnScene00009(A0_27, A1_28, A2_29)
    local L3_30, L4_31
    L4_31 = A2_29
    L3_30 = A2_29.TurnTo
    ...
    L4_31 = A2_29
    L3_30 = A2_29.Talk
    L3_30(L4_31, A1_28, A0_27, A0_27.TEXT_BANSAH301_01400_SEWW_000_020, false)
    L4_31 = A2_29
    L3_30 = A2_29.Talk
    L3_30(L4_31, A1_28, A0_27, A0_27.TEXT_BANSAH301_01400_SEWW_000_021, true)
    L4_31 = A0_27
  ...
  function BanSah301.IsTodoChecked(A0_32, A1_33, A2_34)
    local L3_35
  ...
  function BanSah301.GetBalloonTalkArgs(A0_36, A1_37, A2_38, A3_39)
    local L4_40
    ...
    if A1_37:GetQuestSequence(L4_40) == A0_36.SEQ_1 then
      if A2_38:GetLayoutId() == A0_36.ENEMY1 and A3_39 == A0_36.BALLOON_TALK_TIMING_POP then
        return A0_36.TEXT_BANSAH301_01400_BALLOON_000_010, 5000, false, 0, true
      end
      if A2_38:GetLayoutId() == A0_36.ENEMY3 and A3_39 == A0_36.BALLOON_TALK_TIMING_POP then
        return A0_36.TEXT_BANSAH301_01400_BALLOON_000_011, 5000, false, 0, true
      end
      if A2_38:GetLayoutId() == A0_36.ENEMY5 and A3_39 == A0_36.BALLOON_TALK_TIMING_POP then
        return A0_36.TEXT_BANSAH301_01400_BALLOON_000_012, 5000, false, 0, true
      end
