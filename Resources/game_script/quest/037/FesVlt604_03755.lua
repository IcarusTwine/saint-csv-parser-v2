(function()
  print("FesVlt604 loaded")
  function FesVlt604.OnScene00000(A0_0, A1_1, A2_2)
    A0_0:SystemTalk(A0_0.TEXT_FESVLT604_03755_SYSTEM_000_000, false)
    A0_0:SystemTalk(A0_0.TEXT_FESVLT604_03755_SYSTEM_000_001, true)
    A0_0:Wait(10)
    A2_2:TurnTo(A1_1, false)
    A2_2:WaitForTurn()
    A2_2:LookAt(A1_1)
    A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_BOW)
    A2_2:Talk(A1_1, A0_0, A0_0.TEXT_FESVLT604_03755_RODRIGAULT_000_002, true)
    A0_0:Wait(10)
    while true do
      if A0_0:Menu(A0_0.TEXT_FESVLT604_03755_Q1_000_000, A0_0.TEXT_FESVLT604_03755_A1_000_001, A0_0.TEXT_FESVLT604_03755_A1_000_002, A0_0.TEXT_FESVLT604_03755_A1_000_003) == 1 then
        break
      elseif A0_0:Menu(A0_0.TEXT_FESVLT604_03755_Q1_000_000, A0_0.TEXT_FESVLT604_03755_A1_000_001, A0_0.TEXT_FESVLT604_03755_A1_000_002, A0_0.TEXT_FESVLT604_03755_A1_000_003) == 2 then
        A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
        A2_2:Talk(A1_1, A0_0, A0_0.TEXT_FESVLT604_03755_RODRIGAULT_000_005, false)
        A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK1)
        A2_2:Talk(A1_1, A0_0, A0_0.TEXT_FESVLT604_03755_RODRIGAULT_000_006, false)
        A2_2:Talk(A1_1, A0_0, A0_0.TEXT_FESVLT604_03755_RODRIGAULT_000_007, false)
        A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_ADD_YES)
        A2_2:Talk(A1_1, A0_0, A0_0.TEXT_FESVLT604_03755_RODRIGAULT_000_008, false)
        A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK_BIG)
        A2_2:Talk(A1_1, A0_0, A0_0.TEXT_FESVLT604_03755_RODRIGAULT_000_009, false)
        A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK2)
        A2_2:Talk(A1_1, A0_0, A0_0.TEXT_FESVLT604_03755_RODRIGAULT_000_010, true)
        A0_0:Wait(10)
      else
  ...
  function FesVlt604.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESVLT604_03755_RODRIGAULT_000_003, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_ONEHAND)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESVLT604_03755_RODRIGAULT_000_004, true)
    A0_3:Wait(10)
    A2_5:LookAt()
  ...
  function FesVlt604.OnScene00002(A0_6, A1_7, A2_8)
    ...
    L10_16 = A2_8.Talk
    L12_18 = A1_7
    L10_16(L11_17, L12_18, A0_6, A0_6.TEXT_FESVLT604_03755_LISETTE_000_020, true, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
    L11_17 = A0_6
    L10_16 = A0_6.Wait
    L12_18 = 10
    L10_16(L11_17, L12_18)
    ...
    L10_16 = A2_8.Talk
    L12_18 = A1_7
    L10_16(L11_17, L12_18, A0_6, A0_6.TEXT_FESVLT604_03755_LISETTE_000_021, true, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
    L11_17 = A0_6
    L10_16 = A0_6.Wait
    L12_18 = 10
    L10_16(L11_17, L12_18)
    ...
    L10_16 = A2_8.Talk
    L12_18 = A1_7
    L10_16(L11_17, L12_18, A0_6, A0_6.TEXT_FESVLT604_03755_LISETTE_000_022, true, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
    L11_17 = A0_6
    L10_16 = A0_6.Wait
    L12_18 = 10
    L10_16(L11_17, L12_18)
    ...
    if L10_16 <= 2 then
      ...
      L12_18 = A2_8
      L11_17 = A2_8.Talk
      L11_17(L12_18, A1_7, A0_6, A0_6.TEXT_FESVLT604_03755_LISETTE_000_023, true, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
      L12_18 = A0_6
      L11_17 = A0_6.Wait
      L11_17(L12_18, 10)
    end
    ...
    L11_17(L12_18, A0_6.ACTION_TIMELINE_EMOTE_YES)
    L12_18 = L4_10
  ...
  function FesVlt604.OnScene00003(A0_19, A1_20, A2_21)
    A2_21:TurnTo(A1_20, false)
    A2_21:WaitForTurn()
    A2_21:PlayActionTimeline(A0_19.ACTION_TIMELINE_EVENT_TALK_BOTHHAND)
    A2_21:Talk(A1_20, A0_19, A0_19.TEXT_FESVLT604_03755_ASTRID_000_011, true)
  end
  function FesVlt604.OnScene00004(A0_22, A1_23, A2_24)
    A2_24:TurnTo(A1_23, false)
    A2_24:WaitForTurn()
    A2_24:PlayActionTimeline(A0_22.ACTION_TIMELINE_EVENT_TALK_ONEHAND)
    A2_24:Talk(A1_23, A0_22, A0_22.TEXT_FESVLT604_03755_BERT_000_012, true)
  end
  function FesVlt604.IsTodoChecked(A0_25, A1_26, A2_27)
    local L3_28
