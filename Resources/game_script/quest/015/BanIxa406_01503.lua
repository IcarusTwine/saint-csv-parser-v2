(function()
  print("BanIxa406 loaded")
  function BanIxa406.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanIxa406.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA406_01503_TAZELMEYEAN_000_000, true, A0_3.TALK_SHAPE_EMPHASIS)
    A0_3:Wait(10)
    if A1_4:GetClassJob() == A0_3.CLASS_JOB_BLACKSMITH or A1_4:GetClassJob() == A0_3.CLASS_JOB_ARMOURER or A1_4:GetClassJob() == A0_3.CLASS_JOB_GOLDSMITH then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA406_01503_TAZELMEYEAN_000_010, false)
    elseif A1_4:GetClassJob() == A0_3.CLASS_JOB_ALCHEMIST or A1_4:GetClassJob() == A0_3.CLASS_JOB_CULINARIAN then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA406_01503_TAZELMEYEAN_000_020, false)
    elseif A1_4:GetClassJob() == A0_3.CLASS_JOB_WOODWORKER or A1_4:GetClassJob() == A0_3.CLASS_JOB_TANNER or A1_4:GetClassJob() == A0_3.CLASS_JOB_WEAVER then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA406_01503_TAZELMEYEAN_000_030, false)
    end
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA406_01503_TAZELMEYEAN_000_040, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA406_01503_TAZELMEYEAN_000_041, true)
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanIxa406.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANIXA406_01503_TAZELMEYEAN_000_050, true)
  end
  function BanIxa406.OnScene00003(A0_9, A1_10, A2_11)
    ...
    L6_15(L7_16)
    L9_18 = A0_9
    L6_15(L7_16, L8_17, L9_18, A0_9.TEXT_BANIXA406_01503_DRAKE_000_060, true)
  ...
  function BanIxa406.OnScene00004(A0_19, A1_20, A2_21)
    A0_19:BindCharacter(A0_19.LEVEL_ID_NPC_01):AutoShake(true)
    A0_19:BindCharacter(A0_19.LEVEL_ID_NPC_01):LookAt(A2_21)
    A2_21:Talk(A1_20, A0_19, A0_19.TEXT_BANIXA406_01503_DRAKE_000_061, true)
    A0_19:BindCharacter(A0_19.LEVEL_ID_NPC_01):PlayActionTimeline(A0_19.ACTION_TIMELINE_EMOTE_YES_ADD)
    A2_21:PlayActionTimeline(A0_19.ACTION_TIMELINE_EVENT_GIVE)
    A0_19:Wait(15)
    A0_19:BindCharacter(A0_19.LEVEL_ID_NPC_01):LookAt()
    A0_19:BindCharacter(A0_19.LEVEL_ID_NPC_01):AutoShake(false)
    A2_21:Talk(A1_20, A0_19, A0_19.TEXT_BANIXA406_01503_DRAKE_000_062, true)
    A0_19:Wait(10)
    A0_19:ScenarioMessage(A0_19.TEXT_BANIXA406_01503_POPMESSAGE_000_200)
    A0_19:Wait(10)
  end
  function BanIxa406.OnScene00005(A0_22, A1_23, A2_24)
    A2_24:TurnTo(A1_23, false)
    A2_24:Talk(A1_23, A0_22, A0_22.TEXT_BANIXA406_01503_TAZELMEYEAN_000_050, true)
  end
  function BanIxa406.OnScene00006(A0_25, A1_26, A2_27)
    ...
    L6_31(L7_32)
    L9_34 = A0_25
    L6_31(L7_32, L8_33, L9_34, A0_25.TEXT_BANIXA406_01503_TAZELMEYEAN_000_130, true)
  ...
  function BanIxa406.OnScene00007(A0_35, A1_36, A2_37)
    local L3_38, L4_39
    L4_39 = A2_37
    ...
    L4_39 = A2_37
    L3_38 = A2_37.Talk
    L3_38(L4_39, A1_36, A0_35, A0_35.TEXT_BANIXA406_01503_TAZELMEYEAN_000_131, true)
    L4_39 = A0_35
    L3_38 = A0_35.Wait
    L3_38(L4_39, 20)
    L4_39 = A1_36
    ...
    if L3_38 >= 1 then
      ...
      L3_38(L4_39, A0_35.TEXT_BANIXA406_01503_SYSTEM_200_200, true)
    end
    L4_39 = A0_35
  ...
  function BanIxa406.OnScene00008(A0_40, A1_41, A2_42)
    A2_42:TurnTo(A1_41, false)
    if A1_41:GetNumOfHqItems(A0_40.RITEM1) >= 4 then
      A2_42:Talk(A1_41, A0_40, A0_40.TEXT_BANIXA406_01503_DRAKE_100_100, true)
      A0_40:CancelEventScene()
    else
      A2_42:Talk(A1_41, A0_40, A0_40.TEXT_BANIXA406_01503_DRAKE_000_065, true)
      A0_40:Wait(10)
      A0_40:ScenarioMessage(A0_40.TEXT_BANIXA406_01503_POPMESSAGE_000_200)
      A0_40:Wait(10)
    end
  end
  function BanIxa406.GetEventItems(A0_43, A1_44)
    local L2_45
  ...
  function BanIxa406.IsTodoChecked(A0_46, A1_47, A2_48)
    local L3_49
    ...
    elseif A2_48 == 1 then
      return 1 <= A1_47:GetQuestUI8AL(L3_49)
    elseif A2_48 == 2 then
      return false
    end
  end
...
;(function()
  ...
  function L1_51(A0_54, A1_55, A2_56, A3_57, A4_58)
    ...
    if A1_55:GetQuestSequence(L5_59) == A0_54.SEQ_1 then
      if A3_57 == A0_54.ENEMY0 then
        return 3 > A1_55:GetQuestUI8BH(L5_59)
  ...
  function L1_51(A0_60, A1_61, A2_62, A3_63, A4_64)
    ...
    if A1_61:GetQuestSequence(L5_65) == A0_60.SEQ_1 then
      if A3_63 == A0_60.ENEMY0 then
        return 3 > A1_61:GetQuestUI8BH(L5_65)
  ...
  function L1_51(A0_66, A1_67, A2_68)
    ...
    elseif A2_68 == 2 then
      return A1_67:GetNumOfItems(A0_66.RITEM1, A0_66.NUM_OF_ITEMS_FILTER_HQ, false, true), 4
    end
  end
  ...
  function L1_51(A0_70, A1_71, A2_72)
    ...
    if A1_71:GetQuestSequence(L3_73) == A0_70.SEQ_FINISH then
      ...
      elseif A2_72 == A0_70.ACTOR1 then
  ...
  function L1_51(A0_74, A1_75, A2_76, A3_77, A4_78, A5_79, A6_80)
    ...
    elseif A1_75:GetQuestSequence(L7_81) == A0_74.SEQ_FINISH and A3_77 == A0_74.ACTOR0 and A1_75:GetNumOfItems(A0_74.RITEM1, A0_74.NUM_OF_ITEMS_FILTER_HQ, false, true) < 4 then
