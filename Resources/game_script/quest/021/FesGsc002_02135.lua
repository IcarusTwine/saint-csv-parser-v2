(function()
  print("FesGsc002 loaded")
  function FesGsc002.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function FesGsc002.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EMOTE_BOW)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESGSC002_02135_GSSTAFF02135_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESGSC002_02135_GSSTAFF02135_000_001, true)
    A0_3:QuestAccepted()
  end
  function FesGsc002.OnScene00002(A0_6, A1_7, A2_8)
    local L3_9, L4_10
    L4_10 = A2_8
    L3_9 = A2_8.TurnTo
    ...
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_FESGSC002_02135_GREGE_000_010, true)
    L4_10 = A0_6
    ...
    if L3_9 then
      A0_6:QuestCompleted()
      A0_6:Wait(120)
      A0_6:SystemTalk(A0_6.TEXT_FESGSC002_02135_SYSTEM_000_011, true)
      A0_6:Wait(10)
    end
    return L3_9, L4_10
  end
  function FesGsc002.OnScene00003(A0_11, A1_12, A2_13)
    A2_13:TurnTo(A1_12, false)
    A2_13:WaitForTurn()
    A2_13:PlayActionTimeline(A0_11.ACTION_TIMELINE_EVENT_TALK2)
    A2_13:Talk(A1_12, A0_11, A0_11.TEXT_FESGSC002_02135_GSSTAFF02135_000_002, true)
  end
  function FesGsc002.IsTodoChecked(A0_14, A1_15, A2_16)
    local L3_17
