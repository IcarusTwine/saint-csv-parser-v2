(function()
  print("BanDwa107 loaded")
  function BanDwa107.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanDwa107.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANDWA107_03908_REGITT_000_001, false, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANDWA107_03908_REGITT_000_002, false, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A2_5:CancelActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_ONEHAND)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANDWA107_03908_REGITT_000_003, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A0_3:Wait(10)
    A2_5:CancelActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_ONEHAND)
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanDwa107.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:LookAt(A1_7)
    A2_8:TurnTo(A1_7, false)
    A2_8:WaitForTurn()
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK1)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANDWA107_03908_DAILYDWARF03908_000_010, false, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANDWA107_03908_DAILYDWARF03908_000_011, false, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
    if A1_7:GetClassJob() == A0_6.CLASS_JOB_BLACKSMITH or A1_7:GetClassJob() == A0_6.CLASS_JOB_ARMOURER or A1_7:GetClassJob() == A0_6.CLASS_JOB_GOLDSMITH then
      A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANDWA107_03908_DAILYDWARF03908_000_012, false, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
    elseif A1_7:GetClassJob() == A0_6.CLASS_JOB_WOODWORKER or A1_7:GetClassJob() == A0_6.CLASS_JOB_TANNER or A1_7:GetClassJob() == A0_6.CLASS_JOB_WEAVER then
      A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANDWA107_03908_DAILYDWARF03908_000_013, false, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
    elseif A1_7:GetClassJob() == A0_6.CLASS_JOB_ALCHEMIST or A1_7:GetClassJob() == A0_6.CLASS_JOB_CULINARIAN then
      A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANDWA107_03908_DAILYDWARF03908_000_014, false, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
    end
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK_ONEHAND)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANDWA107_03908_DAILYDWARF03908_000_016, true, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
    A0_6:Wait(10)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_ITEM)
    A0_6:Wait(30)
  end
  function BanDwa107.OnScene00003(A0_9, A1_10, A2_11)
    A2_11:LookAt(A1_10)
    A2_11:TurnTo(A1_10, false)
    A2_11:WaitForTurn()
    A2_11:Talk(A1_10, A0_9, A0_9.TEXT_BANDWA107_03908_AUTOMATON03908_100_010, true, nil, nil, nil, A0_9.SPEAK_NORMAL_MIDDLE)
  end
  function BanDwa107.OnScene00004(A0_12, A1_13, A2_14)
  end
  function BanDwa107.OnScene00005(A0_15, A1_16, A2_17)
  ...
  function BanDwa107.OnScene00006(A0_25, A1_26, A2_27)
    local L3_28, L4_29
    L4_29 = A1_26
    ...
    L4_29 = A2_27
    L3_28 = A2_27.Talk
    L3_28(L4_29, A1_26, A0_25, A0_25.TEXT_BANDWA107_03908_REGITT_000_031, false, nil, nil, nil, A0_25.SPEAK_NORMAL_MIDDLE)
    L4_29 = A2_27
    L3_28 = A2_27.Talk
    L3_28(L4_29, A1_26, A0_25, A0_25.TEXT_BANDWA107_03908_REGITT_000_032, true, nil, nil, nil, A0_25.SPEAK_NORMAL_MIDDLE)
    L4_29 = A0_25
  ...
  function BanDwa107.OnScene00007(A0_30, A1_31, A2_32)
    ...
    if A0_30:GetQuestAcceptClassJob() == A0_30.CLASS_JOB_BLACKSMITH or A0_30:GetQuestAcceptClassJob() == A0_30.CLASS_JOB_ARMOURER or A0_30:GetQuestAcceptClassJob() == A0_30.CLASS_JOB_GOLDSMITH then
      if 3 > A1_31:GetNumOfNqItems(A0_30.RITEM1) and A1_31:GetNumOfItems(A0_30.RITEM0) == 0 then
        A2_32:Talk(A1_31, A0_30, A0_30.TEXT_BANDWA107_03908_AUTOMATON03908_000_020, true)
      else
        A2_32:Talk(A1_31, A0_30, A0_30.TEXT_BANDWA107_03908_AUTOMATON03908_000_017, true)
    ...
    elseif A0_30:GetQuestAcceptClassJob() == A0_30.CLASS_JOB_WOODWORKER or A0_30:GetQuestAcceptClassJob() == A0_30.CLASS_JOB_TANNER or A0_30:GetQuestAcceptClassJob() == A0_30.CLASS_JOB_WEAVER then
      if 3 > A1_31:GetNumOfNqItems(A0_30.RITEM1) and A1_31:GetNumOfItems(A0_30.RITEM0) == 0 then
        A2_32:Talk(A1_31, A0_30, A0_30.TEXT_BANDWA107_03908_AUTOMATON03908_000_021, true)
      else
        A2_32:Talk(A1_31, A0_30, A0_30.TEXT_BANDWA107_03908_AUTOMATON03908_000_018, true)
        A0_30:CancelEventScene()
      end
    elseif A0_30:GetQuestAcceptClassJob() == A0_30.CLASS_JOB_ALCHEMIST or A0_30:GetQuestAcceptClassJob() == A0_30.CLASS_JOB_CULINARIAN then
      if 3 > A1_31:GetNumOfNqItems(A0_30.RITEM1) and A1_31:GetNumOfItems(A0_30.RITEM0) == 0 then
        A2_32:Talk(A1_31, A0_30, A0_30.TEXT_BANDWA107_03908_AUTOMATON03908_000_022, true)
      else
        A2_32:Talk(A1_31, A0_30, A0_30.TEXT_BANDWA107_03908_AUTOMATON03908_000_019, true)
        A0_30:CancelEventScene()
      end
    else
      A0_30:CancelEventScene()
  ...
  function BanDwa107.OnScene00008(A0_33, A1_34, A2_35)
    A2_35:LookAt(A1_34)
    A2_35:TurnTo(A1_34, false)
    A2_35:WaitForTurn()
    if 3 <= A1_34:GetNumOfNqItems(A0_33.RITEM1) then
      A2_35:PlayActionTimeline(A0_33.ACTION_TIMELINE_EVENT_TALK_ONEHAND)
      A2_35:Talk(A1_34, A0_33, A0_33.TEXT_BANDWA107_03908_DAILYDWARF03908_000_023, true, nil, nil, nil, A0_33.SPEAK_NORMAL_MIDDLE)
    elseif A1_34:GetClassJob() == A0_33.CLASS_JOB_BLACKSMITH or A1_34:GetClassJob() == A0_33.CLASS_JOB_ARMOURER or A1_34:GetClassJob() == A0_33.CLASS_JOB_GOLDSMITH then
      A2_35:PlayActionTimeline(A0_33.ACTION_TIMELINE_EVENT_TALK_ONEHAND)
      A2_35:Talk(A1_34, A0_33, A0_33.TEXT_BANDWA107_03908_DAILYDWARF03908_000_116, true, nil, nil, nil, A0_33.SPEAK_NORMAL_MIDDLE)
    elseif A1_34:GetClassJob() == A0_33.CLASS_JOB_WOODWORKER or A1_34:GetClassJob() == A0_33.CLASS_JOB_TANNER or A1_34:GetClassJob() == A0_33.CLASS_JOB_WEAVER then
      A2_35:PlayActionTimeline(A0_33.ACTION_TIMELINE_EVENT_TALK_ONEHAND)
      A2_35:Talk(A1_34, A0_33, A0_33.TEXT_BANDWA107_03908_DAILYDWARF03908_000_117, true, nil, nil, nil, A0_33.SPEAK_NORMAL_MIDDLE)
    elseif A1_34:GetClassJob() == A0_33.CLASS_JOB_ALCHEMIST or A1_34:GetClassJob() == A0_33.CLASS_JOB_CULINARIAN then
      A2_35:PlayActionTimeline(A0_33.ACTION_TIMELINE_EVENT_TALK_ONEHAND)
      A2_35:Talk(A1_34, A0_33, A0_33.TEXT_BANDWA107_03908_DAILYDWARF03908_000_118, true, nil, nil, nil, A0_33.SPEAK_NORMAL_MIDDLE)
    else
      A0_33:CancelEventScene()
    end
  end
  function BanDwa107.OnScene00009(A0_36, A1_37, A2_38)
  end
  function BanDwa107.IsTodoChecked(A0_39, A1_40, A2_41)
    local L3_42
...
;(function()
  ...
  function L1_44(A0_67, A1_68, A2_69, A3_70, A4_71, A5_72, A6_73)
    ...
    elseif A1_68:GetQuestSequence(L7_74) == A0_67.SEQ_FINISH and A3_70 == A0_67.ACTOR0 and A1_68:GetNumOfItems(A0_67.RITEM1, A0_67.NUM_OF_ITEMS_FILTER_NQ_OR_HQ, false, true) < 3 then
