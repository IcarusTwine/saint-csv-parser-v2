(function()
  print("ComLim003 loaded")
  function ComLim003.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function ComLim003.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1, A1_4)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_COMLIM003_01564_TRACHRAET_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_COMLIM003_01564_TRACHRAET_000_001, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_THINK, A1_4)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_COMLIM003_01564_TRACHRAET_000_002, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_COMLIM003_01564_TRACHRAET_100_002, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2, A1_4)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_COMLIM003_01564_TRACHRAET_000_003, true)
    A0_3:QuestAccepted()
  end
  function ComLim003.OnScene00002(A0_6, A1_7, A2_8)
    local L3_9, L4_10
    L4_10 = A2_8
    ...
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_COMLIM003_01564_MOBOFFICER_000_010, false)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_COMLIM003_01564_MOBOFFICER_000_011, false)
    L4_10 = A2_8
    L3_9 = A2_8.PlayActionTimeline
    L3_9(L4_10, A0_6.ACTION_TIMELINE_EVENT_TALK_FOREFINGER, A1_7)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_COMLIM003_01564_MOBOFFICER_000_012, false)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_COMLIM003_01564_MOBOFFICER_000_013, false)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_COMLIM003_01564_MOBOFFICER_000_014, false)
    L4_10 = A2_8
    L3_9 = A2_8.PlayActionTimeline
    L3_9(L4_10, A0_6.LOC_MOT_01, A1_7)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_COMLIM003_01564_MOBOFFICER_000_015, true)
    L4_10 = A0_6
  ...
  function ComLim003.OnScene00003(A0_11, A1_12, A2_13)
    A2_13:PlayActionTimeline(A0_11.ACTION_TIMELINE_EVENT_TALK2, A1_12)
    A2_13:Talk(A1_12, A0_11, A0_11.TEXT_COMLIM003_01564_TRACHRAET_000_005, true)
  end
  function ComLim003.IsTodoChecked(A0_14, A1_15, A2_16)
    local L3_17
