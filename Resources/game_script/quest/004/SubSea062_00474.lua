(function()
  print("SubSea062 loaded")
  function SubSea062.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
    if A0_0:QuestOffer(A2_2, A1_1) then
      A2_2:TurnTo(A1_1, false)
      A2_2:WaitForTurn()
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_GREETING)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBSEA062_00474_KHANMHAR_000_1, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBSEA062_00474_KHANMHAR_000_2, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBSEA062_00474_KHANMHAR_000_3, true)
      A0_0:QuestAccepted()
      return 1
    else
      return 0
  ...
  function SubSea062.OnScene00001(A0_3, A1_4, A2_5)
    ...
    L5_8 = A1_4
    L6_9 = A0_3
    L3_6(L4_7, L5_8, L6_9, A0_3.TEXT_SUBSEA062_00474_WYDALOEF_000_11, true)
    L4_7 = A0_3
    L3_6 = A0_3.NpcTrade
  ...
  function SubSea062.OnScene00100(A0_10, A1_11, A2_12)
    local L3_13, L4_14
    L4_14 = A2_12
    L3_13 = A2_12.TurnTo
    ...
    L4_14 = A2_12
    L3_13 = A2_12.Talk
    L3_13(L4_14, A1_11, A0_10, A0_10.TEXT_SUBSEA062_00474_WYDALOEF_000_12, false)
    L4_14 = A2_12
    L3_13 = A2_12.Talk
    L3_13(L4_14, A1_11, A0_10, A0_10.TEXT_SUBSEA062_00474_WYDALOEF_000_13, false)
    L4_14 = A2_12
    L3_13 = A2_12.PlayActionTimeline
    L3_13(L4_14, A0_10.ACTION_TIMELINE_EVENT_TALK2)
    L4_14 = A2_12
    L3_13 = A2_12.Talk
    L3_13(L4_14, A1_11, A0_10, A0_10.TEXT_SUBSEA062_00474_WYDALOEF_000_14, true)
    L4_14 = A0_10
  ...
  function SubSea062.OnScene00099(A0_15, A1_16, A2_17)
  end
  function SubSea062.GetEventItems(A0_18, A1_19)
    local L2_20
  ...
  function SubSea062.IsTodoChecked(A0_21, A1_22, A2_23)
    local L3_24
...
;(function()
  ...
  function L1_26(A0_36, A1_37, A2_38, A3_39, A4_40, A5_41, A6_42)
    ...
    L7_43 = L7_43(A0_36)
    if A1_37:GetQuestSequence(L7_43) == A0_36.SEQ_OFFER then
    elseif A1_37:GetQuestSequence(L7_43) == A0_36.SEQ_FINISH and A3_39 == A0_36.ACTOR1 and A1_37:GetNumOfItems(A0_36.RITEM0, A0_36.NUM_OF_ITEMS_FILTER_NQ_OR_HQ, false, true) < 1 and 1 > A1_37:GetQuestUI8AH(L7_43) then
