(function()
  print("BanDwa116 loaded")
  function BanDwa116.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanDwa116.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_ANGRY)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANDWA116_03917_REGITT_000_000, false)
    A2_5:CancelActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_ANGRY)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_NO)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANDWA116_03917_REGITT_000_001, false)
    A2_5:CancelActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_NO)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANDWA116_03917_REGITT_000_002, true)
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanDwa116.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7, false)
    A2_8:WaitForTurn()
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK_ONEHAND)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANDWA116_03917_SHIGITT_000_010, false)
    if A1_7:GetClassJob() == A0_6.CLASS_JOB_BLACKSMITH or A1_7:GetClassJob() == A0_6.CLASS_JOB_ARMOURER or A1_7:GetClassJob() == A0_6.CLASS_JOB_GOLDSMITH then
      A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANDWA116_03917_SHIGITT_000_020, true)
    elseif A1_7:GetClassJob() == A0_6.CLASS_JOB_WOODWORKER or A1_7:GetClassJob() == A0_6.CLASS_JOB_TANNER or A1_7:GetClassJob() == A0_6.CLASS_JOB_WEAVER then
      A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANDWA116_03917_SHIGITT_000_030, true)
    elseif A1_7:GetClassJob() == A0_6.CLASS_JOB_ALCHEMIST or A1_7:GetClassJob() == A0_6.CLASS_JOB_CULINARIAN then
      A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANDWA116_03917_SHIGITT_000_040, true)
    end
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_ITEM)
    A0_6:Wait(30)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANDWA116_03917_SHIGITT_000_050, true)
    A0_6:Wait(10)
  end
  function BanDwa116.OnScene00003(A0_9, A1_10, A2_11)
  ...
  function BanDwa116.OnScene00004(A0_19, A1_20, A2_21)
    A1_20:PlayActionTimeline(A0_19.ACTION_TIMELINE_EVENT_ITEM)
    A0_19:Wait(30)
    A2_21:PlayActionTimeline(A0_19.ACTION_TIMELINE_EMOTE_JOY)
    A2_21:Talk(A1_20, A0_19, A0_19.TEXT_BANDWA116_03917_DWARF03917_000_100, true)
  ...
  function BanDwa116.OnScene00005(A0_22, A1_23, A2_24)
    ...
    if A0_22:GetQuestAcceptClassJob() == A0_22.CLASS_JOB_BLACKSMITH or A0_22:GetQuestAcceptClassJob() == A0_22.CLASS_JOB_ARMOURER or A0_22:GetQuestAcceptClassJob() == A0_22.CLASS_JOB_GOLDSMITH then
      if 3 > A1_23:GetNumOfNqItems(A0_22.RITEM1) and A1_23:GetNumOfItems(A0_22.RITEM0) == 0 then
        A2_24:Talk(A1_23, A0_22, A0_22.TEXT_BANDWA116_03917_AUTOMATON_000_080, true)
      else
        A2_24:Talk(A1_23, A0_22, A0_22.TEXT_BANDWA116_03917_AUTOMATON_000_070, true)
    ...
    elseif A0_22:GetQuestAcceptClassJob() == A0_22.CLASS_JOB_WOODWORKER or A0_22:GetQuestAcceptClassJob() == A0_22.CLASS_JOB_TANNER or A0_22:GetQuestAcceptClassJob() == A0_22.CLASS_JOB_WEAVER then
      if 3 > A1_23:GetNumOfNqItems(A0_22.RITEM1) and A1_23:GetNumOfItems(A0_22.RITEM0) == 0 then
        A2_24:Talk(A1_23, A0_22, A0_22.TEXT_BANDWA116_03917_AUTOMATON_000_081, true)
      else
        A2_24:Talk(A1_23, A0_22, A0_22.TEXT_BANDWA116_03917_AUTOMATON_000_071, true)
        A0_22:CancelEventScene()
      end
    elseif A0_22:GetQuestAcceptClassJob() == A0_22.CLASS_JOB_ALCHEMIST or A0_22:GetQuestAcceptClassJob() == A0_22.CLASS_JOB_CULINARIAN then
      if 3 > A1_23:GetNumOfNqItems(A0_22.RITEM1) and A1_23:GetNumOfItems(A0_22.RITEM0) == 0 then
        A2_24:Talk(A1_23, A0_22, A0_22.TEXT_BANDWA116_03917_AUTOMATON_000_082, true)
      else
        A2_24:Talk(A1_23, A0_22, A0_22.TEXT_BANDWA116_03917_AUTOMATON_000_072, true)
        A0_22:CancelEventScene()
      end
    else
      A0_22:CancelEventScene()
  ...
  function BanDwa116.OnScene00006(A0_25, A1_26, A2_27)
    ...
    L5_30 = A2_27
    L4_29 = A2_27.Talk
    L4_29(L5_30, A1_26, A0_25, A0_25.TEXT_BANDWA116_03917_REGITT_000_110, false)
    L5_30 = A2_27
    ...
    L5_30 = A2_27
    L4_29 = A2_27.Talk
    L4_29(L5_30, A1_26, A0_25, A0_25.TEXT_BANDWA116_03917_REGITT_000_111, true)
    L5_30 = A0_25
  ...
  function BanDwa116.IsTodoChecked(A0_31, A1_32, A2_33)
    local L3_34
...
;(function()
  ...
  function L1_36(A0_51, A1_52, A2_53)
    ...
    elseif A2_53 == 1 then
      return A1_52:GetNumOfItems(A0_51.RITEM1, A0_51.NUM_OF_ITEMS_FILTER_NQ_OR_HQ, false, true), 3, A0_51.RITEM1, false
    elseif A2_53 == 2 then
      return A1_52:GetQuestUI8AL(L3_54), 0
    end
  end
  ...
  function L1_36(A0_59, A1_60, A2_61, A3_62, A4_63, A5_64, A6_65)
    ...
    elseif A1_60:GetQuestSequence(L7_66) == A0_59.SEQ_2 then
      if A3_62 == A0_59.ACTOR2 and A1_60:GetNumOfItems(A0_59.RITEM1, A0_59.NUM_OF_ITEMS_FILTER_NQ_OR_HQ, false, true) < 3 then
