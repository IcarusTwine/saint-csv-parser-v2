(function()
  print("ManWil303 loaded")
  function ManWil303.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function ManWil303.OnScene00001(A0_3, A1_4, A2_5)
    local L3_6
    ...
    A0_3:Wait(60)
    L3_6:Talk(A1_4, A0_3, A0_3.TEXT_MANWIL303_00685_MINFILIA_000_20, false, A0_3.LOC_TALKSHAPE1, nil, nil, A0_3.LIP_TYPE_NONE)
    L3_6:Talk(A1_4, A0_3, A0_3.TEXT_MANWIL303_00685_MINFILIA_000_21, false, A0_3.LOC_TALKSHAPE1, nil, nil, A0_3.LIP_TYPE_NONE)
    L3_6:Talk(A1_4, A0_3, A0_3.TEXT_MANWIL303_00685_MINFILIA_000_22, true, A0_3.LOC_TALKSHAPE1, nil, nil, A0_3.LIP_TYPE_NONE)
    A1_4:AutoShake(false)
    A0_3:Wait(15)
    A1_4:LookAt(A2_5)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_MANWIL303_00685_FLAMEPERSONNEL_000_023, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A0_3:Wait(15)
    A0_3:PlayTargetRelationCamera(A2_5, -51.2754, 4.4859, 1.4271, 70.5656, 1.9177, 0.981, 5.7512)
    ...
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_MANWIL303_00685_FLAMEPERSONNEL_000_024, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A0_3:Wait(15)
    A2_5:CancelActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A0_3:Wait(15)
    A2_5:LookAt(-60, 0)
    A0_3:Orbit(-30, 0, 30, 45, 30)
    A0_3:Zoom(3, 0, 30, 45, 30)
    A0_3:SideDolly(-2, 0, 30, 45, 30)
    A0_3:UpdownDolly(-0.3, 0, 30, 45, 30)
    A0_3:Wait(90)
    A1_4:LookAt(45, 0)
    A0_3:Wait(30)
    A0_3:QuestAccepted()
    ...
    A0_3:Wait(135)
    A0_3:DisableSceneSkip()
    A0_3:PlayTargetRelationCamera(A2_5, 85.9328, 5.6433, 0.7809, 104.6113, 7.9652, 1.0761, 3.1958)
    A0_3:DisableSceneSkip()
    ...
    A0_3:Wait(15)
    A0_3:DisableSceneSkip()
    A0_3:SystemTalk(A0_3.TEXT_MANWIL303_00685_SYSTEM_000_025, false)
    A0_3:DisableSceneSkip()
    A0_3:SystemTalk(A0_3.TEXT_MANWIL303_00685_SYSTEM_000_026, true)
    A0_3:DisableSceneSkip()
    A0_3:Wait(15)
  ...
  function ManWil303.OnScene00002(A0_7, A1_8, A2_9)
    local L3_10
    L3_10 = A0_7.Wait
    L3_10(A0_7, 15)
    L3_10 = A0_7.IsInRedo
    ...
    if L3_10 == false then
      ...
      L3_10(A0_7, A0_7.ORDER_OF_THE_IMMORTALS)
      L3_10 = A1_8.GetGrandCompany
      L3_10 = L3_10(A1_8)
      A0_7:ScreenGC(L3_10, A1_8:GetGrandCompanyRank(L3_10), A0_7.JINGLE_GC_IN_URU)
    else
      L3_10 = A0_7.ScreenGC
      L3_10(A0_7, A0_7.ORDER_OF_THE_IMMORTALS, A0_7.GC_RANK_01, A0_7.JINGLE_GC_IN_URU)
    end
    L3_10 = A0_7.Wait
    L3_10(A0_7, 150)
    L3_10 = A1_8.IsHowTo
  ...
  function ManWil303.OnScene00003(A0_11, A1_12, A2_13)
    local L3_14, L4_15
    L4_15 = A2_13
    L3_14 = A2_13.TurnTo
    L3_14(L4_15, A1_12)
    ...
    L4_15 = A2_13
    L3_14 = A2_13.Talk
    L3_14(L4_15, A1_12, A0_11, A0_11.TEXT_MANWIL303_00685_GUIDE_000_200, true)
    L4_15 = A0_11
  ...
  function ManWil303.OnScene00004(A0_16, A1_17, A2_18, ...)
    local L4_20
    L4_20 = (...)
  ...
  function ManWil303.IsTodoChecked(A0_21, A1_22, A2_23)
    local L3_24
