(function()
  print("BanIxa502 loaded")
  function BanIxa502.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
    A0_0:SystemTalk(A0_0.TEXT_BANIXA502_01510_SYSTEM_000_900, true)
  ...
  function BanIxa502.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA502_01510_DUZALMEYEAN_000_000, true)
    A0_3:Wait(10)
    if A1_4:GetClassJob() == A0_3.CLASS_JOB_BLACKSMITH or A1_4:GetClassJob() == A0_3.CLASS_JOB_ARMOURER or A1_4:GetClassJob() == A0_3.CLASS_JOB_GOLDSMITH then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA502_01510_DUZALMEYEAN_000_010, false)
    elseif A1_4:GetClassJob() == A0_3.CLASS_JOB_ALCHEMIST or A1_4:GetClassJob() == A0_3.CLASS_JOB_CULINARIAN then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA502_01510_DUZALMEYEAN_000_020, false)
    elseif A1_4:GetClassJob() == A0_3.CLASS_JOB_WOODWORKER or A1_4:GetClassJob() == A0_3.CLASS_JOB_TANNER or A1_4:GetClassJob() == A0_3.CLASS_JOB_WEAVER then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA502_01510_DUZALMEYEAN_000_030, false)
    end
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_THINK)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA502_01510_DUZALMEYEAN_000_040, true)
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanIxa502.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7, false)
    A2_8:WaitForTurn()
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK1)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANIXA502_01510_FYRBRYDA_000_060, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANIXA502_01510_FYRBRYDA_000_061, false)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANIXA502_01510_FYRBRYDA_000_062, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANIXA502_01510_FYRBRYDA_000_063, true)
  end
  function BanIxa502.OnScene00003(A0_9, A1_10, A2_11)
    A2_11:TurnTo(A1_10, false)
    A2_11:WaitForTurn()
    A2_11:PlayActionTimeline(A0_9.ACTION_TIMELINE_EVENT_TALK1)
    A2_11:Talk(A1_10, A0_9, A0_9.TEXT_BANIXA502_01510_DUZALMEYEAN_000_050, true)
  end
  function BanIxa502.OnScene00004(A0_12, A1_13, A2_14)
    A2_14:TurnTo(A1_13, false)
    A2_14:WaitForTurn()
    A2_14:PlayActionTimeline(A0_12.ACTION_TIMELINE_EVENT_TALK1)
    A2_14:Talk(A1_13, A0_12, A0_12.TEXT_BANIXA502_01510_FYRBRYDA_000_070, false)
    A2_14:Talk(A1_13, A0_12, A0_12.TEXT_BANIXA502_01510_FYRBRYDA_000_071, true)
  end
  function BanIxa502.OnScene00005(A0_15, A1_16, A2_17)
    A2_17:TurnTo(A1_16, false)
    A2_17:WaitForTurn()
    A2_17:PlayActionTimeline(A0_15.ACTION_TIMELINE_EVENT_TALK1)
    A2_17:Talk(A1_16, A0_15, A0_15.TEXT_BANIXA502_01510_DUZALMEYEAN_000_050, true)
  end
  function BanIxa502.OnScene00006(A0_18, A1_19, A2_20)
  ...
  function BanIxa502.OnScene00007(A0_28, A1_29, A2_30)
    A2_30:PlayActionTimeline(A0_28.ACTION_TIMELINE_EVENT_ITEM)
    A2_30:Talk(A1_29, A0_28, A0_28.TEXT_BANIXA502_01510_FYRBRYDA_000_091, true)
    A0_28:Wait(10)
    A0_28:ScenarioMessage(A0_28.TEXT_BANIXA502_01510_POPMESSAGE_000_200)
    A0_28:Wait(10)
  end
  function BanIxa502.OnScene00008(A0_31, A1_32, A2_33)
    A2_33:TurnTo(A1_32, false)
    A2_33:WaitForTurn()
    A2_33:PlayActionTimeline(A0_31.ACTION_TIMELINE_EVENT_TALK1)
    A2_33:Talk(A1_32, A0_31, A0_31.TEXT_BANIXA502_01510_DUZALMEYEAN_000_050, true)
  end
  function BanIxa502.OnScene00009(A0_34, A1_35, A2_36)
  ...
  function BanIxa502.OnScene00010(A0_44, A1_45, A2_46)
    local L3_47, L4_48
    L4_48 = A2_46
    ...
    L4_48 = A2_46
    L3_47 = A2_46.Talk
    L3_47(L4_48, A1_45, A0_44, A0_44.TEXT_BANIXA502_01510_DUZALMEYEAN_000_131, true, A0_44.TALK_SHAPE_EMPHASIS)
    L4_48 = A0_44
    L3_47 = A0_44.Wait
    L3_47(L4_48, 20)
    L4_48 = A1_45
    ...
    if L3_47 >= 1 then
      ...
      L3_47(L4_48, A0_44.TEXT_BANIXA502_01510_SYSTEM_200_200, true)
    end
    L4_48 = A0_44
  ...
  function BanIxa502.OnScene00011(A0_49, A1_50, A2_51)
    A2_51:TurnTo(A1_50, false)
    A2_51:WaitForTurn()
    A2_51:PlayActionTimeline(A0_49.ACTION_TIMELINE_EVENT_TALK1)
    if A1_50:GetNumOfHqItems(A0_49.RITEM1) >= 2 then
      A2_51:Talk(A1_50, A0_49, A0_49.TEXT_BANIXA502_01510_FYRBRYDA_100_100, true)
      A0_49:CancelEventScene()
    else
      A2_51:Talk(A1_50, A0_49, A0_49.TEXT_BANIXA502_01510_FYRBRYDA_000_100, true)
      A0_49:Wait(10)
      A0_49:ScenarioMessage(A0_49.TEXT_BANIXA502_01510_POPMESSAGE_000_200)
      A0_49:Wait(10)
    end
  end
  function BanIxa502.GetEventItems(A0_52, A1_53)
    local L2_54
  ...
  function BanIxa502.IsTodoChecked(A0_55, A1_56, A2_57)
    local L3_58
