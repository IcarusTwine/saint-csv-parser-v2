(function()
  print("BanKob103 loaded")
  function BanKob103.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanKob103.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TROUBLE)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANKOB103_01327_BOZU_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANKOB103_01327_BOZU_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANKOB103_01327_BOZU_000_002, true)
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanKob103.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7)
    A2_8:WaitForTurn()
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK1)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANKOB103_01327_BOZU_000_003, true)
  end
  function BanKob103.OnScene00003(A0_9, A1_10, A2_11)
    ...
    L3_12 = A2_11.Talk
    L5_14 = A1_10
    L9_18 = A0_9.TALK_SHAPE_EMPHASIS
  ...
  function BanKob103.OnScene00004(A0_19, A1_20, A2_21)
    A2_21:PlayActionTimeline(A0_19.ACTION_TIMELINE_EVENT_GIVE)
    A2_21:Talk(A1_20, A0_19, A0_19.TEXT_BANKOB103_01327_BAGO_000_021, false)
    A2_21:Talk(A1_20, A0_19, A0_19.TEXT_BANKOB103_01327_BAGO_000_022, true)
  end
  function BanKob103.OnScene00005(A0_22, A1_23, A2_24)
    A2_24:TurnTo(A1_23)
    A2_24:WaitForTurn()
    A2_24:PlayActionTimeline(A0_22.ACTION_TIMELINE_EVENT_TALK1)
    A2_24:Talk(A1_23, A0_22, A0_22.TEXT_BANKOB103_01327_BOZU_000_003, true)
  end
  function BanKob103.OnScene00006(A0_25, A1_26, A2_27)
    local L3_28, L4_29
    L4_29 = A2_27
    L3_28 = A2_27.TurnTo
    L3_28(L4_29, A1_26)
    ...
    L4_29 = A2_27
    L3_28 = A2_27.Talk
    L3_28(L4_29, A1_26, A0_25, A0_25.TEXT_BANKOB103_01327_BOZU_000_030, false)
    L4_29 = A2_27
    L3_28 = A2_27.Talk
    L3_28(L4_29, A1_26, A0_25, A0_25.TEXT_BANKOB103_01327_BOZU_000_031, true)
    L4_29 = A0_25
    L3_28 = A0_25.QuestReward
    L4_29 = L3_28(L4_29, A2_27, A1_26)
    if L3_28 then
      A0_25:QuestCompleted(A0_25.SCREEN_IMAGE_BEAST_QUEST_COMPLETE)
      if A1_26:IsHowTo(A0_25.HOW_TO_PROOF_OF_FRIENDSHIP) == false then
        A0_25:HowTo(A0_25.HOW_TO_PROOF_OF_FRIENDSHIP)
      end
    end
    return L3_28, L4_29
  end
  function BanKob103.GetEventItems(A0_30, A1_31)
    local L2_32
  ...
  function BanKob103.IsTodoChecked(A0_33, A1_34, A2_35)
    local L3_36
