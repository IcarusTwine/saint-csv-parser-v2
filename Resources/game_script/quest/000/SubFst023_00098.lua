(function()
  print("SubFst023 loaded")
  function SubFst023.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:TurnTo(A1_1)
    if A0_0:QuestOffer(A2_2, A1_1) then
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBFST023_00098_DAMETTA_000_1, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK1)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBFST023_00098_DAMETTA_000_2, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBFST023_00098_DAMETTA_000_3, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBFST023_00098_DAMETTA_000_4, true)
      A0_0:QuestAccepted()
      return 1
    else
      return 0
  ...
  function SubFst023.OnScene00001(A0_3, A1_4, A2_5)
    ...
    L5_8 = A1_4
    L6_9 = A0_3
    L3_6(L4_7, L5_8, L6_9, A0_3.TEXT_SUBFST023_00098_DAMETTA_000_10, true)
    L4_7 = A0_3
    L3_6 = A0_3.NpcTrade
  ...
  function SubFst023.OnScene00100(A0_10, A1_11, A2_12)
    local L3_13, L4_14
    L4_14 = A2_12
    ...
    L3_13(L4_14, A0_10.ACTION_TIMELINE_EVENT_TALK1, A1_11)
    L4_14 = A2_12
    L3_13 = A2_12.Talk
    L3_13(L4_14, A1_11, A0_10, A0_10.TEXT_SUBFST023_00098_DAMETTA_000_11, false)
    L4_14 = A2_12
    L3_13 = A2_12.Talk
    L3_13(L4_14, A1_11, A0_10, A0_10.TEXT_SUBFST023_00098_DAMETTA_000_12, false)
    L4_14 = A2_12
    L3_13 = A2_12.Talk
    L3_13(L4_14, A1_11, A0_10, A0_10.TEXT_SUBFST023_00098_DAMETTA_000_13, false)
    L4_14 = A2_12
    L3_13 = A2_12.PlayActionTimeline
    L3_13(L4_14, A0_10.ACTION_TIMELINE_EVENT_THINK, A1_11)
    L4_14 = A2_12
    L3_13 = A2_12.Talk
    L3_13(L4_14, A1_11, A0_10, A0_10.TEXT_SUBFST023_00098_DAMETTA_000_14, false)
    L4_14 = A2_12
    L3_13 = A2_12.Talk
    L3_13(L4_14, A1_11, A0_10, A0_10.TEXT_SUBFST023_00098_DAMETTA_000_15, false)
    L4_14 = A2_12
    L3_13 = A2_12.Talk
    L3_13(L4_14, A1_11, A0_10, A0_10.TEXT_SUBFST023_00098_DAMETTA_000_16, false)
    L4_14 = A2_12
    L3_13 = A2_12.PlayActionTimeline
    L3_13(L4_14, A0_10.ACTION_TIMELINE_EVENT_TALK1, A1_11)
    L4_14 = A2_12
    L3_13 = A2_12.Talk
    L3_13(L4_14, A1_11, A0_10, A0_10.TEXT_SUBFST023_00098_DAMETTA_000_17, true)
    L4_14 = A0_10
  ...
  function SubFst023.OnScene00099(A0_15, A1_16, A2_17)
  end
  function SubFst023.GetEventItems(A0_18, A1_19)
    local L2_20
  ...
  function SubFst023.IsTodoChecked(A0_21, A1_22, A2_23)
    local L3_24
    ...
    if A2_23 == 0 then
      return A1_22:GetQuestUI8AL(L3_24) >= 4
    elseif A2_23 == 1 then
      return false
    end
  end
...
;(function()
  ...
  function L1_26(A0_29, A1_30, A2_31)
    ...
    if A2_31 == 0 then
      return A1_30:GetQuestUI8AL(L3_32), 4
    elseif A2_31 == 1 then
