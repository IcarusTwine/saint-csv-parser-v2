(function()
  print("GaiUsb603 loaded")
  function GaiUsb603.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsb603.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB603_00885_IDRISTAN_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB603_00885_IDRISTAN_000_001, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ITEM)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB603_00885_IDRISTAN_000_002, true)
    A0_3:QuestAccepted()
  end
  function GaiUsb603.OnScene00002(A0_6, A1_7, A2_8)
    A0_6:Inventory(true)
  end
  function GaiUsb603.OnScene00003(A0_9, A1_10, A2_11)
    A0_9:ScenarioMessage(A0_9.TEXT_GAIUSB603_00885_POP_MESSAGE_000)
  end
  function GaiUsb603.OnScene00004(A0_12, A1_13, A2_14)
    local L3_15, L4_16
    L4_16 = A2_14
    L3_15 = A2_14.TurnTo
    ...
    L4_16 = A2_14
    L3_15 = A2_14.Talk
    L3_15(L4_16, A1_13, A0_12, A0_12.TEXT_GAIUSB603_00885_IDRISTAN_000_020, false)
    L4_16 = A2_14
    L3_15 = A2_14.PlayActionTimeline
    L3_15(L4_16, A0_12.ACTION_TIMELINE_EVENT_ADD_YES)
    L4_16 = A2_14
    L3_15 = A2_14.Talk
    L3_15(L4_16, A1_13, A0_12, A0_12.TEXT_GAIUSB603_00885_IDRISTAN_000_021, true)
    L4_16 = A0_12
  ...
  function GaiUsb603.OnScene00005(A0_17, A1_18, A2_19)
  end
  function GaiUsb603.OnScene00006(A0_20, A1_21, A2_22)
  end
  function GaiUsb603.GetEventItems(A0_23, A1_24)
    local L2_25
  ...
  function GaiUsb603.IsTodoChecked(A0_26, A1_27, A2_28)
    local L3_29
