(function()
  print("GaiUsd018 loaded")
  function GaiUsd018.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsd018.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_REACTION_ELE_M, A1_4)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSD018_01413_URIANGER_000_000, true)
    A0_3:Wait(10)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1, A1_4)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSD018_01413_URIANGER_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSD018_01413_URIANGER_000_002, true)
    A0_3:Wait(10)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_THINK, A1_4)
    if A1_4:IsQuestCompleted(A0_3.QST_COMP_CHK1) == true then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSD018_01413_URIANGER_000_003, true)
    else
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSD018_01413_URIANGER_000_004, true)
    end
    A0_3:Wait(10)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2, A1_4)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSD018_01413_URIANGER_000_005, true)
    A0_3:QuestAccepted()
  end
  function GaiUsd018.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:LookAt(A1_7)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK_ANGRY, A1_7)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_GAIUSD018_01413_RASHAHT_000_010, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_GAIUSD018_01413_RASHAHT_000_011, true)
    A0_6:Wait(10)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK1, A1_7)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_GAIUSD018_01413_RASHAHT_000_012, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_GAIUSD018_01413_RASHAHT_000_013, true)
    A0_6:Wait(10)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK2, A1_7)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_GAIUSD018_01413_RASHAHT_000_014, true)
    A0_6:Wait(10)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK_FOREFINGER, A1_7)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_GAIUSD018_01413_RASHAHT_000_015, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_GAIUSD018_01413_RASHAHT_000_016, true)
  end
  function GaiUsd018.OnScene00003(A0_9, A1_10, A2_11)
    local L3_12, L4_13
    L4_13 = A2_11
    L3_12 = A2_11.LookAt
    L3_12(L4_13, A1_10)
    ...
    L3_12(L4_13, A0_9.ACTION_TIMELINE_EMOTE_SALUTE_GCA, A1_10)
    L4_13 = A2_11
    L3_12 = A2_11.Talk
    L3_12(L4_13, A1_10, A0_9, A0_9.TEXT_GAIUSD018_01413_STYRNLONA_000_020, true)
    L4_13 = A0_9
    L3_12 = A0_9.Wait
    L3_12(L4_13, 10)
    L4_13 = A2_11
    L3_12 = A2_11.PlayActionTimeline
    L3_12(L4_13, A0_9.ACTION_TIMELINE_EVENT_TALK1, A1_10)
    L4_13 = A2_11
    L3_12 = A2_11.Talk
    L3_12(L4_13, A1_10, A0_9, A0_9.TEXT_GAIUSD018_01413_STYRNLONA_000_021, false)
    L4_13 = A2_11
    L3_12 = A2_11.Talk
    L3_12(L4_13, A1_10, A0_9, A0_9.TEXT_GAIUSD018_01413_STYRNLONA_000_022, true)
    L4_13 = A0_9
    L3_12 = A0_9.Wait
    L3_12(L4_13, 10)
    L4_13 = A0_9
  ...
  function GaiUsd018.OnScene00004(A0_14, A1_15, A2_16)
    A2_16:LookAt(A1_15)
    A2_16:PlayActionTimeline(A0_14.ACTION_TIMELINE_EVENT_TALK2, A1_15)
    A2_16:Talk(A1_15, A0_14, A0_14.TEXT_GAIUSD018_01413_RASHAHT_000_019, true)
  end
  function GaiUsd018.IsTodoChecked(A0_17, A1_18, A2_19)
    local L3_20
