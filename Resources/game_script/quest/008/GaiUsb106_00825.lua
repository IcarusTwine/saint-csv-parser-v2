(function()
  print("GaiUsb106 loaded")
  function GaiUsb106.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsb106.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB106_00825_UKHUBATIA_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_THINK)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB106_00825_UKHUBATIA_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB106_00825_UKHUBATIA_000_002, true)
    A0_3:QuestAccepted()
  end
  function GaiUsb106.OnScene00002(A0_6, A1_7, A2_8)
  ...
  function GaiUsb106.OnScene00003(A0_16, A1_17, A2_18)
    local L3_19, L4_20
    L4_20 = A2_18
    ...
    L4_20 = A2_18
    L3_19 = A2_18.Talk
    L3_19(L4_20, A1_17, A0_16, A0_16.TEXT_GAIUSB106_00825_UKHUBATIA_000_035, true)
    L4_20 = A0_16
  ...
  function GaiUsb106.GetEventItems(A0_21, A1_22)
    local L2_23
  ...
  function GaiUsb106.IsTodoChecked(A0_24, A1_25, A2_26)
    local L3_27
    ...
    if A2_26 == 0 then
      return A1_25:GetQuestUI8BH(L3_27) >= 6
    elseif A2_26 == 1 then
      return false
    end
  end
...
;(function()
  ...
  function L1_29(A0_32, A1_33, A2_34)
    ...
    if A2_34 == 0 then
      return A1_33:GetQuestUI8BH(L3_35), 6
    elseif A2_34 == 1 then
