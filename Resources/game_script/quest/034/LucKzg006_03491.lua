(function()
  print("LucKzg006 loaded")
  function LucKzg006.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function LucKzg006.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TROUBLE)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZG006_03491_BHOLBOL_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZG006_03491_BHOLBOL_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZG006_03491_BHOLBOL_000_002, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZG006_03491_BHOLBOL_000_003, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZG006_03491_BHOLBOL_000_004, true)
    A0_3:QuestAccepted()
  end
  function LucKzg006.OnScene00002(A0_6, A1_7, A2_8)
    if A0_6:IsBattleNpcOwner(A1_7, true) == true or A0_6:IsBattleNpcTriggerOwner(A1_7, A2_8, false) == true then
    else
      A0_6:LogMessage(A0_6.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function LucKzg006.OnScene00003(A0_9, A1_10, A2_11)
  end
  function LucKzg006.OnScene00004(A0_12, A1_13, A2_14)
  end
  function LucKzg006.OnScene00005(A0_15, A1_16, A2_17)
  end
  function LucKzg006.OnScene00006(A0_18, A1_19, A2_20)
    A2_20:TurnTo(A1_19, false)
    A2_20:WaitForTurn()
    A2_20:PlayActionTimeline(A0_18.ACTION_TIMELINE_EVENT_TALK2)
    A2_20:Talk(A1_19, A0_18, A0_18.TEXT_LUCKZG006_03491_BHOLBOL_000_010, true)
  end
  function LucKzg006.OnScene00007(A0_21, A1_22, A2_23)
  end
  function LucKzg006.OnScene00008(A0_24, A1_25, A2_26)
  ...
  function LucKzg006.OnScene00009(A0_34, A1_35, A2_36)
    local L3_37, L4_38
    L4_38 = A1_35
    ...
    L3_37(L4_38, A0_34.ACTION_TIMELINE_EVENT_TROUBLE)
    L4_38 = A2_36
    L3_37 = A2_36.Talk
    L3_37(L4_38, A1_35, A0_34, A0_34.TEXT_LUCKZG006_03491_BHOLBOL_000_021, false)
    L4_38 = A2_36
    L3_37 = A2_36.Talk
    L3_37(L4_38, A1_35, A0_34, A0_34.TEXT_LUCKZG006_03491_BHOLBOL_000_022, false)
    L4_38 = A2_36
    L3_37 = A2_36.Talk
    L3_37(L4_38, A1_35, A0_34, A0_34.TEXT_LUCKZG006_03491_BHOLBOL_000_023, false)
    L4_38 = A2_36
    L3_37 = A2_36.PlayActionTimeline
    L3_37(L4_38, A0_34.ACTION_TIMELINE_EVENT_TALK1)
    L4_38 = A2_36
    L3_37 = A2_36.Talk
    L3_37(L4_38, A1_35, A0_34, A0_34.TEXT_LUCKZG006_03491_BHOLBOL_000_024, true)
    L4_38 = A0_34
    L3_37 = A0_34.Wait
    L3_37(L4_38, 10)
    L4_38 = A0_34
  ...
  function LucKzg006.GetEventItems(A0_39, A1_40)
    local L2_41
  ...
  function LucKzg006.IsTodoChecked(A0_42, A1_43, A2_44)
    local L3_45
...
;(function()
  ...
  function L1_47(A0_62, A1_63, A2_64, A3_65)
    ...
    L4_66 = L4_66(A0_62)
    if A1_63:GetQuestSequence(L4_66) == A0_62.SEQ_1 and A2_64:GetLayoutId() == A0_62.ENEMY0 and A3_65 == A0_62.ITEM0 then
      return true
    end
    return false
  end
