(function()
  print("GaiUsb108 loaded")
  function GaiUsb108.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsb108.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB108_00827_MUMUGOI_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB108_00827_MUMUGOI_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB108_00827_MUMUGOI_000_002, true)
    A0_3:QuestAccepted()
  end
  function GaiUsb108.OnScene00002(A0_6, A1_7, A2_8)
  end
  function GaiUsb108.OnScene00003(A0_9, A1_10, A2_11)
  end
  function GaiUsb108.OnScene00004(A0_12, A1_13, A2_14)
  end
  function GaiUsb108.OnScene00005(A0_15, A1_16, A2_17)
    A0_15:ScenarioMessage(A0_15.TEXT_GAIUSB108_00827_POP_MESSAGE_000)
  end
  function GaiUsb108.OnScene00006(A0_18, A1_19, A2_20)
  end
  function GaiUsb108.OnScene00007(A0_21, A1_22, A2_23)
    A0_21:ScenarioMessage(A0_21.TEXT_GAIUSB108_00827_POP_MESSAGE_000)
  end
  function GaiUsb108.OnScene00008(A0_24, A1_25, A2_26)
    A2_26:LookAt(A1_25)
    A2_26:Talk(A1_25, A0_24, A0_24.TEXT_GAIUSB108_00827_MUMUGOI_000_015, false)
    A2_26:Talk(A1_25, A0_24, A0_24.TEXT_GAIUSB108_00827_MUMUGOI_000_016, false)
    A2_26:Talk(A1_25, A0_24, A0_24.TEXT_GAIUSB108_00827_MUMUGOI_000_017, true)
  end
  function GaiUsb108.OnScene00009(A0_27, A1_28, A2_29)
    local L3_30, L4_31
    L4_31 = A2_29
    L3_30 = A2_29.LookAt
    L3_30(L4_31, A1_28)
    L4_31 = A2_29
    L3_30 = A2_29.Talk
    L3_30(L4_31, A1_28, A0_27, A0_27.TEXT_GAIUSB108_00827_MUMUGOI_000_030, true)
    L4_31 = A0_27
  ...
  function GaiUsb108.IsTodoChecked(A0_32, A1_33, A2_34)
    local L3_35
    ...
    elseif A2_34 == 2 then
      return A1_33:GetQuestUI8AL(L3_35) >= 4
    elseif A2_34 == 3 then
      return false
    end
  end
...
;(function()
  ...
  function L1_37(A0_52, A1_53, A2_54)
    ...
    elseif A2_54 == 2 then
      return A1_53:GetQuestUI8AL(L3_55), 4
    elseif A2_54 == 3 then
      return A1_53:GetQuestUI8AL(L3_55), 0
    end
  end
