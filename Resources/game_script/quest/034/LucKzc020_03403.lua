(function()
  print("LucKzc020 loaded")
  function LucKzc020.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function LucKzc020.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_ANGRY)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZC020_03403_ANIALA_000_000, true)
    A0_3:Wait(15)
    ...
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZC020_03403_ANIALA_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZC020_03403_ANIALA_000_002, false)
    A2_5:CancelActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_ANGRY)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZC020_03403_ANIALA_000_003, true)
    A0_3:QuestAccepted()
  end
  function LucKzc020.OnScene00002(A0_6, A1_7, A2_8)
    if A0_6:IsBattleNpcOwner(A1_7, true) == true or A0_6:IsBattleNpcTriggerOwner(A1_7, A2_8, false) == true then
    else
      A0_6:LogMessage(A0_6.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function LucKzc020.OnScene00003(A0_9, A1_10, A2_11)
    if A0_9:IsBattleNpcOwner(A1_10, true) == true or A0_9:IsBattleNpcTriggerOwner(A1_10, A2_11, false) == true then
    else
      A0_9:LogMessage(A0_9.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function LucKzc020.OnScene00004(A0_12, A1_13, A2_14)
    A2_14:TurnTo(A1_13, false)
    A2_14:WaitForTurn()
    A2_14:PlayActionTimeline(A0_12.ACTION_TIMELINE_EVENT_TALK_ANGRY)
    A2_14:Talk(A1_13, A0_12, A0_12.TEXT_LUCKZC020_03403_ANIALA_000_004, true)
  end
  function LucKzc020.OnScene00005(A0_15, A1_16, A2_17)
    local L3_18, L4_19
    L4_19 = A2_17
    L3_18 = A2_17.TurnTo
    ...
    L3_18(L4_19, A0_15.ACTION_TIMELINE_EVENT_JOY)
    L4_19 = A2_17
    L3_18 = A2_17.Talk
    L3_18(L4_19, A1_16, A0_15, A0_15.TEXT_LUCKZC020_03403_ANIALA_000_010, false)
    L4_19 = A2_17
    L3_18 = A2_17.Talk
    L3_18(L4_19, A1_16, A0_15, A0_15.TEXT_LUCKZC020_03403_ANIALA_000_011, false)
    L4_19 = A2_17
    L3_18 = A2_17.PlayActionTimeline
    L3_18(L4_19, A0_15.ACTION_TIMELINE_EVENT_TALK_ANGRY)
    L4_19 = A2_17
    L3_18 = A2_17.Talk
    L3_18(L4_19, A1_16, A0_15, A0_15.TEXT_LUCKZC020_03403_ANIALA_000_012, false)
    L4_19 = A2_17
    L3_18 = A2_17.PlayActionTimeline
    L3_18(L4_19, A0_15.ACTION_TIMELINE_EVENT_JOY_BIG)
    L4_19 = A2_17
    L3_18 = A2_17.Talk
    L3_18(L4_19, A1_16, A0_15, A0_15.TEXT_LUCKZC020_03403_ANIALA_000_013, true)
    L4_19 = A0_15
  ...
  function LucKzc020.IsTodoChecked(A0_20, A1_21, A2_22)
    local L3_23
  ...
  function L1_25(A0_44, A1_45, A2_46, A3_47, A4_48)
    ...
    if A1_45:GetQuestSequence(L5_49) == A0_44.SEQ_1 then
      if A2_46:GetBaseId() == A0_44.ENEMY0 then
        return A0_44.EVENT_STATE_BATTLE
      end
