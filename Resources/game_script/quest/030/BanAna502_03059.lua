(function()
  print("BanAna502 loaded")
  function BanAna502.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanAna502.OnScene00001(A0_3, A1_4, A2_5)
    A1_4:LookAt(A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_GREETING)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANANA502_03059_ESHANA_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANANA502_03059_ESHANA_100_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANANA502_03059_ESHANA_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANANA502_03059_ESHANA_000_002, true)
  ...
  function BanAna502.OnScene00002(A0_6, A1_7, A2_8)
    A0_6:Inventory(true)
  end
  function BanAna502.OnScene00003(A0_9, A1_10, A2_11)
  end
  function BanAna502.OnScene00004(A0_12, A1_13, A2_14)
  end
  function BanAna502.OnScene00005(A0_15, A1_16, A2_17)
    if A0_15:IsBattleNpcOwner(A1_16, true) == true or A0_15:IsBattleNpcTriggerOwner(A1_16, A2_17, false) == true then
    else
      A0_15:SystemTalk(A0_15.TEXT_BANANA502_03059_SYSTEM_000_010, true)
      A2_17:PlayQuestGimmickReaction()
      A0_15:Wait(10)
      A0_15:LogMessage(A0_15.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function BanAna502.OnScene00006(A0_18, A1_19, A2_20)
  end
  function BanAna502.OnScene00007(A0_21, A1_22, A2_23)
    if A0_21:IsBattleNpcOwner(A1_22, true) == true or A0_21:IsBattleNpcTriggerOwner(A1_22, A2_23, false) == true then
    else
      A0_21:LogMessage(A0_21.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function BanAna502.OnScene00008(A0_24, A1_25, A2_26)
    local L3_27, L4_28
    L4_28 = A1_25
    L3_27 = A1_25.LookAt
    L3_27(L4_28, A2_26)
    ...
    L4_28 = A2_26
    L3_27 = A2_26.Talk
    L3_27(L4_28, A1_25, A0_24, A0_24.TEXT_BANANA502_03059_ESHANA_000_020, false)
    L4_28 = A2_26
    L3_27 = A2_26.Talk
    L3_27(L4_28, A1_25, A0_24, A0_24.TEXT_BANANA502_03059_ESHANA_000_021, false)
    L4_28 = A2_26
    L3_27 = A2_26.Talk
    L3_27(L4_28, A1_25, A0_24, A0_24.TEXT_BANANA502_03059_ESHANA_000_022, true)
    L4_28 = A0_24
  ...
  function BanAna502.GetEventItems(A0_29, A1_30)
    local L2_31
  ...
  function BanAna502.IsTodoChecked(A0_32, A1_33, A2_34)
    local L3_35
  ...
  function L1_37(A0_61, A1_62, A2_63)
    ...
    if A1_62:GetQuestSequence(L3_64) == A0_61.SEQ_1 then
      if A2_63:GetBaseId() == A0_61.EOBJECT0 then
        if A1_62:GetQuestBitFlag8(L3_64, 2) == true then
          return true, false
        end
        if 1 <= A1_62:GetQuestUI8AL(L3_64) then
          return true, false
        end
        if A1_62:GetQuestBitFlag8(L3_64, 1) == true then
          return true, false
        end
      end
