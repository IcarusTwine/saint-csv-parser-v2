(function()
  print("SubFst022 loaded")
  function SubFst022.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:TurnTo(A1_1)
    if A0_0:QuestOffer(A2_2, A1_1) then
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBFST022_00097_EADBERT_000_1, false)
      A2_2:WaitForTurn()
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_THINK, A1_1)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBFST022_00097_EADBERT_000_2, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBFST022_00097_EADBERT_000_3, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBFST022_00097_EADBERT_000_4, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK1, A1_1)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBFST022_00097_EADBERT_000_5, true)
      A0_0:QuestAccepted()
      return 1
    else
      return 0
  ...
  function SubFst022.OnScene00002(A0_3, A1_4, A2_5)
    local L3_6, L4_7
    L4_7 = A2_5
    L3_6 = A2_5.TurnTo
    L3_6(L4_7, A1_4)
    ...
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_SUBFST022_00097_EADBERT_000_10, false)
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_SUBFST022_00097_EADBERT_000_11, false)
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_SUBFST022_00097_EADBERT_000_12, false)
    L4_7 = A2_5
    L3_6 = A2_5.PlayActionTimeline
    L3_6(L4_7, A0_3.ACTION_TIMELINE_EVENT_TALK1, A1_4)
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_SUBFST022_00097_EADBERT_000_13, true)
    L4_7 = A0_3
  ...
  function SubFst022.OnScene00001(A0_8, A1_9, A2_10)
  end
  function SubFst022.OnScene00100(A0_11, A1_12, A2_13)
    A0_11:Wait(10)
    A0_11:ScenarioMessage(A0_11.TEXT_SUBFST022_00097_SYSTEM_000_20)
  end
  function SubFst022.OnScene00099(A0_14, A1_15, A2_16)
  end
  function SubFst022.GetEventItems(A0_17, A1_18)
    local L2_19
  ...
  function SubFst022.IsTodoChecked(A0_20, A1_21, A2_22)
    local L3_23
    ...
    if A2_22 == 0 then
      return A1_21:GetQuestUI8AL(L3_23) + A1_21:GetQuestUI8BH(L3_23) * 16 >= 1
    elseif A2_22 == 1 then
      return false
    end
  end
...
;(function()
  ...
  function L1_25(A0_28, A1_29, A2_30, A3_31, A4_32)
    ...
    if A1_29:GetQuestSequence(L5_33) == A0_28.SEQ_1 then
      ...
      elseif A4_32 == A0_28.ENEMY0 then
        return 1 > A1_29:GetQuestUI8AL(L5_33) + A1_29:GetQuestUI8BH(L5_33) * 16
      end
    end
    return false
  end
  ...
  function L1_25(A0_40, A1_41, A2_42)
    ...
    if A2_42 == 0 then
      return A1_41:GetQuestUI8AL(L3_43) + A1_41:GetQuestUI8BH(L3_43) * 16, 0
    elseif A2_42 == 1 then
