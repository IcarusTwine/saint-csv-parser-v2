(function()
  print("GaiUsa204 loaded")
  function GaiUsa204.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsa204.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:LookAt(A1_4)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA204_00727_IANNA_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_NO)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA204_00727_IANNA_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA204_00727_IANNA_000_002, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA204_00727_IANNA_000_003, true)
    if A1_4:IsHowTo(A0_3.HOWTO_EITEM) == false then
      A0_3:HowTo(A0_3.HOWTO_EITEM)
    end
    A0_3:QuestAccepted()
  end
  function GaiUsa204.OnScene00002(A0_6, A1_7, A2_8)
    local L3_9, L4_10
    L4_10 = A2_8
    L3_9 = A2_8.LookAt
    L3_9(L4_10, A1_7)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_GAIUSA204_00727_IANNA_000_040, false)
    L4_10 = A2_8
    L3_9 = A2_8.PlayActionTimeline
    L3_9(L4_10, A0_6.ACTION_TIMELINE_EVENT_ADD_YES)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_GAIUSA204_00727_IANNA_000_041, true)
    L4_10 = A0_6
  ...
  function GaiUsa204.GetEventItems(A0_11, A1_12)
    local L2_13
    ...
    elseif A1_12:GetQuestSequence(L2_13) == A0_11.SEQ_1 then
      return A0_11.ITEM0, A1_12:GetQuestUI8BH(L2_13), true
    else
    end
  end
  function GaiUsa204.IsTodoChecked(A0_14, A1_15, A2_16)
    local L3_17
...
;(function()
  ...
  function L1_19(A0_34, A1_35, A2_36, A3_37)
    ...
    L4_38 = L4_38(A0_34)
    if A1_35:GetQuestSequence(L4_38) == A0_34.SEQ_1 and A2_36:GetBaseId() == A0_34.ENEMY0 and A3_37 == A0_34.ITEM0 then
      return true
    end
    return false
  end
