(function()
  print("JobRel402 loaded")
  function JobRel402.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function JobRel402.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    if A1_4:IsQuestCompleted(A0_3.QST_CHECK_JOBREL402) == false then
      A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBREL402_02381_ANGELET_000_001, true)
      A0_3:Wait(10)
      A2_5:CancelActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
      A1_4:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
      A1_4:WaitForActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
      A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBREL402_02381_ANGELET_000_002, false)
      A2_5:WaitForActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
      A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBREL402_02381_ANGELET_000_003, false)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBREL402_02381_ANGELET_000_004, true)
      A0_3:Wait(10)
      A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ITEM)
    else
      A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_THINK)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBREL402_02381_ANGELET_000_010, false)
      A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_ONEHAND)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBREL402_02381_ANGELET_000_011, false)
      A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ITEM)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBREL402_02381_ANGELET_000_012, true)
    end
    A0_3:SystemTalk(A0_3.TEXT_JOBREL402_02381_SYSTEM_000_000, true)
    A0_3:Wait(10)
    A2_5:WaitForActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ITEM)
    A0_3:QuestAccepted()
  end
  function JobRel402.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7, false)
    A2_8:WaitForTurn()
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK2)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_JOBREL402_02381_ANGELET_000_020, true)
    A0_6:Wait(10)
    A0_6:SystemTalk(A0_6.TEXT_JOBREL402_02381_SYSTEM_000_010, true)
    A0_6:Wait(10)
  end
  function JobRel402.OnScene00003(A0_9, A1_10, A2_11)
    ...
    if L6_15 == 1 then
      ...
      L9_18 = A0_9.ACTION_TIMELINE_EVENT_ADD_NO
      L7_16(L8_17, L9_18)
      L9_18 = A1_10
      L7_16(L8_17, L9_18, A0_9, A0_9.TEXT_JOBREL402_02381_ANGELET_000_041, true)
      L9_18 = 10
      L7_16(L8_17, L9_18)
    end
  end
  function JobRel402.OnScene00004(A0_19, A1_20, A2_21)
    local L3_22, L4_23
    L4_23 = A1_20
    ...
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_JOBREL402_02381_ANGELET_000_042, false)
    L4_23 = A1_20
    L3_22 = A1_20.IsQuestCompleted
    L3_22 = L3_22(L4_23, A0_19.QST_CHECK_JOBREL402)
    if L3_22 == false then
      L4_23 = A2_21
      L3_22 = A2_21.PlayActionTimeline
      ...
      L4_23 = A2_21
      L3_22 = A2_21.Talk
      L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_JOBREL402_02381_ANGELET_000_043, false)
      L4_23 = A2_21
      L3_22 = A2_21.Talk
      L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_JOBREL402_02381_ANGELET_000_044, false)
      L4_23 = A2_21
      L3_22 = A2_21.PlayActionTimeline
      L3_22(L4_23, A0_19.ACTION_TIMELINE_EVENT_TALK_BOTHHAND)
      L4_23 = A2_21
      L3_22 = A2_21.Talk
      L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_JOBREL402_02381_ANGELET_000_045, false)
    else
    end
    L4_23 = A2_21
    L3_22 = A2_21.PlayActionTimeline
    L3_22(L4_23, A0_19.ACTION_TIMELINE_EVENT_GIVE)
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_JOBREL402_02381_ANGELET_000_046, true)
    L4_23 = A0_19
    L3_22 = A0_19.Wait
    L3_22(L4_23, 10)
    L4_23 = A0_19
  ...
  function JobRel402.GetEventItems(A0_24, A1_25)
    local L2_26
    ...
    elseif A1_25:GetQuestSequence(L2_26) == A0_24.SEQ_FINISH then
      return A0_24.ITEM1, A1_25:GetQuestUI8BH(L2_26), false
    end
  end
  function JobRel402.IsTodoChecked(A0_27, A1_28, A2_29)
    local L3_30
...
;(function()
  ...
  L0_31 = JobRel402
  function L1_32(A0_70, A1_71, A2_72, A3_73, ...)
    local L5_75
