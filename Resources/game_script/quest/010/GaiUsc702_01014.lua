(function()
  print("GaiUsc702 loaded")
  function GaiUsc702.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
    if A0_0:QuestOffer(A2_2, A1_1) then
      ...
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_GAIUSC702_01014_NEDRICK_000_000, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_GAIUSC702_01014_NEDRICK_000_001, true)
      return 1
    else
      return 0
    end
  end
  function GaiUsc702.OnScene00001(A0_3, A1_4, A2_5)
    A0_3:QuestAccepted()
  end
  function GaiUsc702.OnScene00002(A0_6, A1_7, A2_8)
    local L3_9, L4_10
    L4_10 = A2_8
    L3_9 = A2_8.TurnTo
    L3_9(L4_10, A1_7)
    ...
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_GAIUSC702_01014_WILLIELMUS_000_020, false)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_GAIUSC702_01014_WILLIELMUS_000_021, false)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_GAIUSC702_01014_WILLIELMUS_000_022, false)
    L4_10 = A2_8
    L3_9 = A2_8.PlayActionTimeline
    L3_9(L4_10, A0_6.ACTION_TIMELINE_EVENT_ADD_NO, A1_7)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_GAIUSC702_01014_WILLIELMUS_000_023, true)
    L4_10 = A0_6
  ...
  function GaiUsc702.IsTodoChecked(A0_11, A1_12, A2_13)
    local L3_14
