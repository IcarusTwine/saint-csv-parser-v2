(function()
  print("GaiUsa304 loaded")
  function GaiUsa304.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsa304.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:LookAt(A1_4)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA304_00736_TANGATOTUNGA_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA304_00736_TANGATOTUNGA_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA304_00736_TANGATOTUNGA_000_002, true)
    A0_3:QuestAccepted()
  end
  function GaiUsa304.OnScene00002(A0_6, A1_7, A2_8)
  end
  function GaiUsa304.OnScene00003(A0_9, A1_10, A2_11)
  end
  function GaiUsa304.OnScene00004(A0_12, A1_13, A2_14)
  end
  function GaiUsa304.OnScene00005(A0_15, A1_16, A2_17)
  end
  function GaiUsa304.OnScene00006(A0_18, A1_19, A2_20)
  end
  function GaiUsa304.OnScene00007(A0_21, A1_22, A2_23)
  end
  function GaiUsa304.OnScene00008(A0_24, A1_25, A2_26)
  end
  function GaiUsa304.OnScene00009(A0_27, A1_28, A2_29)
  end
  function GaiUsa304.OnScene00010(A0_30, A1_31, A2_32)
  end
  function GaiUsa304.OnScene00011(A0_33, A1_34, A2_35)
  end
  function GaiUsa304.OnScene00012(A0_36, A1_37, A2_38)
  end
  function GaiUsa304.OnScene00013(A0_39, A1_40, A2_41)
  end
  function GaiUsa304.OnScene00014(A0_42, A1_43, A2_44)
  ...
  function GaiUsa304.OnScene00015(A0_52, A1_53, A2_54)
    local L3_55, L4_56
    L4_56 = A2_54
    ...
    L4_56 = A2_54
    L3_55 = A2_54.Talk
    L3_55(L4_56, A1_53, A0_52, A0_52.TEXT_GAIUSA304_00736_TANGATOTUNGA_000_035, false)
    L4_56 = A2_54
    L3_55 = A2_54.Talk
    L3_55(L4_56, A1_53, A0_52, A0_52.TEXT_GAIUSA304_00736_TANGATOTUNGA_000_036, false)
    L4_56 = A2_54
    L3_55 = A2_54.PlayActionTimeline
    L3_55(L4_56, A0_52.ACTION_TIMELINE_EVENT_CHAIR_TALK)
    L4_56 = A2_54
    L3_55 = A2_54.Talk
    L3_55(L4_56, A1_53, A0_52, A0_52.TEXT_GAIUSA304_00736_TANGATOTUNGA_000_037, false)
    L4_56 = A2_54
    L3_55 = A2_54.Talk
    L3_55(L4_56, A1_53, A0_52, A0_52.TEXT_GAIUSA304_00736_TANGATOTUNGA_000_038, true)
    L4_56 = A0_52
  ...
  function GaiUsa304.GetEventItems(A0_57, A1_58)
    local L2_59
    ...
    elseif A1_58:GetQuestSequence(L2_59) == A0_57.SEQ_1 then
      return A0_57.ITEM1, A1_58:GetQuestUI8BL(L2_59), false, A0_57.ITEM0, A1_58:GetQuestUI8CH(L2_59), false
  ...
  function GaiUsa304.IsTodoChecked(A0_60, A1_61, A2_62)
    local L3_63
    ...
    elseif A2_62 == 1 then
      return A1_61:GetQuestUI8BH(L3_63) >= 2
    elseif A2_62 == 2 then
      return false
    end
  end
  ...
  function L1_65(A0_68, A1_69, A2_70, A3_71, A4_72)
    ...
    if A1_69:GetQuestSequence(L5_73) == A0_68.SEQ_1 then
      ...
      elseif A3_71 == A0_68.EOBJECT2 then
        if 2 <= A1_69:GetQuestUI8BH(L5_73) then
          return false
        end
  ...
  function L1_65(A0_74, A1_75, A2_76, A3_77, A4_78)
    ...
    if A1_75:GetQuestSequence(L5_79) == A0_74.SEQ_1 then
      ...
      elseif A3_77 == A0_74.EOBJECT2 then
        if 2 <= A1_75:GetQuestUI8BH(L5_79) then
          return false
        end
