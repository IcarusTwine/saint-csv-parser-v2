(function()
  print("SubWil119 loaded")
  function SubWil119.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
    if A0_0:QuestOffer(A2_2, A1_1) then
      A2_2:TurnTo(A1_1)
      A2_2:WaitForTurn()
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK1)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL119_00629_EADUUARD_000_1, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL119_00629_EADUUARD_000_2, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL119_00629_EADUUARD_000_3, true)
      A0_0:QuestAccepted()
      return 1
    else
      return 0
  ...
  function SubWil119.OnScene00001(A0_3, A1_4, A2_5)
  end
  function SubWil119.OnScene00002(A0_6, A1_7, A2_8)
    if A0_6:IsBattleNpcOwner(A1_7, true) == true or A0_6:IsBattleNpcTriggerOwner(A1_7, A2_8, false) == true then
    else
      A0_6:ScenarioMessage(A0_6.TEXT_SUBWIL119_00629_POP_MESSAGE)
    end
  end
  function SubWil119.OnScene00003(A0_9, A1_10, A2_11)
    local L3_12
    L3_12 = A0_9.GetQuestId
    L3_12 = L3_12(A0_9)
    if 2 > A1_10:GetQuestUI8AL(L3_12) then
      A0_9:ScenarioMessage(A0_9.TEXT_SUBWIL119_00629_ACCESS_MESSAGE)
      return
    end
  end
  function SubWil119.OnScene00004(A0_13, A1_14, A2_15)
  end
  function SubWil119.OnScene00005(A0_16, A1_17, A2_18)
  end
  function SubWil119.OnScene00006(A0_19, A1_20, A2_21)
  end
  function SubWil119.OnScene00007(A0_22, A1_23, A2_24)
  ...
  function SubWil119.OnScene00008(A0_32, A1_33, A2_34)
    A2_34:Talk(A1_33, A0_32, A0_32.TEXT_SUBWIL119_00629_ESMOUR_000_11, false)
    A2_34:PlayActionTimeline(A0_32.ACTION_TIMELINE_EVENT_ADD_NO)
    A2_34:Talk(A1_33, A0_32, A0_32.TEXT_SUBWIL119_00629_ESMOUR_000_12, true)
  end
  function SubWil119.OnScene00009(A0_35, A1_36, A2_37)
    local L3_38, L4_39
    L4_39 = A2_37
    L3_38 = A2_37.TurnTo
    L3_38(L4_39, A1_36)
    ...
    L4_39 = A2_37
    L3_38 = A2_37.Talk
    L3_38(L4_39, A1_36, A0_35, A0_35.TEXT_SUBWIL119_00629_EADUUARD_000_20, false)
    L4_39 = A2_37
    L3_38 = A2_37.Talk
    L3_38(L4_39, A1_36, A0_35, A0_35.TEXT_SUBWIL119_00629_EADUUARD_000_21, false)
    L4_39 = A2_37
    L3_38 = A2_37.Talk
    L3_38(L4_39, A1_36, A0_35, A0_35.TEXT_SUBWIL119_00629_EADUUARD_000_22, true)
    L4_39 = A0_35
  ...
  function SubWil119.GetEventItems(A0_40, A1_41)
    local L2_42
  ...
  function SubWil119.IsTodoChecked(A0_43, A1_44, A2_45)
    local L3_46
    ...
    if A2_45 == 0 then
      return A1_44:GetQuestUI8AH(L3_46) >= 1
    elseif A2_45 == 1 then
  ...
  function L1_48(A0_67, A1_68, A2_69, A3_70, A4_71)
    ...
    if A1_68:GetQuestSequence(L5_72) == A0_67.SEQ_1 then
      if A4_71 == A0_67.EVENTRANGE0 then
        return A0_67.EVENT_STATE_LIGHT
      end
