(function()
  print("FesSum505 loaded")
  function FesSum505.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function FesSum505.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    if A1_4:IsQuestCompleted(A0_3.QST_FESSUM505) == true then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESSUM505_03667_JNANGHO_000_004, false)
    else
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESSUM505_03667_JNANGHO_000_000, false)
      A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESSUM505_03667_JNANGHO_000_001, false)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESSUM505_03667_JNANGHO_000_002, false)
      A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_BOTHHAND)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESSUM505_03667_JNANGHO_000_003, false)
    end
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESSUM505_03667_JNANGHO_000_005, true)
    A0_3:Wait(10)
    A0_3:QuestAccepted()
  end
  function FesSum505.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7, false)
    A2_8:WaitForTurn()
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK2)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_FESSUM505_03667_JNANGHO_000_006, true)
  end
  function FesSum505.OnScene00003(A0_9, A1_10, A2_11)
  ...
  function FesSum505.OnScene00004(A0_19, A1_20, A2_21)
    local L3_22, L4_23
    L4_23 = A2_21
    ...
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_FESSUM505_03667_JNANGHO_000_011, false)
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_FESSUM505_03667_JNANGHO_000_012, true)
    L4_23 = A0_19
    L3_22 = A0_19.Wait
    L3_22(L4_23, 10)
    L4_23 = A0_19
  ...
  function FesSum505.GetEventItems(A0_24, A1_25)
    local L2_26
  ...
  function FesSum505.IsTodoChecked(A0_27, A1_28, A2_29)
    local L3_30
