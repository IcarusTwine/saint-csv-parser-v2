(function()
  print("XxaFst031 loaded")
  function XxaFst031.OnScene00000(A0_0, A1_1, A2_2)
    if A1_1:IsQuestAccepted(A0_0.QST_ACCEPT_CHECK_01) == true or A1_1:IsQuestAccepted(A0_0.QST_ACCEPT_CHECK_02) == true then
      A0_0:SystemTalk(A0_0.TEXT_XXAFST031_03855_SYSTEM_100_000, true)
  ...
  function XxaFst031.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_XXAFST031_03855_PAULINE_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_XXAFST031_03855_PAULINE_000_001, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_XXAFST031_03855_PAULINE_000_002, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_XXAFST031_03855_PAULINE_000_003, true)
    A0_3:QuestAccepted()
  end
  function XxaFst031.OnScene00002(A0_6, A1_7, A2_8)
  end
  function XxaFst031.OnScene00003(A0_9, A1_10, A2_11)
  end
  function XxaFst031.OnScene00004(A0_12, A1_13, A2_14)
    A2_14:TurnTo(A1_13, false)
    A2_14:WaitForTurn()
    A2_14:PlayActionTimeline(A0_12.ACTION_TIMELINE_EVENT_TALK1)
    A2_14:Talk(A1_13, A0_12, A0_12.TEXT_XXAFST031_03855_PAULINE_000_010, false)
    A2_14:Talk(A1_13, A0_12, A0_12.TEXT_XXAFST031_03855_PAULINE_000_011, false)
    A2_14:Talk(A1_13, A0_12, A0_12.TEXT_XXAFST031_03855_PAULINE_000_012, true)
  end
  function XxaFst031.OnScene00005(A0_15, A1_16, A2_17)
  ...
  function XxaFst031.OnScene00006(A0_25, A1_26, A2_27)
    local L3_28, L4_29
    L4_29 = A1_26
    ...
    L4_29 = A2_27
    L3_28 = A2_27.Talk
    L3_28(L4_29, A1_26, A0_25, A0_25.TEXT_XXAFST031_03855_TSUBHKHAMAZOM_000_030, false)
    L4_29 = A2_27
    L3_28 = A2_27.Talk
    L3_28(L4_29, A1_26, A0_25, A0_25.TEXT_XXAFST031_03855_TSUBHKHAMAZOM_000_031, true)
    L4_29 = A0_25
  ...
  function XxaFst031.GetEventItems(A0_30, A1_31)
    local L2_32
    ...
    elseif A1_31:GetQuestSequence(L2_32) == A0_30.SEQ_1 then
      return A0_30.ITEM0, A1_31:GetQuestUI8BL(L2_32), false
  ...
  function XxaFst031.IsTodoChecked(A0_33, A1_34, A2_35)
    local L3_36
  ...
  function L1_38(A0_41, A1_42, A2_43, A3_44, A4_45)
    ...
    if A1_42:GetQuestSequence(L5_46) == A0_41.SEQ_1 then
      ...
      elseif A3_44 == A0_41.ENEMY0 then
        if 3 <= A1_42:GetQuestUI8BH(L5_46) then
          return false
        end
  ...
  function L1_38(A0_47, A1_48, A2_49, A3_50, A4_51)
    ...
    if A1_48:GetQuestSequence(L5_52) == A0_47.SEQ_1 then
      ...
      elseif A3_50 == A0_47.ENEMY0 then
        if 3 <= A1_48:GetQuestUI8BH(L5_52) then
          return false
        end
