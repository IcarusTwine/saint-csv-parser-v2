(function()
  print("GaiUsa806 loaded")
  function GaiUsa806.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsa806.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA806_00790_ORIANE_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA806_00790_ORIANE_000_001, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ITEM)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA806_00790_ORIANE_000_002, true)
    A0_3:QuestAccepted()
  end
  function GaiUsa806.OnScene00002(A0_6, A1_7, A2_8)
    A0_6:Inventory(true)
  end
  function GaiUsa806.OnScene00003(A0_9, A1_10, A2_11)
    A0_9:ScenarioMessage(A0_9.TEXT_GAIUSA806_00790_POP_MESSAGE_000)
  end
  function GaiUsa806.OnScene00004(A0_12, A1_13, A2_14)
    A0_12:Inventory(true)
  end
  function GaiUsa806.OnScene00005(A0_15, A1_16, A2_17)
    A0_15:ScenarioMessage(A0_15.TEXT_GAIUSA806_00790_POP_MESSAGE_000)
  end
  function GaiUsa806.OnScene00006(A0_18, A1_19, A2_20)
    A0_18:Inventory(true)
  end
  function GaiUsa806.OnScene00007(A0_21, A1_22, A2_23)
    A0_21:ScenarioMessage(A0_21.TEXT_GAIUSA806_00790_POP_MESSAGE_000)
  end
  function GaiUsa806.OnScene00008(A0_24, A1_25, A2_26)
    local L3_27, L4_28
    L4_28 = A2_26
    L3_27 = A2_26.TurnTo
    ...
    L4_28 = A2_26
    L3_27 = A2_26.Talk
    L3_27(L4_28, A1_25, A0_24, A0_24.TEXT_GAIUSA806_00790_ORIANE_000_020, false)
    L4_28 = A2_26
    L3_27 = A2_26.PlayActionTimeline
    L3_27(L4_28, A0_24.ACTION_TIMELINE_EVENT_ADD_YES)
    L4_28 = A2_26
    L3_27 = A2_26.Talk
    L3_27(L4_28, A1_25, A0_24, A0_24.TEXT_GAIUSA806_00790_ORIANE_000_021, false)
    L4_28 = A2_26
    L3_27 = A2_26.PlayActionTimeline
    L3_27(L4_28, A0_24.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    L4_28 = A2_26
    L3_27 = A2_26.Talk
    L3_27(L4_28, A1_25, A0_24, A0_24.TEXT_GAIUSA806_00790_ORIANE_000_022, true)
    L4_28 = A0_24
  ...
  function GaiUsa806.GetEventItems(A0_29, A1_30)
    local L2_31
  ...
  function GaiUsa806.IsTodoChecked(A0_32, A1_33, A2_34)
    local L3_35
...
;(function()
  ...
  function L1_37(A0_52, A1_53, A2_54, A3_55)
    ...
    if A1_53:GetQuestSequence(L4_56) == A0_52.SEQ_1 then
      if A2_54:GetBaseId() == A0_52.EOBJECT0 or A2_54:GetBaseId() == A0_52.ENEMY0 then
        if A3_55 == A0_52.ITEM0 then
          return true
        end
      elseif A2_54:GetBaseId() == A0_52.EOBJECT1 or A2_54:GetBaseId() == A0_52.ENEMY1 then
        if A3_55 == A0_52.ITEM0 then
          return true
        end
      elseif (A2_54:GetBaseId() == A0_52.EOBJECT2 or A2_54:GetBaseId() == A0_52.ENEMY2) and A3_55 == A0_52.ITEM0 then
        return true
      end
    end
    return false
