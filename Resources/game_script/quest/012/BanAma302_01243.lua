(function()
  print("BanAma302 loaded")
  function BanAma302.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanAma302.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANAMA302_01243_YADOVVGAH_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANAMA302_01243_YADOVVGAH_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANAMA302_01243_YADOVVGAH_000_002, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANAMA302_01243_YADOVVGAH_000_003, true)
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanAma302.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANAMA302_01243_YADOVVGAH_000_010, true)
  end
  function BanAma302.OnScene00003(A0_9, A1_10, A2_11)
    local L3_12, L4_13
    L4_13 = A2_11
    L3_12 = A2_11.TurnTo
    ...
    L4_13 = A2_11
    L3_12 = A2_11.Talk
    L3_12(L4_13, A1_10, A0_9, A0_9.TEXT_BANAMA302_01243_YADOVVGAH_000_020, false)
    L4_13 = A2_11
    L3_12 = A2_11.Talk
    L3_12(L4_13, A1_10, A0_9, A0_9.TEXT_BANAMA302_01243_YADOVVGAH_000_021, false)
    L4_13 = A2_11
    L3_12 = A2_11.Talk
    L3_12(L4_13, A1_10, A0_9, A0_9.TEXT_BANAMA302_01243_YADOVVGAH_000_022, true)
    L4_13 = A0_9
  ...
  function BanAma302.IsTodoChecked(A0_14, A1_15, A2_16)
    local L3_17
    ...
    if A2_16 == 0 then
      return A1_15:GetQuestUI8BH(L3_17) >= 3
    elseif A2_16 == 1 then
      return 3 <= A1_15:GetQuestUI8BL(L3_17)
    elseif A2_16 == 2 then
      return false
    end
  end
