(function()
  print("GaiUsd016 loaded")
  function GaiUsd016.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsd016.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSD016_01309_LARAINA_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSD016_01309_LARAINA_000_001, true)
    A0_3:QuestAccepted()
  end
  function GaiUsd016.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:LookAt(A1_7)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_GAIUSD016_01309_LARAINA_000_010, true)
  end
  function GaiUsd016.OnScene00003(A0_9, A1_10, A2_11)
  ...
  function GaiUsd016.OnScene00004(A0_19, A1_20, A2_21)
    local L3_22, L4_23
    L4_23 = A2_21
    L3_22 = A2_21.TurnTo
    ...
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_GAIUSD016_01309_LARAINA_000_011, true)
    L4_23 = A0_19
    L3_22 = A0_19.Wait
    L3_22(L4_23, 15)
    L4_23 = A2_21
    ...
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_GAIUSD016_01309_LARAINA_000_012, true)
    L4_23 = A0_19
  ...
  function GaiUsd016.GetEventItems(A0_24, A1_25)
    local L2_26
  ...
  function GaiUsd016.IsTodoChecked(A0_27, A1_28, A2_29)
    local L3_30
    ...
    elseif A2_29 == 1 then
      return 1 <= A1_28:GetQuestUI8AL(L3_30)
    elseif A2_29 == 2 then
      return 1 <= A1_28:GetQuestUI8BH(L3_30)
    elseif A2_29 == 3 then
      return false
    end
  end
  ...
  function L1_32(A0_35, A1_36, A2_37, A3_38, A4_39)
    ...
    if A1_36:GetQuestSequence(L5_40) == A0_35.SEQ_1 then
      if A3_38 == A0_35.BASE_ID_PLAYER then
        return true
      elseif A3_38 == A0_35.BASE_ID_PLAYER then
        return true
      elseif A3_38 == A0_35.BASE_ID_PLAYER then
        return true
