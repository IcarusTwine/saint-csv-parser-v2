(function()
  print("ClsRog021 loaded")
  function ClsRog021.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function ClsRog021.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_CLSROG021_00104_JACKE_000_000, true)
    A0_3:Wait(10)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1, A1_4)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_CLSROG021_00104_JACKE_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_CLSROG021_00104_JACKE_000_002, true)
    A0_3:QuestAccepted()
  end
  function ClsRog021.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:LookAt(A1_7)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK1, A1_7)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_CLSROG021_00104_JACKE_000_010, true)
    A0_6:Wait(10)
  end
  function ClsRog021.OnScene00003(A0_9, A1_10, A2_11)
    local L3_12, L4_13
    L4_13 = A2_11
    L3_12 = A2_11.LookAt
    L3_12(L4_13, A1_10)
    ...
    L4_13 = A2_11
    L3_12 = A2_11.Talk
    L3_12(L4_13, A1_10, A0_9, A0_9.TEXT_CLSROG021_00104_JACKE_000_020, false)
    L4_13 = A2_11
    L3_12 = A2_11.Talk
    L3_12(L4_13, A1_10, A0_9, A0_9.TEXT_CLSROG021_00104_JACKE_000_021, true)
    L4_13 = A0_9
    L3_12 = A0_9.Wait
    L3_12(L4_13, 10)
    L4_13 = A2_11
    L3_12 = A2_11.PlayActionTimeline
    L3_12(L4_13, A0_9.ACTION_TIMELINE_EVENT_TALK_FOREFINGER, A1_10)
    L4_13 = A2_11
    L3_12 = A2_11.Talk
    L3_12(L4_13, A1_10, A0_9, A0_9.TEXT_CLSROG021_00104_JACKE_000_022, false)
    L4_13 = A2_11
    L3_12 = A2_11.Talk
    L3_12(L4_13, A1_10, A0_9, A0_9.TEXT_CLSROG021_00104_JACKE_000_023, true)
    L4_13 = A0_9
    L3_12 = A0_9.Wait
    L3_12(L4_13, 10)
    L4_13 = A2_11
    L3_12 = A2_11.PlayActionTimeline
    L3_12(L4_13, A0_9.ACTION_TIMELINE_EVENT_GREETING, A1_10)
    L4_13 = A2_11
    L3_12 = A2_11.Talk
    L3_12(L4_13, A1_10, A0_9, A0_9.TEXT_CLSROG021_00104_JACKE_000_024, true)
    L4_13 = A0_9
    L3_12 = A0_9.Wait
    L3_12(L4_13, 10)
    L4_13 = A0_9
    ...
    if L3_12 then
      A0_9:QuestCompleted()
      A0_9:SystemTalk(A0_9.TEXT_CLSROG021_00104_SYSTEM_000_030, true)
    end
    return L3_12, L4_13
  end
  function ClsRog021.IsTodoChecked(A0_14, A1_15, A2_16)
    local L3_17
    ...
    if A2_16 == 0 then
      return A1_15:GetQuestUI8BL(L3_17) >= 3
    elseif A2_16 == 1 then
      return 3 <= A1_15:GetQuestUI8AL(L3_17)
    elseif A2_16 == 2 then
      return 3 <= A1_15:GetQuestUI8BH(L3_17)
    elseif A2_16 == 3 then
      return false
    end
  end
...
;(function()
  ...
  function L1_19(A0_34, A1_35, A2_36)
    ...
    if A2_36 == 0 then
      return A1_35:GetQuestUI8BL(L3_37), 3
    elseif A2_36 == 1 then
      return A1_35:GetQuestUI8AL(L3_37), 3
    elseif A2_36 == 2 then
      return A1_35:GetQuestUI8BH(L3_37), 3
    elseif A2_36 == 3 then
