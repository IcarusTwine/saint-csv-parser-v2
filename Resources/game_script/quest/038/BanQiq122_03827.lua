(function()
  print("BanQiq122 loaded")
  function BanQiq122.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanQiq122.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_DEMIHUMAN)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ122_03827_QHOTERLPASOL_000_000, false, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ122_03827_QHOTERLPASOL_000_001, false, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A2_5:CancelActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_DEMIHUMAN)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ122_03827_QHOTERLPASOL_000_002, false, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    if A1_4:GetClassJob() == A0_3.CLASS_JOB_MINER then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ122_03827_QHOTERLPASOL_000_003, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    elseif A1_4:GetClassJob() == A0_3.CLASS_JOB_HARVESTER then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ122_03827_QHOTERLPASOL_000_004, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    elseif A1_4:GetClassJob() == A0_3.CLASS_JOB_FISHERMAN then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ122_03827_QHOTERLPASOL_000_005, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    else
      A0_3:CancelEventScene()
    end
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanQiq122.OnScene00002(A0_6, A1_7, A2_8)
    ...
    if L6_12 == L10_16 then
      ...
      if L7_13 > L10_16 then
        L13_19 = A0_6
        L10_16(L11_17, L12_18, L13_19, A0_6.TEXT_BANQIQ122_03827_QHOTERLPASOL_000_006, true, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
      else
        L13_19 = A0_6
        L10_16(L11_17, L12_18, L13_19, A0_6.TEXT_BANQIQ122_03827_QHOTERLPASOL_000_010, true, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
      end
    elseif L6_12 == L10_16 then
      L13_19 = A0_6.NUM_OF_ITEMS_FILTER_HQ
      if L8_14 > L10_16 then
        L13_19 = A0_6
        L10_16(L11_17, L12_18, L13_19, A0_6.TEXT_BANQIQ122_03827_QHOTERLPASOL_000_007, true, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
      else
        L13_19 = A0_6
        L10_16(L11_17, L12_18, L13_19, A0_6.TEXT_BANQIQ122_03827_QHOTERLPASOL_000_010, true, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
      end
    elseif L6_12 == L10_16 then
      ...
      if L9_15 > L10_16 then
        L13_19 = A0_6
        L10_16(L11_17, L12_18, L13_19, A0_6.TEXT_BANQIQ122_03827_QHOTERLPASOL_000_008, true, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
      else
        L13_19 = A0_6
        L10_16(L11_17, L12_18, L13_19, A0_6.TEXT_BANQIQ122_03827_QHOTERLPASOL_000_010, true, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
      end
  ...
  function BanQiq122.OnScene00003(A0_20, A1_21, A2_22)
    ...
    L5_25 = A2_22
    L4_24 = A2_22.Talk
    L4_24(L5_25, A1_21, A0_20, A0_20.TEXT_BANQIQ122_03827_QHOTERLPASOL_000_011, true, nil, nil, nil, A0_20.SPEAK_NORMAL_MIDDLE)
    ...
    if L3_23 == L4_24 then
      ...
      if L4_24 > 0 then
        ...
        L4_24(L5_25, A0_20.TEXT_BANQIQ122_03827_SYSTEM_000_020, true)
      end
    else
  ...
  function BanQiq122.OnScene00004(A0_26, A1_27, A2_28)
  end
  function BanQiq122.OnScene00005(A0_29, A1_30, A2_31)
  end
  function BanQiq122.OnScene00006(A0_32, A1_33, A2_34)
  end
  function BanQiq122.IsTodoChecked(A0_35, A1_36, A2_37)
    local L3_38
