(function()
  print("GaiUsb101 loaded")
  function GaiUsb101.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsb101.OnScene00001(A0_3, A1_4, A2_5)
    A1_4:Position(A2_5, A0_3.ARRANGE_TYPE_BACK, 3)
    ...
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB101_00820_UODHNUN_000_000, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    ...
    A2_5:WaitForActionTimeline(A0_3.ACTION_TIMELINE_EVENT_REACTION_MIQO_M)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB101_00820_UODHNUN_000_001, true, nil, nil, nil, A0_3.SPEAK_NORMAL_LONG)
    A2_5:CancelActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A0_3:Wait(10)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EMOTE_ME)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB101_00820_UODHNUN_000_002, true, nil, nil, nil, A0_3.SPEAK_NORMAL_LONG)
    A2_5:WaitForActionTimeline(A0_3.ACTION_TIMELINE_EMOTE_ME)
    A0_3:Wait(10)
    A0_3:PlayCamera(5, A2_5)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB101_00820_UODHNUN_000_003, false, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB101_00820_UODHNUN_000_004, true, nil, nil, nil, A0_3.SPEAK_NORMAL_LONG)
    A2_5:WaitForActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A0_3:Wait(10)
    A0_3:PlayTwoShotCamera(A0_3.TWOSHOT_TYPE_RIGHT_ZOOM, A2_5, A1_4, 0)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB101_00820_UODHNUN_000_005, false, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB101_00820_UODHNUN_000_006, true, nil, nil, nil, A0_3.SPEAK_NORMAL_LONG)
    A2_5:CancelActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A0_3:Wait(10)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EMOTE_POINT, nil, A0_3.AUTO_SHAKE_ENABLE)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB101_00820_UODHNUN_000_007, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
  ...
  function GaiUsb101.OnScene00002(A0_6, A1_7, A2_8)
  ...
  function GaiUsb101.OnScene00003(A0_16, A1_17, A2_18)
    local L3_19, L4_20
    L4_20 = A2_18
    ...
    L4_20 = A2_18
    L3_19 = A2_18.Talk
    L3_19(L4_20, A1_17, A0_16, A0_16.TEXT_GAIUSB101_00820_UODHNUN_000_035, false)
    L4_20 = A2_18
    L3_19 = A2_18.PlayActionTimeline
    L3_19(L4_20, A0_16.ACTION_TIMELINE_EVENT_ADD_NO)
    L4_20 = A2_18
    L3_19 = A2_18.Talk
    L3_19(L4_20, A1_17, A0_16, A0_16.TEXT_GAIUSB101_00820_UODHNUN_000_036, true)
    L4_20 = A0_16
  ...
  function GaiUsb101.GetEventItems(A0_21, A1_22)
    local L2_23
  ...
  function GaiUsb101.IsTodoChecked(A0_24, A1_25, A2_26)
    local L3_27
    ...
    if A2_26 == 0 then
      return A1_25:GetQuestUI8BH(L3_27) >= 7
    elseif A2_26 == 1 then
      return false
    end
  end
...
;(function()
  ...
  function L1_29(A0_32, A1_33, A2_34)
    ...
    if A2_34 == 0 then
      return A1_33:GetQuestUI8BH(L3_35), 7
    elseif A2_34 == 1 then
