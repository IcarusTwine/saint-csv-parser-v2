(function()
  print("FesXms008 loaded")
  function FesXms008.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function FesXms008.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESXMS008_00340_AMHGARANJY_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESXMS008_00340_AMHGARANJY_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESXMS008_00340_AMHGARANJY_000_002, true)
    A2_5:CancelActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A0_3:QuestAccepted()
    A0_3:Wait(100)
    if A1_4:IsQuestCompleted(A0_3.QUEST0) ~= true then
      A0_3:SystemTalk(A0_3.TEXT_FESXMS008_00340_SYSTEM_100_002, false)
    end
    A2_5:CloseTalk()
  end
  function FesXms008.OnScene00002(A0_6, A1_7, A2_8)
    local L3_9, L4_10
    L4_10 = A2_8
    L3_9 = A2_8.TurnTo
    ...
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_FESXMS008_00340_VOLUNTEER65876_000_010, false)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_FESXMS008_00340_VOLUNTEER65876_000_011, false)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_FESXMS008_00340_VOLUNTEER65876_000_012, false)
    L4_10 = A2_8
    ...
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_FESXMS008_00340_VOLUNTEER65876_000_013, true)
    L4_10 = A2_8
    L3_9 = A2_8.CancelActionTimeline
    L3_9(L4_10, A0_6.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    L4_10 = A0_6
    ...
    if L3_9 then
      A0_6:QuestCompleted()
      A0_6:Wait(100)
      A0_6:SystemTalk(A0_6.TEXT_FESXMS008_00340_SYSTEM_000_014, false)
      A0_6:SystemTalk(A0_6.TEXT_FESXMS008_00340_SYSTEM_000_015, true)
    end
    return L3_9, L4_10
  end
  function FesXms008.OnScene00003(A0_11, A1_12, A2_13)
    A2_13:TurnTo(A1_12, false)
    A2_13:WaitForTurn()
    A2_13:PlayActionTimeline(A0_11.ACTION_TIMELINE_EVENT_TALK2)
    A2_13:Talk(A1_12, A0_11, A0_11.TEXT_FESXMS008_00340_AMHGARANJY_000_003, true)
    A2_13:CancelActionTimeline(A0_11.ACTION_TIMELINE_EVENT_TALK2)
  end
  function FesXms008.IsTodoChecked(A0_14, A1_15, A2_16)
    local L3_17
