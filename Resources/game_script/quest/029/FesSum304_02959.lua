(function()
  print("FesSum304 loaded")
  function FesSum304.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function FesSum304.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    if A1_4:IsQuestCompleted(A0_3.QUEST0) == true then
      A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESSUM304_02959_BEAUDEFOIN_000_030, true)
    else
      if A1_4:IsQuestCompleted(A0_3.QUEST1) == true then
        A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
        A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESSUM304_02959_BEAUDEFOIN_000_000, false)
        A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESSUM304_02959_BEAUDEFOIN_000_001, true)
        A2_5:CancelActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
      else
        A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
        A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESSUM304_02959_BEAUDEFOIN_000_010, true)
        A2_5:CancelActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
      end
      A1_4:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
      A0_3:Wait(50)
      A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESSUM304_02959_BEAUDEFOIN_000_020, false)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESSUM304_02959_BEAUDEFOIN_000_021, false)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESSUM304_02959_BEAUDEFOIN_000_022, true)
    end
    A0_3:QuestAccepted()
  end
  function FesSum304.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7, false)
    A2_8:WaitForTurn()
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK2)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_FESSUM304_02959_BEAUDEFOIN_000_031, true)
  end
  function FesSum304.OnScene00003(A0_9, A1_10, A2_11)
  ...
  function FesSum304.OnScene00004(A0_19, A1_20, A2_21)
    local L3_22, L4_23
    L4_23 = A2_21
    L3_22 = A2_21.TurnTo
    ...
    L3_22 = L3_22(L4_23, A0_19.QUEST0)
    if L3_22 == true then
      L4_23 = A2_21
      ...
      L4_23 = A2_21
      L3_22 = A2_21.Talk
      L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_FESSUM304_02959_BEAUDEFOIN_000_060, true)
    else
      L4_23 = A2_21
      L3_22 = A2_21.PlayActionTimeline
      L3_22(L4_23, A0_19.ACTION_TIMELINE_EVENT_TALK_ANGRY)
      L4_23 = A2_21
      L3_22 = A2_21.Talk
      L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_FESSUM304_02959_BEAUDEFOIN_000_050, false)
      L4_23 = A2_21
      L3_22 = A2_21.Talk
      L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_FESSUM304_02959_BEAUDEFOIN_000_051, true)
    end
    L4_23 = A0_19
  ...
  function FesSum304.GetEventItems(A0_24, A1_25)
    local L2_26
  ...
  function FesSum304.IsTodoChecked(A0_27, A1_28, A2_29)
    local L3_30
