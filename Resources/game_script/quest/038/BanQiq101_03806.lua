(function()
  print("BanQiq101 loaded")
  function BanQiq101.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanQiq101.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_DEMIHUMAN)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ101_03806_QHOTERLPASOL_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ101_03806_QHOTERLPASOL_000_001, false)
    ...
    if A1_4:GetClassJob() == A0_3.CLASS_JOB_MINER then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ101_03806_QHOTERLPASOL_000_010, true)
    elseif A1_4:GetClassJob() == A0_3.CLASS_JOB_HARVESTER then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ101_03806_QHOTERLPASOL_000_020, true)
    elseif A1_4:GetClassJob() == A0_3.CLASS_JOB_FISHERMAN then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ101_03806_QHOTERLPASOL_000_030, true)
    else
      A0_3:CancelEventScene()
    end
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanQiq101.OnScene00002(A0_6, A1_7, A2_8)
  ...
  function BanQiq101.OnScene00003(A0_20, A1_21, A2_22)
    ...
    if L3_23 == L4_24 then
      L5_25 = A2_22
      L4_24 = A2_22.Talk
      L4_24(L5_25, A1_21, A0_20, A0_20.TEXT_BANQIQ101_03806_QHOTERLPASOL_000_060, false)
    else
      L4_24 = A0_20.CLASS_JOB_HARVESTER
      if L3_23 == L4_24 then
        L5_25 = A2_22
        L4_24 = A2_22.Talk
        L4_24(L5_25, A1_21, A0_20, A0_20.TEXT_BANQIQ101_03806_QHOTERLPASOL_000_070, false)
      else
        L5_25 = A2_22
        L4_24 = A2_22.Talk
        L4_24(L5_25, A1_21, A0_20, A0_20.TEXT_BANQIQ101_03806_QHOTERLPASOL_000_080, false)
      end
    end
    L5_25 = A2_22
    L4_24 = A2_22.Talk
    L4_24(L5_25, A1_21, A0_20, A0_20.TEXT_BANQIQ101_03806_QHOTERLPASOL_000_090, true)
    L5_25 = A0_20
  ...
  function BanQiq101.OnScene00004(A0_26, A1_27, A2_28)
  end
  function BanQiq101.OnScene00005(A0_29, A1_30, A2_31)
  end
  function BanQiq101.OnScene00006(A0_32, A1_33, A2_34)
  end
  function BanQiq101.IsTodoChecked(A0_35, A1_36, A2_37)
    local L3_38
