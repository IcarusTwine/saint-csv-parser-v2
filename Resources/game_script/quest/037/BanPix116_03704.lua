(function()
  print("BanPix116 loaded")
  function BanPix116.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanPix116.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANPIX116_03704_UINNEE_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANPIX116_03704_UINNEE_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANPIX116_03704_UINNEE_000_002, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ACT_TALK)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANPIX116_03704_UINNEE_000_003, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANPIX116_03704_UINNEE_000_004, true)
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanPix116.OnScene00002(A0_6, A1_7, A2_8)
  end
  function BanPix116.OnScene00003(A0_9, A1_10, A2_11)
    A0_9:LogMessage(A0_9.LOG_MSG_EVENT_POP_MESSAGE)
  end
  function BanPix116.OnScene00004(A0_12, A1_13, A2_14)
  end
  function BanPix116.OnScene00005(A0_15, A1_16, A2_17)
    if A0_15:IsBattleNpcOwner(A1_16, true) == true or A0_15:IsBattleNpcTriggerOwner(A1_16, A2_17, false) == true then
    else
      A0_15:LogMessage(A0_15.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function BanPix116.OnScene00006(A0_18, A1_19, A2_20)
  end
  function BanPix116.OnScene00007(A0_21, A1_22, A2_23)
    A0_21:LogMessage(A0_21.LOG_MSG_EVENT_POP_MESSAGE)
  end
  function BanPix116.OnScene00008(A0_24, A1_25, A2_26)
  end
  function BanPix116.OnScene00009(A0_27, A1_28, A2_29)
    if A0_27:IsBattleNpcOwner(A1_28, true) == true or A0_27:IsBattleNpcTriggerOwner(A1_28, A2_29, false) == true then
    else
      A0_27:LogMessage(A0_27.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function BanPix116.OnScene00010(A0_30, A1_31, A2_32)
  end
  function BanPix116.OnScene00011(A0_33, A1_34, A2_35)
    A0_33:LogMessage(A0_33.LOG_MSG_EVENT_POP_MESSAGE)
  end
  function BanPix116.OnScene00012(A0_36, A1_37, A2_38)
  end
  function BanPix116.OnScene00013(A0_39, A1_40, A2_41)
    if A0_39:IsBattleNpcOwner(A1_40, true) == true or A0_39:IsBattleNpcTriggerOwner(A1_40, A2_41, false) == true then
    else
      A0_39:LogMessage(A0_39.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function BanPix116.OnScene00014(A0_42, A1_43, A2_44)
  ...
  function BanPix116.OnScene00015(A0_52, A1_53, A2_54)
    local L3_55, L4_56
    L4_56 = A1_53
    ...
    L4_56 = A2_54
    L3_55 = A2_54.Talk
    L3_55(L4_56, A1_53, A0_52, A0_52.TEXT_BANPIX116_03704_UINNEE_000_021, false)
    L4_56 = A2_54
    L3_55 = A2_54.Talk
    L3_55(L4_56, A1_53, A0_52, A0_52.TEXT_BANPIX116_03704_UINNEE_000_022, true)
    L4_56 = A0_52
  ...
  function BanPix116.GetEventItems(A0_57, A1_58)
    local L2_59
  ...
  function BanPix116.IsTodoChecked(A0_60, A1_61, A2_62)
    local L3_63
