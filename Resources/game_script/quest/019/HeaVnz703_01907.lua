(function()
  print("HeaVnz703 loaded")
  function HeaVnz703.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function HeaVnz703.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ703_01907_CONUVANU_000_000, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.EVENT_ACTION_SIJI)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ703_01907_CONUVANU_000_001, true)
    A0_3:Wait(10)
    A0_3:QuestAccepted()
  end
  function HeaVnz703.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:LookAt(A1_7)
    A2_8:TurnTo(A1_7, false)
    A2_8:WaitForTurn()
    A2_8:PlayActionTimeline(A0_6.EVENT_ACTION_SIJI)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_HEAVNZ703_01907_CONUVANU_000_010, true)
  end
  function HeaVnz703.OnScene00003(A0_9, A1_10, A2_11)
  ...
  function HeaVnz703.OnScene00004(A0_19, A1_20, A2_21)
    local L3_22, L4_23
    L4_23 = A2_21
    ...
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_HEAVNZ703_01907_CONUVANU_000_021, false)
    L4_23 = A2_21
    ...
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_HEAVNZ703_01907_CONUVANU_000_022, true)
    L4_23 = A0_19
    L3_22 = A0_19.Wait
    L3_22(L4_23, 10)
    L4_23 = A0_19
  ...
  function HeaVnz703.GetEventItems(A0_24, A1_25)
    local L2_26
  ...
  function HeaVnz703.IsTodoChecked(A0_27, A1_28, A2_29)
    local L3_30
...
;(function()
  ...
  function L1_32(A0_35, A1_36, A2_37, A3_38, A4_39)
    ...
    if A1_36:GetQuestSequence(L5_40) == A0_35.SEQ_1 then
      if A3_38 == A0_35.ENEMY0 then
        return 5 > A1_36:GetQuestUI8BH(L5_40)
  ...
  function L1_32(A0_41, A1_42, A2_43, A3_44, A4_45)
    ...
    if A1_42:GetQuestSequence(L5_46) == A0_41.SEQ_1 then
      if A3_44 == A0_41.ENEMY0 then
        return 5 > A1_42:GetQuestUI8BH(L5_46)
  ...
  function L1_32(A0_47, A1_48, A2_49)
    ...
    if A2_49 == 0 then
      return A1_48:GetQuestUI8BH(L3_50), 5
    elseif A2_49 == 1 then
