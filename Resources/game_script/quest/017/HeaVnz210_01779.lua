(function()
  print("HeaVnz210 loaded")
  function HeaVnz210.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function HeaVnz210.OnScene00001(A0_3, A1_4, A2_5)
    ...
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ210_01779_MARCECHAMP_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_CHAIR_TALK)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ210_01779_MARCECHAMP_000_001, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ210_01779_MARCECHAMP_000_002, true)
    A0_3:Wait(10)
    A0_3:QuestAccepted()
  end
  function HeaVnz210.OnScene00002(A0_6, A1_7, A2_8)
  ...
  function HeaVnz210.OnScene00003(A0_9, A1_10, A2_11)
    A0_9:LogMessage(A0_9.LOG_MSG_EVENT_POP_MESSAGE)
  end
  function HeaVnz210.OnScene00004(A0_12, A1_13, A2_14)
  end
  function HeaVnz210.OnScene00005(A0_15, A1_16, A2_17)
    A0_15:LogMessage(A0_15.LOG_MSG_EVENT_POP_MESSAGE)
  end
  function HeaVnz210.OnScene00006(A0_18, A1_19, A2_20)
  ...
  function HeaVnz210.OnScene00007(A0_21, A1_22, A2_23)
    A0_21:LogMessage(A0_21.LOG_MSG_EVENT_POP_MESSAGE)
  end
  function HeaVnz210.OnScene00008(A0_24, A1_25, A2_26)
  end
  function HeaVnz210.OnScene00009(A0_27, A1_28, A2_29)
    A0_27:LogMessage(A0_27.LOG_MSG_EVENT_POP_MESSAGE)
  end
  function HeaVnz210.OnScene00010(A0_30, A1_31, A2_32)
  ...
  function HeaVnz210.OnScene00011(A0_33, A1_34, A2_35)
    A0_33:LogMessage(A0_33.LOG_MSG_EVENT_POP_MESSAGE)
  end
  function HeaVnz210.OnScene00012(A0_36, A1_37, A2_38)
  end
  function HeaVnz210.OnScene00013(A0_39, A1_40, A2_41)
    A0_39:LogMessage(A0_39.LOG_MSG_EVENT_POP_MESSAGE)
  end
  function HeaVnz210.OnScene00014(A0_42, A1_43, A2_44)
    A2_44:LookAt(A1_43)
    A2_44:Talk(A1_43, A0_42, A0_42.TEXT_HEAVNZ210_01779_MARCECHAMP_000_010, true)
  end
  function HeaVnz210.OnScene00015(A0_45, A1_46, A2_47)
    local L3_48, L4_49
    L4_49 = A2_47
    L3_48 = A2_47.LookAt
    L3_48(L4_49, A1_46)
    ...
    L4_49 = A2_47
    L3_48 = A2_47.Talk
    L3_48(L4_49, A1_46, A0_45, A0_45.TEXT_HEAVNZ210_01779_MARCECHAMP_000_020, false)
    L4_49 = A2_47
    L3_48 = A2_47.PlayActionTimeline
    L3_48(L4_49, A0_45.ACTION_TIMELINE_EVENT_CHAIR_TALK)
    L4_49 = A2_47
    L3_48 = A2_47.Talk
    L3_48(L4_49, A1_46, A0_45, A0_45.TEXT_HEAVNZ210_01779_MARCECHAMP_000_021, false)
    L4_49 = A2_47
    L3_48 = A2_47.PlayActionTimeline
    L3_48(L4_49, A0_45.ACTION_TIMELINE_EVENT_ADD_NO)
    L4_49 = A2_47
    L3_48 = A2_47.Talk
    L3_48(L4_49, A1_46, A0_45, A0_45.TEXT_HEAVNZ210_01779_MARCECHAMP_000_022, true)
    L4_49 = A0_45
    L3_48 = A0_45.Wait
    L3_48(L4_49, 10)
    L4_49 = A0_45
  ...
  function HeaVnz210.GetEventItems(A0_50, A1_51)
    local L2_52
  ...
  function HeaVnz210.IsTodoChecked(A0_53, A1_54, A2_55)
    local L3_56
...
;(function()
  ...
  function L1_58(A0_73, A1_74, A2_75, A3_76)
    ...
    if A1_74:GetQuestSequence(L4_77) == A0_73.SEQ_1 then
      ...
      elseif A2_75:GetLayoutId() == A0_73.ENEMY0 then
        if A3_76 == A0_73.ITEM0 then
          return true
        end
      ...
      elseif A2_75:GetLayoutId() == A0_73.ENEMY1 then
        if A3_76 == A0_73.ITEM0 then
          return true
        end
