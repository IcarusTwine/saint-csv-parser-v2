(function()
  print("BanQiq128 loaded")
  function BanQiq128.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanQiq128.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_DEMIHUMAN)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ128_03833_QHOTERLPASOL_000_000, false, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ128_03833_QHOTERLPASOL_000_001, false, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    ...
    if A1_4:GetClassJob() == A0_3.CLASS_JOB_MINER then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ128_03833_QHOTERLPASOL_000_002, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    elseif A1_4:GetClassJob() == A0_3.CLASS_JOB_HARVESTER then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ128_03833_QHOTERLPASOL_000_003, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    elseif A1_4:GetClassJob() == A0_3.CLASS_JOB_FISHERMAN then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ128_03833_QHOTERLPASOL_000_004, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
      if A1_4:IsQuestCompleted(A0_3.QUEST_StmBdy104) == false then
        A0_3:Wait(10)
        A0_3:SystemTalk(A0_3.TEXT_BANQIQ128_03833_SYSTEM_000_008, true)
      end
    else
  ...
  function BanQiq128.OnScene00002(A0_6, A1_7, A2_8)
      ...
      if L6_12 == L10_16 then
        ...
        if L6_12 == L10_16 then
          ...
          if L9_15 > L10_16 then
            ...
            L10_16(L11_17, L12_18, L13_19, L14_20, L15_21, L16_22, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
            L11_17 = A1_7
            L10_16 = A1_7.IsQuestCompleted
            L12_18 = A0_6.QUEST_StmBdy104
            ...
            if L10_16 == false then
              ...
              L10_16(L11_17, L12_18)
              L11_17 = A0_6
              L10_16 = A0_6.SystemTalk
              L12_18 = A0_6.TEXT_BANQIQ128_03833_SYSTEM_000_008
              L10_16(L11_17, L12_18, L13_19)
            end
          else
            L11_17 = A2_8
  ...
  function BanQiq128.OnScene00003(A0_23, A1_24, A2_25)
    ...
    L5_28 = A2_25
    L4_27 = A2_25.Talk
    L4_27(L5_28, A1_24, A0_23, A0_23.TEXT_BANQIQ128_03833_QHOTERLPASOL_000_011, false, nil, nil, nil, A0_23.SPEAK_NORMAL_MIDDLE)
    L5_28 = A2_25
    L4_27 = A2_25.Talk
    L4_27(L5_28, A1_24, A0_23, A0_23.TEXT_BANQIQ128_03833_QHOTERLPASOL_000_012, true, nil, nil, nil, A0_23.SPEAK_NORMAL_MIDDLE)
    L5_28 = A0_23
    L4_27 = A0_23.Wait
    L4_27(L5_28, 10)
    ...
    if L3_26 == L4_27 then
      ...
      if L4_27 > 0 then
        ...
        L4_27(L5_28, A0_23.TEXT_BANQIQ128_03833_SYSTEM_000_020, true)
      end
    else
  ...
  function BanQiq128.OnScene00004(A0_29, A1_30, A2_31)
  end
  function BanQiq128.OnScene00005(A0_32, A1_33, A2_34)
  end
  function BanQiq128.OnScene00006(A0_35, A1_36, A2_37)
  end
  function BanQiq128.IsTodoChecked(A0_38, A1_39, A2_40)
    local L3_41
