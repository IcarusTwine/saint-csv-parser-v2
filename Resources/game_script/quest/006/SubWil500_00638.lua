(function()
  print("SubWil500 loaded")
  function SubWil500.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
    if A0_0:QuestOffer(A2_2, A1_1) then
      A2_2:TurnTo(A1_1)
      A2_2:WaitForTurn()
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK1, A1_1)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL500_00638_SWYNBROES_000, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL500_00638_SWYNBROES_001, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK2, A1_1)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL500_00638_SWYNBROES_002, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL500_00638_SWYNBROES_003, true)
      A0_0:QuestAccepted()
      return 1
    else
      return 0
  ...
  function SubWil500.OnScene00001(A0_3, A1_4, A2_5)
    local L3_6, L4_7
    L4_7 = A2_5
    L3_6 = A2_5.TurnTo
    L3_6(L4_7, A1_4)
    ...
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_SUBWIL500_00638_SWYNBROES_010, false)
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_SUBWIL500_00638_SWYNBROES_011, false)
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_SUBWIL500_00638_SWYNBROES_012, false)
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_SUBWIL500_00638_SWYNBROES_013, true)
    L4_7 = A0_3
    L3_6 = A0_3.Wait
    L3_6(L4_7, 10)
    L4_7 = A0_3
    L3_6 = A0_3.SystemTalk
    L3_6(L4_7, A0_3.TEXT_SUBWIL500_00638_SYSTEM_014, true)
    L4_7 = A0_3
    ...
    if L3_6 then
      ...
      A0_3:ScreenImage(A0_3.UNLOCK_IMAGE_MATERIA)
      A0_3:HowTo(A0_3.HOW_TO_01)
    end
    return L3_6, L4_7
  end
  function SubWil500.IsTodoChecked(A0_8, A1_9, A2_10)
    local L3_11
