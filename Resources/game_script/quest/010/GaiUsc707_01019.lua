(function()
  print("GaiUsc707 loaded")
  function GaiUsc707.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsc707.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_TALK)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSC707_01019_BLOEIDIN_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSC707_01019_BLOEIDIN_000_001, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ITEM)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSC707_01019_BLOEIDIN_000_002, true)
    A0_3:QuestAccepted()
  end
  function GaiUsc707.OnScene00002(A0_6, A1_7, A2_8)
  end
  function GaiUsc707.OnScene00003(A0_9, A1_10, A2_11)
    A2_11:PlayQuestGimmickReaction()
  end
  function GaiUsc707.OnScene00004(A0_12, A1_13, A2_14)
    A0_12:Inventory(true)
  end
  function GaiUsc707.OnScene00005(A0_15, A1_16, A2_17)
    A2_17:PlayQuestGimmickReaction()
  end
  function GaiUsc707.OnScene00006(A0_18, A1_19, A2_20)
    A0_18:Inventory(true)
  end
  function GaiUsc707.OnScene00007(A0_21, A1_22, A2_23)
    A2_23:PlayQuestGimmickReaction()
  end
  function GaiUsc707.OnScene00008(A0_24, A1_25, A2_26)
    local L3_27, L4_28
    L4_28 = A2_26
    L3_27 = A2_26.TurnTo
    ...
    L4_28 = A2_26
    L3_27 = A2_26.Talk
    L3_27(L4_28, A1_25, A0_24, A0_24.TEXT_GAIUSC707_01019_BLOEIDIN_000_010, false)
    L4_28 = A2_26
    L3_27 = A2_26.Talk
    L3_27(L4_28, A1_25, A0_24, A0_24.TEXT_GAIUSC707_01019_BLOEIDIN_000_011, true)
    L4_28 = A0_24
  ...
  function GaiUsc707.GetEventItems(A0_29, A1_30)
    local L2_31
  ...
  function GaiUsc707.IsTodoChecked(A0_32, A1_33, A2_34)
    local L3_35
...
;(function()
  ...
  function L1_37(A0_52, A1_53, A2_54, A3_55)
    ...
    L4_56 = L4_56(A0_52)
    if A1_53:GetQuestSequence(L4_56) == A0_52.SEQ_1 and A3_55 == A0_52.ITEM0 and A3_55 == A0_52.ITEM0 and A3_55 == A0_52.ITEM0 then
      return true
    end
    return false
  end
