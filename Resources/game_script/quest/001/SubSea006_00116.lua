(function()
  print("SubSea006 loaded")
  function SubSea006.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:TurnTo(A1_1, false)
    if A0_0:QuestOffer(A2_2, A1_1) then
      A2_2:WaitForTurn()
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EMOTE_BOW)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBSEA006_00116_HLAHONO_000_0, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBSEA006_00116_HLAHONO_000_1, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_ADD_YES)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBSEA006_00116_HLAHONO_000_2, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBSEA006_00116_HLAHONO_000_3, true)
      A0_0:QuestAccepted()
      return 1
    else
      return 0
  ...
  function SubSea006.OnScene00001(A0_3, A1_4, A2_5)
  end
  function SubSea006.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:LookAt(A1_7)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_SUBSEA006_00116_ABYLFARR_000_10, false)
    A2_8:LookAt(0, 25)
    A0_6:Wait(45)
    A2_8:LookAt(A1_7)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_SUBSEA006_00116_ABYLFARR_000_11, true)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_8:LookAt(90, 0)
    A2_8:WaitForActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
  end
  function SubSea006.OnScene00003(A0_9, A1_10, A2_11)
  ...
  function SubSea006.OnScene00004(A0_19, A1_20, A2_21)
    local L3_22, L4_23
    L4_23 = A2_21
    ...
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_SUBSEA006_00116_HLAHONO_000_21, false)
    L4_23 = A2_21
    L3_22 = A2_21.PlayActionTimeline
    L3_22(L4_23, A0_19.ACTION_TIMELINE_EVENT_ADD_YES)
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_SUBSEA006_00116_HLAHONO_000_22, true)
    L4_23 = A0_19
  ...
  function SubSea006.GetEventItems(A0_24, A1_25)
    local L2_26
  ...
  function SubSea006.IsTodoChecked(A0_27, A1_28, A2_29)
    local L3_30
