(function()
  print("SubWil097 loaded")
  function SubWil097.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
    if A0_0:QuestOffer(A2_2, A1_1) then
      A2_2:TurnTo(A1_1)
      A2_2:WaitForTurn()
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EMOTE_POINT)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL097_00505_TOTORUNA_000, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL097_00505_TOTORUNA_001, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK1)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL097_00505_TOTORUNA_002, true)
      A0_0:QuestAccepted()
      return 1
    else
      return 0
  ...
  function SubWil097.OnScene00001(A0_3, A1_4, A2_5)
    local L3_6, L4_7
    L4_7 = A2_5
    L3_6 = A2_5.TurnTo
    L3_6(L4_7, A1_4)
    ...
    L3_6(L4_7, A0_3.ACTION_TIMELINE_EVENT_BASE_IDLE3)
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_SUBWIL097_00505_TOTORUNA_010, false)
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_SUBWIL097_00505_TOTORUNA_011, false)
    L4_7 = A2_5
    L3_6 = A2_5.PlayActionTimeline
    L3_6(L4_7, A0_3.ACTION_TIMELINE_EMOTE_HUH)
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_SUBWIL097_00505_TOTORUNA_012, true)
    L4_7 = A0_3
  ...
  function SubWil097.IsTodoChecked(A0_8, A1_9, A2_10)
    local L3_11
    ...
    if A2_10 == 0 then
      return A1_9:GetQuestUI8AL(L3_11) >= 6
    elseif A2_10 == 1 then
      return false
    end
  end
...
;(function()
  ...
  function L1_13(A0_16, A1_17, A2_18)
    ...
    if A2_18 == 0 then
      return A1_17:GetQuestUI8AL(L3_19), 6
    elseif A2_18 == 1 then
