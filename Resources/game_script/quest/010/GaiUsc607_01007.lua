(function()
  print("GaiUsc607 loaded")
  function GaiUsc607.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsc607.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSC607_01007_URIANGER_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSC607_01007_URIANGER_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSC607_01007_URIANGER_000_002, true)
    A0_3:QuestAccepted()
  end
  function GaiUsc607.OnScene00002(A0_6, A1_7, A2_8)
    local L3_9, L4_10
    L4_10 = A2_8
    L3_9 = A2_8.TurnTo
    L3_9(L4_10, A1_7)
    ...
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_GAIUSC607_01007_LEWIN_000_010, false)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_GAIUSC607_01007_LEWIN_000_011, true)
    L4_10 = A0_6
  ...
  function GaiUsc607.OnScene00003(A0_11, A1_12, A2_13)
    A2_13:TurnTo(A1_12)
    A2_13:WaitForTurn()
    A2_13:PlayActionTimeline(A0_11.ACTION_TIMELINE_EVENT_TALK2)
    return (A0_11:YesNo(A0_11.TEXT_GAIUSC607_01007_SYSTEM_EVENTAREA_WARP_YESNO_TITLE, A0_11.TEXT_GAIUSC607_01007_SYSTEM_EVENTAREA_WARP_YESNO_YES, A0_11.TEXT_GAIUSC607_01007_SYSTEM_EVENTAREA_WARP_YESNO_NO, A0_11.DEFAULT_NO))
  end
  function GaiUsc607.IsTodoChecked(A0_14, A1_15, A2_16)
    local L3_17
...
;(function()
  ...
  function L1_19(A0_22, A1_23, A2_24, A3_25, A4_26)
    ...
    if A1_23:GetQuestSequence(L5_27) == A0_22.SEQ_FINISH then
      if A3_25 == A0_22.ACTOR1 then
        return true
      elseif A3_25 == A0_22.ACTOR2 then
        return true
      end
    end
    return false
  ...
  function L1_19(A0_34, A1_35, A2_36)
    ...
    if A2_36 == 0 then
      return A1_35:GetQuestUI8AH(L3_37), 0
    end
  end
