(function()
  print("GaiUsa902 loaded")
  function GaiUsa902.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsa902.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA902_00797_ADEMAR_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA902_00797_ADEMAR_000_001, true)
    if A1_4:IsHowTo(A0_3.HOWTO_EITEM) == false then
      A0_3:HowTo(A0_3.HOWTO_EITEM)
    end
    A0_3:QuestAccepted()
  end
  function GaiUsa902.OnScene00002(A0_6, A1_7, A2_8)
  ...
  function GaiUsa902.OnScene00003(A0_16, A1_17, A2_18)
    local L3_19, L4_20
    L4_20 = A2_18
    ...
    L4_20 = A2_18
    L3_19 = A2_18.Talk
    L3_19(L4_20, A1_17, A0_16, A0_16.TEXT_GAIUSA902_00797_ADEMAR_000_025, true)
    L4_20 = A0_16
  ...
  function GaiUsa902.GetEventItems(A0_21, A1_22)
    local L2_23
    ...
    elseif A1_22:GetQuestSequence(L2_23) == A0_21.SEQ_FINISH then
      return A0_21.ITEM1, A1_22:GetQuestUI8BL(L2_23), false
    end
  end
  function GaiUsa902.IsTodoChecked(A0_24, A1_25, A2_26)
    local L3_27
    ...
    if A2_26 == 0 then
      return A1_25:GetQuestUI8BL(L3_27) >= 2
    elseif A2_26 == 1 then
      return false
    end
  end
...
;(function()
  ...
  function L1_29(A0_37, A1_38, A2_39)
    ...
    if A2_39 == 0 then
      return A1_38:GetQuestUI8BL(L3_40), 2
    elseif A2_39 == 1 then
