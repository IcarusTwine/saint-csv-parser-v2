(function()
  print("BanQiq119 loaded")
  function BanQiq119.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanQiq119.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_DEMIHUMAN)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ119_03824_QHOTERLPASOL_000_000, false, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ119_03824_QHOTERLPASOL_000_001, false, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A2_5:CancelActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_DEMIHUMAN)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ119_03824_QHOTERLPASOL_000_002, false, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    if A1_4:GetClassJob() == A0_3.CLASS_JOB_MINER then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ119_03824_QHOTERLPASOL_000_003, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    elseif A1_4:GetClassJob() == A0_3.CLASS_JOB_HARVESTER then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ119_03824_QHOTERLPASOL_000_004, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    elseif A1_4:GetClassJob() == A0_3.CLASS_JOB_FISHERMAN then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ119_03824_QHOTERLPASOL_000_005, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    else
      A0_3:CancelEventScene()
    end
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanQiq119.OnScene00002(A0_6, A1_7, A2_8)
    ...
    if L6_12 == L10_16 then
      ...
      if L7_13 > L10_16 then
        L13_19 = A0_6
        L10_16(L11_17, L12_18, L13_19, A0_6.TEXT_BANQIQ119_03824_QHOTERLPASOL_000_006, true, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
      else
        L13_19 = A0_6
        L10_16(L11_17, L12_18, L13_19, A0_6.TEXT_BANQIQ119_03824_QHOTERLPASOL_000_010, true, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
      end
    elseif L6_12 == L10_16 then
      L13_19 = A0_6.NUM_OF_ITEMS_FILTER_NQ_OR_HQ
      if L8_14 > L10_16 then
        L13_19 = A0_6
        L10_16(L11_17, L12_18, L13_19, A0_6.TEXT_BANQIQ119_03824_QHOTERLPASOL_000_007, true, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
      else
        L13_19 = A0_6
        L10_16(L11_17, L12_18, L13_19, A0_6.TEXT_BANQIQ119_03824_QHOTERLPASOL_000_010, true, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
      end
    elseif L6_12 == L10_16 then
      ...
      if L9_15 > L10_16 then
        L13_19 = A0_6
        L10_16(L11_17, L12_18, L13_19, A0_6.TEXT_BANQIQ119_03824_QHOTERLPASOL_000_008, true, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
      else
        L13_19 = A0_6
        L10_16(L11_17, L12_18, L13_19, A0_6.TEXT_BANQIQ119_03824_QHOTERLPASOL_000_010, true, nil, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
      end
  ...
  function BanQiq119.OnScene00003(A0_20, A1_21, A2_22)
    local L3_23, L4_24
    L4_24 = A1_21
    ...
    L4_24 = A2_22
    L3_23 = A2_22.Talk
    L3_23(L4_24, A1_21, A0_20, A0_20.TEXT_BANQIQ119_03824_QHOTERLPASOL_000_011, false, nil, nil, nil, A0_20.SPEAK_NORMAL_MIDDLE)
    L4_24 = A2_22
    L3_23 = A2_22.Talk
    L3_23(L4_24, A1_21, A0_20, A0_20.TEXT_BANQIQ119_03824_QHOTERLPASOL_000_012, false, nil, nil, nil, A0_20.SPEAK_NORMAL_MIDDLE)
    L4_24 = A2_22
    L3_23 = A2_22.PlayActionTimeline
    L3_23(L4_24, A0_20.ACTION_TIMELINE_EVENT_TALK_ANGRY)
    L4_24 = A2_22
    L3_23 = A2_22.Talk
    L3_23(L4_24, A1_21, A0_20, A0_20.TEXT_BANQIQ119_03824_QHOTERLPASOL_000_013, true, nil, nil, nil, A0_20.SPEAK_NORMAL_MIDDLE)
    L4_24 = A0_20
  ...
  function BanQiq119.OnScene00004(A0_25, A1_26, A2_27)
  end
  function BanQiq119.OnScene00005(A0_28, A1_29, A2_30)
  end
  function BanQiq119.OnScene00006(A0_31, A1_32, A2_33)
  end
  function BanQiq119.IsTodoChecked(A0_34, A1_35, A2_36)
    local L3_37
