(function()
  print("FesEst203 loaded")
  function FesEst203.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function FesEst203.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EMOTE_WELCOME)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESEST203_02130_EGGHUNTINGSTAFFB02130_000_001, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESEST203_02130_EGGHUNTINGSTAFFB02130_000_002, true)
    A0_3:QuestAccepted()
  end
  function FesEst203.OnScene00002(A0_6, A1_7, A2_8)
    A0_6:Inventory(true)
  end
  function FesEst203.OnScene00003(A0_9, A1_10, A2_11)
  end
  function FesEst203.OnScene00004(A0_12, A1_13, A2_14)
    A2_14:TurnTo(A1_13, false)
    A2_14:WaitForTurn()
    A2_14:PlayActionTimeline(A0_12.ACTION_TIMELINE_EVENT_TALK1)
    A2_14:Talk(A1_13, A0_12, A0_12.TEXT_FESEST203_02130_EGGHUNTINGSTAFFB02130_000_003, true)
  end
  function FesEst203.OnScene00005(A0_15, A1_16, A2_17)
  ...
  function FesEst203.OnScene00006(A0_25, A1_26, A2_27)
    local L3_28, L4_29
    L4_29 = A2_27
    ...
    L4_29 = A2_27
    L3_28 = A2_27.Talk
    L3_28(L4_29, A1_26, A0_25, A0_25.TEXT_FESEST203_02130_EGGHUNTINGSTAFFB02130_000_010, false)
    L4_29 = A2_27
    L3_28 = A2_27.PlayActionTimeline
    L3_28(L4_29, A0_25.ACTION_TIMELINE_EMOTE_JOY)
    L4_29 = A2_27
    L3_28 = A2_27.Talk
    L3_28(L4_29, A1_26, A0_25, A0_25.TEXT_FESEST203_02130_EGGHUNTINGSTAFFB02130_000_011, true)
    L4_29 = A0_25
  ...
  function FesEst203.GetEventItems(A0_30, A1_31)
    local L2_32
  ...
  function FesEst203.IsTodoChecked(A0_33, A1_34, A2_35)
    local L3_36
    ...
    if A2_35 == 0 then
      return A1_34:GetQuestUI8BL(L3_36) >= 1
    elseif A2_35 == 1 then
      return false
    end
  end
...
;(function()
  ...
  function L1_38(A0_58, A1_59, A2_60)
    ...
    if A2_60 == 0 then
      return A1_59:GetQuestUI8BL(L3_61), 1
    elseif A2_60 == 1 then
