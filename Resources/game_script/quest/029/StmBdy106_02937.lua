(function()
  print("StmBdy106 loaded")
  function StmBdy106.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function StmBdy106.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EMOTE_JOY)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDY106_02937_ESTRILD_000_001, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_SIGH)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_NO)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDY106_02937_ESTRILD_000_002, true)
    A0_3:Wait(10)
    ...
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDY106_02937_ESTRILD_000_003, false)
    A2_5:PlayActionTimeline(A0_3.TEXT_STMBDY106_02937_ESTRILD_000_003)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_FINGER)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_FACIAL_BAD)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDY106_02937_ESTRILD_000_004, true)
    A0_3:Wait(10)
    ...
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDY106_02937_ESTRILD_000_005, true)
    A0_3:QuestAccepted()
  end
  function StmBdy106.OnScene00002(A0_6, A1_7, A2_8)
    local L3_9, L4_10
    L4_10 = A2_8
    L3_9 = A2_8.LookAt
    L3_9(L4_10, A1_7)
    ...
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_STMBDY106_02937_WLVEVA_000_010, false)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_STMBDY106_02937_WLVEVA_000_011, true)
    L4_10 = A2_8
    ...
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_STMBDY106_02937_WLVEVA_000_012, true)
    L4_10 = A0_6
    L3_9 = A0_6.Wait
    L3_9(L4_10, 10)
    L4_10 = A0_6
    ...
    if L3_9 then
      A0_6:QuestCompleted()
      A0_6:Wait(90)
      A0_6:ScenarioMessage(A0_6.TEXT_STMBDY106_02937_SYSTEM_100_013)
      A0_6:Wait(10)
      A0_6:SystemTalk(A0_6.TEXT_STMBDY106_02937_SYSTEM_000_013, false)
      A0_6:SystemTalk(A0_6.TEXT_STMBDY106_02937_SYSTEM_000_014, true)
    end
    return L3_9, L4_10
  end
  function StmBdy106.OnScene00003(A0_11, A1_12, A2_13)
    A2_13:LookAt(A1_12)
    A2_13:TurnTo(A1_12, false)
    A2_13:WaitForTurn()
    A2_13:PlayActionTimeline(A0_11.ACTION_TIMELINE_EVENT_TALK_FINGER)
    A2_13:PlayActionTimeline(A0_11.ACTION_TIMELINE_FACIAL_BAD)
    A2_13:Talk(A1_12, A0_11, A0_11.TEXT_STMBDY106_02937_ESTRILD_000_015, true)
  end
  function StmBdy106.IsTodoChecked(A0_14, A1_15, A2_16)
    local L3_17
