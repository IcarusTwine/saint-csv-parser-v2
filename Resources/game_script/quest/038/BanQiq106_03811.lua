(function()
  print("BanQiq106 loaded")
  function BanQiq106.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanQiq106.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ106_03811_QHOTERLPASOL_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ106_03811_QHOTERLPASOL_000_001, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    if A1_4:GetClassJob() == A0_3.CLASS_JOB_MINER then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ106_03811_QHOTERLPASOL_000_010, false)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ106_03811_QHOTERLPASOL_000_040, true)
    elseif A1_4:GetClassJob() == A0_3.CLASS_JOB_HARVESTER then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ106_03811_QHOTERLPASOL_000_020, false)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ106_03811_QHOTERLPASOL_000_040, true)
    elseif A1_4:GetClassJob() == A0_3.CLASS_JOB_FISHERMAN then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ106_03811_QHOTERLPASOL_000_030, false)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ106_03811_QHOTERLPASOL_000_040, true)
    else
      A0_3:CancelEventScene()
    end
    if A1_4:GetClassJob() == A0_3.CLASS_JOB_FISHERMAN and A1_4:IsQuestCompleted(A0_3.QUEST_StmBdy104) == false then
      A0_3:Wait(10)
      A0_3:SystemTalk(A0_3.TEXT_BANQIQ106_03811_SYSTEM_100_040, true)
    end
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanQiq106.OnScene00002(A0_6, A1_7, A2_8)
    local L3_9, L4_10, L5_11, L6_12, L7_13, L8_14, L9_15, L10_16, L11_17, L12_18, L13_19
    L4_10 = A0_6
    L3_9 = A0_6.GetQuestAcceptClassJob
    L3_9 = L3_9(L4_10)
    L4_10 = 3
    L5_11 = 3
    L6_12 = 1
    ...
    L7_13(L8_14, L9_15)
    L7_13 = A0_6.CLASS_JOB_MINER
    if L3_9 == L7_13 then
      L8_14 = A1_7
      L7_13 = A1_7.GetNumOfItems
      L9_15 = A0_6.QST_GATHERING_ITEM_MIN
      L7_13 = L7_13(L8_14, L9_15, L10_16, L11_17, L12_18)
      if L4_10 > L7_13 then
        L8_14 = A2_8
        L7_13 = A2_8.Talk
        L9_15 = A1_7
        L7_13(L8_14, L9_15, L10_16, L11_17, L12_18)
      else
        L8_14 = A2_8
        L7_13 = A2_8.Talk
        L9_15 = A1_7
      ...
      L7_13 = A0_6.CLASS_JOB_HARVESTER
      if L3_9 == L7_13 then
        L8_14 = A1_7
        L7_13 = A1_7.GetNumOfItems
        L9_15 = A0_6.QST_GATHERING_ITEM_HRV
        L7_13 = L7_13(L8_14, L9_15, L10_16, L11_17, L12_18)
        if L5_11 > L7_13 then
          L8_14 = A2_8
          L7_13 = A2_8.Talk
        ...
        L7_13 = A0_6.CLASS_JOB_FISHERMAN
        if L3_9 == L7_13 then
          L8_14 = A1_7
          L7_13 = A1_7.GetNumOfItems
          L9_15 = A0_6.QST_GATHERING_ITEM_FSH
          L7_13 = L7_13(L8_14, L9_15, L10_16, L11_17, L12_18)
          if L6_12 > L7_13 then
            L8_14 = A2_8
            L7_13 = A2_8.Talk
            ...
            if L7_13 == false then
              ...
              L9_15 = A0_6.TEXT_BANQIQ106_03811_SYSTEM_100_040
              L7_13(L8_14, L9_15, L10_16)
            end
          else
            L8_14 = A2_8
          ...
          L8_14 = A0_6
          L7_13 = A0_6.CancelEventScene
          L7_13(L8_14)
        end
      end
    end
    L8_14 = A0_6
    L7_13 = A0_6.GetQuestId
    L7_13 = L7_13(L8_14)
    L9_15 = A1_7
    L8_14 = A1_7.GetQuestSequence
    L8_14 = L8_14(L9_15, L10_16)
    L9_15 = 1
    for L13_19 = 1, L9_15 do
      A0_6:SetNpcTradeItem(L13_19, unpack(A0_6:getNpcTradeItemInfo(L13_19, L8_14, A2_8:GetBaseId())))
    end
    L13_19 = nil
    if L10_16 == 1 then
      return L10_16
  ...
  function BanQiq106.OnScene00003(A0_20, A1_21, A2_22)
    ...
    L4_24(L5_25, A0_20.ACTION_TIMELINE_EVENT_TALK_ANGRY)
    L4_24 = A0_20.CLASS_JOB_MINER
    if L3_23 == L4_24 then
      L5_25 = A2_22
      L4_24 = A2_22.Talk
      L4_24(L5_25, A1_21, A0_20, A0_20.TEXT_BANQIQ106_03811_QHOTERLPASOL_000_060, false)
    else
      L4_24 = A0_20.CLASS_JOB_HARVESTER
      if L3_23 == L4_24 then
        L5_25 = A2_22
        L4_24 = A2_22.Talk
        L4_24(L5_25, A1_21, A0_20, A0_20.TEXT_BANQIQ106_03811_QHOTERLPASOL_000_070, false)
      else
        L5_25 = A2_22
        L4_24 = A2_22.Talk
        L4_24(L5_25, A1_21, A0_20, A0_20.TEXT_BANQIQ106_03811_QHOTERLPASOL_000_080, false)
      end
    end
    L5_25 = A2_22
    L4_24 = A2_22.Talk
    L4_24(L5_25, A1_21, A0_20, A0_20.TEXT_BANQIQ106_03811_QHOTERLPASOL_000_090, true)
    L5_25 = A0_20
  ...
  function BanQiq106.OnScene00004(A0_26, A1_27, A2_28)
  end
  function BanQiq106.OnScene00005(A0_29, A1_30, A2_31)
  end
  function BanQiq106.OnScene00006(A0_32, A1_33, A2_34)
  end
  function BanQiq106.IsTodoChecked(A0_35, A1_36, A2_37)
    local L3_38
  ...
  function L1_40(A0_49, A1_50, A2_51, A3_52, A4_53)
    ...
    if A1_50:GetQuestSequence(L5_54) == A0_49.SEQ_FINISH then
      ...
      elseif A3_52 == A0_49.ACTOR1 then
        if A0_49:GetQuestAcceptClassJob() == A0_49.CLASS_JOB_MINER and A1_50:GetNumOfItems(A0_49.QST_GATHERING_ITEM_MIN, A0_49.NUM_OF_ITEMS_FILTER_NQ, false, true) < 3 then
          return true, true
        end
      elseif A3_52 == A0_49.ACTOR2 then
        if A0_49:GetQuestAcceptClassJob() == A0_49.CLASS_JOB_HARVESTER and 3 > A1_50:GetNumOfItems(A0_49.QST_GATHERING_ITEM_HRV, A0_49.NUM_OF_ITEMS_FILTER_NQ, false, true) then
          return true, true
        end
      elseif A3_52 == A0_49.ACTOR3 and A0_49:GetQuestAcceptClassJob() == A0_49.CLASS_JOB_FISHERMAN and A1_50:GetNumOfItems(A0_49.QST_GATHERING_ITEM_FSH, A0_49.NUM_OF_ITEMS_FILTER_NQ, false, true) < 1 then
        return true, true
      end
    end
    return false
