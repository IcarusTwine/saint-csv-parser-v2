(function()
  print("XxaUsa104 loaded")
  function XxaUsa104.OnScene00000(A0_0, A1_1, A2_2)
    if A1_1:IsQuestAccepted(A0_0.QST_ACCEPT_CHECK) == true then
      A0_0:SystemTalk(A0_0.TEXT_XXAUSA104_03858_SYSTEM_100_000, true)
  ...
  function XxaUsa104.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_XXAUSA104_03858_PAPALYMO_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_XXAUSA104_03858_PAPALYMO_000_001, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_XXAUSA104_03858_PAPALYMO_000_002, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_XXAUSA104_03858_PAPALYMO_000_003, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_ONEHAND)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_XXAUSA104_03858_PAPALYMO_000_004, true)
    A0_3:QuestAccepted()
  end
  function XxaUsa104.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7, false)
    A2_8:WaitForTurn()
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK2)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_XXAUSA104_03858_IMEDIA_000_010, true)
    A1_7:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK2)
    A1_7:WaitForActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK2)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_XXAUSA104_03858_IMEDIA_000_011, false)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_THINK)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_XXAUSA104_03858_IMEDIA_000_012, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_XXAUSA104_03858_IMEDIA_000_013, false)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_XXAUSA104_03858_IMEDIA_000_014, true)
  end
  function XxaUsa104.OnScene00003(A0_9, A1_10, A2_11)
  end
  function XxaUsa104.OnScene00004(A0_12, A1_13, A2_14)
  end
  function XxaUsa104.OnScene00005(A0_15, A1_16, A2_17)
  end
  function XxaUsa104.OnScene00006(A0_18, A1_19, A2_20)
  end
  function XxaUsa104.OnScene00007(A0_21, A1_22, A2_23)
  end
  function XxaUsa104.OnScene00008(A0_24, A1_25, A2_26)
  end
  function XxaUsa104.OnScene00009(A0_27, A1_28, A2_29)
  ...
  function XxaUsa104.OnScene00010(A0_37, A1_38, A2_39)
    local L3_40, L4_41
    L4_41 = A1_38
    ...
    L3_40(L4_41, A0_37.ACTION_TIMELINE_EVENT_FIDGET)
    L4_41 = A2_39
    L3_40 = A2_39.Talk
    L3_40(L4_41, A1_38, A0_37, A0_37.TEXT_XXAUSA104_03858_KOMUXIO_000_031, false)
    L4_41 = A2_39
    L3_40 = A2_39.Talk
    L3_40(L4_41, A1_38, A0_37, A0_37.TEXT_XXAUSA104_03858_KOMUXIO_000_032, false)
    L4_41 = A2_39
    L3_40 = A2_39.PlayActionTimeline
    L3_40(L4_41, A0_37.ACTION_TIMELINE_EVENT_TALK1)
    L4_41 = A2_39
    L3_40 = A2_39.Talk
    L3_40(L4_41, A1_38, A0_37, A0_37.TEXT_XXAUSA104_03858_KOMUXIO_000_033, true)
    L4_41 = A0_37
  ...
  function XxaUsa104.GetEventItems(A0_42, A1_43)
    local L2_44
  ...
  function XxaUsa104.IsTodoChecked(A0_45, A1_46, A2_47)
    local L3_48
    ...
    elseif A2_47 == 1 then
      return 1 <= A1_46:GetQuestUI8BL(L3_48)
    elseif A2_47 == 2 then
...
;(function()
  ...
  function L1_50(A0_53, A1_54, A2_55, A3_56, A4_57)
    ...
    if A1_54:GetQuestSequence(L5_58) == A0_53.SEQ_2 then
      if A3_56 == A0_53.ENEMY0 then
        ...
        return 1 > A1_54:GetQuestUI8BL(L5_58)
  ...
  function L1_50(A0_73, A1_74, A2_75, A3_76)
    ...
    elseif A2_75 == A0_73.SEQ_FINISH and A3_76 == A0_73.ACTOR2 then
      ({})[1] = {
        A0_73.ITEM0,
        3,
        false,
