(function()
  print("ManFst304 loaded")
  function ManFst304.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function ManFst304.OnScene00001(A0_3, A1_4, A2_5)
    A0_3:Skip(A0_3.SKIP_FINALIZE_AUTO_FADEIN)
    A0_3:BeginCutScene()
    A0_3:PlayCutScene(A0_3.CUT_MANFST30420)
    A0_3:EndCutScene()
    A0_3:QuestAccepted()
  end
  function ManFst304.OnScene00002(A0_6, A1_7, A2_8)
    local L3_9, L4_10
    L4_10 = A2_8
    ...
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_MANFST304_00513_VORSAILE_000_010, false)
    L4_10 = A2_8
    L3_9 = A2_8.TurnTo
    L3_9(L4_10, A1_7)
    L4_10 = A2_8
    ...
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_MANFST304_00513_VORSAILE_000_011, true)
    L4_10 = A0_6
  ...
  function ManFst304.IsTodoChecked(A0_11, A1_12, A2_13)
    local L3_14
