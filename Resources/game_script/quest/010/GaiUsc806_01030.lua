(function()
  print("GaiUsc806 loaded")
  function GaiUsc806.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsc806.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSC806_01030_EILIS_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSC806_01030_EILIS_000_001, true)
    A0_3:QuestAccepted()
  end
  function GaiUsc806.OnScene00002(A0_6, A1_7, A2_8)
    local L3_9, L4_10
    L4_10 = A2_8
    L3_9 = A2_8.TurnTo
    L3_9(L4_10, A1_7)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_GAIUSC806_01030_EILIS_000_020, false)
    L4_10 = A2_8
    L3_9 = A2_8.PlayActionTimeline
    L3_9(L4_10, A0_6.ACTION_TIMELINE_EVENT_ADD_NO)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_GAIUSC806_01030_EILIS_000_021, true)
    L4_10 = A0_6
  ...
  function GaiUsc806.IsTodoChecked(A0_11, A1_12, A2_13)
    local L3_14
...
;(function()
  ...
  function L1_16(A0_19, A1_20, A2_21, A3_22, A4_23)
    ...
    if A1_20:GetQuestSequence(L5_24) == A0_19.SEQ_1 and (A3_22 == A0_19.ENEMY0 or A3_22 == A0_19.ENEMY1 or A3_22 == A0_19.ENEMY2) then
      if 4 <= A1_20:GetQuestUI8AL(L5_24) then
        return false
      end
      return 4 > A1_20:GetQuestUI8AL(L5_24)
    end
    return false
  end
  ...
  function L1_16(A0_31, A1_32, A2_33)
    ...
    if A2_33 == 0 then
      return A1_32:GetQuestUI8AL(L3_34), 4
    elseif A2_33 == 1 then
