(function()
  print("BanGna305 loaded")
  function BanGna305.OnScene00000(A0_0, A1_1, A2_2)
  ...
  function BanGna305.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANGNA305_02265_SEARCHER_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANGNA305_02265_SEARCHER_000_001, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANGNA305_02265_SEARCHER_000_002, true)
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanGna305.OnScene00002(A0_6, A1_7, A2_8)
  end
  function BanGna305.OnScene00003(A0_9, A1_10, A2_11)
  end
  function BanGna305.OnScene00004(A0_12, A1_13, A2_14)
  end
  function BanGna305.OnScene00005(A0_15, A1_16, A2_17)
  end
  function BanGna305.OnScene00006(A0_18, A1_19, A2_20)
  end
  function BanGna305.OnScene00007(A0_21, A1_22, A2_23)
  end
  function BanGna305.OnScene00008(A0_24, A1_25, A2_26)
  end
  function BanGna305.OnScene00009(A0_27, A1_28, A2_29)
  end
  function BanGna305.OnScene00010(A0_30, A1_31, A2_32)
  end
  function BanGna305.OnScene00011(A0_33, A1_34, A2_35)
  end
  function BanGna305.OnScene00012(A0_36, A1_37, A2_38)
  end
  function BanGna305.OnScene00013(A0_39, A1_40, A2_41)
  end
  function BanGna305.OnScene00014(A0_42, A1_43, A2_44)
  end
  function BanGna305.OnScene00015(A0_45, A1_46, A2_47)
  end
  function BanGna305.OnScene00016(A0_48, A1_49, A2_50)
  end
  function BanGna305.OnScene00017(A0_51, A1_52, A2_53)
  end
  function BanGna305.OnScene00018(A0_54, A1_55, A2_56)
  ...
  function BanGna305.OnScene00019(A0_64, A1_65, A2_66)
    local L3_67, L4_68
    L4_68 = A1_65
    ...
    L4_68 = A2_66
    L3_67 = A2_66.PlayActionTimeline
    L3_67(L4_68, A0_64.EVENT_ACTION_JOY)
    L4_68 = A2_66
    L3_67 = A2_66.Talk
    L3_67(L4_68, A1_65, A0_64, A0_64.TEXT_BANGNA305_02265_SEARCHER_000_011, false)
    L4_68 = A2_66
    L3_67 = A2_66.PlayActionTimeline
    L3_67(L4_68, A0_64.ACTION_TIMELINE_EVENT_TALK1)
    L4_68 = A2_66
    L3_67 = A2_66.Talk
    L3_67(L4_68, A1_65, A0_64, A0_64.TEXT_BANGNA305_02265_SEARCHER_000_012, false)
    L4_68 = A2_66
    L3_67 = A2_66.Talk
    L3_67(L4_68, A1_65, A0_64, A0_64.TEXT_BANGNA305_02265_SEARCHER_000_013, true)
    L4_68 = A2_66
    ...
    L4_68 = A2_66
    L3_67 = A2_66.Talk
    L3_67(L4_68, A1_65, A0_64, A0_64.TEXT_BANGNA305_02265_SEARCHER_000_014, true)
    L4_68 = A0_64
  ...
  function BanGna305.GetEventItems(A0_69, A1_70)
    local L2_71
    ...
    elseif A1_70:GetQuestSequence(L2_71) == A0_69.SEQ_1 then
      return A0_69.ITEM0, A1_70:GetQuestUI8BL(L2_71), false, A0_69.ITEM1, A1_70:GetQuestUI8CH(L2_71), false
    elseif A1_70:GetQuestSequence(L2_71) == A0_69.SEQ_FINISH then
      return A0_69.ITEM0, A1_70:GetQuestUI8BH(L2_71), false, A0_69.ITEM1, A1_70:GetQuestUI8BL(L2_71), false
    end
  end
  function BanGna305.IsTodoChecked(A0_72, A1_73, A2_74)
    local L3_75
    ...
    elseif A2_74 == 1 then
      return 3 <= A1_73:GetQuestUI8BH(L3_75)
    elseif A2_74 == 2 then
      return false
    end
  end
...
;(function()
  ...
  function L1_77(A0_80, A1_81, A2_82, A3_83, A4_84)
    ...
    if A1_81:GetQuestSequence(L5_85) == A0_80.SEQ_1 then
      ...
      elseif A3_83 == A0_80.EOBJECT3 then
        if 3 <= A1_81:GetQuestUI8BH(L5_85) then
          return false
        end
  ...
  function L1_77(A0_92, A1_93, A2_94)
    ...
    elseif A2_94 == 1 then
      return A1_93:GetQuestUI8BH(L3_95), 3
    elseif A2_94 == 2 then
