(function()
  print("BanQiq022 loaded")
  function BanQiq022.OnScene00000(A0_0, A1_1, A2_2)
    if A1_1:IsQuestAcceptQualified(A0_0:GetQuestId()) then
      A2_2:TurnTo(A1_1, false)
      A2_2:WaitForTurn()
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_ACT_TALK)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_BANQIQ022_03801_CHAQURLQHOTL_000_001, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_BANQIQ022_03801_CHAQURLQHOTL_000_002, true)
      A0_0:Wait(10)
      A0_0:SystemTalk(A0_0.TEXT_BANQIQ022_03801_SYSTEM_000_003, false)
      A0_0:SystemTalk(A0_0.TEXT_BANQIQ022_03801_SYSTEM_000_004, true)
      A0_0:Wait(10)
      if A0_0:YesNo(A0_0.TEXT_BANQIQ022_03801_Q1_000_000) == false then
        A0_0:CancelEventScene()
      else
        A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_JOY_BIG)
        A2_2:Talk(A1_1, A0_0, A0_0.TEXT_BANQIQ022_03801_CHAQURLQHOTL_100_005, true)
      end
    end
  ...
  function BanQiq022.OnScene00001(A0_3, A1_4, A2_5)
    local L3_6
    ...
    L3_6:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ022_03801_QITARLNATL_000_006, true)
    L3_6:LookAt()
    ...
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANQIQ022_03801_CHAQURLQHOTL_000_007, true)
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanQiq022.OnScene00002(A0_7, A1_8, A2_9)
    local L3_10, L4_11
    L4_11 = A2_9
    L3_10 = A2_9.TurnTo
    ...
    L4_11 = A2_9
    L3_10 = A2_9.Talk
    L3_10(L4_11, A1_8, A0_7, A0_7.TEXT_BANQIQ022_03801_CHAQURLQHOTL_000_008, true)
    L4_11 = A0_7
  ...
  function BanQiq022.OnScene00003(A0_12, A1_13, A2_14, ...)
    local L4_16
    L4_16 = (...)
    A0_12:BeginCutScene()
  ...
  function BanQiq022.IsTodoChecked(A0_17, A1_18, A2_19)
    local L3_20
