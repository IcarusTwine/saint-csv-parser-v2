(function()
  print("SubWil061 loaded")
  function SubWil061.OnScene00000(A0_0, A1_1, A2_2)
    if A0_0:QuestOffer(A2_2, A1_1) then
      ...
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL061_00304_WOWOBARU_000_1, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL061_00304_WOWOBARU_000_2, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK1)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL061_00304_WOWOBARU_000_3, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL061_00304_WOWOBARU_000_4, true)
      A0_0:QuestAccepted()
      return 1
    else
      return 0
  ...
  function SubWil061.OnScene00001(A0_3, A1_4, A2_5)
  end
  function SubWil061.OnScene00002(A0_6, A1_7, A2_8)
    A0_6:ScenarioMessage(A0_6.TEXT_SUBWIL061_00304_POP_MESSAGE)
  end
  function SubWil061.OnScene00003(A0_9, A1_10, A2_11)
  end
  function SubWil061.OnScene00004(A0_12, A1_13, A2_14)
  end
  function SubWil061.OnScene00005(A0_15, A1_16, A2_17)
    A0_15:ScenarioMessage(A0_15.TEXT_SUBWIL061_00304_POP_MESSAGE)
  end
  function SubWil061.OnScene00006(A0_18, A1_19, A2_20)
  end
  function SubWil061.OnScene00007(A0_21, A1_22, A2_23)
  end
  function SubWil061.OnScene00008(A0_24, A1_25, A2_26)
    A0_24:ScenarioMessage(A0_24.TEXT_SUBWIL061_00304_POP_MESSAGE)
  end
  function SubWil061.OnScene00009(A0_27, A1_28, A2_29)
  end
  function SubWil061.OnScene00010(A0_30, A1_31, A2_32)
  end
  function SubWil061.OnScene00011(A0_33, A1_34, A2_35)
    A0_33:ScenarioMessage(A0_33.TEXT_SUBWIL061_00304_POP_MESSAGE)
  end
  function SubWil061.OnScene00012(A0_36, A1_37, A2_38)
  end
  function SubWil061.OnScene00013(A0_39, A1_40, A2_41)
  ...
  function SubWil061.OnScene00014(A0_49, A1_50, A2_51)
    local L3_52, L4_53
    L4_53 = A2_51
    L3_52 = A2_51.PlayActionTimeline
    L3_52(L4_53, A0_49.ACTION_TIMELINE_EMOTE_JOY, A1_50)
    L4_53 = A2_51
    L3_52 = A2_51.Talk
    L3_52(L4_53, A1_50, A0_49, A0_49.TEXT_SUBWIL061_00304_WOWOBARU_000_11, false)
    L4_53 = A2_51
    L3_52 = A2_51.Talk
    L3_52(L4_53, A1_50, A0_49, A0_49.TEXT_SUBWIL061_00304_WOWOBARU_000_12, false)
    L4_53 = A2_51
    L3_52 = A2_51.PlayActionTimeline
    L3_52(L4_53, A0_49.ACTION_TIMELINE_EVENT_TALK_FOREFINGER, A1_50)
    L4_53 = A2_51
    L3_52 = A2_51.Talk
    L3_52(L4_53, A1_50, A0_49, A0_49.TEXT_SUBWIL061_00304_WOWOBARU_000_13, true)
    L4_53 = A0_49
  ...
  function SubWil061.OnScene00015(A0_54, A1_55, A2_56)
  end
  function SubWil061.GetEventItems(A0_57, A1_58)
    local L2_59
  ...
  function SubWil061.IsTodoChecked(A0_60, A1_61, A2_62)
    local L3_63
