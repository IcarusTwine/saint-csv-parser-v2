(function()
  print("LucKze018 loaded")
  function LucKze018.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function LucKze018.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZE018_03452_MENTOR03452_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZE018_03452_MENTOR03452_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZE018_03452_MENTOR03452_000_002, true)
  ...
  function LucKze018.OnScene00002(A0_6, A1_7, A2_8)
  end
  function LucKze018.OnScene00003(A0_9, A1_10, A2_11)
    A0_9:SystemTalk(A0_9.TEXT_LUCKZE018_03452_SYSTEM_000_010, true)
    A0_9:CancelEventScene()
  end
  function LucKze018.OnScene00004(A0_12, A1_13, A2_14)
  end
  function LucKze018.OnScene00005(A0_15, A1_16, A2_17)
    A0_15:SystemTalk(A0_15.TEXT_LUCKZE018_03452_SYSTEM_000_011, true)
    A0_15:CancelEventScene()
  end
  function LucKze018.OnScene00006(A0_18, A1_19, A2_20)
  end
  function LucKze018.OnScene00007(A0_21, A1_22, A2_23)
    if A0_21:IsBattleNpcOwner(A1_22, true) == true or A0_21:IsBattleNpcTriggerOwner(A1_22, A2_23, false) == true then
    else
      A0_21:LogMessage(A0_21.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function LucKze018.OnScene00008(A0_24, A1_25, A2_26)
  end
  function LucKze018.OnScene00009(A0_27, A1_28, A2_29)
    if A0_27:IsBattleNpcOwner(A1_28, true) == true or A0_27:IsBattleNpcTriggerOwner(A1_28, A2_29, false) == true then
    else
      A0_27:LogMessage(A0_27.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function LucKze018.OnScene00010(A0_30, A1_31, A2_32)
  end
  function LucKze018.OnScene00011(A0_33, A1_34, A2_35)
    ...
    L5_38 = A0_33.ACTION_TIMELINE_EVENT_ADD_YES
    L3_36(L4_37, L5_38)
    L4_37 = A2_35
    L3_36 = A2_35.Talk
    L5_38 = A1_34
  ...
  function LucKze018.OnScene00012(A0_43, A1_44, A2_45)
    local L3_46, L4_47
    L4_47 = A1_44
    ...
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_LUCKZE018_03452_MENTOR03452_000_021, false)
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_LUCKZE018_03452_MENTOR03452_000_022, false)
    L4_47 = A2_45
    L3_46 = A2_45.PlayActionTimeline
    L3_46(L4_47, A0_43.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_LUCKZE018_03452_MENTOR03452_000_023, true)
    L4_47 = A2_45
    ...
    if L3_46 then
      ...
      A2_45:LookAt()
      A2_45:TurnTo(55, false, true)
      A2_45:WaitForTurn()
      A0_43:Wait(10)
      A2_45:WalkOut(0, 6, A0_43.MOVE_WALK)
      A0_43:Wait(10)
  ...
  function LucKze018.GetEventItems(A0_48, A1_49)
    local L2_50
  ...
  function LucKze018.IsTodoChecked(A0_51, A1_52, A2_53)
    local L3_54
