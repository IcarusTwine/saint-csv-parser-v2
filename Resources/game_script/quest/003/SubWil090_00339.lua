(function()
  print("SubWil090 loaded")
  function SubWil090.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
    if A0_0:QuestOffer(A2_2, A1_1) then
      A2_2:TurnTo(A1_1)
      A2_2:WaitForTurn()
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EMOTE_WELCOME)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL090_00339_ZUZUTYRO_000, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL090_00339_ZUZUTYRO_001, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_ITEM)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL090_00339_ZUZUTYRO_002, true)
      return 1
    else
      return 0
    end
  end
  function SubWil090.OnScene00001(A0_3, A1_4, A2_5)
    A0_3:QuestAccepted()
  end
  function SubWil090.OnScene00002(A0_6, A1_7, A2_8)
  ...
  function SubWil090.OnScene00003(A0_16, A1_17, A2_18)
    local L3_19, L4_20
    L4_20 = A2_18
    ...
    L4_20 = A2_18
    L3_19 = A2_18.Talk
    L3_19(L4_20, A1_17, A0_16, A0_16.TEXT_SUBWIL090_00339_ZUZUTYRO_011, false)
    L4_20 = A2_18
    L3_19 = A2_18.Talk
    L3_19(L4_20, A1_17, A0_16, A0_16.TEXT_SUBWIL090_00339_ZUZUTYRO_012, true)
    L4_20 = A0_16
  ...
  function SubWil090.OnScene00004(A0_21, A1_22, A2_23)
  end
  function SubWil090.GetEventItems(A0_24, A1_25)
    local L2_26
  ...
  function SubWil090.IsTodoChecked(A0_27, A1_28, A2_29)
    local L3_30
