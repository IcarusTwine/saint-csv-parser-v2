(function()
  print("GaiUsb908 loaded")
  function GaiUsb908.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsb908.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:LookAt(A1_4)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB908_00931_CHAUNOLLET_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB908_00931_CHAUNOLLET_000_001, true)
    A0_3:QuestAccepted()
  end
  function GaiUsb908.OnScene00002(A0_6, A1_7, A2_8)
  end
  function GaiUsb908.OnScene00003(A0_9, A1_10, A2_11)
  end
  function GaiUsb908.OnScene00004(A0_12, A1_13, A2_14)
  end
  function GaiUsb908.OnScene00005(A0_15, A1_16, A2_17)
  end
  function GaiUsb908.OnScene00006(A0_18, A1_19, A2_20)
  end
  function GaiUsb908.OnScene00007(A0_21, A1_22, A2_23)
  end
  function GaiUsb908.OnScene00008(A0_24, A1_25, A2_26)
  end
  function GaiUsb908.OnScene00009(A0_27, A1_28, A2_29)
  end
  function GaiUsb908.OnScene00010(A0_30, A1_31, A2_32)
  end
  function GaiUsb908.OnScene00011(A0_33, A1_34, A2_35)
  end
  function GaiUsb908.OnScene00012(A0_36, A1_37, A2_38)
    local L3_39, L4_40
    L4_40 = A2_38
    L3_39 = A2_38.LookAt
    L3_39(L4_40, A1_37)
    L4_40 = A2_38
    L3_39 = A2_38.Talk
    L3_39(L4_40, A1_37, A0_36, A0_36.TEXT_GAIUSB908_00931_CHAUNOLLET_000_020, false)
    L4_40 = A2_38
    L3_39 = A2_38.Talk
    L3_39(L4_40, A1_37, A0_36, A0_36.TEXT_GAIUSB908_00931_CHAUNOLLET_000_021, true)
    L4_40 = A0_36
  ...
  function GaiUsb908.IsTodoChecked(A0_41, A1_42, A2_43)
    local L3_44
  ...
  function L1_46(A0_49, A1_50, A2_51, A3_52, A4_53)
    ...
    if A1_50:GetQuestSequence(L5_54) == A0_49.SEQ_1 then
      ...
      elseif A3_52 == A0_49.EOBJECT4 then
        if 1 <= A1_50:GetQuestUI8CL(L5_54) then
          return false
        end
