(function()
  print("GaiUsa604 loaded")
  function GaiUsa604.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsa604.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GaiUsa604_00766_BALAN_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GaiUsa604_00766_BALAN_000_001, true)
    A0_3:QuestAccepted()
  end
  function GaiUsa604.OnScene00002(A0_6, A1_7, A2_8)
  end
  function GaiUsa604.OnScene00003(A0_9, A1_10, A2_11)
    A0_9:ScenarioMessage(A0_9.TEXT_GaiUsa604_00766_POP_MESSAGE_000)
  end
  function GaiUsa604.OnScene00004(A0_12, A1_13, A2_14)
  end
  function GaiUsa604.OnScene00005(A0_15, A1_16, A2_17)
    A0_15:ScenarioMessage(A0_15.TEXT_GaiUsa604_00766_POP_MESSAGE_000)
  end
  function GaiUsa604.OnScene00006(A0_18, A1_19, A2_20)
  end
  function GaiUsa604.OnScene00007(A0_21, A1_22, A2_23)
    A0_21:ScenarioMessage(A0_21.TEXT_GaiUsa604_00766_POP_MESSAGE_000)
  end
  function GaiUsa604.OnScene00008(A0_24, A1_25, A2_26)
    local L3_27, L4_28
    L4_28 = A2_26
    L3_27 = A2_26.TurnTo
    ...
    L4_28 = A2_26
    L3_27 = A2_26.Talk
    L3_27(L4_28, A1_25, A0_24, A0_24.TEXT_GaiUsa604_00766_BALAN_000_010, true)
    L4_28 = A0_24
  ...
  function GaiUsa604.IsTodoChecked(A0_29, A1_30, A2_31)
    local L3_32
