(function()
  print("ClsAlc011 loaded")
  function ClsAlc011.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
    A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK2)
    A2_2:Talk(A1_1, A0_0, A0_0.TEXT_CLSALC011_00575_DEITRICH_000, true)
    if A0_0:QuestOffer(A2_2, A1_1) then
      A2_2:TurnTo(A1_1)
      A2_2:WaitForTurn()
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EMOTE_YES)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_CLSALC011_00575_DEITRICH_020, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK1)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_CLSALC011_00575_DEITRICH_021, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_CLSALC011_00575_DEITRICH_022, true)
      A0_0:QuestAccepted()
      return 1
    else
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EMOTE_NO)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_CLSALC011_00575_DEITRICH_010, true)
      return 0
    end
  end
  function ClsAlc011.OnScene00001(A0_3, A1_4, A2_5)
    ...
    L3_6 = A2_5.Talk
    L5_8 = A1_4
    L3_6(L4_7, L5_8, A0_3, A0_3.TEXT_CLSALC011_00575_SEVERIAN_000, false)
    L4_7 = A2_5
    L3_6 = A2_5.PlayActionTimeline
    ...
    L3_6 = A2_5.Talk
    L5_8 = A1_4
    L3_6(L4_7, L5_8, A0_3, A0_3.TEXT_CLSALC011_00575_SEVERIAN_001, true)
    L4_7 = A0_3
    L3_6 = A0_3.YesNo
    L5_8 = A0_3.TEXT_CLSALC011_00575_Q1_1
    L3_6 = L3_6(L4_7, L5_8, A0_3.TEXT_CLSALC011_00575_A1_1, A0_3.TEXT_CLSALC011_00575_A1_2, A0_3.DEFAULT_NO)
    if L3_6 == true then
      L5_8 = A2_5
      L4_7 = A2_5.PlayActionTimeline
      L4_7(L5_8, A0_3.ACTION_TIMELINE_EMOTE_ANGRY_STRONG)
      L5_8 = A2_5
      L4_7 = A2_5.Talk
      L4_7(L5_8, A1_4, A0_3, A0_3.TEXT_CLSALC011_00575_SEVERIAN_020, false)
      L5_8 = A2_5
      L4_7 = A2_5.Talk
      L4_7(L5_8, A1_4, A0_3, A0_3.TEXT_CLSALC011_00575_SEVERIAN_021, false)
      L5_8 = A2_5
      L4_7 = A2_5.PlayActionTimeline
      L4_7(L5_8, A0_3.ACTION_TIMELINE_EVENT_THINK)
      L5_8 = A2_5
      L4_7 = A2_5.Talk
      L4_7(L5_8, A1_4, A0_3, A0_3.TEXT_CLSALC011_00575_SEVERIAN_022, false)
      L5_8 = A2_5
      L4_7 = A2_5.Talk
      L4_7(L5_8, A1_4, A0_3, A0_3.TEXT_CLSALC011_00575_SEVERIAN_023, false)
      L5_8 = A2_5
      L4_7 = A2_5.PlayActionTimeline
      L4_7(L5_8, A0_3.ACTION_TIMELINE_EVENT_ITEM)
      L5_8 = A2_5
      L4_7 = A2_5.Talk
      L4_7(L5_8, A1_4, A0_3, A0_3.TEXT_CLSALC011_00575_SEVERIAN_024, true)
      L5_8 = A0_3
      L4_7 = A0_3.QuestReward
      L5_8 = L4_7(L5_8, A2_5, A1_4)
      if L4_7 then
        A0_3:QuestCompleted()
        A0_3:ScreenImage(A0_3.UNLOCK_IMAGE_CLASS_ALC)
      ...
      L5_8 = A2_5
      L4_7 = A2_5.Talk
      L4_7(L5_8, A1_4, A0_3, A0_3.TEXT_CLSALC011_00575_SEVERIAN_010, true)
    end
  end
  function ClsAlc011.IsTodoChecked(A0_9, A1_10, A2_11)
    local L3_12
