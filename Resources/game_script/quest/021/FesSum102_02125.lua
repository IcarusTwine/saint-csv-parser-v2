(function()
  print("FesSum102 loaded")
  function FesSum102.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function FesSum102.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    if A1_4:IsQuestCompleted(A0_3.QUEST0) ~= true then
      A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_GREETING)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESSUM102_02125_CZIBHOTIA_000_000, false)
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESSUM102_02125_CZIBHOTIA_000_001, false)
    end
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_FESSUM102_02125_CZIBHOTIA_000_002, true)
    A0_3:QuestAccepted()
  end
  function FesSum102.OnScene00002(A0_6, A1_7, A2_8)
  ...
  function FesSum102.OnScene00003(A0_16, A1_17, A2_18)
    local L3_19, L4_20
    L4_20 = A1_17
    ...
    if L3_19 ~= true then
      ...
      L4_20 = A2_18
      L3_19 = A2_18.Talk
      L3_19(L4_20, A1_17, A0_16, A0_16.TEXT_FESSUM102_02125_CZIBHOTIA_000_020, false)
      L4_20 = A2_18
      L3_19 = A2_18.Talk
      L3_19(L4_20, A1_17, A0_16, A0_16.TEXT_FESSUM102_02125_CZIBHOTIA_000_021, true)
    else
      L4_20 = A2_18
      L3_19 = A2_18.PlayActionTimeline
      L3_19(L4_20, A0_16.ACTION_TIMELINE_EVENT_TALK1)
  ...
  function FesSum102.IsTodoChecked(A0_21, A1_22, A2_23)
    local L3_24
