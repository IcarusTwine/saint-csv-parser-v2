(function()
  print("BanNam301 loaded")
  function BanNam301.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanNam301.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:LookAt(A1_4)
    A1_4:LookAt(A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANNAM301_03103_KOFUINSEIGETSU_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANNAM301_03103_KOFUINSEIGETSU_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANNAM301_03103_KOFUINSEIGETSU_000_002, true)
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanNam301.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_FACIAL_WORRY)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_THINK)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANNAM301_03103_DAILYNAMAZUO03103_000_010, true)
    A2_8:LookAt(A1_7)
    A1_7:LookAt(A2_8)
    ...
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANNAM301_03103_DAILYNAMAZUO03103_000_011, false)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_FACIAL_DEFAULT)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANNAM301_03103_DAILYNAMAZUO03103_000_012, false)
    A2_8:WaitForActionTimeline(A0_6.ACTION_TIMELINE_EVENT_SHOCKED)
    math.randomseed(os.time())
    if math.random(10000) % 3 == 0 then
      A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK_ANGRY)
      A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANNAM301_03103_DAILYNAMAZUO03103_000_013, false)
    ...
    elseif math.random(10000) % 3 == 1 then
      ...
      A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANNAM301_03103_DAILYNAMAZUO03103_000_014, false)
      A2_8:CancelActionTimeline(A0_6.ACTION_TIMELINE_EVENT_GREETING)
    else
      A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK2)
      A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANNAM301_03103_DAILYNAMAZUO03103_000_015, false)
      A2_8:CancelActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK2)
    end
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANNAM301_03103_DAILYNAMAZUO03103_000_016, false)
    ...
    if A0_6:GetQuestAcceptClassJob() == A0_6.CLASS_JOB_BLACKSMITH or A0_6:GetQuestAcceptClassJob() == A0_6.CLASS_JOB_ARMOURER or A0_6:GetQuestAcceptClassJob() == A0_6.CLASS_JOB_GOLDSMITH then
      A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANNAM301_03103_DAILYNAMAZUO03103_000_017, false)
    elseif A0_6:GetQuestAcceptClassJob() == A0_6.CLASS_JOB_WOODWORKER or A0_6:GetQuestAcceptClassJob() == A0_6.CLASS_JOB_TANNER or A0_6:GetQuestAcceptClassJob() == A0_6.CLASS_JOB_WEAVER then
      A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANNAM301_03103_DAILYNAMAZUO03103_000_018, false)
    elseif A0_6:GetQuestAcceptClassJob() == A0_6.CLASS_JOB_ALCHEMIST or A0_6:GetQuestAcceptClassJob() == A0_6.CLASS_JOB_CULINARIAN then
      A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANNAM301_03103_DAILYNAMAZUO03103_000_019, false)
    elseif A0_6:GetQuestAcceptClassJob() == A0_6.CLASS_JOB_MINER then
      A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANNAM301_03103_DAILYNAMAZUO03103_000_020, false)
    elseif A0_6:GetQuestAcceptClassJob() == A0_6.CLASS_JOB_HARVESTER then
      A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANNAM301_03103_DAILYNAMAZUO03103_000_021, false)
    elseif A0_6:GetQuestAcceptClassJob() == A0_6.CLASS_JOB_FISHERMAN then
      A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANNAM301_03103_DAILYNAMAZUO03103_000_022, false)
    else
      A0_6:CancelEventScene()
    end
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_GREETING)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANNAM301_03103_DAILYNAMAZUO03103_000_023, true)
    A2_8:CancelActionTimeline(A0_6.ACTION_TIMELINE_EVENT_GREETING)
  end
  function BanNam301.OnScene00003(A0_9, A1_10, A2_11)
    if A0_9:GetQuestAcceptClassJob() == A0_9.CLASS_JOB_BLACKSMITH or A0_9:GetQuestAcceptClassJob() == A0_9.CLASS_JOB_ARMOURER or A0_9:GetQuestAcceptClassJob() == A0_9.CLASS_JOB_GOLDSMITH then
      A0_9:SystemTalk(A0_9.TEXT_BANNAM301_03103_SYSTEM_000_027, true)
    elseif A0_9:GetQuestAcceptClassJob() == A0_9.CLASS_JOB_WOODWORKER or A0_9:GetQuestAcceptClassJob() == A0_9.CLASS_JOB_TANNER or A0_9:GetQuestAcceptClassJob() == A0_9.CLASS_JOB_WEAVER then
      A0_9:SystemTalk(A0_9.TEXT_BANNAM301_03103_SYSTEM_000_028, true)
    elseif A0_9:GetQuestAcceptClassJob() == A0_9.CLASS_JOB_ALCHEMIST or A0_9:GetQuestAcceptClassJob() == A0_9.CLASS_JOB_CULINARIAN then
      A0_9:SystemTalk(A0_9.TEXT_BANNAM301_03103_SYSTEM_000_029, true)
    elseif A0_9:GetQuestAcceptClassJob() == A0_9.CLASS_JOB_MINER or A0_9:GetQuestAcceptClassJob() == A0_9.CLASS_JOB_HARVESTER or A0_9:GetQuestAcceptClassJob() == A0_9.CLASS_JOB_FISHERMAN then
      A0_9:SystemTalk(A0_9.TEXT_BANNAM301_03103_SYSTEM_000_030, true)
    else
      A0_9:CancelEventScene()
    end
  end
  function BanNam301.OnScene00004(A0_12, A1_13, A2_14)
  ...
  function BanNam301.OnScene00005(A0_27, A1_28, A2_29)
    ...
    A2_29:Talk(A1_28, A0_27, A0_27.TEXT_BANNAM301_03103_DAILYNAMAZUO03103_000_041, false)
    A2_29:Talk(A1_28, A0_27, A0_27.TEXT_BANNAM301_03103_DAILYNAMAZUO03103_000_042, true)
  end
  function BanNam301.OnScene00006(A0_30, A1_31, A2_32)
    if A0_30:GetQuestAcceptClassJob() == A0_30.CLASS_JOB_BLACKSMITH or A0_30:GetQuestAcceptClassJob() == A0_30.CLASS_JOB_ARMOURER or A0_30:GetQuestAcceptClassJob() == A0_30.CLASS_JOB_GOLDSMITH then
      if 2 > A1_31:GetNumOfItems(A0_30.QST_PRODUCT_ITEM, A0_30.NUM_OF_ITEMS_FILTER_NQ_OR_HQ, false, true) and A1_31:GetNumOfItems(A0_30.RITEM1) == 0 then
        A0_30:SystemTalk(A0_30.TEXT_BANNAM301_03103_SYSTEM_000_031, true)
      else
        A0_30:SystemTalk(A0_30.TEXT_BANNAM301_03103_SYSTEM_000_027, true)
    ...
    elseif A0_30:GetQuestAcceptClassJob() == A0_30.CLASS_JOB_WOODWORKER or A0_30:GetQuestAcceptClassJob() == A0_30.CLASS_JOB_TANNER or A0_30:GetQuestAcceptClassJob() == A0_30.CLASS_JOB_WEAVER then
      if 2 > A1_31:GetNumOfItems(A0_30.QST_PRODUCT_ITEM, A0_30.NUM_OF_ITEMS_FILTER_NQ_OR_HQ, false, true) and A1_31:GetNumOfItems(A0_30.RITEM1) == 0 then
        A0_30:SystemTalk(A0_30.TEXT_BANNAM301_03103_SYSTEM_000_032, true)
      else
        A0_30:SystemTalk(A0_30.TEXT_BANNAM301_03103_SYSTEM_000_028, true)
        A0_30:CancelEventScene()
      end
    elseif A0_30:GetQuestAcceptClassJob() == A0_30.CLASS_JOB_ALCHEMIST or A0_30:GetQuestAcceptClassJob() == A0_30.CLASS_JOB_CULINARIAN then
      if 2 > A1_31:GetNumOfItems(A0_30.QST_PRODUCT_ITEM, A0_30.NUM_OF_ITEMS_FILTER_NQ_OR_HQ, false, true) and A1_31:GetNumOfItems(A0_30.RITEM1) == 0 then
        A0_30:SystemTalk(A0_30.TEXT_BANNAM301_03103_SYSTEM_000_033, true)
      else
        A0_30:SystemTalk(A0_30.TEXT_BANNAM301_03103_SYSTEM_000_029, true)
        A0_30:CancelEventScene()
      end
    else
      if A0_30:GetQuestAcceptClassJob() == A0_30.CLASS_JOB_MINER or A0_30:GetQuestAcceptClassJob() == A0_30.CLASS_JOB_HARVESTER or A0_30:GetQuestAcceptClassJob() == A0_30.CLASS_JOB_FISHERMAN then
        A0_30:SystemTalk(A0_30.TEXT_BANNAM301_03103_SYSTEM_000_030, true)
      end
      A0_30:CancelEventScene()
    end
  end
  function BanNam301.OnScene00007(A0_33, A1_34, A2_35)
    local L3_36, L4_37
    L4_37 = A2_35
    L3_36 = A2_35.LookAt
    L3_36(L4_37, A1_34)
    ...
    L4_37 = A2_35
    L3_36 = A2_35.Talk
    L3_36(L4_37, A1_34, A0_33, A0_33.TEXT_BANNAM301_03103_KOFUINSEIGETSU_100_050, true)
    L4_37 = A1_34
    ...
    L4_37 = A2_35
    L3_36 = A2_35.Talk
    L3_36(L4_37, A1_34, A0_33, A0_33.TEXT_BANNAM301_03103_KOFUINSEIGETSU_000_050, false)
    L4_37 = A2_35
    L3_36 = A2_35.Talk
    L3_36(L4_37, A1_34, A0_33, A0_33.TEXT_BANNAM301_03103_KOFUINSEIGETSU_000_051, false)
    L4_37 = A2_35
    L3_36 = A2_35.Talk
    L3_36(L4_37, A1_34, A0_33, A0_33.TEXT_BANNAM301_03103_KOFUINSEIGETSU_000_052, true)
    L4_37 = A0_33
  ...
  function BanNam301.OnScene00008(A0_38, A1_39, A2_40)
    A2_40:LookAt(A1_39)
    A1_39:LookAt(A2_40)
    A2_40:TurnTo(A1_39, false)
    A2_40:WaitForTurn()
    A2_40:PlayActionTimeline(A0_38.ACTION_TIMELINE_EVENT_TALK1)
    A2_40:Talk(A1_39, A0_38, A0_38.TEXT_BANNAM301_03103_DAILYNAMAZUO03103_000_043, true)
  end
  function BanNam301.OnScene00009(A0_41, A1_42, A2_43)
    if A0_41:GetQuestAcceptClassJob() == A0_41.CLASS_JOB_BLACKSMITH or A0_41:GetQuestAcceptClassJob() == A0_41.CLASS_JOB_ARMOURER or A0_41:GetQuestAcceptClassJob() == A0_41.CLASS_JOB_GOLDSMITH then
      A0_41:SystemTalk(A0_41.TEXT_BANNAM301_03103_SYSTEM_000_027, true)
    elseif A0_41:GetQuestAcceptClassJob() == A0_41.CLASS_JOB_WOODWORKER or A0_41:GetQuestAcceptClassJob() == A0_41.CLASS_JOB_TANNER or A0_41:GetQuestAcceptClassJob() == A0_41.CLASS_JOB_WEAVER then
      A0_41:SystemTalk(A0_41.TEXT_BANNAM301_03103_SYSTEM_000_028, true)
    elseif A0_41:GetQuestAcceptClassJob() == A0_41.CLASS_JOB_ALCHEMIST or A0_41:GetQuestAcceptClassJob() == A0_41.CLASS_JOB_CULINARIAN then
      A0_41:SystemTalk(A0_41.TEXT_BANNAM301_03103_SYSTEM_000_029, true)
    elseif A0_41:GetQuestAcceptClassJob() == A0_41.CLASS_JOB_MINER or A0_41:GetQuestAcceptClassJob() == A0_41.CLASS_JOB_HARVESTER or A0_41:GetQuestAcceptClassJob() == A0_41.CLASS_JOB_FISHERMAN then
      A0_41:SystemTalk(A0_41.TEXT_BANNAM301_03103_SYSTEM_000_030, true)
    else
      A0_41:CancelEventScene()
    end
  end
  function BanNam301.IsTodoChecked(A0_44, A1_45, A2_46)
    local L3_47
...
;(function()
  ...
  function L1_49(A0_64, A1_65, A2_66)
    ...
    elseif A2_66 == 1 then
      return A1_65:GetNumOfItems(A0_64.RITEM0, A0_64.NUM_OF_ITEMS_FILTER_NQ_AND_HQ, false, true), 1, A0_64.RITEM0, false
    elseif A2_66 == 2 then
      return A1_65:GetQuestUI8AL(L3_67), 0
    end
  end
  ...
  function L1_49(A0_72, A1_73, A2_74, A3_75, A4_76, A5_77, A6_78)
    ...
    elseif A1_73:GetQuestSequence(L7_79) == A0_72.SEQ_2 then
      if A3_75 == A0_72.ACTOR1 and A1_73:GetNumOfItems(A0_72.RITEM0, A0_72.NUM_OF_ITEMS_FILTER_NQ_AND_HQ, false, true) < 1 then
