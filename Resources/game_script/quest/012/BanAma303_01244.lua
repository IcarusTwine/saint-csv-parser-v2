(function()
  print("BanAma303 loaded")
  function BanAma303.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanAma303.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANAMA303_01244_YADOVVGAH_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANAMA303_01244_YADOVVGAH_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANAMA303_01244_YADOVVGAH_000_002, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANAMA303_01244_YADOVVGAH_000_003, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANAMA303_01244_YADOVVGAH_000_004, true)
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanAma303.OnScene00002(A0_6, A1_7, A2_8)
  end
  function BanAma303.OnScene00003(A0_9, A1_10, A2_11)
  end
  function BanAma303.OnScene00004(A0_12, A1_13, A2_14)
  end
  function BanAma303.OnScene00005(A0_15, A1_16, A2_17)
  end
  function BanAma303.OnScene00006(A0_18, A1_19, A2_20)
  end
  function BanAma303.OnScene00007(A0_21, A1_22, A2_23)
  end
  function BanAma303.OnScene00008(A0_24, A1_25, A2_26)
  end
  function BanAma303.OnScene00009(A0_27, A1_28, A2_29)
  end
  function BanAma303.OnScene00010(A0_30, A1_31, A2_32)
  end
  function BanAma303.OnScene00011(A0_33, A1_34, A2_35)
  end
  function BanAma303.OnScene00012(A0_36, A1_37, A2_38)
  end
  function BanAma303.OnScene00013(A0_39, A1_40, A2_41)
  end
  function BanAma303.OnScene00014(A0_42, A1_43, A2_44)
  end
  function BanAma303.OnScene00015(A0_45, A1_46, A2_47)
  end
  function BanAma303.OnScene00016(A0_48, A1_49, A2_50)
  end
  function BanAma303.OnScene00017(A0_51, A1_52, A2_53)
  end
  function BanAma303.OnScene00018(A0_54, A1_55, A2_56)
    A2_56:TurnTo(A1_55, false)
    A2_56:WaitForTurn()
    A2_56:PlayActionTimeline(A0_54.ACTION_TIMELINE_EVENT_TALK1)
    A2_56:Talk(A1_55, A0_54, A0_54.TEXT_BANAMA303_01244_YADOVVGAH_000_010, true)
  end
  function BanAma303.OnScene00019(A0_57, A1_58, A2_59)
    ...
    L5_62(L6_63, L7_64)
    L5_62 = A2_59.Talk
    L9_66 = A0_57.TEXT_BANAMA303_01244_YADOVVGAH_000_020
  ...
  function BanAma303.OnScene00020(A0_67, A1_68, A2_69)
    local L3_70, L4_71
    L4_71 = A2_69
    ...
    L4_71 = A2_69
    L3_70 = A2_69.Talk
    L3_70(L4_71, A1_68, A0_67, A0_67.TEXT_BANAMA303_01244_YADOVVGAH_000_021, false)
    L4_71 = A2_69
    L3_70 = A2_69.Talk
    L3_70(L4_71, A1_68, A0_67, A0_67.TEXT_BANAMA303_01244_YADOVVGAH_000_022, true)
    L4_71 = A0_67
  ...
  function BanAma303.GetEventItems(A0_72, A1_73)
    local L2_74
  ...
  function BanAma303.IsTodoChecked(A0_75, A1_76, A2_77)
    local L3_78
