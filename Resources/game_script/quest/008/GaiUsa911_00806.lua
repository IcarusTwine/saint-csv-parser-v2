(function()
  print("GaiUsa911 loaded")
  function GaiUsa911.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsa911.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:LookAt(A1_4)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_NO, A1_4)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA911_00806_HOBRIAUT_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA911_00806_HOBRIAUT_000_001, true)
    A0_3:QuestAccepted()
  end
  function GaiUsa911.OnScene00002(A0_6, A1_7, A2_8)
  end
  function GaiUsa911.OnScene00003(A0_9, A1_10, A2_11)
  end
  function GaiUsa911.OnScene00004(A0_12, A1_13, A2_14)
  end
  function GaiUsa911.OnScene00005(A0_15, A1_16, A2_17)
  end
  function GaiUsa911.OnScene00006(A0_18, A1_19, A2_20)
  end
  function GaiUsa911.OnScene00007(A0_21, A1_22, A2_23)
  end
  function GaiUsa911.OnScene00008(A0_24, A1_25, A2_26)
    ...
    L5_29 = A0_24.ACTION_TIMELINE_EVENT_ADD_NO
  ...
  function GaiUsa911.OnScene00009(A0_34, A1_35, A2_36)
    local L3_37, L4_38
    L4_38 = A2_36
    L3_37 = A2_36.LookAt
    L3_37(L4_38, A1_35)
    ...
    L4_38 = A2_36
    L3_37 = A2_36.Talk
    L3_37(L4_38, A1_35, A0_34, A0_34.TEXT_GAIUSA911_00806_HOBRIAUT_000_020, false)
    L4_38 = A2_36
    L3_37 = A2_36.Talk
    L3_37(L4_38, A1_35, A0_34, A0_34.TEXT_GAIUSA911_00806_HOBRIAUT_000_021, true)
    L4_38 = A0_34
  ...
  function GaiUsa911.GetEventItems(A0_39, A1_40)
    local L2_41
  ...
  function GaiUsa911.IsTodoChecked(A0_42, A1_43, A2_44)
    local L3_45
