(function()
  print("GaiUsa310 loaded")
  function GaiUsa310.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsa310.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA310_00742_AUPHILIOT_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA310_00742_AUPHILIOT_000_001, true)
    A0_3:QuestAccepted()
  end
  function GaiUsa310.OnScene00002(A0_6, A1_7, A2_8)
  end
  function GaiUsa310.OnScene00003(A0_9, A1_10, A2_11)
    A0_9:ScenarioMessage(A0_9.TEXT_GAIUSA310_00742_POP_MESSAGE_000)
  end
  function GaiUsa310.OnScene00004(A0_12, A1_13, A2_14)
  end
  function GaiUsa310.OnScene00005(A0_15, A1_16, A2_17)
    A0_15:ScenarioMessage(A0_15.TEXT_GAIUSA310_00742_POP_MESSAGE_000)
  end
  function GaiUsa310.OnScene00006(A0_18, A1_19, A2_20)
    local L3_21, L4_22
    L4_22 = A2_20
    L3_21 = A2_20.LookAt
    L3_21(L4_22, A1_19)
    ...
    L4_22 = A2_20
    L3_21 = A2_20.Talk
    L3_21(L4_22, A1_19, A0_18, A0_18.TEXT_GAIUSA310_00742_AUPHILIOT_000_010, false)
    L4_22 = A2_20
    L3_21 = A2_20.Talk
    L3_21(L4_22, A1_19, A0_18, A0_18.TEXT_GAIUSA310_00742_AUPHILIOT_000_011, true)
    L4_22 = A0_18
  ...
  function GaiUsa310.IsTodoChecked(A0_23, A1_24, A2_25)
    local L3_26
