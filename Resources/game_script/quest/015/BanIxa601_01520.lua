(function()
  print("BanIxa601 loaded")
  function BanIxa601.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
    A0_0:SystemTalk(A0_0.TEXT_BANIXA601_01520_SYSTEM_000_900, true)
  ...
  function BanIxa601.OnScene00001(A0_3, A1_4, A2_5)
    ...
    if A1_4:GetClassJob() == A0_3.CLASS_JOB_BLACKSMITH or A1_4:GetClassJob() == A0_3.CLASS_JOB_ARMOURER or A1_4:GetClassJob() == A0_3.CLASS_JOB_GOLDSMITH then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA601_01520_JEZULAHUATAN_000_010, true)
    elseif A1_4:GetClassJob() == A0_3.CLASS_JOB_ALCHEMIST or A1_4:GetClassJob() == A0_3.CLASS_JOB_CULINARIAN then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA601_01520_JEZULAHUATAN_000_020, true)
    elseif A1_4:GetClassJob() == A0_3.CLASS_JOB_WOODWORKER or A1_4:GetClassJob() == A0_3.CLASS_JOB_TANNER or A1_4:GetClassJob() == A0_3.CLASS_JOB_WEAVER then
      A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA601_01520_JEZULAHUATAN_000_030, true)
    end
    A0_3:Wait(10)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA601_01520_JEZULAHUATAN_000_040, false, A0_3.TALK_SHAPE_EMPHASIS)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANIXA601_01520_JEZULAHUATAN_000_041, true, A0_3.TALK_SHAPE_EMPHASIS)
    A0_3:QuestAccepted(A0_3.SCREEN_IMAGE_BEAST_QUEST_ACCEPTED)
  end
  function BanIxa601.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7, false)
    A2_8:WaitForTurn()
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_BANIXA601_01520_JEZULAHUATAN_000_050, true, A0_6.TALK_SHAPE_EMPHASIS)
  end
  function BanIxa601.OnScene00003(A0_9, A1_10, A2_11)
  ...
  function BanIxa601.OnScene00004(A0_19, A1_20, A2_21)
    A2_21:PlayActionTimeline(A0_19.ACTION_TIMELINE_EVENT_ITEM)
    A2_21:Talk(A1_20, A0_19, A0_19.TEXT_BANIXA601_01520_FISHER01520_000_071, false)
    A2_21:Talk(A1_20, A0_19, A0_19.TEXT_BANIXA601_01520_FISHER01520_000_072, true)
  end
  function BanIxa601.OnScene00005(A0_22, A1_23, A2_24)
    A2_24:TurnTo(A1_23, false)
    A2_24:WaitForTurn()
    A2_24:PlayActionTimeline(A0_22.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_24:Talk(A1_23, A0_22, A0_22.TEXT_BANIXA601_01520_JEZULAHUATAN_000_050, true, A0_22.TALK_SHAPE_EMPHASIS)
  end
  function BanIxa601.OnScene00006(A0_25, A1_26, A2_27)
  ...
  function BanIxa601.OnScene00007(A0_35, A1_36, A2_37)
    A2_37:PlayActionTimeline(A0_35.ACTION_TIMELINE_EVENT_ITEM)
    A2_37:Talk(A1_36, A0_35, A0_35.TEXT_BANIXA601_01520_NORBETTAUX_000_091, false)
    A2_37:Talk(A1_36, A0_35, A0_35.TEXT_BANIXA601_01520_NORBETTAUX_000_092, true)
    A0_35:Wait(10)
    A0_35:ScenarioMessage(A0_35.TEXT_BANIXA601_01520_POPMESSAGE_000_200)
    A0_35:Wait(10)
  end
  function BanIxa601.OnScene00008(A0_38, A1_39, A2_40)
    A2_40:TurnTo(A1_39, false)
    A2_40:WaitForTurn()
    A2_40:PlayActionTimeline(A0_38.ACTION_TIMELINE_EVENT_TALK2)
    A2_40:Talk(A1_39, A0_38, A0_38.TEXT_BANIXA601_01520_FISHER01520_000_080, true)
  end
  function BanIxa601.OnScene00009(A0_41, A1_42, A2_43)
    A2_43:TurnTo(A1_42, false)
    A2_43:WaitForTurn()
    A2_43:PlayActionTimeline(A0_41.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_43:Talk(A1_42, A0_41, A0_41.TEXT_BANIXA601_01520_JEZULAHUATAN_000_050, true, A0_41.TALK_SHAPE_EMPHASIS)
  end
  function BanIxa601.OnScene00010(A0_44, A1_45, A2_46)
  ...
  function BanIxa601.OnScene00011(A0_54, A1_55, A2_56)
    local L3_57, L4_58
    L4_58 = A2_56
    ...
    L4_58 = A2_56
    L3_57 = A2_56.Talk
    L3_57(L4_58, A1_55, A0_54, A0_54.TEXT_BANIXA601_01520_JEZULAHUATAN_000_131, true, A0_54.TALK_SHAPE_EMPHASIS)
    L4_58 = A0_54
    L3_57 = A0_54.Wait
    L3_57(L4_58, 20)
    L4_58 = A1_55
    ...
    if L3_57 >= 1 then
      ...
      L3_57(L4_58, A0_54.TEXT_BANIXA601_01520_SYSTEM_200_200, true)
    end
    L4_58 = A0_54
  ...
  function BanIxa601.OnScene00012(A0_59, A1_60, A2_61)
    A2_61:TurnTo(A1_60, false)
    A2_61:WaitForTurn()
    A2_61:PlayActionTimeline(A0_59.ACTION_TIMELINE_EVENT_GREETING)
    if A1_60:GetNumOfHqItems(A0_59.RITEM1) >= 1 then
      A2_61:Talk(A1_60, A0_59, A0_59.TEXT_BANIXA601_01520_NORBETTAUX_100_100, true)
      A0_59:CancelEventScene()
    else
      A2_61:Talk(A1_60, A0_59, A0_59.TEXT_BANIXA601_01520_NORBETTAUX_000_100, true)
      A0_59:Wait(10)
      A0_59:ScenarioMessage(A0_59.TEXT_BANIXA601_01520_POPMESSAGE_000_200)
      A0_59:Wait(10)
    end
  end
  function BanIxa601.OnScene00013(A0_62, A1_63, A2_64)
    A2_64:TurnTo(A1_63, false)
    A2_64:WaitForTurn()
    A2_64:PlayActionTimeline(A0_62.ACTION_TIMELINE_EVENT_TALK2)
    A2_64:Talk(A1_63, A0_62, A0_62.TEXT_BANIXA601_01520_FISHER01520_000_080, true)
  end
  function BanIxa601.GetEventItems(A0_65, A1_66)
    local L2_67
    ...
    elseif A1_66:GetQuestSequence(L2_67) == A0_65.SEQ_2 then
      return A0_65.ITEM0, A1_66:GetQuestUI8BH(L2_67), false, A0_65.ITEM1, A1_66:GetQuestUI8BL(L2_67), false
    elseif A1_66:GetQuestSequence(L2_67) == A0_65.SEQ_3 then
      return A0_65.ITEM1, A1_66:GetQuestUI8BH(L2_67), false
    else
    end
  end
  function BanIxa601.IsTodoChecked(A0_68, A1_69, A2_70)
    local L3_71
...
;(function()
  ...
  function L1_73(A0_88, A1_89, A2_90)
    ...
    elseif A2_90 == 2 then
      return A1_89:GetQuestUI8AL(L3_91), 0
    elseif A2_90 == 3 then
      return A1_89:GetNumOfItems(A0_88.RITEM1, A0_88.NUM_OF_ITEMS_FILTER_HQ, false, true), 1
    end
  end
  ...
  function L1_73(A0_96, A1_97, A2_98, A3_99, A4_100, A5_101, A6_102)
    ...
    elseif A1_97:GetQuestSequence(L7_103) == A0_96.SEQ_FINISH and A3_99 == A0_96.ACTOR0 and A1_97:GetNumOfItems(A0_96.RITEM1, A0_96.NUM_OF_ITEMS_FILTER_HQ, false, true) < 1 then
