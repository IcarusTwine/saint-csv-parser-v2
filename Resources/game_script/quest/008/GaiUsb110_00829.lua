(function()
  print("GaiUsb110 loaded")
  function GaiUsb110.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsb110.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_GREETING)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB110_00829_UTYKHATIA_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB110_00829_UTYKHATIA_000_001, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EMOTE_PSYCH)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB110_00829_UTYKHATIA_000_002, true)
    A0_3:QuestAccepted()
  end
  function GaiUsb110.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_GAIUSB110_00829_UKAHZUNA_000_020, true)
  end
  function GaiUsb110.OnScene00003(A0_9, A1_10, A2_11)
    A2_11:Talk(A1_10, A0_9, A0_9.TEXT_GAIUSB110_00829_UKAHZUNA_000_020, true)
  end
  function GaiUsb110.OnScene00004(A0_12, A1_13, A2_14)
    A2_14:TurnTo(0, false)
    A2_14:LookAt(A1_13)
    A2_14:PlayActionTimeline(A0_12.ACTION_TIMELINE_EVENT_TALK2)
    A2_14:Talk(A1_13, A0_12, A0_12.TEXT_GAIUSB110_00829_UKAHZUNA_000_021, true)
    A2_14:LookAt()
    A2_14:WalkOut(-110, 5, A0_12.MOVE_RUN)
    A0_12:Wait(0)
    A2_14:Transparency(A0_12.TRANS_TYPE_FADE_OUT, 30)
    A2_14:WaitForTransparency()
  end
  function GaiUsb110.OnScene00005(A0_15, A1_16, A2_17)
  end
  function GaiUsb110.OnScene00006(A0_18, A1_19, A2_20)
    local L3_21, L4_22
    L4_22 = A2_20
    L3_21 = A2_20.TurnTo
    ...
    L4_22 = A2_20
    L3_21 = A2_20.Talk
    L3_21(L4_22, A1_19, A0_18, A0_18.TEXT_GAIUSB110_00829_UTYKHATIA_000_030, false)
    L4_22 = A2_20
    L3_21 = A2_20.PlayActionTimeline
    L3_21(L4_22, A0_18.ACTION_TIMELINE_EMOTE_ANGRY)
    L4_22 = A2_20
    L3_21 = A2_20.Talk
    L3_21(L4_22, A1_19, A0_18, A0_18.TEXT_GAIUSB110_00829_UTYKHATIA_000_031, true)
    L4_22 = A0_18
  ...
  function GaiUsb110.IsTodoChecked(A0_23, A1_24, A2_25)
    local L3_26
...
;(function()
  ...
  function L1_28(A0_31, A1_32, A2_33, A3_34, A4_35)
    ...
    if A1_32:GetQuestSequence(L5_36) == A0_31.SEQ_1 then
      if A3_34 == A0_31.ENEMY0 or A3_34 == A0_31.ENEMY1 or A3_34 == A0_31.ENEMY2 then
  ...
  function L1_28(A0_37, A1_38, A2_39, A3_40, A4_41)
    ...
    if A1_38:GetQuestSequence(L5_42) == A0_37.SEQ_1 then
      if A3_40 == A0_37.ENEMY0 or A3_40 == A0_37.ENEMY1 or A3_40 == A0_37.ENEMY2 then
