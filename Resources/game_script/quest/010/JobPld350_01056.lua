(function()
  print("JobPld350 loaded")
  function JobPld350.OnScene00000(A0_0, A1_1, A2_2)
  ...
  function JobPld350.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EMOTE_WELCOME)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBPLD350_01056_JENLYNS_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBPLD350_01056_JENLYNS_000_001, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBPLD350_01056_JENLYNS_000_002, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_THINK)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBPLD350_01056_JENLYNS_000_003, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBPLD350_01056_JENLYNS_000_004, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBPLD350_01056_JENLYNS_000_005, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_NO)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBPLD350_01056_JENLYNS_000_006, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBPLD350_01056_JENLYNS_000_007, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBPLD350_01056_JENLYNS_000_008, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EMOTE_FUME)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBPLD350_01056_JENLYNS_000_009, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBPLD350_01056_JENLYNS_000_010, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBPLD350_01056_JENLYNS_000_11, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBPLD350_01056_JENLYNS_000_12, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_YES)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBPLD350_01056_JENLYNS_000_13, true)
    A0_3:QuestAccepted()
  end
  function JobPld350.OnScene00002(A0_6, A1_7, A2_8)
  end
  function JobPld350.OnScene00003(A0_9, A1_10, A2_11)
    A0_9:ScenarioMessage(A0_9.TEXT_JOBPLD350_01056_POP_MESSAGE)
  end
  function JobPld350.OnScene00004(A0_12, A1_13, A2_14)
    local L3_15, L4_16
    L4_16 = A2_14
    L3_15 = A2_14.TurnTo
    ...
    L4_16 = A2_14
    L3_15 = A2_14.Talk
    L3_15(L4_16, A1_13, A0_12, A0_12.TEXT_JOBPLD350_01056_JENLYNS_000_20, false)
    L4_16 = A2_14
    ...
    L4_16 = A2_14
    L3_15 = A2_14.Talk
    L3_15(L4_16, A1_13, A0_12, A0_12.TEXT_JOBPLD350_01056_JENLYNS_000_21, true)
    L4_16 = A0_12
  ...
  function JobPld350.OnScene00005(A0_17, A1_18, A2_19, ...)
    local L4_21
    L4_21 = (...)
    A1_18:LookAt()
  ...
  function JobPld350.OnScene00006(A0_22, A1_23, A2_24)
  end
  function JobPld350.OnScene00007(A0_25, A1_26, A2_27)
  end
  function JobPld350.IsTodoChecked(A0_28, A1_29, A2_30)
    local L3_31
