(function()
  print("GaiUsb713 loaded")
  function GaiUsb713.OnScene00000(A0_0, A1_1, A2_2)
  ...
  function GaiUsb713.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB713_00908_MIAHMOLKOT_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EMOTE_NO)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB713_00908_MIAHMOLKOT_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB713_00908_MIAHMOLKOT_000_002, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ITEM)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB713_00908_MIAHMOLKOT_000_003, true)
    A0_3:QuestAccepted()
  end
  function GaiUsb713.OnScene00002(A0_6, A1_7, A2_8)
    A0_6:Inventory(true)
  end
  function GaiUsb713.OnScene00003(A0_9, A1_10, A2_11)
    if A0_9:IsBattleNpcOwner(A1_10, true) == false and A0_9:IsBattleNpcTriggerOwner(A1_10, A2_11, false) == false then
      A0_9:Wait(15)
      A2_11:PlayQuestGimmickReaction()
      A0_9:ScenarioMessage(A0_9.TEXT_GAIUSB713_00908_POP_MESSAGE_000)
    end
  end
  function GaiUsb713.OnScene00004(A0_12, A1_13, A2_14)
    local L3_15, L4_16
    L4_16 = A2_14
    L3_15 = A2_14.TurnTo
    ...
    L4_16 = A2_14
    L3_15 = A2_14.Talk
    L3_15(L4_16, A1_13, A0_12, A0_12.TEXT_GAIUSB713_00908_MIAHMOLKOT_000_040, false)
    L4_16 = A2_14
    L3_15 = A2_14.PlayActionTimeline
    L3_15(L4_16, A0_12.ACTION_TIMELINE_EVENT_ADD_YES)
    L4_16 = A2_14
    L3_15 = A2_14.Talk
    L3_15(L4_16, A1_13, A0_12, A0_12.TEXT_GAIUSB713_00908_MIAHMOLKOT_000_041, true)
    L4_16 = A0_12
  ...
  function GaiUsb713.GetEventItems(A0_17, A1_18)
    local L2_19
  ...
  function GaiUsb713.IsTodoChecked(A0_20, A1_21, A2_22)
    local L3_23
...
;(function()
  ...
  function L1_25(A0_40, A1_41, A2_42, A3_43)
    ...
    L4_44 = L4_44(A0_40)
    if A1_41:GetQuestSequence(L4_44) == A0_40.SEQ_1 and (A2_42:GetBaseId() == A0_40.EOBJECT0 or A2_42:GetBaseId() == A0_40.ENEMY0 or A2_42:GetBaseId() == A0_40.ENEMY1 or A2_42:GetBaseId() == A0_40.ENEMY2) and A3_43 == A0_40.ITEM0 then
      return true
    end
    return false
  end
