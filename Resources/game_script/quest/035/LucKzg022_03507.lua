(function()
  print("LucKzg022 loaded")
  function LucKzg022.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function LucKzg022.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZG022_03507_DALRIC_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZG022_03507_DALRIC_000_001, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_NO)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZG022_03507_DALRIC_000_002, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZG022_03507_DALRIC_000_003, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZG022_03507_DALRIC_000_004, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZG022_03507_DALRIC_000_005, true)
    A0_3:QuestAccepted()
  end
  function LucKzg022.OnScene00002(A0_6, A1_7, A2_8)
  end
  function LucKzg022.OnScene00003(A0_9, A1_10, A2_11)
    if A0_9:IsBattleNpcOwner(A1_10, true) == true or A0_9:IsBattleNpcTriggerOwner(A1_10, A2_11, false) == true then
    else
      A0_9:LogMessage(A0_9.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function LucKzg022.OnScene00004(A0_12, A1_13, A2_14)
  end
  function LucKzg022.OnScene00005(A0_15, A1_16, A2_17)
    if A0_15:IsBattleNpcOwner(A1_16, true) == true or A0_15:IsBattleNpcTriggerOwner(A1_16, A2_17, false) == true then
    else
      A0_15:LogMessage(A0_15.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function LucKzg022.OnScene00006(A0_18, A1_19, A2_20)
  end
  function LucKzg022.OnScene00007(A0_21, A1_22, A2_23)
    if A0_21:IsBattleNpcOwner(A1_22, true) == true or A0_21:IsBattleNpcTriggerOwner(A1_22, A2_23, false) == true then
    else
      A0_21:LogMessage(A0_21.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function LucKzg022.OnScene00008(A0_24, A1_25, A2_26)
  end
  function LucKzg022.OnScene00009(A0_27, A1_28, A2_29)
    if A0_27:IsBattleNpcOwner(A1_28, true) == true or A0_27:IsBattleNpcTriggerOwner(A1_28, A2_29, false) == true then
    else
      A0_27:LogMessage(A0_27.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function LucKzg022.OnScene00010(A0_30, A1_31, A2_32)
    A2_32:TurnTo(A1_31, false)
    A2_32:WaitForTurn()
    A2_32:PlayActionTimeline(A0_30.ACTION_TIMELINE_EVENT_TALK1)
    A2_32:Talk(A1_31, A0_30, A0_30.TEXT_LUCKZG022_03507_DALRIC_000_010, true)
  end
  function LucKzg022.OnScene00011(A0_33, A1_34, A2_35)
  ...
  function LucKzg022.OnScene00012(A0_43, A1_44, A2_45)
    local L3_46, L4_47
    L4_47 = A1_44
    ...
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_LUCKZG022_03507_DALRIC_000_021, false)
    L4_47 = A2_45
    L3_46 = A2_45.PlayActionTimeline
    L3_46(L4_47, A0_43.ACTION_TIMELINE_EVENT_HAND_CHEST, nil, A0_43.AUTO_SHAKE_ENABLE)
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_LUCKZG022_03507_DALRIC_000_022, false)
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_LUCKZG022_03507_DALRIC_000_023, true)
    L4_47 = A2_45
    ...
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_LUCKZG022_03507_DALRIC_000_024, true)
    L4_47 = A0_43
  ...
  function LucKzg022.GetEventItems(A0_48, A1_49)
    local L2_50
  ...
  function LucKzg022.IsTodoChecked(A0_51, A1_52, A2_53)
    local L3_54
  ...
  function L1_56(A0_59, A1_60, A2_61, A3_62, A4_63)
    ...
    if A1_60:GetQuestSequence(L5_64) == A0_59.SEQ_1 then
      ...
      elseif A4_63 == A0_59.ENEMY0 then
        return 3 > A1_60:GetQuestUI8AL(L5_64)
  ...
  function L1_56(A0_65, A1_66, A2_67, A3_68, A4_69)
    ...
    if A1_66:GetQuestSequence(L5_70) == A0_65.SEQ_1 then
      ...
      elseif A4_69 == A0_65.ENEMY0 then
        return 3 > A1_66:GetQuestUI8AL(L5_70)
