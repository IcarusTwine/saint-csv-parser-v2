(function()
  print("GaiUsa208 loaded")
  function GaiUsa208.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsa208.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EMOTE_THINK)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA208_00731_ROLANDAIX_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA208_00731_ROLANDAIX_000_001, true)
    A0_3:QuestAccepted()
  end
  function GaiUsa208.OnScene00002(A0_6, A1_7, A2_8)
  end
  function GaiUsa208.OnScene00003(A0_9, A1_10, A2_11)
  end
  function GaiUsa208.OnScene00004(A0_12, A1_13, A2_14)
  end
  function GaiUsa208.OnScene00005(A0_15, A1_16, A2_17)
  end
  function GaiUsa208.OnScene00006(A0_18, A1_19, A2_20)
  end
  function GaiUsa208.OnScene00007(A0_21, A1_22, A2_23)
  end
  function GaiUsa208.OnScene00008(A0_24, A1_25, A2_26)
  end
  function GaiUsa208.OnScene00009(A0_27, A1_28, A2_29)
  end
  function GaiUsa208.OnScene00010(A0_30, A1_31, A2_32)
  end
  function GaiUsa208.OnScene00011(A0_33, A1_34, A2_35)
  end
  function GaiUsa208.OnScene00012(A0_36, A1_37, A2_38)
  end
  function GaiUsa208.OnScene00013(A0_39, A1_40, A2_41)
  end
  function GaiUsa208.OnScene00014(A0_42, A1_43, A2_44)
  end
  function GaiUsa208.OnScene00015(A0_45, A1_46, A2_47)
  end
  function GaiUsa208.OnScene00016(A0_48, A1_49, A2_50)
  end
  function GaiUsa208.OnScene00017(A0_51, A1_52, A2_53)
  end
  function GaiUsa208.OnScene00018(A0_54, A1_55, A2_56)
    ...
    L5_59 = A0_54.ACTION_TIMELINE_EVENT_ADD_QUESTION
    L3_57(L4_58, L5_59)
    L4_58 = A2_56
    L3_57 = A2_56.Talk
    L5_59 = A1_55
  ...
  function GaiUsa208.OnScene00019(A0_64, A1_65, A2_66)
    local L3_67, L4_68
    L4_68 = A2_66
    L3_67 = A2_66.TurnTo
    ...
    L4_68 = A2_66
    L3_67 = A2_66.Talk
    L3_67(L4_68, A1_65, A0_64, A0_64.TEXT_GAIUSA208_00731_ROLANDAIX_000_020, false)
    L4_68 = A2_66
    L3_67 = A2_66.Talk
    L3_67(L4_68, A1_65, A0_64, A0_64.TEXT_GAIUSA208_00731_ROLANDAIX_000_021, false)
    L4_68 = A2_66
    L3_67 = A2_66.PlayActionTimeline
    L3_67(L4_68, A0_64.ACTION_TIMELINE_EMOTE_NO)
    L4_68 = A2_66
    L3_67 = A2_66.Talk
    L3_67(L4_68, A1_65, A0_64, A0_64.TEXT_GAIUSA208_00731_ROLANDAIX_000_022, true)
    L4_68 = A0_64
  ...
  function GaiUsa208.GetEventItems(A0_69, A1_70)
    local L2_71
  ...
  function GaiUsa208.IsTodoChecked(A0_72, A1_73, A2_74)
    local L3_75
