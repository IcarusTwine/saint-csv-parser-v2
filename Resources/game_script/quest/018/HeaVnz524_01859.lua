(function()
  print("HeaVnz524 loaded")
  function HeaVnz524.OnScene00000(A0_0, A1_1, A2_2)
  ...
  function HeaVnz524.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.EVENT_ACTION_ZANNEN)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ524_01859_BOTANISTAIRPORTMOG01859_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ524_01859_BOTANISTAIRPORTMOG01859_000_001, true)
    A0_3:Wait(10)
    A0_3:QuestAccepted()
  end
  function HeaVnz524.OnScene00002(A0_6, A1_7, A2_8)
  end
  function HeaVnz524.OnScene00003(A0_9, A1_10, A2_11)
  end
  function HeaVnz524.OnScene00004(A0_12, A1_13, A2_14)
  end
  function HeaVnz524.OnScene00005(A0_15, A1_16, A2_17)
  end
  function HeaVnz524.OnScene00006(A0_18, A1_19, A2_20)
  end
  function HeaVnz524.OnScene00007(A0_21, A1_22, A2_23)
  end
  function HeaVnz524.OnScene00008(A0_24, A1_25, A2_26)
  end
  function HeaVnz524.OnScene00009(A0_27, A1_28, A2_29)
  end
  function HeaVnz524.OnScene00010(A0_30, A1_31, A2_32)
  end
  function HeaVnz524.OnScene00011(A0_33, A1_34, A2_35)
  end
  function HeaVnz524.OnScene00012(A0_36, A1_37, A2_38)
    A2_38:TurnTo(A1_37)
    A2_38:WaitForTurn()
    A2_38:PlayActionTimeline(A0_36.EVENT_ACTION_ZANNEN)
    A2_38:Talk(A1_37, A0_36, A0_36.TEXT_HEAVNZ524_01859_BOTANISTAIRPORTMOG01859_000_010, true)
  end
  function HeaVnz524.OnScene00013(A0_39, A1_40, A2_41)
  ...
  function HeaVnz524.OnScene00014(A0_49, A1_50, A2_51)
    local L3_52, L4_53
    L4_53 = A2_51
    ...
    L4_53 = A2_51
    L3_52 = A2_51.Talk
    L3_52(L4_53, A1_50, A0_49, A0_49.TEXT_HEAVNZ524_01859_BOTANISTAIRPORTMOG01859_000_021, true)
    L4_53 = A2_51
    ...
    L4_53 = A2_51
    L3_52 = A2_51.WalkOut
    L3_52(L4_53, 0, 5, A0_49.MOVE_WALK)
    L4_53 = A0_49
    L3_52 = A0_49.Wait
    L3_52(L4_53, 45)
    L4_53 = A2_51
    L3_52 = A2_51.Transparency
    L3_52(L4_53, A0_49.TRANS_TYPE_FADE_OUT, 30)
    L4_53 = A2_51
    L3_52 = A2_51.WaitForTransparency
    L3_52(L4_53)
    L4_53 = A0_49
  ...
  function HeaVnz524.GetEventItems(A0_54, A1_55)
    local L2_56
  ...
  function HeaVnz524.IsTodoChecked(A0_57, A1_58, A2_59)
    local L3_60
