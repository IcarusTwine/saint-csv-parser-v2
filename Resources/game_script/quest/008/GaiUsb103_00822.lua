(function()
  print("GaiUsb103 loaded")
  function GaiUsb103.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsb103.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:LookAt(A1_4)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EMOTE_HUH)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB103_00822_UODHNUN_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB103_00822_UODHNUN_000_001, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB103_00822_UODHNUN_000_002, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB103_00822_UODHNUN_000_003, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB103_00822_UODHNUN_000_004, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB103_00822_UODHNUN_000_005, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_QUESTION)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB103_00822_UODHNUN_000_006, true)
    A0_3:QuestAccepted()
  end
  function GaiUsb103.OnScene00002(A0_6, A1_7, A2_8)
    A0_6:Inventory(true)
  end
  function GaiUsb103.OnScene00003(A0_9, A1_10, A2_11)
  end
  function GaiUsb103.OnScene00004(A0_12, A1_13, A2_14)
  end
  function GaiUsb103.OnScene00005(A0_15, A1_16, A2_17)
    A0_15:ScenarioMessage(A0_15.TEXT_GAIUSB103_00822_POP_MESSAGE_000)
  end
  function GaiUsb103.OnScene00006(A0_18, A1_19, A2_20)
  end
  function GaiUsb103.OnScene00007(A0_21, A1_22, A2_23)
  end
  function GaiUsb103.OnScene00008(A0_24, A1_25, A2_26)
    ...
    L5_29 = A0_24.ACTION_TIMELINE_EVENT_ADD_YES
    L3_27(L4_28, L5_29)
    L4_28 = A2_26
    L3_27 = A2_26.Talk
    L5_29 = A1_25
  ...
  function GaiUsb103.OnScene00009(A0_34, A1_35, A2_36)
    local L3_37, L4_38
    L4_38 = A1_35
    ...
    L3_37(L4_38, A0_34.ACTION_TIMELINE_EMOTE_THINK)
    L4_38 = A2_36
    L3_37 = A2_36.Talk
    L3_37(L4_38, A1_35, A0_34, A0_34.TEXT_GAIUSB103_00822_UODHNUN_000_035, false)
    L4_38 = A2_36
    L3_37 = A2_36.PlayActionTimeline
    L3_37(L4_38, A0_34.ACTION_TIMELINE_EMOTE_YES)
    L4_38 = A2_36
    L3_37 = A2_36.Talk
    L3_37(L4_38, A1_35, A0_34, A0_34.TEXT_GAIUSB103_00822_UODHNUN_000_036, false)
    L4_38 = A2_36
    L3_37 = A2_36.Talk
    L3_37(L4_38, A1_35, A0_34, A0_34.TEXT_GAIUSB103_00822_UODHNUN_000_037, false)
    L4_38 = A2_36
    L3_37 = A2_36.PlayActionTimeline
    L3_37(L4_38, A0_34.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    L4_38 = A2_36
    L3_37 = A2_36.Talk
    L3_37(L4_38, A1_35, A0_34, A0_34.TEXT_GAIUSB103_00822_UODHNUN_000_038, true)
    L4_38 = A0_34
  ...
  function GaiUsb103.GetEventItems(A0_39, A1_40)
    local L2_41
  ...
  function GaiUsb103.IsTodoChecked(A0_42, A1_43, A2_44)
    local L3_45
...
;(function()
  ...
  function L1_47(A0_62, A1_63, A2_64, A3_65)
    ...
    L4_66 = L4_66(A0_62)
    if A1_63:GetQuestSequence(L4_66) == A0_62.SEQ_2 and A2_64:GetBaseId() == A0_62.EOBJECT0 and A3_65 == A0_62.ITEM0 then
      return true
    end
    return false
  end
  ...
  function L1_47(A0_76, A1_77, A2_78)
    ...
    elseif A1_77:GetQuestSequence(L3_79) == A0_76.SEQ_2 then
      if A2_78:GetBaseId() == A0_76.EOBJECT0 then
        ...
        if A1_77:GetQuestBitFlag8(L3_79, 1) then
          return true, false
        end
      end
