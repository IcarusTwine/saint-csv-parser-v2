(function()
  print("GaiUsc102 loaded")
  function GaiUsc102.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsc102.OnScene00001(A0_3, A1_4, A2_5)
    A0_3:BeginCutScene()
    A0_3:PlayCutScene(A0_3.CUT_GAIUSC10210)
    A0_3:EndCutScene()
    A0_3:QuestAccepted()
  end
  function GaiUsc102.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7)
    A2_8:WaitForTurn()
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK2)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_GAIUSC102_00953_LIONNELLAIS_000_100, true)
    return (A0_6:YesNo(A0_6.TEXT_GAIUSC102_00953_Q1_000_110, A0_6.TEXT_GAIUSC102_00953_A1_000_111, A0_6.TEXT_GAIUSC102_00953_A1_000_112, A0_6.DEFAULT_NO))
  end
  function GaiUsc102.OnScene00003(A0_9, A1_10, A2_11)
    local L3_12, L4_13
    L4_13 = A2_11
    L3_12 = A2_11.LookAt
    L3_12(L4_13, A1_10)
    ...
    L3_12(L4_13, A0_9.ACTION_TIMELINE_EVENT_CHAIR_TALK)
    L4_13 = A2_11
    L3_12 = A2_11.Talk
    L3_12(L4_13, A1_10, A0_9, A0_9.TEXT_GAIUSC102_00953_LAMBERTEINT_000_050, true)
    L4_13 = A0_9
  ...
  function GaiUsc102.IsTodoChecked(A0_14, A1_15, A2_16)
    local L3_17
...
;(function()
  ...
  function L1_19(A0_22, A1_23, A2_24, A3_25, A4_26)
    ...
    L5_27 = L5_27(A0_22)
    if A1_23:GetQuestSequence(L5_27) == A0_22.SEQ_0 then
      if A3_25 == A0_22.ACTOR0 then
        if 1 <= A1_23:GetQuestUI8AL(L5_27) then
          return false
        end
        return A1_23:GetQuestBitFlag8(L5_27, 1) == false
      elseif A3_25 == A0_22.ACTOR1 then
        return true
      end
    end
    return false
