(function()
  print("GaiUsa607 loaded")
  function GaiUsa607.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsa607.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:LookAt(A1_4)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA607_00769_FAWKES_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA607_00769_FAWKES_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSA607_00769_FAWKES_000_002, true)
    A0_3:QuestAccepted()
  end
  function GaiUsa607.OnScene00002(A0_6, A1_7, A2_8)
    A0_6:Inventory(true)
  end
  function GaiUsa607.OnScene00003(A0_9, A1_10, A2_11)
  end
  function GaiUsa607.OnScene00004(A0_12, A1_13, A2_14)
  ...
  function GaiUsa607.OnScene00005(A0_22, A1_23, A2_24)
    local L3_25, L4_26
    L4_26 = A2_24
    L3_25 = A2_24.TurnTo
    ...
    L4_26 = A2_24
    L3_25 = A2_24.Talk
    L3_25(L4_26, A1_23, A0_22, A0_22.TEXT_GAIUSA607_00769_CASTELLAINT_000_020, true)
    L4_26 = A0_22
  ...
  function GaiUsa607.OnScene00006(A0_27, A1_28, A2_29)
  end
  function GaiUsa607.OnScene00007(A0_30, A1_31, A2_32)
  end
  function GaiUsa607.GetEventItems(A0_33, A1_34)
    local L2_35
    ...
    elseif A1_34:GetQuestSequence(L2_35) == A0_33.SEQ_1 then
      return A0_33.ITEM0, A1_34:GetQuestUI8BH(L2_35), true
    elseif A1_34:GetQuestSequence(L2_35) == A0_33.SEQ_FINISH then
      return A0_33.ITEM0, A1_34:GetQuestUI8BH(L2_35), false
    end
  end
  function GaiUsa607.IsTodoChecked(A0_36, A1_37, A2_38)
    local L3_39
...
;(function()
  ...
  function L1_41(A0_56, A1_57, A2_58, A3_59)
    ...
    L4_60 = L4_60(A0_56)
    if A1_57:GetQuestSequence(L4_60) == A0_56.SEQ_1 and A2_58:GetBaseId() == A0_56.EOBJECT0 and A3_59 == A0_56.ITEM0 then
      return true
    end
    return false
  end
  ...
  function L1_41(A0_65, A1_66, A2_67, A3_68)
    ...
    if A1_66:GetQuestSequence(L4_69) == A0_65.SEQ_1 then
      if A2_67:GetBaseId() == A0_65.EOBJECT0 then
        if 1 <= A1_66:GetQuestUI8AL(L4_69) then
          return false
        end
  ...
  function L1_41(A0_70, A1_71, A2_72)
    ...
    if A1_71:GetQuestSequence(L3_73) == A0_70.SEQ_1 then
      if A2_72:GetBaseId() == A0_70.EOBJECT0 then
        if 1 <= A1_71:GetQuestUI8AL(L3_73) then
          return true, false
        end
        if A1_71:GetQuestBitFlag8(L3_73, 1) then
          return true, false
        end
      end
