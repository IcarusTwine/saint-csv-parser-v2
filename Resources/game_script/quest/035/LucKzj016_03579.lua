(function()
  print("LucKzj016 loaded")
  function LucKzj016.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function LucKzj016.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZJ016_03579_SORASHSKOAL_000_000, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_THINK)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZJ016_03579_SORASHSKOAL_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZJ016_03579_SORASHSKOAL_000_002, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TROUBLE)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_LUCKZJ016_03579_SORASHSKOAL_000_003, true)
    A0_3:QuestAccepted()
  end
  function LucKzj016.OnScene00002(A0_6, A1_7, A2_8)
  end
  function LucKzj016.OnScene00003(A0_9, A1_10, A2_11)
    if A0_9:IsBattleNpcOwner(A1_10, true) == true or A0_9:IsBattleNpcTriggerOwner(A1_10, A2_11, false) == true then
    else
      A0_9:LogMessage(A0_9.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function LucKzj016.OnScene00004(A0_12, A1_13, A2_14)
  end
  function LucKzj016.OnScene00005(A0_15, A1_16, A2_17)
    if A0_15:IsBattleNpcOwner(A1_16, true) == true or A0_15:IsBattleNpcTriggerOwner(A1_16, A2_17, false) == true then
    else
      A0_15:LogMessage(A0_15.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function LucKzj016.OnScene00006(A0_18, A1_19, A2_20)
  end
  function LucKzj016.OnScene00007(A0_21, A1_22, A2_23)
    A1_22:LookAt()
    A0_21:SystemTalk(A0_21.TEXT_LUCKZJ016_03579_SYETEM_000_005, true)
    A0_21:CancelEventScene()
  end
  function LucKzj016.OnScene00008(A0_24, A1_25, A2_26)
  end
  function LucKzj016.OnScene00009(A0_27, A1_28, A2_29)
    A1_28:LookAt()
    A0_27:SystemTalk(A0_27.TEXT_LUCKZJ016_03579_SYETEM_000_005, true)
    A0_27:CancelEventScene()
  end
  function LucKzj016.OnScene00010(A0_30, A1_31, A2_32)
    A2_32:TurnTo(A1_31, false)
    A2_32:WaitForTurn()
    A2_32:PlayActionTimeline(A0_30.ACTION_TIMELINE_EVENT_TALK2)
    A2_32:Talk(A1_31, A0_30, A0_30.TEXT_LUCKZJ016_03579_SORASHSKOAL_000_005, true)
  end
  function LucKzj016.OnScene00011(A0_33, A1_34, A2_35)
  ...
  function LucKzj016.OnScene00012(A0_43, A1_44, A2_45)
    local L3_46, L4_47
    L4_47 = A2_45
    ...
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_LUCKZJ016_03579_SORASHSKOAL_000_011, false)
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_LUCKZJ016_03579_SORASHSKOAL_000_012, false)
    L4_47 = A2_45
    L3_46 = A2_45.PlayActionTimeline
    L3_46(L4_47, A0_43.ACTION_TIMELINE_EVENT_TALK1)
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_LUCKZJ016_03579_SORASHSKOAL_000_013, false)
    L4_47 = A2_45
    L3_46 = A2_45.PlayActionTimeline
    L3_46(L4_47, A0_43.ACTION_TIMELINE_EVENT_ADD_YES)
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_LUCKZJ016_03579_SORASHSKOAL_000_014, true)
    L4_47 = A0_43
  ...
  function LucKzj016.GetEventItems(A0_48, A1_49)
    local L2_50
  ...
  function LucKzj016.IsTodoChecked(A0_51, A1_52, A2_53)
    local L3_54
    ...
    if A2_53 == 0 then
      return A1_52:GetQuestUI8AH(L3_54) >= 1
    elseif A2_53 == 1 then
      return false
    end
  end
