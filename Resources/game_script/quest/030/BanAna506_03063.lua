(function()
  print("BanAna506 loaded")
  function BanAna506.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function BanAna506.OnScene00001(A0_3, A1_4, A2_5)
    A1_4:LookAt(A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANANA506_03063_ESHANA_000_000, true)
    A1_4:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_QUESTION)
    A1_4:WaitForActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_QUESTION)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANANA506_03063_ESHANA_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_BANANA506_03063_ESHANA_000_002, true)
  ...
  function BanAna506.OnScene00002(A0_6, A1_7, A2_8)
  ...
  function BanAna506.OnScene00003(A0_9, A1_10, A2_11)
    A0_9:LogMessage(A0_9.LOG_MSG_EVENT_POP_MESSAGE)
  end
  function BanAna506.OnScene00004(A0_12, A1_13, A2_14)
  end
  function BanAna506.OnScene00005(A0_15, A1_16, A2_17)
    A0_15:LogMessage(A0_15.LOG_MSG_EVENT_POP_MESSAGE)
  end
  function BanAna506.OnScene00006(A0_18, A1_19, A2_20)
  ...
  function BanAna506.OnScene00007(A0_21, A1_22, A2_23)
    A0_21:LogMessage(A0_21.LOG_MSG_EVENT_POP_MESSAGE)
  end
  function BanAna506.OnScene00008(A0_24, A1_25, A2_26)
  end
  function BanAna506.OnScene00009(A0_27, A1_28, A2_29)
    A0_27:LogMessage(A0_27.LOG_MSG_EVENT_POP_MESSAGE)
  end
  function BanAna506.OnScene00010(A0_30, A1_31, A2_32)
  ...
  function BanAna506.OnScene00011(A0_33, A1_34, A2_35)
    A0_33:LogMessage(A0_33.LOG_MSG_EVENT_POP_MESSAGE)
  end
  function BanAna506.OnScene00012(A0_36, A1_37, A2_38)
  end
  function BanAna506.OnScene00013(A0_39, A1_40, A2_41)
    A0_39:LogMessage(A0_39.LOG_MSG_EVENT_POP_MESSAGE)
  end
  function BanAna506.OnScene00014(A0_42, A1_43, A2_44)
  ...
  function BanAna506.OnScene00015(A0_45, A1_46, A2_47)
    A0_45:LogMessage(A0_45.LOG_MSG_EVENT_POP_MESSAGE)
  end
  function BanAna506.OnScene00016(A0_48, A1_49, A2_50)
  end
  function BanAna506.OnScene00017(A0_51, A1_52, A2_53)
    A0_51:LogMessage(A0_51.LOG_MSG_EVENT_POP_MESSAGE)
  end
  function BanAna506.OnScene00018(A0_54, A1_55, A2_56)
  ...
  function BanAna506.OnScene00019(A0_64, A1_65, A2_66)
    local L3_67, L4_68
    L4_68 = A1_65
    ...
    L4_68 = A2_66
    L3_67 = A2_66.Talk
    L3_67(L4_68, A1_65, A0_64, A0_64.TEXT_BANANA506_03063_ESHANA_000_011, false)
    L4_68 = A2_66
    L3_67 = A2_66.Talk
    L3_67(L4_68, A1_65, A0_64, A0_64.TEXT_BANANA506_03063_ESHANA_000_012, false)
    L4_68 = A2_66
    L3_67 = A2_66.Talk
    L3_67(L4_68, A1_65, A0_64, A0_64.TEXT_BANANA506_03063_ESHANA_000_013, true)
    L4_68 = A0_64
  ...
  function BanAna506.GetEventItems(A0_69, A1_70)
    local L2_71
    ...
    elseif A1_70:GetQuestSequence(L2_71) == A0_69.SEQ_1 then
      return A0_69.ITEM0, A1_70:GetQuestUI8CL(L2_71), true, A0_69.ITEM1, A1_70:GetQuestUI8DH(L2_71), false
    elseif A1_70:GetQuestSequence(L2_71) == A0_69.SEQ_FINISH then
      return A0_69.ITEM1, A1_70:GetQuestUI8BH(L2_71), false
    end
  end
  function BanAna506.IsTodoChecked(A0_72, A1_73, A2_74)
    local L3_75
...
;(function()
  ...
  function L1_77(A0_78, A1_79, A2_80, A3_81)
    ...
    if A1_79:GetQuestSequence(L4_82) == A0_78.SEQ_1 then
      for _FORV_10_ = 1, A0_78.TODO1_RANDOM_SELECT_TABLE_SIZE[A1_79:GetQuestUI8DL(L4_82)] do
        if A0_78.TODO1_RANDOM_SELECT_TABLE[A1_79:GetQuestUI8DL(L4_82)][_FORV_10_] == A2_80 or A0_78.TODO1_RANDOM_SELECT_TABLE[A1_79:GetQuestUI8DL(L4_82)][_FORV_10_] == A3_81 then
          return true
        end
      end
  ...
  function L1_77(A0_97, A1_98, A2_99, A3_100)
    ...
    if A1_98:GetQuestSequence(L4_101) == A0_97.SEQ_1 then
      ...
      elseif A2_99:GetLayoutId() == A0_97.ENEMY3 and A3_100 == A0_97.ITEM0 then
        return true
      end
    end
    return false
