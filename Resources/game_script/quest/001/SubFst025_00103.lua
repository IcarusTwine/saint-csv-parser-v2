(function()
  print("SubFst025 loaded")
  function SubFst025.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:TurnTo(A1_1)
    A2_2:WaitForTurn()
  ...
  function SubFst025.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1, A1_4)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_SUBFST025_00103_QDJAWANA_000_1, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_SUBFST025_00103_QDJAWANA_000_2, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_SUBFST025_00103_QDJAWANA_000_3, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_THINK, A1_4)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_SUBFST025_00103_QDJAWANA_000_4, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_SUBFST025_00103_QDJAWANA_000_5, true)
    A0_3:QuestAccepted()
  end
  function SubFst025.OnScene00002(A0_6, A1_7, A2_8)
    ...
    if L6_12 == 1 then
      ...
      L9_15 = A1_7
      L7_13(L8_14, L9_15, A0_6, A0_6.TEXT_SUBFST025_00103_DAMETTA_000_11, false)
      L9_15 = A1_7
      L7_13(L8_14, L9_15, A0_6, A0_6.TEXT_SUBFST025_00103_DAMETTA_000_12, false)
      L9_15 = A1_7
      L7_13(L8_14, L9_15, A0_6, A0_6.TEXT_SUBFST025_00103_DAMETTA_000_13, false)
      L9_15 = A0_6.ACTION_TIMELINE_EVENT_THINK
      L7_13(L8_14, L9_15, A1_7)
      L9_15 = A1_7
      L7_13(L8_14, L9_15, A0_6, A0_6.TEXT_SUBFST025_00103_DAMETTA_000_14, false)
      L9_15 = A1_7
      L7_13(L8_14, L9_15, A0_6, A0_6.TEXT_SUBFST025_00103_DAMETTA_000_15, false)
      L9_15 = A0_6.ACTION_TIMELINE_EVENT_TALK1
      L7_13(L8_14, L9_15, A1_7)
      L9_15 = A1_7
      L7_13(L8_14, L9_15, A0_6, A0_6.TEXT_SUBFST025_00103_DAMETTA_000_16, true)
      return L6_12
    else
    end
  end
  function SubFst025.OnScene00003(A0_16, A1_17, A2_18)
    local L3_19, L4_20
    L4_20 = A0_16
  ...
  function SubFst025.OnScene00004(A0_21, A1_22, A2_23)
  end
  function SubFst025.GetEventItems(A0_24, A1_25)
    local L2_26
  ...
  function SubFst025.IsTodoChecked(A0_27, A1_28, A2_29)
    local L3_30
    ...
    if A2_29 == 0 then
      return A1_28:GetQuestUI8BH(L3_30) >= 6
    elseif A2_29 == 1 then
      return false
    end
  end
...
;(function()
  ...
  function L1_32(A0_35, A1_36, A2_37)
    ...
    if A2_37 == 0 then
      return A1_36:GetQuestUI8BH(L3_38), 6
    elseif A2_37 == 1 then
  ...
  function L1_32(A0_43, A1_44, A2_45, A3_46)
    ...
    elseif A2_45 == A0_43.SEQ_FINISH and A3_46 == A0_43.ACTOR1 then
      ({})[1] = {
        A0_43.ITEM0,
        6,
        false,
