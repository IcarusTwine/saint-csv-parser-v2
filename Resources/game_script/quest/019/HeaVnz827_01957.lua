(function()
  print("HeaVnz827 loaded")
  function HeaVnz827.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function HeaVnz827.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ827_01957_DRYDOX_000_000, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.EVENT_ACTION_TALK_DEMIHUMAN)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ827_01957_DRYDOX_000_001, true)
    A0_3:Wait(10)
    A0_3:QuestAccepted()
  end
  function HeaVnz827.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_HEAVNZ827_01957_BOOMSHOX_000_020, false)
    A2_8:WaitForTurn()
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TROUBLE)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_HEAVNZ827_01957_BOOMSHOX_000_021, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_HEAVNZ827_01957_BOOMSHOX_000_022, true)
  end
  function HeaVnz827.OnScene00003(A0_9, A1_10, A2_11)
    A2_11:LookAt(A1_10)
    A2_11:Talk(A1_10, A0_9, A0_9.TEXT_HEAVNZ827_01957_DRYDOX_000_010, true)
  end
  function HeaVnz827.OnScene00004(A0_12, A1_13, A2_14)
    A2_14:LookAt(A1_13)
    A2_14:Talk(A1_13, A0_12, A0_12.TEXT_HEAVNZ827_01957_DRYDOX_000_031, true)
  end
  function HeaVnz827.OnScene00005(A0_15, A1_16, A2_17)
    A2_17:TurnTo(A1_16)
    A2_17:WaitForTurn()
    A2_17:PlayActionTimeline(A0_15.ACTION_TIMELINE_EVENT_TROUBLE)
    A2_17:Talk(A1_16, A0_15, A0_15.TEXT_HEAVNZ827_01957_BOOMSHOX_000_030, true)
  end
  function HeaVnz827.OnScene00006(A0_18, A1_19, A2_20)
    local L3_21, L4_22
    L4_22 = A2_20
    L3_21 = A2_20.TurnTo
    L3_21(L4_22, A1_19)
    ...
    L4_22 = A2_20
    L3_21 = A2_20.Talk
    L3_21(L4_22, A1_19, A0_18, A0_18.TEXT_HEAVNZ827_01957_BOOMSHOX_000_040, false)
    L4_22 = A2_20
    L3_21 = A2_20.Talk
    L3_21(L4_22, A1_19, A0_18, A0_18.TEXT_HEAVNZ827_01957_BOOMSHOX_000_041, true)
    L4_22 = A0_18
    L3_21 = A0_18.Wait
    L3_21(L4_22, 10)
    L4_22 = A0_18
  ...
  function HeaVnz827.OnScene00007(A0_23, A1_24, A2_25)
    A2_25:LookAt(A1_24)
    A2_25:Talk(A1_24, A0_23, A0_23.TEXT_HEAVNZ827_01957_DRYDOX_000_050, true)
  end
  function HeaVnz827.IsTodoChecked(A0_26, A1_27, A2_28)
    local L3_29
...
;(function()
  ...
  function L1_31(A0_34, A1_35, A2_36, A3_37, A4_38)
    ...
    elseif A1_35:GetQuestSequence(L5_39) == A0_34.SEQ_2 then
      if A3_37 == A0_34.ENEMY0 then
        if A1_35:GetQuestUI8AL(L5_39) >= 5 then
          return false
        end
        return A1_35:GetQuestUI8AL(L5_39) < 5
      elseif A3_37 == A0_34.ACTOR0 then
        return true
  ...
  function L1_31(A0_40, A1_41, A2_42, A3_43, A4_44)
    ...
    elseif A1_41:GetQuestSequence(L5_45) == A0_40.SEQ_2 then
      if A3_43 == A0_40.ENEMY0 then
        if A1_41:GetQuestUI8AL(L5_45) >= 5 then
          return false
        end
        return A1_41:GetQuestUI8AL(L5_45) < 5
      elseif A3_43 == A0_40.ACTOR0 then
        return false
  ...
  function L1_31(A0_46, A1_47, A2_48)
    ...
    elseif A2_48 == 1 then
      return A1_47:GetQuestUI8AL(L3_49), 5
    elseif A2_48 == 2 then
      return A1_47:GetQuestUI8AL(L3_49), 0
    end
  end
