...
function L0_1(...)
  ...
  function L1_2(A0_3, A1_3, A2_3)
    ...
    L5_3 = A1_3
    L6_3 = A0_3
    L7_3 = A0_3.TEXT_GAIUSB010_00817_DETOHMOSHROCA_000_000
    L8_3 = false
    ...
    L5_3 = A1_3
    L6_3 = A0_3
    L7_3 = A0_3.TEXT_GAIUSB010_00817_DETOHMOSHROCA_000_001
    L8_3 = false
    L3_3(L4_3, L5_3, L6_3, L7_3, L8_3)
    L4_3 = A2_3
    L3_3 = A2_3.PlayActionTimeline
    ...
    L5_3 = A1_3
    L6_3 = A0_3
    L7_3 = A0_3.TEXT_GAIUSB010_00817_DETOHMOSHROCA_000_002
    L8_3 = true
    L3_3(L4_3, L5_3, L6_3, L7_3, L8_3)
    L4_3 = A0_3
  ...
  function L1_2(A0_3, A1_3, A2_3)
    ...
    if L3_3 ~= true then
      ...
      if L3_3 == true then
        ...
        L5_3 = A0_3.TEXT_GAIUSB010_00817_POP_MESSAGE_000
        L3_3(L4_3, L5_3)
      end
    end
  end
  ...
  function L1_2(A0_3, A1_3, A2_3)
    ...
    if L4_3 > L5_3 then
      ...
      L8_3 = A0_3.TEXT_GAIUSB010_00817_ACCESS_MESSAGE
      L6_3(L7_3, L8_3)
      return
    end
  end
  ...
  function L1_2(A0_3, A1_3, A2_3)
    ...
    L5_3 = A1_3
    L6_3 = A0_3
    L7_3 = A0_3.TEXT_GAIUSB010_00817_MERCHANT_000_020
    L8_3 = true
    L3_3(L4_3, L5_3, L6_3, L7_3, L8_3)
  end
  ...
  function L1_2(A0_3, A1_3, A2_3)
    ...
    L5_3 = A1_3
    L6_3 = A0_3
    L7_3 = A0_3.TEXT_GAIUSB010_00817_DETOHMOSHROCA_000_030
    L8_3 = true
    L3_3(L4_3, L5_3, L6_3, L7_3, L8_3)
    L4_3 = A0_3
    L3_3 = A0_3.GetQuestId
  ...
  function L1_2(A0_3, A1_3, A2_3)
    ...
    L4_3 = A2_3
    L3_3 = A2_3.PlayActionTimeline
    L5_3 = A0_3.ACTION_TIMELINE_EVENT_REACTION_MIQO_W
    L3_3(L4_3, L5_3)
    L4_3 = A2_3
    L3_3 = A2_3.Talk
    L5_3 = A1_3
    L6_3 = A0_3
    L7_3 = A0_3.TEXT_GAIUSB010_00817_DETOHMOSHROCA_000_031
    L8_3 = false
    L3_3(L4_3, L5_3, L6_3, L7_3, L8_3)
    L4_3 = A2_3
    L3_3 = A2_3.Talk
    L5_3 = A1_3
    L6_3 = A0_3
    L7_3 = A0_3.TEXT_GAIUSB010_00817_DETOHMOSHROCA_000_032
    L8_3 = true
    L3_3(L4_3, L5_3, L6_3, L7_3, L8_3)
    L4_3 = A0_3
  ...
  function L1_2(A0_3, A1_3, A2_3)
    ...
    L5_3 = A1_3
    L6_3 = A0_3
    L7_3 = A0_3.TEXT_GAIUSB010_00817_MERCHANT_000_021
    L8_3 = true
    L3_3(L4_3, L5_3, L6_3, L7_3, L8_3)
  end
