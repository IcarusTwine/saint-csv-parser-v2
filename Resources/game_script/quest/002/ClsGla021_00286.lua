(function()
  print("ClsGla021 loaded")
  function ClsGla021.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
    if A0_0:QuestOffer(A2_2, A1_1) then
      A2_2:TurnTo(A1_1)
      A2_2:WaitForTurn()
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_GREETING)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_CLSGLA021_00286_MYLLA_000_1, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_CLSGLA021_00286_MYLLA_000_2, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_CLSGLA021_00286_MYLLA_000_3, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK2)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_CLSGLA021_00286_MYLLA_000_4, true)
      A0_0:QuestAccepted()
      return 1
    else
      return 0
  ...
  function ClsGla021.OnScene00001(A0_3, A1_4, A2_5)
    local L3_6, L4_7
    L4_7 = A2_5
    L3_6 = A2_5.TurnTo
    L3_6(L4_7, A1_4)
    ...
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_CLSGLA021_00286_MYLLA_000_10, false)
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_CLSGLA021_00286_MYLLA_000_11, false)
    L4_7 = A2_5
    L3_6 = A2_5.PlayActionTimeline
    L3_6(L4_7, A0_3.ACTION_TIMELINE_EVENT_TALK2)
    L4_7 = A2_5
    L3_6 = A2_5.Talk
    L3_6(L4_7, A1_4, A0_3, A0_3.TEXT_CLSGLA021_00286_MYLLA_000_12, true)
    L4_7 = A0_3
    L3_6 = A0_3.SystemTalk
    L3_6(L4_7, A0_3.TEXT_CLSGLA021_00286_SYSTEM_000_15, true)
    L4_7 = A0_3
  ...
  function ClsGla021.IsTodoChecked(A0_8, A1_9, A2_10)
    local L3_11
