(function()
  print("GaiUsb210 loaded")
  function GaiUsb210.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function GaiUsb210.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2, A1_4)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB210_00841_ETGAR_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_GAIUSB210_00841_ETGAR_000_001, true)
    A0_3:QuestAccepted()
  end
  function GaiUsb210.OnScene00002(A0_6, A1_7, A2_8)
    local L3_9, L4_10
    L4_10 = A2_8
    L3_9 = A2_8.TurnTo
    ...
    L3_9(L4_10, A0_6.ACTION_TIMELINE_EMOTE_JOY, A1_7)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_GAIUSB210_00841_ETGAR_000_020, true)
    L4_10 = A0_6
  ...
  function GaiUsb210.IsTodoChecked(A0_11, A1_12, A2_13)
    local L3_14
