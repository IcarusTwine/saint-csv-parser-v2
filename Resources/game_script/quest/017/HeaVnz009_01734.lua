(function()
  print("HeaVnz009 loaded")
  function HeaVnz009.OnScene00000(A0_0, A1_1, A2_2)
  ...
  function HeaVnz009.OnScene00001(A0_3, A1_4, A2_5)
    ...
    A1_4:Direction(A2_5)
    A0_3:Wait(10)
    A2_5:Position(A1_4, A0_3.ARRANGE_TYPE_LEFT, 0.5)
    A0_3:Wait(10)
    A2_5:TurnTo(20, false)
    A2_5:WaitForTurn()
    A0_3:Wait(10)
    ...
    elseif A1_4:GetRace() == A0_3.RACE_LALAFELL then
      A0_3:PlayTwoShotCamera(A0_3.TWOSHOT_TYPE_FRONT, A1_4, A2_5, 0)
      ...
      A0_3:PlayTwoShotCamera(A0_3.TWOSHOT_TYPE_FRONT, A1_4, A2_5, 1)
    ...
    A0_3:WaitForFade()
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ009_01734_SIGAN_000_000, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A2_5:AutoShake(false)
    A2_5:WaitForActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TAKE_LOOK)
    A2_5:LookAt(A1_4)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ009_01734_SIGAN_000_001, false, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ009_01734_SIGAN_000_002, false, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_NO)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ009_01734_SIGAN_000_003, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A0_3:Wait(20)
    A2_5:LookAt(15, 15)
    ...
    A1_4:LookAt(-60, 15)
    A0_3:Wait(10)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ009_01734_SIGAN_000_004, false, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ009_01734_SIGAN_000_005, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A0_3:Wait(20)
    A2_5:LookAt(A1_4)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_ONEHAND)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ009_01734_SIGAN_000_006, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A0_3:Wait(20)
    A0_3:QuestAccepted()
    A0_3:Wait(120)
  ...
  function HeaVnz009.OnScene00002(A0_6, A1_7, A2_8)
  end
  function HeaVnz009.OnScene00003(A0_9, A1_10, A2_11)
  end
  function HeaVnz009.OnScene00004(A0_12, A1_13, A2_14)
  end
  function HeaVnz009.OnScene00005(A0_15, A1_16, A2_17)
  end
  function HeaVnz009.OnScene00006(A0_18, A1_19, A2_20)
  end
  function HeaVnz009.OnScene00007(A0_21, A1_22, A2_23)
    A0_21:LogMessage(A0_21.LOG_MSG_EVENT_POP_MESSAGE)
  end
  function HeaVnz009.OnScene00008(A0_24, A1_25, A2_26)
  end
  function HeaVnz009.OnScene00009(A0_27, A1_28, A2_29)
    if A0_27:IsBattleNpcOwner(A1_28, true) == true or A0_27:IsBattleNpcTriggerOwner(A1_28, A2_29, false) == true then
    else
      A0_27:LogMessage(A0_27.LOG_MSG_EVENT_POP_MESSAGE)
    end
  end
  function HeaVnz009.OnScene00010(A0_30, A1_31, A2_32)
    A2_32:LookAt(A1_31)
    A2_32:TurnTo(A1_31, false)
    A2_32:Talk(A1_31, A0_30, A0_30.TEXT_HEAVNZ009_01734_SIGAN_000_010, false)
  end
  function HeaVnz009.OnScene00011(A0_33, A1_34, A2_35)
  ...
  function HeaVnz009.OnScene00012(A0_43, A1_44, A2_45)
    local L3_46, L4_47
    L4_47 = A1_44
    ...
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_HEAVNZ009_01734_SIGAN_000_021, true)
    L4_47 = A0_43
    L3_46 = A0_43.Wait
    L3_46(L4_47, 30)
    L4_47 = A2_45
    ...
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_HEAVNZ009_01734_SIGAN_000_022, false)
    L4_47 = A2_45
    L3_46 = A2_45.PlayActionTimeline
    L3_46(L4_47, A0_43.ACTION_TIMELINE_EMOTE_HUH)
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_HEAVNZ009_01734_SIGAN_000_023, false)
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_HEAVNZ009_01734_SIGAN_000_024, false)
    L4_47 = A2_45
    L3_46 = A2_45.PlayActionTimeline
    L3_46(L4_47, A0_43.ACTION_TIMELINE_EVENT_ADD_NO)
    L4_47 = A2_45
    L3_46 = A2_45.Talk
    L3_46(L4_47, A1_44, A0_43, A0_43.TEXT_HEAVNZ009_01734_SIGAN_000_025, true)
    L4_47 = A0_43
    L3_46 = A0_43.Wait
    L3_46(L4_47, 20)
    L4_47 = A2_45
    ...
    L4_47 = A2_45
    L3_46 = A2_45.WalkOut
    L3_46(L4_47, 0, 5, A0_43.MOVE_WALK)
    L4_47 = A0_43
    L3_46 = A0_43.Wait
    L3_46(L4_47, 45)
    L4_47 = A2_45
    L3_46 = A2_45.Transparency
    L3_46(L4_47, A0_43.TRANS_TYPE_FADE_OUT, 30)
    L4_47 = A2_45
    L3_46 = A2_45.WaitForTransparency
    L3_46(L4_47)
    L4_47 = A0_43
  ...
  function HeaVnz009.GetEventItems(A0_48, A1_49)
    local L2_50
  ...
  function HeaVnz009.IsTodoChecked(A0_51, A1_52, A2_53)
    local L3_54
