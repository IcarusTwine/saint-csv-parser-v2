(function()
  print("StmBda127 loaded")
  function StmBda127.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function StmBda127.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDA127_02954_GRISELDIS_000_001, true, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A0_3:Wait(10)
    A1_4:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A1_4:PlayActionTimeline(A0_3.ACTION_TIMELINE_SPEAK_NORMAL_MIDDLE)
    A1_4:WaitForActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDA127_02954_GRISELDIS_000_002, false, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDA127_02954_GRISELDIS_000_003, false, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDA127_02954_GRISELDIS_000_004, true, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A0_3:Wait(10)
    A1_4:PlayActionTimeline(A0_3.ACTION_TIMELINE_EMOTE_ME)
    A1_4:WaitForActionTimeline(A0_3.ACTION_TIMELINE_EMOTE_ME)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_STMBDA127_02954_GRISELDIS_000_005, true, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A0_3:Wait(10)
    A0_3:QuestAccepted()
  end
  function StmBda127.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:LookAt(A1_7)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_STMBDA127_02954_GRISELDIS_000_010, true, nil, nil, A0_6.SPEAK_NORMAL_MIDDLE)
  end
  function StmBda127.OnScene00003(A0_9, A1_10, A2_11)
    ...
    L5_14 = A1_10
    L9_18 = nil
    L3_12(L4_13, L5_14, L6_15, L7_16, L8_17, L9_18, nil, A0_9.SPEAK_NORMAL_MIDDLE)
    L4_13 = A0_9
    L3_12 = A0_9.Wait
    L5_14 = 10
    L3_12(L4_13, L5_14)
  ...
  function StmBda127.OnScene00004(A0_19, A1_20, A2_21)
    local L3_22, L4_23
    L4_23 = A1_20
    ...
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_STMBDA127_02954_GRISELDIS_000_021, false, nil, nil, A0_19.SPEAK_NORMAL_MIDDLE)
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_STMBDA127_02954_GRISELDIS_000_022, false, nil, nil, A0_19.SPEAK_NORMAL_MIDDLE)
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_STMBDA127_02954_GRISELDIS_000_023, false, nil, nil, A0_19.SPEAK_NORMAL_MIDDLE)
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_STMBDA127_02954_GRISELDIS_000_024, false, nil, nil, A0_19.SPEAK_NORMAL_MIDDLE)
    L4_23 = A2_21
    L3_22 = A2_21.PlayActionTimeline
    L3_22(L4_23, A0_19.ACTION_TIMELINE_EVENT_ADD_NO)
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_STMBDA127_02954_GRISELDIS_000_025, false, nil, nil, A0_19.SPEAK_NORMAL_MIDDLE)
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_STMBDA127_02954_GRISELDIS_000_026, false, nil, nil, A0_19.SPEAK_NORMAL_MIDDLE)
    L4_23 = A2_21
    L3_22 = A2_21.Talk
    L3_22(L4_23, A1_20, A0_19, A0_19.TEXT_STMBDA127_02954_GRISELDIS_000_027, true, nil, nil, A0_19.SPEAK_NORMAL_MIDDLE)
    L4_23 = A0_19
    L3_22 = A0_19.Wait
    L3_22(L4_23, 10)
    L4_23 = A0_19
  ...
  function StmBda127.GetEventItems(A0_24, A1_25)
    local L2_26
    ...
    elseif A1_25:GetQuestSequence(L2_26) == A0_24.SEQ_1 then
      return A0_24.ITEM0, A1_25:GetQuestUI8BL(L2_26), false, A0_24.ITEM1, A1_25:GetQuestUI8CH(L2_26), false
  ...
  function StmBda127.IsTodoChecked(A0_27, A1_28, A2_29)
    local L3_30
    ...
    if A2_29 == 0 then
      return A1_28:GetQuestUI8BL(L3_30) >= 1
    elseif A2_29 == 1 then
      return 1 <= A1_28:GetQuestUI8CH(L3_30)
    elseif A2_29 == 2 then
      return false
    end
  end
...
;(function()
  ...
  function L1_32(A0_35, A1_36, A2_37, A3_38, A4_39)
    ...
    if A1_36:GetQuestSequence(L5_40) == A0_35.SEQ_1 then
      if A3_38 == A0_35.ENEMY0 then
        return 1 > A1_36:GetQuestUI8BL(L5_40)
      elseif A3_38 == A0_35.ENEMY1 then
        return 1 > A1_36:GetQuestUI8CH(L5_40)
  ...
  function L1_32(A0_41, A1_42, A2_43, A3_44, A4_45)
    ...
    if A1_42:GetQuestSequence(L5_46) == A0_41.SEQ_1 then
      ...
      elseif A3_44 == A0_41.ENEMY1 then
  ...
  function L1_32(A0_47, A1_48, A2_49)
    ...
    if A2_49 == 0 then
      return A1_48:GetQuestUI8BL(L3_50), 1
    elseif A2_49 == 1 then
      return A1_48:GetQuestUI8CH(L3_50), 1
    elseif A2_49 == 2 then
