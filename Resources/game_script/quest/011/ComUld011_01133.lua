(function()
  print("ComUld011 loaded")
  function ComUld011.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
    if A0_0:QuestOffer(A2_2, A1_1) then
      ...
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_COMULD011_01133_SWIFT_000_000, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_COMULD011_01133_SWIFT_000_001, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_COMULD011_01133_SWIFT_000_002, true)
      return 1
    else
      return 0
    end
  end
  function ComUld011.OnScene00001(A0_3, A1_4, A2_5)
    A0_3:QuestAccepted()
  end
  function ComUld011.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7)
    A2_8:WaitForTurn()
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_BASE_IDLE)
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK2)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_COMULD011_01133_WILLIELMUS_000_010, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_COMULD011_01133_WILLIELMUS_000_011, false)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_COMULD011_01133_WILLIELMUS_000_012, true)
  ...
  function ComUld011.OnScene00003(A0_9, A1_10, A2_11)
    local L3_12, L4_13
    L4_13 = A2_11
    L3_12 = A2_11.TurnTo
    L3_12(L4_13, A1_10)
    ...
    L4_13 = A2_11
    L3_12 = A2_11.Talk
    L3_12(L4_13, A1_10, A0_9, A0_9.TEXT_COMULD011_01133_SWIFT_000_020, false)
    L4_13 = A2_11
    L3_12 = A2_11.Talk
    L3_12(L4_13, A1_10, A0_9, A0_9.TEXT_COMULD011_01133_SWIFT_000_021, false)
    L4_13 = A2_11
    L3_12 = A2_11.Talk
    L3_12(L4_13, A1_10, A0_9, A0_9.TEXT_COMULD011_01133_SWIFT_000_022, true)
    L4_13 = A0_9
  ...
  function ComUld011.IsTodoChecked(A0_14, A1_15, A2_16)
    local L3_17
