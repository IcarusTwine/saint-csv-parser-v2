(function()
  print("JobBrd350 loaded")
  function JobBrd350.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
    if A0_0:QuestOffer(A2_2, A1_1) then
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_ADD_YES)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_JOBBRD350_01086_JEHANTEL_000_000, false)
      A2_2:LookAt(0, 0)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_JOBBRD350_01086_JEHANTEL_000_001, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_ADD_NO)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_JOBBRD350_01086_JEHANTEL_000_002, false)
      A2_2:TurnTo(A1_1, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_JOBBRD350_01086_JEHANTEL_000_003, false)
      A2_2:WaitForTurn()
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_JOBBRD350_01086_JEHANTEL_000_004, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK1)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_JOBBRD350_01086_JEHANTEL_000_005, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_JOBBRD350_01086_JEHANTEL_000_006, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_JOBBRD350_01086_JEHANTEL_000_007, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_THINK)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_JOBBRD350_01086_JEHANTEL_000_008, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_JOBBRD350_01086_JEHANTEL_000_009, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_JOBBRD350_01086_JEHANTEL_000_010, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK2)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_JOBBRD350_01086_JEHANTEL_000_011, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_JOBBRD350_01086_JEHANTEL_000_012, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_JOBBRD350_01086_JEHANTEL_000_013, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EMOTE_HUH)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_JOBBRD350_01086_JEHANTEL_000_014, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_JOBBRD350_01086_JEHANTEL_000_015, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_JOBBRD350_01086_JEHANTEL_000_016, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_JOBBRD350_01086_JEHANTEL_000_017, true)
      return 1
    else
      return 0
    end
  end
  function JobBrd350.OnScene00001(A0_3, A1_4, A2_5)
    A0_3:QuestAccepted()
  end
  function JobBrd350.OnScene00002(A0_6, A1_7, A2_8)
  end
  function JobBrd350.OnScene00003(A0_9, A1_10, A2_11)
    A0_9:ScenarioMessage(A0_9.TEXT_JOBBRD350_01086_POP_MESSAGE)
  end
  function JobBrd350.OnScene00004(A0_12, A1_13, A2_14)
    local L3_15, L4_16
    L4_16 = A2_14
    L3_15 = A2_14.LookAt
    L3_15(L4_16, A1_13)
    L4_16 = A2_14
    L3_15 = A2_14.Talk
    L3_15(L4_16, A1_13, A0_12, A0_12.TEXT_JOBBRD350_01086_JEHANTEL_000_020, false)
    L4_16 = A2_14
    L3_15 = A2_14.PlayActionTimeline
    L3_15(L4_16, A0_12.ACTION_TIMELINE_EVENT_ADD_YES)
    L4_16 = A2_14
    L3_15 = A2_14.Talk
    L3_15(L4_16, A1_13, A0_12, A0_12.TEXT_JOBBRD350_01086_JEHANTEL_000_021, true)
    L4_16 = A0_12
  ...
  function JobBrd350.OnScene00005(A0_17, A1_18, A2_19, ...)
    local L4_21
    L4_21 = (...)
    A1_18:LookAt()
  ...
  function JobBrd350.IsTodoChecked(A0_22, A1_23, A2_24)
    local L3_25
