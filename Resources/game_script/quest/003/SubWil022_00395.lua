(function()
  print("SubWil022 loaded")
  function SubWil022.OnScene00000(A0_0, A1_1, A2_2)
    if A0_0:QuestOffer(A2_2, A1_1) then
      A2_2:LookAt(A1_1)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL022_00395_LANDEBER_000_1, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_ADD_YES)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL022_00395_LANDEBER_000_2, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_ADD_NO)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL022_00395_LANDEBER_000_3, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL022_00395_LANDEBER_000_4, true)
      A0_0:QuestAccepted()
      return 1
    else
      return 0
  ...
  function SubWil022.OnScene00001(A0_3, A1_4, A2_5)
    ...
    L5_8 = A1_4
    L6_9 = A0_3
    L3_6(L4_7, L5_8, L6_9, A0_3.TEXT_SUBWIL022_00395_SYNTGOHT_000_10, true)
    L4_7 = A0_3
    L3_6 = A0_3.NpcTrade
  ...
  function SubWil022.OnScene00100(A0_10, A1_11, A2_12)
    local L3_13, L4_14
    L4_14 = A2_12
    L3_13 = A2_12.Talk
    L3_13(L4_14, A1_11, A0_10, A0_10.TEXT_SUBWIL022_00395_SYNTGOHT_000_11, false)
    L4_14 = A2_12
    L3_13 = A2_12.PlayActionTimeline
    L3_13(L4_14, A0_10.ACTION_TIMELINE_EVENT_TALK1)
    L4_14 = A2_12
    L3_13 = A2_12.Talk
    L3_13(L4_14, A1_11, A0_10, A0_10.TEXT_SUBWIL022_00395_SYNTGOHT_000_12, false)
    L4_14 = A2_12
    L3_13 = A2_12.Talk
    L3_13(L4_14, A1_11, A0_10, A0_10.TEXT_SUBWIL022_00395_SYNTGOHT_000_13, true)
    L4_14 = A0_10
  ...
  function SubWil022.OnScene00099(A0_15, A1_16, A2_17)
  end
  function SubWil022.GetEventItems(A0_18, A1_19)
    local L2_20
  ...
  function SubWil022.IsTodoChecked(A0_21, A1_22, A2_23)
    local L3_24
