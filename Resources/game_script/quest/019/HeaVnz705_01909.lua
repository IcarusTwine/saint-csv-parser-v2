(function()
  print("HeaVnz705 loaded")
  function HeaVnz705.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function HeaVnz705.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TROUBLE)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ705_01909_GANUVALI_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ705_01909_GANUVALI_000_001, true)
    A0_3:Wait(10)
    A0_3:QuestAccepted()
  end
  function HeaVnz705.OnScene00002(A0_6, A1_7, A2_8)
  end
  function HeaVnz705.OnScene00003(A0_9, A1_10, A2_11)
  end
  function HeaVnz705.OnScene00004(A0_12, A1_13, A2_14)
  end
  function HeaVnz705.OnScene00005(A0_15, A1_16, A2_17)
  end
  function HeaVnz705.OnScene00006(A0_18, A1_19, A2_20)
  end
  function HeaVnz705.OnScene00007(A0_21, A1_22, A2_23)
  end
  function HeaVnz705.OnScene00008(A0_24, A1_25, A2_26)
    A2_26:TurnTo(A1_25)
    A2_26:WaitForTurn()
    A2_26:PlayActionTimeline(A0_24.ACTION_TIMELINE_EVENT_TROUBLE)
    A2_26:Talk(A1_25, A0_24, A0_24.TEXT_HEAVNZ705_01909_GANUVALI_000_010, true)
  end
  function HeaVnz705.OnScene00009(A0_27, A1_28, A2_29)
  ...
  function HeaVnz705.OnScene00010(A0_37, A1_38, A2_39)
    local L3_40, L4_41
    L4_41 = A2_39
    L3_40 = A2_39.PlayActionTimeline
    L3_40(L4_41, A0_37.EVENT_ACTION_JOY)
    L4_41 = A2_39
    L3_40 = A2_39.Talk
    L3_40(L4_41, A1_38, A0_37, A0_37.TEXT_HEAVNZ705_01909_GANUVALI_000_021, true)
    L4_41 = A0_37
  ...
  function HeaVnz705.GetEventItems(A0_42, A1_43)
    local L2_44
  ...
  function HeaVnz705.IsTodoChecked(A0_45, A1_46, A2_47)
    local L3_48
