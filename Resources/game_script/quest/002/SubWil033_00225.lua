(function()
  print("SubWil033 loaded")
  function SubWil033.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
    if A0_0:QuestOffer(A2_2, A1_1) then
      A2_2:TurnTo(A1_1)
      A2_2:WaitForTurn()
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EMOTE_UPSET)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL033_00225_FAFAFONO_001, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL033_00225_FAFAFONO_002, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_ADD_NO)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_SUBWIL033_00225_FAFAFONO_003, true)
      A0_0:QuestAccepted()
      return 1
    else
      return 0
  ...
  function SubWil033.OnScene00001(A0_3, A1_4, A2_5)
  end
  function SubWil033.OnScene00002(A0_6, A1_7, A2_8)
  end
  function SubWil033.OnScene00003(A0_9, A1_10, A2_11)
  end
  function SubWil033.OnScene00004(A0_12, A1_13, A2_14)
  end
  function SubWil033.OnScene00005(A0_15, A1_16, A2_17)
  end
  function SubWil033.OnScene00006(A0_18, A1_19, A2_20)
  end
  function SubWil033.OnScene00007(A0_21, A1_22, A2_23)
  end
  function SubWil033.OnScene00008(A0_24, A1_25, A2_26)
  end
  function SubWil033.OnScene00009(A0_27, A1_28, A2_29)
  end
  function SubWil033.OnScene00010(A0_30, A1_31, A2_32)
  ...
  function SubWil033.OnScene00011(A0_40, A1_41, A2_42)
    local L3_43, L4_44
    L4_44 = A2_42
    L3_43 = A2_42.PlayActionTimeline
    L3_43(L4_44, A0_40.ACTION_TIMELINE_EVENT_BASE_IDLE2)
    L4_44 = A2_42
    L3_43 = A2_42.Talk
    L3_43(L4_44, A1_41, A0_40, A0_40.TEXT_SUBWIL033_00225_FAFAFONO_012, false)
    L4_44 = A2_42
    L3_43 = A2_42.Talk
    L3_43(L4_44, A1_41, A0_40, A0_40.TEXT_SUBWIL033_00225_FAFAFONO_013, false)
    L4_44 = A2_42
    L3_43 = A2_42.PlayActionTimeline
    L3_43(L4_44, A0_40.ACTION_TIMELINE_EVENT_ADD_NO)
    L4_44 = A2_42
    L3_43 = A2_42.Talk
    L3_43(L4_44, A1_41, A0_40, A0_40.TEXT_SUBWIL033_00225_FAFAFONO_014, false)
    L4_44 = A2_42
    L3_43 = A2_42.Talk
    L3_43(L4_44, A1_41, A0_40, A0_40.TEXT_SUBWIL033_00225_FAFAFONO_015, true)
    L4_44 = A0_40
  ...
  function SubWil033.OnScene00012(A0_45, A1_46, A2_47)
  end
  function SubWil033.GetEventItems(A0_48, A1_49)
    local L2_50
  ...
  function SubWil033.IsTodoChecked(A0_51, A1_52, A2_53)
    local L3_54
