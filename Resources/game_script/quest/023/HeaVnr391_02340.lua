(function()
  print("HeaVnr391 loaded")
  function HeaVnr391.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function HeaVnr391.OnScene00001(A0_3, A1_4, A2_5)
    local L3_6, L4_7
    L4_7 = A2_5
    L3_6 = A2_5.TurnTo
    ...
    L4_7:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNR391_02340_WANDERINGMINSTREL_000_000, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A0_3:Wait(20)
    ...
    L4_7:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNR391_02340_WANDERINGMINSTREL_000_001, false, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    L4_7:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNR391_02340_WANDERINGMINSTREL_000_002, false, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    ...
    L4_7:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNR391_02340_WANDERINGMINSTREL_000_003, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    ...
    A0_3:WaitForFade()
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNR391_02340_WANDERINGMINSTREL_000_010, false, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNR391_02340_WANDERINGMINSTREL_000_011, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A0_3:Wait(20)
    A0_3:FadeOut(A0_3.FADE_SHORT, A0_3.FADE_LAYER_BACK)
    A0_3:WaitForFade()
    ...
    L4_7:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNR391_02340_WANDERINGMINSTREL_000_020, false, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    L4_7:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNR391_02340_WANDERINGMINSTREL_000_021, false, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    L4_7:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_BOTHHAND)
    L4_7:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNR391_02340_WANDERINGMINSTREL_000_022, true, nil, nil, nil, A0_3.SPEAK_NORMAL_MIDDLE)
    A0_3:QuestAccepted()
    A0_3:Wait(120)
  ...
  function HeaVnr391.OnScene00002(A0_8, A1_9, A2_10)
    local L3_11, L4_12
    L4_12 = A2_10
    L3_11 = A2_10.TurnTo
    ...
    L4_12 = A2_10
    L3_11 = A2_10.Talk
    L3_11(L4_12, A1_9, A0_8, A0_8.TEXT_HEAVNR391_02340_SNAPCLIX_000_010, true)
    L4_12 = A0_8
    ...
    if L3_11 then
      ...
      if A1_9:IsInstanceContentEnableFinder(A0_8.CONTENT_FINDER_CONDITION) then
        ...
        A0_8:Wait(120)
        A0_8:SystemTalk(A0_8.TEXT_HEAVNR391_02340_SYSTEM_000_020, true)
      else
        A0_8:Wait(60)
        if A1_9:IsQuestCompleted(A0_8.DPS_CHALLENGE_OPEN_QUEST) == true then
  ...
  function HeaVnr391.OnScene00003(A0_13, A1_14, A2_15)
    A2_15:LookAt(A1_14)
    A2_15:Talk(A1_14, A0_13, A0_13.TEXT_HEAVNR391_02340_WANDERINGMINSTREL_000_030, true)
  end
  function HeaVnr391.IsTodoChecked(A0_16, A1_17, A2_18)
    local L3_19
