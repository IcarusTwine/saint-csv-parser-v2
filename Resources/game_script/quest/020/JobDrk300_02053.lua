(function()
  print("JobDrk300 loaded")
  function JobDrk300.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function JobDrk300.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRK300_02053_CITIZEN02053_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRK300_02053_CITIZEN02053_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRK300_02053_CITIZEN02053_000_002, false)
    A2_5:CancelActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK1)
    A0_3:Wait(10)
    A2_5:Idle(A0_3.ACTION_TIMELINE_EVENT_BASE_IDLE1)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_ADD_NO)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRK300_02053_CITIZEN02053_000_003, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRK300_02053_CITIZEN02053_000_004, false)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK2)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_JOBDRK300_02053_CITIZEN02053_000_005, true)
  ...
  function JobDrk300.OnScene00002(A0_6, A1_7, A2_8)
    A0_6:BeginCutScene()
    A0_6:PlayCutScene(A0_6.NCUT_01)
    A0_6:EndCutScene()
  end
  function JobDrk300.OnScene00003(A0_9, A1_10, A2_11)
  end
  function JobDrk300.OnScene00004(A0_12, A1_13, A2_14)
  end
  function JobDrk300.OnScene00005(A0_15, A1_16, A2_17)
    local L3_18, L4_19
    L4_19 = A2_17
    L3_18 = A2_17.TurnTo
    ...
    L4_19 = A2_17
    L3_18 = A2_17.Talk
    L3_18(L4_19, A1_16, A0_15, A0_15.TEXT_JOBDRK300_02053_FRAY_000_060, false)
    L4_19 = A2_17
    ...
    L4_19 = A2_17
    L3_18 = A2_17.Idle
    L3_18(L4_19, A0_15.ACTION_TIMELINE_EVENT_BASE_IDLE1)
    L4_19 = A2_17
    L3_18 = A2_17.Talk
    L3_18(L4_19, A1_16, A0_15, A0_15.TEXT_JOBDRK300_02053_FRAY_000_061, false)
    L4_19 = A2_17
    L3_18 = A2_17.Talk
    L3_18(L4_19, A1_16, A0_15, A0_15.TEXT_JOBDRK300_02053_FRAY_000_062, false)
    L4_19 = A2_17
    L3_18 = A2_17.Idle
    ...
    L4_19 = A2_17
    L3_18 = A2_17.Talk
    L3_18(L4_19, A1_16, A0_15, A0_15.TEXT_JOBDRK300_02053_FRAY_000_063, true)
    L4_19 = A0_15
    L3_18 = A0_15.Wait
    L3_18(L4_19, 30)
    L4_19 = A0_15
    ...
    if L3_18 then
      ...
      A0_15:Wait(120)
      A0_15:ScreenImage(A0_15.UNLOCK_IMAGE_CLASS)
      A0_15:Wait(50)
    end
    return L3_18, L4_19
  end
  function JobDrk300.IsTodoChecked(A0_20, A1_21, A2_22)
    local L3_23
