(function()
  print("GaiUsa602 loaded")
  function GaiUsa602.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
    if A0_0:QuestOffer(A2_2, A1_1) then
      ...
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_GAIUSA602_00764_NEDRICK_000_000, false)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_GAIUSA602_00764_NEDRICK_000_001, false)
      A2_2:PlayActionTimeline(A0_0.ACTION_TIMELINE_EVENT_TALK2, A1_1)
      A2_2:Talk(A1_1, A0_0, A0_0.TEXT_GAIUSA602_00764_NEDRICK_000_002, true)
      return 1
    else
      return 0
    end
  end
  function GaiUsa602.OnScene00001(A0_3, A1_4, A2_5)
    A0_3:QuestAccepted()
  end
  function GaiUsa602.OnScene00002(A0_6, A1_7, A2_8)
    local L3_9, L4_10
    L4_10 = A2_8
    L3_9 = A2_8.TurnTo
    L3_9(L4_10, A1_7)
    ...
    L3_9(L4_10, A0_6.ACTION_TIMELINE_EVENT_BASE_IDLE, A1_7)
    L4_10 = A2_8
    L3_9 = A2_8.PlayActionTimeline
    L3_9(L4_10, A0_6.ACTION_TIMELINE_EVENT_TALK2, A1_7)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_GAIUSA602_00764_BIBIMU_000_010, false)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_GAIUSA602_00764_BIBIMU_000_011, false)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_GAIUSA602_00764_BIBIMU_000_012, false)
    L4_10 = A2_8
    L3_9 = A2_8.PlayActionTimeline
    L3_9(L4_10, A0_6.ACTION_TIMELINE_EVENT_TALK_FOREFINGER, A1_7)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_GAIUSA602_00764_BIBIMU_000_013, true)
    L4_10 = A0_6
  ...
  function GaiUsa602.IsTodoChecked(A0_11, A1_12, A2_13)
    local L3_14
