(function()
  print("HeaVnz525 loaded")
  function HeaVnz525.OnScene00000(A0_0, A1_1, A2_2)
  ...
  function HeaVnz525.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ525_01860_MOGGZIA_000_010, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_ANGRY)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ525_01860_MOGGZIA_000_011, true)
    A0_3:Wait(10)
    A0_3:QuestAccepted()
  end
  function HeaVnz525.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_HEAVNZ525_01860_LYINGMOGB01836_100_001, true)
  end
  function HeaVnz525.OnScene00003(A0_9, A1_10, A2_11)
    A2_11:TurnTo(A1_10)
    A2_11:Talk(A1_10, A0_9, A0_9.TEXT_HEAVNZ525_01860_CAREGIVERMOG01836_100_000, true)
  end
  function HeaVnz525.OnScene00004(A0_12, A1_13, A2_14)
    A2_14:TurnTo(A1_13)
    A2_14:Talk(A1_13, A0_12, A0_12.TEXT_HEAVNZ525_01860_LYINGMOGA01836_100_002, true)
  end
  function HeaVnz525.OnScene00005(A0_15, A1_16, A2_17)
  end
  function HeaVnz525.OnScene00006(A0_18, A1_19, A2_20)
  end
  function HeaVnz525.OnScene00007(A0_21, A1_22, A2_23)
  end
  function HeaVnz525.OnScene00008(A0_24, A1_25, A2_26)
  end
  function HeaVnz525.OnScene00009(A0_27, A1_28, A2_29)
  end
  function HeaVnz525.OnScene00010(A0_30, A1_31, A2_32)
  end
  function HeaVnz525.OnScene00011(A0_33, A1_34, A2_35)
    A2_35:TurnTo(A1_34, false)
    A2_35:WaitForTurn()
    A2_35:PlayActionTimeline(A0_33.ACTION_TIMELINE_EVENT_TALK_ANGRY)
    A2_35:Talk(A1_34, A0_33, A0_33.TEXT_HEAVNZ525_01860_MOGGZIA_000_020, true)
  end
  function HeaVnz525.OnScene00012(A0_36, A1_37, A2_38)
  ...
  function HeaVnz525.OnScene00013(A0_46, A1_47, A2_48)
    local L3_49, L4_50
    L4_50 = A2_48
    ...
    L4_50 = A2_48
    L3_49 = A2_48.Talk
    L3_49(L4_50, A1_47, A0_46, A0_46.TEXT_HEAVNZ525_01860_MOGGZIA_000_031, true)
    L4_50 = A0_46
    L3_49 = A0_46.Wait
    L3_49(L4_50, 10)
    L4_50 = A0_46
  ...
  function HeaVnz525.GetEventItems(A0_51, A1_52)
    local L2_53
  ...
  function HeaVnz525.IsTodoChecked(A0_54, A1_55, A2_56)
    local L3_57
