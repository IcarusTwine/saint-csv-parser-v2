(function()
  print("SubCts642 loaded")
  function SubCts642.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function SubCts642.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_SUBCTS642_03731_ANFRIGG_000_000, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_SUBCTS642_03731_ANFRIGG_000_001, false)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_SUBCTS642_03731_ANFRIGG_000_002, true)
    A0_3:QuestAccepted()
  end
  function SubCts642.OnScene00002(A0_6, A1_7, A2_8)
    local L3_9, L4_10
    L4_10 = A2_8
    L3_9 = A2_8.TurnTo
    ...
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_SUBCTS642_03731_LEREBERD_000_020, false)
    L4_10 = A2_8
    L3_9 = A2_8.PlayActionTimeline
    L3_9(L4_10, A0_6.ACTION_TIMELINE_EVENT_TALK1)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_SUBCTS642_03731_LEREBERD_000_021, false)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_SUBCTS642_03731_LEREBERD_000_022, false)
    L4_10 = A2_8
    L3_9 = A2_8.PlayActionTimeline
    L3_9(L4_10, A0_6.ACTION_TIMELINE_EVENT_TALK_FOREFINGER)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_SUBCTS642_03731_LEREBERD_000_023, false)
    L4_10 = A2_8
    L3_9 = A2_8.Talk
    L3_9(L4_10, A1_7, A0_6, A0_6.TEXT_SUBCTS642_03731_LEREBERD_000_024, true)
    L4_10 = A0_6
    L3_9 = A0_6.Wait
    L3_9(L4_10, 10)
    L4_10 = A0_6
  ...
  function SubCts642.OnScene00003(A0_11, A1_12, A2_13)
    A2_13:LookAt(A1_12)
    A2_13:Talk(A1_12, A0_11, A0_11.TEXT_SUBCTS642_03731_ANFRIGG_000_010, true)
  end
  function SubCts642.IsTodoChecked(A0_14, A1_15, A2_16)
    local L3_17
