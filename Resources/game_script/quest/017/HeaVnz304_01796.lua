(function()
  print("HeaVnz304 loaded")
  function HeaVnz304.OnScene00000(A0_0, A1_1, A2_2)
    A2_2:LookAt(A1_1)
  ...
  function HeaVnz304.OnScene00001(A0_3, A1_4, A2_5)
    A2_5:TurnTo(A1_4, false)
    A2_5:WaitForTurn()
    A2_5:PlayActionTimeline(A0_3.EVENT_ACTION_JOY)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ304_01796_STORYTELLER_000_000, false)
    A0_3:Wait(10)
    A2_5:CancelActionTimeline(A0_3.EVENT_ACTION_JOY)
    A2_5:PlayActionTimeline(A0_3.ACTION_TIMELINE_EVENT_TALK_ANGRY)
    A2_5:Talk(A1_4, A0_3, A0_3.TEXT_HEAVNZ304_01796_STORYTELLER_000_001, true)
    A0_3:Wait(10)
    A0_3:QuestAccepted()
  end
  function HeaVnz304.OnScene00002(A0_6, A1_7, A2_8)
    A2_8:TurnTo(A1_7)
    A2_8:WaitForTurn()
    A2_8:PlayActionTimeline(A0_6.ACTION_TIMELINE_EVENT_TALK_ANGRY)
    A2_8:Talk(A1_7, A0_6, A0_6.TEXT_HEAVNZ304_01796_STORYTELLER_000_010, true)
  end
  function HeaVnz304.OnScene00003(A0_9, A1_10, A2_11)
    local L3_12, L4_13
    L4_13 = A2_11
    L3_12 = A2_11.TurnTo
    ...
    L4_13 = A2_11
    L3_12 = A2_11.Talk
    L3_12(L4_13, A1_10, A0_9, A0_9.TEXT_HEAVNZ304_01796_STORYTELLER_000_030, false)
    L4_13 = A2_11
    L3_12 = A2_11.PlayActionTimeline
    L3_12(L4_13, A0_9.ACTION_TIMELINE_EVENT_ADD_NO)
    L4_13 = A2_11
    L3_12 = A2_11.Talk
    L3_12(L4_13, A1_10, A0_9, A0_9.TEXT_HEAVNZ304_01796_STORYTELLER_000_031, true)
    L4_13 = A0_9
    L3_12 = A0_9.Wait
    L3_12(L4_13, 10)
    L4_13 = A0_9
  ...
  function HeaVnz304.IsTodoChecked(A0_14, A1_15, A2_16)
    local L3_17
  ...
  function L1_19(A0_22, A1_23, A2_24, A3_25, A4_26)
    ...
    if A1_23:GetQuestSequence(L5_27) == A0_22.SEQ_1 then
      if A3_25 == A0_22.ENEMY0 then
        if 1 <= A1_23:GetQuestUI8BL(L5_27) then
          return false
        end
